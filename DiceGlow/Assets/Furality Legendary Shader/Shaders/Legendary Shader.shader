...
Shader "Furality/Legendary Shader/Legendary Shader"
{
	Properties
	{
	...
	SubShader
	{
		...
		void outlineVertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float3 vertexPos2051 = ( ase_vertex3Pos + ( ase_vertexNormal * temp_output_932_0 ) );
			float4 ase_screenPos2051 = ComputeScreenPos( UnityObjectToClipPos( vertexPos2051 ) );
			o.screenPosition2051 = ase_screenPos2051;
		...
		{
			float4 ase_screenPos2051 = i.screenPosition2051;
			float4 ase_screenPosNorm2051 = ase_screenPos2051 / ase_screenPos2051.w;
			ase_screenPosNorm2051.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm2051.z : ase_screenPosNorm2051.z * 0.5 + 0.5;
			float screenDepth2051 = LinearEyeDepth(SAMPLE_DEPTH_TEXTURE( _CameraDepthTexture, ase_screenPosNorm2051.xy ));
			float distanceDepth2051 = ( screenDepth2051 - LinearEyeDepth( ase_screenPosNorm2051.z ) ) / ( _OutlineDepthFade );
			...
			float lerpResult2066 = lerp( saturate( distanceDepth2051 ) , 1.0 , isLightMissing1721);
			o.Emission = _OutlineColor.rgb;
			clip( lerpResult2066 - _Cutoff );
		}
		ENDCG
		...
		float3 CustomReflectionProbeSample2053( float3 uvw )
		{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float DistanceBlendAlpha2076 = temp_output_38_0;
			float lerpResult2087 = lerp( lerpResult1787 , saturate( NdotL23 ) , DistanceBlendAlpha2076);
			float saferPower2_g374 = max( ( 1.0 / 2.71828 ) , 0.0001 );
			float ShadowLength1497 = _ShadowLength;
			float ShadowOffset1502 = _ShadowOffset;
			float saferPower1_g374 = max( ( -( 1.0 - (6.0 + (ShadowLength1497 - 0.0) * (64.0 - 6.0) / (16.0 - 0.0)) ) * ( BaseNdotL286 + ShadowOffset1502 ) ) , 0.0001 );
			float temp_output_2_0_g374 = pow( saferPower2_g374 , pow( saferPower1_g374 , 2.0 ) );
			float ToonLighting1505 = ( 1.0 - temp_output_2_0_g374 );
			float lerpResult1796 = lerp( lerpResult2087 , ToonLighting1505 , saturate( ( ShadowStyleIndex1758 - 6.0 ) ));
			float saferPower2_g375 = max( ( 1.0 / 2.71828 ) , 0.0001 );
			float saferPower1_g375 = max( ( -( 1.0 - (2.0 + (ShadowLength1497 - 0.0) * (16.0 - 2.0) / (16.0 - 0.0)) ) * ( (BaseNdotL286*0.5 + 0.5) + ShadowOffset1502 ) ) , 0.0001 );
			float temp_output_2_0_g375 = pow( saferPower2_g375 , pow( saferPower1_g375 , 2.0 ) );
			float HalfLambert1522 = ( 1.0 - temp_output_2_0_g375 );
			...
			float temp_output_3_0_g400 = ( 0.0 - ( Circles338 - ( 1.0 - ase_lightAtten ) ) );
			float CircularShadows967 = ( 1.0 - ( saturate( ( temp_output_3_0_g400 / fwidth( temp_output_3_0_g400 ) ) ) * ( 1.0 - ase_lightAtten ) ) );
			...
			float temp_output_3_0_g402 = ( 0.0 - ( ( Squares684 * 0.5 ) - ( 1.0 - ase_lightAtten ) ) );
			float SquareShadows988 = ( 1.0 - ( saturate( ( temp_output_3_0_g402 / fwidth( temp_output_3_0_g402 ) ) ) * ( 1.0 - ase_lightAtten ) ) );
			...
			float temp_output_3_0_g403 = ( 0.0 - localHexagon1064 );
			float HexagonalShadows1051 = ( 1.0 - ( saturate( ( temp_output_3_0_g403 / fwidth( temp_output_3_0_g403 ) ) ) * ( 1.0 - ase_lightAtten ) ) );
			...
			float temp_output_3_0_g404 = ( 0.0 - localRegularStar1038 );
			float StarShadows21034 = ( 1.0 - ( saturate( ( temp_output_3_0_g404 / fwidth( temp_output_3_0_g404 ) ) ) * ( 1.0 - ase_lightAtten ) ) );
			...
			float temp_output_3_0_g429 = ( 0.0 - localRegularStar1024 );
			float StarShadows11021 = ( 1.0 - ( saturate( ( temp_output_3_0_g429 / fwidth( temp_output_3_0_g429 ) ) ) * ( 1.0 - ase_lightAtten ) ) );
			float lerpResult1836 = lerp( lerpResult1827 , StarShadows11021 , saturate( ( ShadowStyleIndex1758 - 4.0 ) ));
			float lerpResult2101 = lerp( lerpResult1836 , ase_lightAtten , DistanceBlendAlpha2076);
			float Lines725 = temp_output_89_0;
			float temp_output_3_0_g436 = ( 0.0 - ( ( Lines725 * 0.5 ) - ( 1.0 - ase_lightAtten ) ) );
			float LineShadows1003 = ( 1.0 - ( saturate( ( temp_output_3_0_g436 / fwidth( temp_output_3_0_g436 ) ) ) * ( 1.0 - ase_lightAtten ) ) );
			float lerpResult1837 = lerp( lerpResult2101 , LineShadows1003 , saturate( ( ShadowStyleIndex1758 - 5.0 ) ));
			...
			float lerpResult1841 = lerp( lerpResult1837 , smoothstepResult1848 , saturate( ( ShadowStyleIndex1758 - 6.0 ) ));
			...
			float3 uvw2053 = (WorldNormalVector( i , Normal7 ));
			float3 localCustomReflectionProbeSample2053 = CustomReflectionProbeSample2053( uvw2053 );
			float3 CustomProbe2056 = localCustomReflectionProbeSample2053;
			float3 lerpResult2058 = lerp( temp_output_1419_0 , ( ( temp_output_1419_0 + CustomProbe2056 ) * float3( 0.5,0.5,0.5 ) ) , isLightMissing1721);
			float3 IndirectDiffuse728 = lerpResult2058;
			float3 lerpResult1706 = lerp( ( ase_lightColor.rgb * StylizedAttenuation1077 ) , ( ( IndirectDiffuse728 + CustomProbe2056 ) * float3( 0.5,0.5,0.5 ) ) , isLightMissing1721);
			...
			float temp_output_3_0_g434 = ( 0.0 - ( length( ( SpecularHalftoneUVS416 + float2( -0.5,-0.5 ) ) ) - HalftoneSpecular379 ) );
			float CircularSpecular404 = ( ( saturate( ( temp_output_3_0_g434 / fwidth( temp_output_3_0_g434 ) ) ) * 3.5 ) * ( DefaultSpecular324 + ( HalftoneSpecular379 * 2.0 ) ) * Smoothness354 );
			...
			float temp_output_3_0_g440 = ( 0.0 - ( ( ( max( max( break426.x , break426.y ) , max( break427.x , break427.y ) ) * 1.9 ) - 1.5 ) - HalftoneSpecular379 ) );
			float SquareSpecular444 = ( ( saturate( ( temp_output_3_0_g440 / fwidth( temp_output_3_0_g440 ) ) ) * 3.5 ) * ( DefaultSpecular324 + ( HalftoneSpecular379 * 2.0 ) ) * Smoothness354 );
			...
			float temp_output_3_0_g444 = ( 0.0 - localHexagon525 );
			float SpecularHexagon531 = ( ( saturate( ( temp_output_3_0_g444 / fwidth( temp_output_3_0_g444 ) ) ) * 3.5 ) * ( DefaultSpecular324 + ( HalftoneSpecular379 * 2.0 ) ) * Smoothness354 );
			...
			float temp_output_3_0_g447 = ( 0.0 - localRegularStar508 );
			float Specular4SidedStar513 = ( ( saturate( ( temp_output_3_0_g447 / fwidth( temp_output_3_0_g447 ) ) ) * 3.5 ) * ( DefaultSpecular324 + ( HalftoneSpecular379 * 2.0 ) ) * Smoothness354 );
			...
			float temp_output_3_0_g450 = ( 0.0 - localRegularStar486 );
			float Specular8SidedStar491 = ( ( saturate( ( temp_output_3_0_g450 / fwidth( temp_output_3_0_g450 ) ) ) * 3.5 ) * ( DefaultSpecular324 + ( HalftoneSpecular379 * 2.0 ) ) * Smoothness354 );
			...
			float temp_output_3_0_g452 = ( 0.0 - ( ( abs( sin( rotator455.x ) ) * 0.5 ) - HalftoneSpecular379 ) );
			float LinesSpecular467 = ( ( saturate( ( temp_output_3_0_g452 / fwidth( temp_output_3_0_g452 ) ) ) * 3.5 ) * ( DefaultSpecular324 + ( HalftoneSpecular379 * 2.0 ) ) * Smoothness354 );
			float lerpResult2031 = lerp( lerpResult2025 , LinesSpecular467 , saturate( ( SpecularStyleIndex1995 - 5.0 ) ));
			float lerpResult2107 = lerp( lerpResult2031 , DefaultSpecular324 , DistanceBlendAlpha2076);
			float ToonSpecular1545 = ( ( HalftoneSpecular379 * 3.5 ) * ( HalftoneSpecular379 * 2.0 ) );
			float lerpResult2033 = lerp( lerpResult2107 , ToonSpecular1545 , saturate( ( SpecularStyleIndex1995 - 6.0 ) ));
			float SelectedSpecularStyle388 = lerpResult2033;
			float saferPower2_g376 = max( ( 1.0 / 2.71828 ) , 0.0001 );
			...
			float saferPower1_g376 = max( ( -( 1.0 - _RimlightLength ) * ( -dotResult738 + _RimlightOffset ) ) , 0.0001 );
			float temp_output_2_0_g376 = pow( saferPower2_g376 , pow( saferPower1_g376 , 2.0 ) );
			float temp_output_1451_0 = ( 1.0 - temp_output_2_0_g376 );
			...
			float temp_output_3_0_g428 = ( 0.0 - ( length( ( RimlightHalftoneUVS784 + float2( -0.5,-0.5 ) ) ) - ( Rimlight773 + DistanceBlend40 ) ) );
			float BaseRimlight769 = ( temp_output_1451_0 * SelectedLightingStyle165 * 2.0 );
			float CircularRimlight786 = ( saturate( ( temp_output_3_0_g428 / fwidth( temp_output_3_0_g428 ) ) ) * BaseRimlight769 );
			...
			float temp_output_3_0_g430 = ( 0.0 - ( ( ( max( max( break807.x , break807.y ) , max( break806.x , break806.y ) ) * 1.5 ) - 0.85 ) - Rimlight773 ) );
			float SquareRimlight824 = ( saturate( ( temp_output_3_0_g430 / fwidth( temp_output_3_0_g430 ) ) ) * BaseRimlight769 );
			...
			float temp_output_3_0_g435 = ( 0.0 - localHexagon919 );
			float RimlightHexagon927 = ( saturate( ( temp_output_3_0_g435 / fwidth( temp_output_3_0_g435 ) ) ) * BaseRimlight769 );
			...
			float temp_output_3_0_g439 = ( 0.0 - localRegularStar905 );
			float Rimlight4SidedStar913 = ( saturate( ( temp_output_3_0_g439 / fwidth( temp_output_3_0_g439 ) ) ) * BaseRimlight769 );
			...
			float temp_output_3_0_g443 = ( 0.0 - localRegularStar888 );
			float Rimlight8SidedStar894 = ( saturate( ( temp_output_3_0_g443 / fwidth( temp_output_3_0_g443 ) ) ) * BaseRimlight769 );
			...
			float temp_output_3_0_g448 = ( 0.56 - ( abs( sin( rotator868.x ) ) - Rimlight773 ) );
			float RimlightLines862 = ( saturate( ( temp_output_3_0_g448 / fwidth( temp_output_3_0_g448 ) ) ) * BaseRimlight769 );
			float lerpResult1935 = lerp( lerpResult1926 , RimlightLines862 , saturate( ( RimlightStyleIndex1942 - 5.0 ) ));
			float lerpResult2096 = lerp( lerpResult1935 , saturate( Rimlight773 ) , DistanceBlendAlpha2076);
			...
			float saferPower1_g453 = max( ( -( 1.0 - (6.0 + (RimlightLength1560 - 0.0) * (32.0 - 6.0) / (16.0 - 0.0)) ) * ( BaseRimlightForToon1744 + (0.3 + (RimlightOffset1561 - -1.0) * (1.0 - 0.3) / (5.0 - -1.0)) ) ) , 0.0001 );
			float temp_output_2_0_g453 = pow( saferPower2_g453 , pow( saferPower1_g453 , 2.0 ) );
			float ToonRimlight1559 = ( ( 1.0 - temp_output_2_0_g453 ) * SelectedLightingStyle165 );
			float lerpResult1938 = lerp( lerpResult2096 , ToonRimlight1559 , saturate( ( RimlightStyleIndex1942 - 6.0 ) ));
		...
		void surf( Input i , inout SurfaceOutputCustomLightingCustom o )
		{
			...
			float cos695_g454 = cos( radians( _GradientDirection ) );
			float sin695_g454 = sin( radians( _GradientDirection ) );
			float2 rotator695_g454 = mul( i.uv_texcoord - float2( 0.5,0.5 ) , float2x2( cos695_g454 , -sin695_g454 , sin695_g454 , cos695_g454 )) + float2( 0.5,0.5 );
			float2 GradientUVs698_g454 = rotator695_g454;
			float4 _GradientZone2 = float4(9.4,0,0.57,0.49);
			float2 appendResult34_g454 = (float2(( 1.0 / _GradientZone2.x ) , 0.0));
			float2 appendResult42_g454 = (float2(_GradientZone2.z , _GradientZone2.w));
			float2 clampResult707_g454 = clamp( (GradientUVs698_g454*appendResult34_g454 + appendResult42_g454) , float2( 0.571,0 ) , float2( 0.676,1 ) );
			float2 GradientZone0175_g454 = clampResult707_g454;
			float4 _GradientZone3 = float4(9.4,0,0.6805,0.49);
			float2 appendResult38_g454 = (float2(( 1.0 / _GradientZone3.x ) , 0.0));
			float2 appendResult41_g454 = (float2(_GradientZone3.z , _GradientZone3.w));
			float2 clampResult710_g454 = clamp( (GradientUVs698_g454*appendResult38_g454 + appendResult41_g454) , float2( 0.681,0 ) , float2( 0.786,1 ) );
			float2 GradientZone0282_g454 = clampResult710_g454;
			int EmissionZoneIndex47_g454 = _EmissionZone;
			float2 lerpResult169_g454 = lerp( GradientZone0175_g454 , GradientZone0282_g454 , (float)saturate( EmissionZoneIndex47_g454 ));
			float4 _GradientZone4 = float4(9.4,0,0.791,0.49);
			float2 appendResult57_g454 = (float2(( 1.0 / _GradientZone4.x ) , 0.0));
			float2 appendResult52_g454 = (float2(_GradientZone4.z , _GradientZone4.w));
			float2 clampResult711_g454 = clamp( (GradientUVs698_g454*appendResult57_g454 + appendResult52_g454) , float2( 0.792,0 ) , float2( 0.896,1 ) );
			float2 GradientZone03122_g454 = clampResult711_g454;
			float2 lerpResult214_g454 = lerp( lerpResult169_g454 , GradientZone03122_g454 , (float)saturate( ( EmissionZoneIndex47_g454 - 1 ) ));
			float2 OriginalOffset44_g454 = float2( 0.1,0.471 );
			float2 Zone01138_g454 = ( float2( 0.955,0.992 ) - OriginalOffset44_g454 );
			float2 lerpResult249_g454 = lerp( lerpResult214_g454 , Zone01138_g454 , (float)saturate( ( EmissionZoneIndex47_g454 - 2 ) ));
			float2 Zone02188_g454 = ( float2( 0.964,0.992 ) - OriginalOffset44_g454 );
			float2 lerpResult286_g454 = lerp( lerpResult249_g454 , Zone02188_g454 , (float)saturate( ( EmissionZoneIndex47_g454 - 3 ) ));
			float2 Zone03224_g454 = ( float2( 0.955,0.978 ) - OriginalOffset44_g454 );
			float2 lerpResult343_g454 = lerp( lerpResult286_g454 , Zone03224_g454 , (float)saturate( ( EmissionZoneIndex47_g454 - 4 ) ));
			...
			float3 DebugGradient1111_g454 = appendResult65_g454;
			float temp_output_713_0_g454 = saturate( ( 1.0 - abs( sin( ( GradientUVs698_g454.x + _Time.y + 0.3 ) ) ) ) );
			float3 appendResult72_g454 = (float3(temp_output_713_0_g454 , temp_output_713_0_g454 , 0.0));
			float3 DebugGradient2110_g454 = appendResult72_g454;
			float3 lerpResult181_g454 = lerp( DebugGradient1111_g454 , DebugGradient2110_g454 , (float)saturate( EmissionZoneIndex47_g454 ));
			float temp_output_714_0_g454 = saturate( ( 1.0 - abs( sin( ( GradientUVs698_g454.x + _Time.y + 0.6 ) ) ) ) );
			float3 appendResult96_g454 = (float3(0.0 , temp_output_714_0_g454 , temp_output_714_0_g454));
			float3 DebugGradient3173_g454 = appendResult96_g454;
			float3 lerpResult244_g454 = lerp( lerpResult181_g454 , DebugGradient3173_g454 , (float)saturate( ( EmissionZoneIndex47_g454 - 1 ) ));
			float3 appendResult139_g454 = (float3(0.0 , 0.0 , saturate( ( 1.0 - abs( sin( _Time.y ) ) ) )));
			float3 DebugZone1195_g454 = appendResult139_g454;
			float3 lerpResult278_g454 = lerp( lerpResult244_g454 , DebugZone1195_g454 , (float)saturate( ( EmissionZoneIndex47_g454 - 2 ) ));
			float temp_output_716_0_g454 = saturate( ( 1.0 - abs( sin( ( _Time.y + 0.2 ) ) ) ) );
			float3 appendResult192_g454 = (float3(temp_output_716_0_g454 , temp_output_716_0_g454 , temp_output_716_0_g454));
			float3 DebugZone2250_g454 = appendResult192_g454;
			float3 lerpResult352_g454 = lerp( lerpResult278_g454 , DebugZone2250_g454 , (float)saturate( ( EmissionZoneIndex47_g454 - 3 ) ));
			float3 appendResult259_g454 = (float3(saturate( ( 1.0 - abs( sin( ( _Time.y + 0.4 ) ) ) ) ) , 0.0 , 0.0));
			float3 DebugZone3309_g454 = appendResult259_g454;
			float3 lerpResult362_g454 = lerp( lerpResult352_g454 , DebugZone3309_g454 , (float)saturate( ( EmissionZoneIndex47_g454 - 4 ) ));
			float3 appendResult306_g454 = (float3(0.0 , saturate( ( 1.0 - abs( sin( ( _Time.y + 0.6 ) ) ) ) ) , 0.0));
			...
			int GlowMaskRIndex48_g454 = _GlowMaskZoneR;
			float2 lerpResult170_g454 = lerp( GradientZone0175_g454 , GradientZone0282_g454 , (float)saturate( GlowMaskRIndex48_g454 ));
			float2 lerpResult216_g454 = lerp( lerpResult170_g454 , GradientZone03122_g454 , (float)saturate( ( GlowMaskRIndex48_g454 - 1 ) ));
			float2 lerpResult263_g454 = lerp( lerpResult216_g454 , Zone01138_g454 , (float)saturate( ( GlowMaskRIndex48_g454 - 2 ) ));
			float2 lerpResult298_g454 = lerp( lerpResult263_g454 , Zone02188_g454 , (float)saturate( ( GlowMaskRIndex48_g454 - 3 ) ));
			float2 lerpResult338_g454 = lerp( lerpResult298_g454 , Zone03224_g454 , (float)saturate( ( GlowMaskRIndex48_g454 - 4 ) ));
			float2 lerpResult355_g454 = lerp( lerpResult338_g454 , Zone04291_g454 , (float)saturate( ( GlowMaskRIndex48_g454 - 5 ) ));
			float2 GlowMaskZoneRUV376_g454 = lerpResult355_g454;
			float temp_output_424_0_g454 = ( 1.0 - _EnableGlowMaskR );
			float3 lerpResult175_g454 = lerp( DebugGradient1111_g454 , DebugGradient2110_g454 , (float)saturate( GlowMaskRIndex48_g454 ));
			float3 lerpResult233_g454 = lerp( lerpResult175_g454 , DebugGradient3173_g454 , (float)saturate( ( GlowMaskRIndex48_g454 - 1 ) ));
			float3 lerpResult305_g454 = lerp( lerpResult233_g454 , DebugZone1195_g454 , (float)saturate( ( GlowMaskRIndex48_g454 - 2 ) ));
			float3 lerpResult321_g454 = lerp( lerpResult305_g454 , DebugZone2250_g454 , (float)saturate( ( GlowMaskRIndex48_g454 - 3 ) ));
			float3 lerpResult363_g454 = lerp( lerpResult321_g454 , DebugZone3309_g454 , (float)saturate( ( GlowMaskRIndex48_g454 - 4 ) ));
			...
			float4 GlowMaskZoneRColor468_g454 = ( lerpResult633_g454 * _GlowMaskTintR * GlowMask605_g454.x );
			int ReactivityIndexR469_g454 = _ReacitvityR;
			float4 lerpResult539_g454 = lerp( GlowMaskZoneRColor468_g454 , ( GlowMaskZoneRColor468_g454 * LowBlink431_g454 ) , (float)saturate( ReactivityIndexR469_g454 ));
			float4 lerpResult577_g454 = lerp( lerpResult539_g454 , ( GlowMaskZoneRColor468_g454 * LowPulse493_g454 ) , (float)saturate( ( ReactivityIndexR469_g454 - 1 ) ));
			float4 lerpResult588_g454 = lerp( lerpResult577_g454 , ( GlowMaskZoneRColor468_g454 * HighBlink464_g454 ) , (float)saturate( ( ReactivityIndexR469_g454 - 2 ) ));
			float4 lerpResult595_g454 = lerp( lerpResult588_g454 , ( GlowMaskZoneRColor468_g454 * HighPulse556_g454 ) , (float)saturate( ( ReactivityIndexR469_g454 - 3 ) ));
			float4 FinalGlowR599_g454 = lerpResult595_g454;
			int GlowMaskGIndex45_g454 = _GlowMaskZoneG;
			float2 lerpResult155_g454 = lerp( GradientZone0175_g454 , GradientZone0282_g454 , (float)saturate( GlowMaskGIndex45_g454 ));
			float2 lerpResult222_g454 = lerp( lerpResult155_g454 , GradientZone03122_g454 , (float)saturate( ( GlowMaskGIndex45_g454 - 1 ) ));
			float2 lerpResult230_g454 = lerp( lerpResult222_g454 , Zone01138_g454 , (float)saturate( ( GlowMaskGIndex45_g454 - 2 ) ));
			float2 lerpResult300_g454 = lerp( lerpResult230_g454 , Zone02188_g454 , (float)saturate( ( GlowMaskGIndex45_g454 - 3 ) ));
			float2 lerpResult330_g454 = lerp( lerpResult300_g454 , Zone03224_g454 , (float)saturate( ( GlowMaskGIndex45_g454 - 4 ) ));
			float2 lerpResult367_g454 = lerp( lerpResult330_g454 , Zone04291_g454 , (float)saturate( ( GlowMaskGIndex45_g454 - 5 ) ));
			float2 GlowMaskZoneGUV385_g454 = lerpResult367_g454;
			float temp_output_419_0_g454 = ( 1.0 - _EnableGlowMaskG );
			float3 lerpResult212_g454 = lerp( DebugGradient1111_g454 , DebugGradient2110_g454 , (float)saturate( GlowMaskGIndex45_g454 ));
			float3 lerpResult236_g454 = lerp( lerpResult212_g454 , DebugGradient3173_g454 , (float)saturate( ( GlowMaskGIndex45_g454 - 1 ) ));
			float3 lerpResult296_g454 = lerp( lerpResult236_g454 , DebugZone1195_g454 , (float)saturate( ( GlowMaskGIndex45_g454 - 2 ) ));
			float3 lerpResult323_g454 = lerp( lerpResult296_g454 , DebugZone2250_g454 , (float)saturate( ( GlowMaskGIndex45_g454 - 3 ) ));
			float3 lerpResult354_g454 = lerp( lerpResult323_g454 , DebugZone3309_g454 , (float)saturate( ( GlowMaskGIndex45_g454 - 4 ) ));
			...
			float4 lerpResult551_g454 = lerp( GlowMaskZoneGColor472_g454 , ( GlowMaskZoneGColor472_g454 * LowBlink431_g454 ) , (float)saturate( ReactivityIndexG467_g454 ));
			float4 lerpResult564_g454 = lerp( lerpResult551_g454 , ( GlowMaskZoneGColor472_g454 * LowPulse493_g454 ) , (float)saturate( ( ReactivityIndexG467_g454 - 1 ) ));
			float4 lerpResult585_g454 = lerp( lerpResult564_g454 , ( GlowMaskZoneGColor472_g454 * HighBlink464_g454 ) , (float)saturate( ( ReactivityIndexG467_g454 - 2 ) ));
			float4 lerpResult593_g454 = lerp( lerpResult585_g454 , ( GlowMaskZoneGColor472_g454 * HighPulse556_g454 ) , (float)saturate( ( ReactivityIndexG467_g454 - 3 ) ));
			float4 FinalGlowG598_g454 = lerpResult593_g454;
			int GlowMaskBIndex50_g454 = _GlowMaskZoneB;
			float2 lerpResult157_g454 = lerp( GradientZone0175_g454 , GradientZone0282_g454 , (float)saturate( GlowMaskBIndex50_g454 ));
			float2 lerpResult205_g454 = lerp( lerpResult157_g454 , GradientZone03122_g454 , (float)saturate( ( GlowMaskBIndex50_g454 - 1 ) ));
			float2 lerpResult262_g454 = lerp( lerpResult205_g454 , Zone01138_g454 , (float)saturate( ( GlowMaskBIndex50_g454 - 2 ) ));
			float2 lerpResult311_g454 = lerp( lerpResult262_g454 , Zone02188_g454 , (float)saturate( ( GlowMaskBIndex50_g454 - 3 ) ));
			float2 lerpResult336_g454 = lerp( lerpResult311_g454 , Zone03224_g454 , (float)saturate( ( GlowMaskBIndex50_g454 - 4 ) ));
			float2 lerpResult370_g454 = lerp( lerpResult336_g454 , Zone04291_g454 , (float)saturate( ( GlowMaskBIndex50_g454 - 5 ) ));
			float2 GlowMaskZoneBUV383_g454 = lerpResult370_g454;
			float temp_output_421_0_g454 = ( 1.0 - _EnableGlowMaskB );
			float3 lerpResult197_g454 = lerp( DebugGradient1111_g454 , DebugGradient2110_g454 , (float)saturate( GlowMaskBIndex50_g454 ));
			float3 lerpResult237_g454 = lerp( lerpResult197_g454 , DebugGradient3173_g454 , (float)saturate( ( GlowMaskBIndex50_g454 - 1 ) ));
			float3 lerpResult287_g454 = lerp( lerpResult237_g454 , DebugZone1195_g454 , (float)saturate( ( GlowMaskBIndex50_g454 - 2 ) ));
			float3 lerpResult339_g454 = lerp( lerpResult287_g454 , DebugZone2250_g454 , (float)saturate( ( GlowMaskBIndex50_g454 - 3 ) ));
			float3 lerpResult360_g454 = lerp( lerpResult339_g454 , DebugZone3309_g454 , (float)saturate( ( GlowMaskBIndex50_g454 - 4 ) ));
			...
			float4 lerpResult553_g454 = lerp( GlowMaskZoneBColor466_g454 , ( GlowMaskZoneBColor466_g454 * LowBlink431_g454 ) , (float)saturate( ReactivityIndexB480_g454 ));
			float4 lerpResult574_g454 = lerp( lerpResult553_g454 , ( GlowMaskZoneBColor466_g454 * LowPulse493_g454 ) , (float)saturate( ( ReactivityIndexB480_g454 - 1 ) ));
			float4 lerpResult591_g454 = lerp( lerpResult574_g454 , ( GlowMaskZoneBColor466_g454 * HighBlink464_g454 ) , (float)saturate( ( ReactivityIndexB480_g454 - 2 ) ));
			float4 lerpResult594_g454 = lerp( lerpResult591_g454 , ( GlowMaskZoneBColor466_g454 * HighPulse556_g454 ) , (float)saturate( ( ReactivityIndexB480_g454 - 3 ) ));
			float4 FinalGlowB597_g454 = lerpResult594_g454;
			float4 Emission1488 = ( FinalGlowEmission600_g454 + FinalGlowR599_g454 + FinalGlowG598_g454 + FinalGlowB597_g454 );
...
/*ASEBEGIN
Version=18906
566;670.6667;1891;724;-3952.352;-4140.045;1;True;False
Node;AmplifyShaderEditor.CommentaryNode;285;12791.42,1480.654;Inherit;False;2194.738;2092.908;Texture Assignment;73;1657;1495;1658;1660;1661;1494;1488;1659;1634;1650;1624;1664;1649;1484;1665;1483;1663;1666;1669;1482;1662;1668;1477;1667;1417;1672;1416;1410;33;1113;1412;1409;1299;1689;1411;1473;31;1680;1408;1493;1298;1401;1671;32;1670;1476;1104;354;1406;1407;1405;304;1399;1403;1398;1404;1397;1402;1400;1396;30;29;7;936;935;4;934;5;1564;6;3;2042;2043;Texture Assignment;0.8455408,0.2776789,0.9811321,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;283;1316.517,7391.053;Inherit;False;2051.217;3418.291;;10;1521;1507;226;244;111;227;28;87;65;25;Lighting Styles;0.2658419,0.9716981,0.3154366,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;65;1366.517,7441.052;Inherit;False;1271.911;315.6205;Halftone UVS;11;171;105;63;17;91;170;18;13;19;92;338;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;538;10203.23,518.9999;Inherit;False;2345.553;2830.088;;13;729;943;1655;549;785;352;27;728;2059;2058;2061;2064;2063;Lighting Calculations;1,0.9828576,0.1981132,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;27;10243.15,555.7958;Inherit;False;1514.091;403.2091;Base Lighting Calculation;14;1502;286;1497;23;1444;55;1518;54;56;10;1;9;1711;2073;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;87;1377.725,8110.888;Inherit;False;1908.546;380.3793;SquareEffectLighting;23;86;82;183;81;80;176;83;73;79;78;85;76;84;72;68;71;70;67;69;66;684;1438;2079;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;28;1381.502,7760.777;Inherit;False;1159.949;333.3966;CircleEffectLighting;12;64;20;48;47;21;14;24;16;260;178;261;1437;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;111;1377.725,8494.891;Inherit;False;1741.949;329.9518;SketchyEffectLighting;18;106;108;107;109;90;104;98;97;99;89;95;100;94;101;102;262;291;725;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;260;2220.301,7821.177;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;178;2465.501,7826.777;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;82;2885.824,8190.889;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;57;4260.069,4313.341;Inherit;False;1480.991;334.9148;Distance Blending;11;40;37;38;52;44;36;42;35;34;1453;2076;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;25;2609.501,7826.777;Inherit;False;CircularEffectLighting;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;176;3004.824,8189.889;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;86;3149.824,8185.889;Inherit;False;SquareEffectLighting;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;52;4798.686,4473.041;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;94;2672.324,8573.991;Inherit;False;Step Antialiasing;-1;;373;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0.56;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;1507;1359.203,10046.22;Inherit;False;1475.756;347.8193;Toon Lighting;7;1498;1501;1504;1503;1515;1514;1505;;1,1,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;44;4803.235,4565.804;Inherit;False;Property;_BlendLength;   Blend Length;24;0;Create;True;0;0;0;False;0;False;5;10;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;928;6801.586,7320.029;Inherit;False;3068.318;2460.014;;9;914;896;877;787;740;803;849;774;1548;Rimlight Styles;0.05079699,0,1,1;0;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;1498;1566.766,10115.15;Inherit;False;286;BaseNdotL;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;102;2997.324,8545.392;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;1501;1766.524,10286.97;Inherit;False;1497;ShadowLength;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;1504;1447.371,10217.1;Inherit;False;1502;ShadowOffset;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleDivideOpNode;1453;5034.953,4474.724;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;103;3273.524,8506.392;Inherit;False;SketchyEffectLighting;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;38;5175.815,4473.679;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;1503;2036.314,10127.41;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;2091;3101.613,6519.891;Inherit;False;682.3669;239.6001;Blend default lighting at distance;4;2087;2088;2090;2089;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;1515;2010.431,10216.16;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;16;False;3;FLOAT;6;False;4;FLOAT;64;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2089;3151.613,6569.891;Inherit;False;23;NdotL;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;2076;5481.912,4502.75;Inherit;False;DistanceBlendAlpha;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1514;2221.533,10123.26;Inherit;False;ExponentialSquared Blend;-1;;374;28efb435c6e4d7a48baa2d68777a317c;1,7,1;2;12;FLOAT;0;False;9;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;2090;3319.613,6571.891;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2088;3228.613,6641.891;Inherit;False;2076;DistanceBlendAlpha;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1524;2198.472,10457.26;Inherit;False;ExponentialSquared Blend;-1;;375;28efb435c6e4d7a48baa2d68777a317c;1,7,1;2;12;FLOAT;0;False;9;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;2087;3613.614,6581.194;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;338;1828.674,7668.919;Inherit;False;Circles;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;361;22097.24,7702.47;Inherit;False;354;Smoothness;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;165;4829.053,6866.56;Inherit;False;SelectedLightingStyle;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1451;11554.56,1730.175;Inherit;False;ExponentialSquared Blend;-1;;376;28efb435c6e4d7a48baa2d68777a317c;1,7,1;2;12;FLOAT;0;False;9;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;961;15016.59,7188.257;Inherit;False;Step Antialiasing;-1;;400;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;985;15018.56,7548.203;Inherit;False;Step Antialiasing;-1;;402;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;812;7674.575,7837.111;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;1.5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1053;15570.16,9026.35;Inherit;False;Step Antialiasing;-1;;403;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1031;15563.97,8653.84;Inherit;False;Step Antialiasing;-1;;404;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;815;7802.573,7821.111;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0.85;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;750;8827.441,7434.029;Inherit;False;Step Antialiasing;-1;;428;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1017;15563.11,8284.372;Inherit;False;Step Antialiasing;-1;;429;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;819;8074.575,7821.111;Inherit;False;Step Antialiasing;-1;;430;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2055;12654.24,802.0409;Inherit;False;7;Normal;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.WorldNormalVector;2054;12811.24,802.0409;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.FunctionNode;999;15016.83,7907.567;Inherit;False;Step Antialiasing;-1;;436;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;921;7586.16,9389.22;Inherit;False;Step Antialiasing;-1;;435;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;401;22895.03,7965.543;Inherit;False;Step Antialiasing;-1;;434;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CustomExpressionNode;2053;12991.24,802.0409;Inherit;False;half4 skyData = UNITY_SAMPLE_TEXCUBE_LOD(unity_SpecCube0, uvw, 5)@ //('cubemap', 'sample coordinate', 'map-map level')$         half3 skyColor = DecodeHDR (skyData, unity_SpecCube0_HDR)@$         return half4(skyColor, 1.0)@;3;Create;1;True;uvw;FLOAT3;0,0,0;In;;Inherit;False;CustomReflectionProbeSample;True;False;0;;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;441;23275.53,8345.855;Inherit;False;Step Antialiasing;-1;;440;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;909;8092.575,8982.958;Inherit;False;Step Antialiasing;-1;;439;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;1548;8373.302,9345.401;Inherit;False;1475.756;347.8193;Toon Rimlight;11;1559;1558;1557;1556;1555;1554;1553;1551;1747;1746;2068;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.FunctionNode;528;22775.32,9913.095;Inherit;False;Step Antialiasing;-1;;444;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;1554;8391.413,9507.191;Inherit;False;1561;RimlightOffset;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;2099;15496.4,6202.849;Inherit;False;682.3669;239.6001;Blend default lighting at distance;3;2101;2100;2104;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;2056;13261.72,797.2333;Inherit;False;CustomProbe;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;890;8061.209,8559.333;Inherit;False;Step Antialiasing;-1;;443;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;1551;8580.864,9414.328;Inherit;False;1744;BaseRimlightForToon;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;2068;8595.315,9509.758;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;-1;False;2;FLOAT;5;False;3;FLOAT;0.3;False;4;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;1553;8780.622,9586.149;Inherit;False;1560;RimlightLength;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2061;11096.43,1439.338;Inherit;False;2056;CustomProbe;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.LightAttenuation;2104;15651.17,6253.139;Inherit;False;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;1910;7594.28,7014.845;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;509;23244.69,9507.333;Inherit;False;Step Antialiasing;-1;;447;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2070;16088.53,6801.507;Inherit;False;1497;ShadowLength;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;860;8115.768,8252.51;Inherit;False;Step Antialiasing;-1;;448;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0.56;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2100;15623.4,6324.849;Inherit;False;2076;DistanceBlendAlpha;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;2101;16008.4,6264.15;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;1556;9024.529,9515.341;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;16;False;3;FLOAT;6;False;4;FLOAT;32;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;2069;16320.53,6805.507;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;16;False;3;FLOAT;0.5;False;4;FLOAT;0.65;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;2063;11369.7,1436.142;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;487;23175.55,9119.052;Inherit;False;Step Antialiasing;-1;;450;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;1555;9050.412,9426.591;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;2072;16513.53,6806.507;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;16;False;3;FLOAT;1;False;4;FLOAT;0.66;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;2064;11487.16,1434.151;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0.5,0.5,0.5;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;2059;11099.1,1506.43;Inherit;False;1721;isLightMissing;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;1747;9343.664,9609.918;Inherit;False;165;SelectedLightingStyle;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1557;9235.631,9422.44;Inherit;False;ExponentialSquared Blend;-1;;453;28efb435c6e4d7a48baa2d68777a317c;1,7,1;2;12;FLOAT;0;False;9;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;2092;9279.823,6502.184;Inherit;False;682.3669;239.6001;Blend default lighting at distance;4;2096;2095;2097;2098;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.FunctionNode;465;23351.19,8762.227;Inherit;False;Step Antialiasing;-1;;452;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LightAttenuation;1849;16968.41,6595.229;Inherit;False;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1746;9645.849,9546.838;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2097;9324.473,6543.222;Inherit;False;773;Rimlight;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;2058;11628.71,1405.619;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;1,1,1;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.CommentaryNode;943;11798.43,587.8798;Inherit;False;806.6416;384.319;Light Color;10;1706;942;1713;1705;941;939;1086;2057;2065;2062;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;1559;9645.068,9417.43;Inherit;False;ToonRimlight;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;2098;9504.378,6546.665;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;2095;9406.823,6624.184;Inherit;False;2076;DistanceBlendAlpha;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;728;11807.75,1391.397;Inherit;False;IndirectDiffuse;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;1713;11829.09,835.1286;Inherit;False;728;IndirectDiffuse;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.CommentaryNode;1235;15784.49,1469.517;Inherit;False;895.8398;535.298;Outline;7;932;931;929;930;2052;2066;2067;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2057;12055.92,885.9714;Inherit;False;2056;CustomProbe;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.LerpOp;2096;9791.824,6563.486;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;2105;23872.02,6277.675;Inherit;False;682.3669;239.6001;Blend default lighting at distance;3;2107;2106;2109;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;931;15820.98,1945.077;Inherit;False;Property;_OutlineWidth;   Outline Width;32;0;Create;True;0;0;0;False;0;False;0.15;0.002;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;2062;12259.85,838.4515;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2109;24019.96,6324.929;Inherit;False;324;DefaultSpecular;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;932;16031.41,1956.815;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.01;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;1705;11825.06,901.1096;Inherit;False;1721;isLightMissing;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2106;23999.02,6399.675;Inherit;False;2076;DistanceBlendAlpha;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;2065;12402.08,841.6477;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0.5,0.5,0.5;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.NormalVertexDataNode;2046;15285.38,1714.933;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.LerpOp;2107;24384.02,6338.976;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.PosVertexDataNode;2047;15287.97,1558.933;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;2048;15467.38,1729.233;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;2049;15503.78,1599.233;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;2050;15356.09,1861.599;Inherit;False;Property;_OutlineDepthFade;   Outline Depth Fade;55;0;Create;True;0;0;0;False;0;False;0.075;0.075;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.DepthFade;2051;15707.09,1703.795;Inherit;False;True;False;False;2;1;FLOAT3;0,0,0;False;0;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;2052;15995.2,1702.495;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2067;15963.93,1776.522;Inherit;False;1721;isLightMissing;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;930;15907,1519.517;Inherit;False;Property;_OutlineColor;   Outline Color;31;0;Create;True;1;Outline Settings;0;0;False;0;False;0,0,0,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.LerpOp;2066;16202.93,1702.522;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;1;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.OutlineNode;929;16477.13,1643.841;Inherit;False;0;True;Masked;0;0;Front;3;0;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;1659;14290.16,2925.887;Inherit;False;LumaGlowFunction;34;;454;b17985a035b3ebb42b5dfc7fc9435eb2;0;3;618;SAMPLER2D;0;False;612;FLOAT3;0,0,0;False;611;FLOAT3;0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;1132;16693.65,1639.971;Inherit;False;Outline;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SmoothstepOpNode;1558;9484.479,9421.456;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0.8;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2079;2772.032,8404.171;Inherit;False;2076;DistanceBlendAlpha;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;2073;11489.77,673.5023;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2042;14710.43,1542.048;Inherit;False;Property;_Culling;   Culling;66;2;[Header];[Enum];Create;False;0;3;Back;2;Front;1;Off;0;0;True;0;False;2;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2043;14789.7,1632.705;Inherit;False;Property;_BlendModeIndex;BlendModeIndex;56;0;Create;True;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2045;15621.6,1953.343;Inherit;False;Property;_MaskClip;Mask Clip Value;61;0;Create;False;0;0;0;True;0;False;0.5;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2110;4527.353,4218.045;Inherit;False;Property;_OutlineMaskClip;   Outline Mask Clip;54;0;Create;True;0;0;0;True;0;False;0.5;0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;11028.64,-2168.996;Float;False;True;-1;2;LegendsShaderGUI;0;0;CustomLighting;Furality/Legendary Shader/Legendary Shader;False;False;False;False;False;False;True;True;True;False;True;False;False;False;False;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;All;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;0;0;True;2042;-1;0;False;1742;0;0;0;False;0.1;False;-1;0;False;-1;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;2076;0;38;0
WireConnection;1525;0;1529;0
WireConnection;1514;12;1503;0
WireConnection;1514;9;1515;0
...
WireConnection;2087;0;1787;0
WireConnection;2087;1;2090;0
WireConnection;2087;2;2088;0
...
WireConnection;2101;0;1836;0
WireConnection;2101;1;2104;0
WireConnection;2101;2;2100;0
WireConnection;1476;0;1399;1
WireConnection;1556;0;1553;0
WireConnection;2069;0;2070;0
WireConnection;2063;0;1419;0
WireConnection;2063;1;2061;0
...
WireConnection;1555;0;1551;0
WireConnection;1555;1;2068;0
...
WireConnection;1837;0;2101;0
WireConnection;1837;1;1081;0
WireConnection;1837;2;1833;0
WireConnection;1557;12;1555;0
WireConnection;1557;9;1556;0
...
WireConnection;1746;0;1557;0
WireConnection;1746;1;1747;0
...
WireConnection;1559;0;1746;0
WireConnection;1299;0;31;0
WireConnection;1299;1;1298;0
WireConnection;2098;0;2097;0
...
WireConnection;2096;0;1935;0
WireConnection;2096;1;2098;0
WireConnection;2096;2;2095;0
...
WireConnection;1938;0;2096;0
WireConnection;1938;1;1562;0
WireConnection;1938;2;1933;0
WireConnection;2023;0;2020;0
WireConnection;2062;0;1713;0
WireConnection;2062;1;2057;0
...
WireConnection;2107;0;2031;0
WireConnection;2107;1;2109;0
WireConnection;2107;2;2106;0
WireConnection;1706;0;941;0
WireConnection;1706;1;2065;0
WireConnection;1706;2;1705;0
WireConnection;1377;0;1307;2
WireConnection;796;0;1939;0
WireConnection;2048;0;2046;0
WireConnection;2048;1;932;0
...
WireConnection;2049;0;2047;0
WireConnection;2049;1;2048;0
WireConnection;1693;0;1682;0
WireConnection;1693;2;1692;0
WireConnection;2033;0;2107;0
...
WireConnection;2066;0;2052;0
WireConnection;2066;2;2067;0
WireConnection;1310;0;1307;0
WireConnection;929;0;930;0
WireConnection;929;2;2066;0
...
ASEEND*/
//CHKSM=00E29C66DC9782A9F819CF1007F7BA6D3559C6EB