...
Shader "Furality/Legendary Shader/No Outline/Legendary Shader - No Outline"
{
	Properties
	{
	...
	SubShader
	{
		...
		float3 CustomReflectionProbeSample2055( float3 uvw )
		{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float DistanceBlendAlpha2088 = temp_output_38_0;
			float lerpResult2093 = lerp( lerpResult1787 , saturate( NdotL23 ) , DistanceBlendAlpha2088);
			float saferPower2_g459 = max( ( 1.0 / 2.71828 ) , 0.0001 );
			float ShadowLength1497 = _ShadowLength;
			float ShadowOffset1502 = _ShadowOffset;
			float saferPower1_g459 = max( ( -( 1.0 - (6.0 + (ShadowLength1497 - 0.0) * (64.0 - 6.0) / (16.0 - 0.0)) ) * ( BaseNdotL286 + ShadowOffset1502 ) ) , 0.0001 );
			float temp_output_2_0_g459 = pow( saferPower2_g459 , pow( saferPower1_g459 , 2.0 ) );
			float ToonLighting1505 = ( 1.0 - temp_output_2_0_g459 );
			float lerpResult1796 = lerp( lerpResult2093 , ToonLighting1505 , saturate( ( ShadowStyleIndex1758 - 6.0 ) ));
			float saferPower2_g460 = max( ( 1.0 / 2.71828 ) , 0.0001 );
			float saferPower1_g460 = max( ( -( 1.0 - (2.0 + (ShadowLength1497 - 0.0) * (16.0 - 2.0) / (16.0 - 0.0)) ) * ( (BaseNdotL286*0.5 + 0.5) + ShadowOffset1502 ) ) , 0.0001 );
			float temp_output_2_0_g460 = pow( saferPower2_g460 , pow( saferPower1_g460 , 2.0 ) );
			float HalfLambert1522 = ( 1.0 - temp_output_2_0_g460 );
			...
			float temp_output_3_0_g462 = ( 0.0 - ( Circles338 - ( 1.0 - ase_lightAtten ) ) );
			float CircularShadows967 = ( 1.0 - ( saturate( ( temp_output_3_0_g462 / fwidth( temp_output_3_0_g462 ) ) ) * ( 1.0 - ase_lightAtten ) ) );
			...
			float temp_output_3_0_g463 = ( 0.0 - ( ( Squares684 * 0.5 ) - ( 1.0 - ase_lightAtten ) ) );
			float SquareShadows988 = ( 1.0 - ( saturate( ( temp_output_3_0_g463 / fwidth( temp_output_3_0_g463 ) ) ) * ( 1.0 - ase_lightAtten ) ) );
			...
			float temp_output_3_0_g464 = ( 0.0 - localHexagon1064 );
			float HexagonalShadows1051 = ( 1.0 - ( saturate( ( temp_output_3_0_g464 / fwidth( temp_output_3_0_g464 ) ) ) * ( 1.0 - ase_lightAtten ) ) );
			...
			float temp_output_3_0_g465 = ( 0.0 - localRegularStar1038 );
			float StarShadows21034 = ( 1.0 - ( saturate( ( temp_output_3_0_g465 / fwidth( temp_output_3_0_g465 ) ) ) * ( 1.0 - ase_lightAtten ) ) );
			...
			float temp_output_3_0_g468 = ( 0.0 - localRegularStar1024 );
			float StarShadows11021 = ( 1.0 - ( saturate( ( temp_output_3_0_g468 / fwidth( temp_output_3_0_g468 ) ) ) * ( 1.0 - ase_lightAtten ) ) );
			...
			float temp_output_3_0_g471 = ( 0.0 - ( ( Lines725 * 0.5 ) - ( 1.0 - ase_lightAtten ) ) );
			float LineShadows1003 = ( 1.0 - ( saturate( ( temp_output_3_0_g471 / fwidth( temp_output_3_0_g471 ) ) ) * ( 1.0 - ase_lightAtten ) ) );
			float lerpResult1837 = lerp( lerpResult1836 , LineShadows1003 , saturate( ( ShadowStyleIndex1758 - 5.0 ) ));
			float lerpResult2102 = lerp( lerpResult1837 , ase_lightAtten , DistanceBlendAlpha2088);
			...
			float lerpResult1841 = lerp( lerpResult2102 , smoothstepResult1848 , saturate( ( ShadowStyleIndex1758 - 6.0 ) ));
			...
			float3 uvw2055 = (WorldNormalVector( i , Normal7 ));
			float3 localCustomReflectionProbeSample2055 = CustomReflectionProbeSample2055( uvw2055 );
			float3 CustomProbe2056 = localCustomReflectionProbeSample2055;
			float3 lerpResult2066 = lerp( temp_output_1419_0 , ( ( temp_output_1419_0 + CustomProbe2056 ) * float3( 0.5,0.5,0.5 ) ) , isLightMissing1721);
			float3 IndirectDiffuse728 = lerpResult2066;
			...
			float temp_output_3_0_g475 = ( 0.0 - ( length( ( SpecularHalftoneUVS416 + float2( -0.5,-0.5 ) ) ) - HalftoneSpecular379 ) );
			float CircularSpecular404 = ( ( saturate( ( temp_output_3_0_g475 / fwidth( temp_output_3_0_g475 ) ) ) * 3.5 ) * ( DefaultSpecular324 + ( HalftoneSpecular379 * 2.0 ) ) * Smoothness354 );
			...
			float temp_output_3_0_g476 = ( 0.0 - ( ( ( max( max( break426.x , break426.y ) , max( break427.x , break427.y ) ) * 1.9 ) - 1.5 ) - HalftoneSpecular379 ) );
			float SquareSpecular444 = ( ( saturate( ( temp_output_3_0_g476 / fwidth( temp_output_3_0_g476 ) ) ) * 3.5 ) * ( DefaultSpecular324 + ( HalftoneSpecular379 * 2.0 ) ) * Smoothness354 );
			...
			float temp_output_3_0_g478 = ( 0.0 - localHexagon525 );
			float SpecularHexagon531 = ( ( saturate( ( temp_output_3_0_g478 / fwidth( temp_output_3_0_g478 ) ) ) * 3.5 ) * ( DefaultSpecular324 + ( HalftoneSpecular379 * 2.0 ) ) * Smoothness354 );
			...
			float temp_output_3_0_g480 = ( 0.0 - localRegularStar508 );
			float Specular4SidedStar513 = ( ( saturate( ( temp_output_3_0_g480 / fwidth( temp_output_3_0_g480 ) ) ) * 3.5 ) * ( DefaultSpecular324 + ( HalftoneSpecular379 * 2.0 ) ) * Smoothness354 );
			...
			float temp_output_3_0_g482 = ( 0.0 - localRegularStar486 );
			float Specular8SidedStar491 = ( ( saturate( ( temp_output_3_0_g482 / fwidth( temp_output_3_0_g482 ) ) ) * 3.5 ) * ( DefaultSpecular324 + ( HalftoneSpecular379 * 2.0 ) ) * Smoothness354 );
			...
			float temp_output_3_0_g483 = ( 0.0 - ( ( abs( sin( rotator455.x ) ) * 0.5 ) - HalftoneSpecular379 ) );
			float LinesSpecular467 = ( ( saturate( ( temp_output_3_0_g483 / fwidth( temp_output_3_0_g483 ) ) ) * 3.5 ) * ( DefaultSpecular324 + ( HalftoneSpecular379 * 2.0 ) ) * Smoothness354 );
			float lerpResult2031 = lerp( lerpResult2025 , LinesSpecular467 , saturate( ( SpecularStyleIndex1995 - 5.0 ) ));
			float lerpResult2106 = lerp( lerpResult2031 , DefaultSpecular324 , DistanceBlendAlpha2088);
			float ToonSpecular1545 = ( ( HalftoneSpecular379 * 3.5 ) * ( HalftoneSpecular379 * 2.0 ) );
			float lerpResult2033 = lerp( lerpResult2106 , ToonSpecular1545 , saturate( ( SpecularStyleIndex1995 - 6.0 ) ));
			float SelectedSpecularStyle388 = lerpResult2033;
			float saferPower2_g461 = max( ( 1.0 / 2.71828 ) , 0.0001 );
			...
			float saferPower1_g461 = max( ( -( 1.0 - _RimlightLength ) * ( -dotResult738 + _RimlightOffset ) ) , 0.0001 );
			float temp_output_2_0_g461 = pow( saferPower2_g461 , pow( saferPower1_g461 , 2.0 ) );
			float temp_output_1451_0 = ( 1.0 - temp_output_2_0_g461 );
			...
			float temp_output_3_0_g469 = ( 0.0 - ( length( ( RimlightHalftoneUVS784 + float2( -0.5,-0.5 ) ) ) - ( Rimlight773 + DistanceBlend40 ) ) );
			float BaseRimlight769 = ( temp_output_1451_0 * SelectedLightingStyle165 * 2.0 );
			float CircularRimlight786 = ( saturate( ( temp_output_3_0_g469 / fwidth( temp_output_3_0_g469 ) ) ) * BaseRimlight769 );
			...
			float temp_output_3_0_g472 = ( 0.0 - ( ( ( max( max( break807.x , break807.y ) , max( break806.x , break806.y ) ) * 2.0 ) - 1.5 ) - Rimlight773 ) );
			float SquareRimlight824 = ( saturate( ( temp_output_3_0_g472 / fwidth( temp_output_3_0_g472 ) ) ) * BaseRimlight769 );
			...
			float temp_output_3_0_g474 = ( 0.0 - localHexagon919 );
			float RimlightHexagon927 = ( saturate( ( temp_output_3_0_g474 / fwidth( temp_output_3_0_g474 ) ) ) * BaseRimlight769 );
			...
			float temp_output_3_0_g477 = ( 0.0 - localRegularStar905 );
			float Rimlight4SidedStar913 = ( saturate( ( temp_output_3_0_g477 / fwidth( temp_output_3_0_g477 ) ) ) * BaseRimlight769 );
			...
			float temp_output_3_0_g479 = ( 0.0 - localRegularStar888 );
			float Rimlight8SidedStar894 = ( saturate( ( temp_output_3_0_g479 / fwidth( temp_output_3_0_g479 ) ) ) * BaseRimlight769 );
			...
			float temp_output_3_0_g481 = ( 0.56 - ( abs( sin( rotator868.x ) ) - Rimlight773 ) );
			float RimlightLines862 = ( saturate( ( temp_output_3_0_g481 / fwidth( temp_output_3_0_g481 ) ) ) * BaseRimlight769 );
			float lerpResult1935 = lerp( lerpResult1926 , RimlightLines862 , saturate( ( RimlightStyleIndex1942 - 5.0 ) ));
			float lerpResult2096 = lerp( lerpResult1935 , saturate( Rimlight773 ) , DistanceBlendAlpha2088);
			float saferPower2_g484 = max( ( 1.0 / 2.71828 ) , 0.0001 );
			...
			float saferPower1_g484 = max( ( -( 1.0 - (6.0 + (RimlightLength1560 - 0.0) * (32.0 - 6.0) / (16.0 - 0.0)) ) * ( BaseRimlightForToon1744 + (0.3 + (RimlightOffset1561 - -1.0) * (1.0 - 0.3) / (5.0 - -1.0)) ) ) , 0.0001 );
			float temp_output_2_0_g484 = pow( saferPower2_g484 , pow( saferPower1_g484 , 2.0 ) );
			float ToonRimlight1559 = ( ( 1.0 - temp_output_2_0_g484 ) * SelectedLightingStyle165 );
		...
		void surf( Input i , inout SurfaceOutputCustomLightingCustom o )
		{
			...
			float cos695_g485 = cos( radians( _GradientDirection ) );
			float sin695_g485 = sin( radians( _GradientDirection ) );
			float2 rotator695_g485 = mul( i.uv_texcoord - float2( 0.5,0.5 ) , float2x2( cos695_g485 , -sin695_g485 , sin695_g485 , cos695_g485 )) + float2( 0.5,0.5 );
			float2 GradientUVs698_g485 = rotator695_g485;
			float4 _GradientZone2 = float4(9.4,0,0.57,0.49);
			float2 appendResult34_g485 = (float2(( 1.0 / _GradientZone2.x ) , 0.0));
			float2 appendResult42_g485 = (float2(_GradientZone2.z , _GradientZone2.w));
			float2 clampResult707_g485 = clamp( (GradientUVs698_g485*appendResult34_g485 + appendResult42_g485) , float2( 0.571,0 ) , float2( 0.676,1 ) );
			float2 GradientZone0175_g485 = clampResult707_g485;
			float4 _GradientZone3 = float4(9.4,0,0.6805,0.49);
			float2 appendResult38_g485 = (float2(( 1.0 / _GradientZone3.x ) , 0.0));
			float2 appendResult41_g485 = (float2(_GradientZone3.z , _GradientZone3.w));
			float2 clampResult710_g485 = clamp( (GradientUVs698_g485*appendResult38_g485 + appendResult41_g485) , float2( 0.681,0 ) , float2( 0.786,1 ) );
			float2 GradientZone0282_g485 = clampResult710_g485;
			int EmissionZoneIndex47_g485 = _EmissionZone;
			float2 lerpResult169_g485 = lerp( GradientZone0175_g485 , GradientZone0282_g485 , (float)saturate( EmissionZoneIndex47_g485 ));
			float4 _GradientZone4 = float4(9.4,0,0.791,0.49);
			float2 appendResult57_g485 = (float2(( 1.0 / _GradientZone4.x ) , 0.0));
			float2 appendResult52_g485 = (float2(_GradientZone4.z , _GradientZone4.w));
			float2 clampResult711_g485 = clamp( (GradientUVs698_g485*appendResult57_g485 + appendResult52_g485) , float2( 0.792,0 ) , float2( 0.896,1 ) );
			float2 GradientZone03122_g485 = clampResult711_g485;
			float2 lerpResult214_g485 = lerp( lerpResult169_g485 , GradientZone03122_g485 , (float)saturate( ( EmissionZoneIndex47_g485 - 1 ) ));
			float2 OriginalOffset44_g485 = float2( 0.1,0.471 );
			float2 Zone01138_g485 = ( float2( 0.955,0.992 ) - OriginalOffset44_g485 );
			float2 lerpResult249_g485 = lerp( lerpResult214_g485 , Zone01138_g485 , (float)saturate( ( EmissionZoneIndex47_g485 - 2 ) ));
			float2 Zone02188_g485 = ( float2( 0.964,0.992 ) - OriginalOffset44_g485 );
			float2 lerpResult286_g485 = lerp( lerpResult249_g485 , Zone02188_g485 , (float)saturate( ( EmissionZoneIndex47_g485 - 3 ) ));
			float2 Zone03224_g485 = ( float2( 0.955,0.978 ) - OriginalOffset44_g485 );
			float2 lerpResult343_g485 = lerp( lerpResult286_g485 , Zone03224_g485 , (float)saturate( ( EmissionZoneIndex47_g485 - 4 ) ));
			float2 Zone04291_g485 = ( float2( 0.964,0.978 ) - OriginalOffset44_g485 );
			float2 lerpResult364_g485 = lerp( lerpResult343_g485 , Zone04291_g485 , (float)saturate( ( EmissionZoneIndex47_g485 - 5 ) ));
			float2 EmissionZoneUV375_g485 = lerpResult364_g485;
			float temp_output_423_0_g485 = ( 1.0 - _EnableEmissionGlow );
			float StoredTextureTog669_g485 = step( max( _Stored_TexelSize.z , _Stored_TexelSize.w ) , 500.0 );
			float temp_output_712_0_g485 = saturate( ( 1.0 - abs( sin( ( GradientUVs698_g485.x + _Time.y ) ) ) ) );
			float3 appendResult65_g485 = (float3(temp_output_712_0_g485 , temp_output_712_0_g485 , temp_output_712_0_g485));
			float3 DebugGradient1111_g485 = appendResult65_g485;
			float temp_output_713_0_g485 = saturate( ( 1.0 - abs( sin( ( GradientUVs698_g485.x + _Time.y + 0.3 ) ) ) ) );
			float3 appendResult72_g485 = (float3(temp_output_713_0_g485 , temp_output_713_0_g485 , 0.0));
			float3 DebugGradient2110_g485 = appendResult72_g485;
			float3 lerpResult181_g485 = lerp( DebugGradient1111_g485 , DebugGradient2110_g485 , (float)saturate( EmissionZoneIndex47_g485 ));
			float temp_output_714_0_g485 = saturate( ( 1.0 - abs( sin( ( GradientUVs698_g485.x + _Time.y + 0.6 ) ) ) ) );
			float3 appendResult96_g485 = (float3(0.0 , temp_output_714_0_g485 , temp_output_714_0_g485));
			float3 DebugGradient3173_g485 = appendResult96_g485;
			float3 lerpResult244_g485 = lerp( lerpResult181_g485 , DebugGradient3173_g485 , (float)saturate( ( EmissionZoneIndex47_g485 - 1 ) ));
			float3 appendResult139_g485 = (float3(0.0 , 0.0 , saturate( ( 1.0 - abs( sin( _Time.y ) ) ) )));
			float3 DebugZone1195_g485 = appendResult139_g485;
			float3 lerpResult278_g485 = lerp( lerpResult244_g485 , DebugZone1195_g485 , (float)saturate( ( EmissionZoneIndex47_g485 - 2 ) ));
			float temp_output_716_0_g485 = saturate( ( 1.0 - abs( sin( ( _Time.y + 0.2 ) ) ) ) );
			float3 appendResult192_g485 = (float3(temp_output_716_0_g485 , temp_output_716_0_g485 , temp_output_716_0_g485));
			float3 DebugZone2250_g485 = appendResult192_g485;
			float3 lerpResult352_g485 = lerp( lerpResult278_g485 , DebugZone2250_g485 , (float)saturate( ( EmissionZoneIndex47_g485 - 3 ) ));
			float3 appendResult259_g485 = (float3(saturate( ( 1.0 - abs( sin( ( _Time.y + 0.4 ) ) ) ) ) , 0.0 , 0.0));
			float3 DebugZone3309_g485 = appendResult259_g485;
			float3 lerpResult362_g485 = lerp( lerpResult352_g485 , DebugZone3309_g485 , (float)saturate( ( EmissionZoneIndex47_g485 - 4 ) ));
			float3 appendResult306_g485 = (float3(0.0 , saturate( ( 1.0 - abs( sin( ( _Time.y + 0.6 ) ) ) ) ) , 0.0));
			float3 DebugZone4332_g485 = appendResult306_g485;
			float3 lerpResult379_g485 = lerp( lerpResult362_g485 , DebugZone4332_g485 , (float)saturate( ( EmissionZoneIndex47_g485 - 5 ) ));
			float EnableGlowMaskEmission683_g485 = temp_output_423_0_g485;
			float3 DebugEmissionColor399_g485 = saturate( ( lerpResult379_g485 + EnableGlowMaskEmission683_g485 ) );
			float DebugSwitch628_g485 = _DebugMode;
			float4 lerpResult634_g485 = lerp( saturate( ( tex2Dlod( _Stored, float4( EmissionZoneUV375_g485, 0, 0.0) ) + temp_output_423_0_g485 + StoredTextureTog669_g485 ) ) , float4( DebugEmissionColor399_g485 , 0.0 ) , DebugSwitch628_g485);
			...
			float3 Emission436_g485 = ( tex2D( _Emission, panner1666 ) * _EmissionColor * tex2D( _EmissionMask, uv_EmissionMask ).r ).rgb;
			float4 EmissionGlowColor471_g485 = ( lerpResult634_g485 * float4( Emission436_g485 , 0.0 ) );
			float2 ReactiveZone365_g485 = ( float2( 0.673,0.985 ) - OriginalOffset44_g485 );
			float mulTime293_g485 = _Time.y * 13.0;
			float3 appendResult390_g485 = (float3(saturate( sin( mulTime293_g485 ) ) , saturate( sin( ( mulTime293_g485 + 0.5 ) ) ) , 0.0));
			float4 lerpResult637_g485 = lerp( saturate( ( StoredTextureTog669_g485 + tex2D( _Stored, ReactiveZone365_g485 ) ) ) , float4( appendResult390_g485 , 0.0 ) , DebugSwitch628_g485);
			float4 break417_g485 = lerpResult637_g485;
			float LowBlink431_g485 = break417_g485.r;
			int ReactivityIndexEmission470_g485 = _EmissionReactivity;
			float4 lerpResult532_g485 = lerp( EmissionGlowColor471_g485 , ( EmissionGlowColor471_g485 * LowBlink431_g485 ) , (float)saturate( ReactivityIndexEmission470_g485 ));
			float cos437_g485 = cos( radians( _LowsPulseDirection ) );
			float sin437_g485 = sin( radians( _LowsPulseDirection ) );
			float2 rotator437_g485 = mul( i.uv_texcoord - float2( 0.5,0.5 ) , float2x2( cos437_g485 , -sin437_g485 , sin437_g485 , cos437_g485 )) + float2( 0.5,0.5 );
			float LowPulse493_g485 = saturate( ( rotator437_g485.y - ( 1.0 - LowBlink431_g485 ) ) );
			float4 lerpResult580_g485 = lerp( lerpResult532_g485 , ( EmissionGlowColor471_g485 * LowPulse493_g485 ) , (float)saturate( ( ReactivityIndexEmission470_g485 - 1 ) ));
			float HighBlink464_g485 = break417_g485.g;
			float4 lerpResult590_g485 = lerp( lerpResult580_g485 , ( EmissionGlowColor471_g485 * HighBlink464_g485 ) , (float)saturate( ( ReactivityIndexEmission470_g485 - 2 ) ));
			float cos456_g485 = cos( radians( _HighsPulseDirection ) );
			float sin456_g485 = sin( radians( _HighsPulseDirection ) );
			float2 rotator456_g485 = mul( i.uv_texcoord - float2( 0.5,0.5 ) , float2x2( cos456_g485 , -sin456_g485 , sin456_g485 , cos456_g485 )) + float2( 0.5,0.5 );
			float HighPulse556_g485 = saturate( ( rotator456_g485.y - ( 1.0 - HighBlink464_g485 ) ) );
			float4 lerpResult596_g485 = lerp( lerpResult590_g485 , ( EmissionGlowColor471_g485 * HighPulse556_g485 ) , (float)saturate( ( ReactivityIndexEmission470_g485 - 3 ) ));
			float4 FinalGlowEmission600_g485 = lerpResult596_g485;
			int GlowMaskRIndex48_g485 = _GlowMaskZoneR;
			float2 lerpResult170_g485 = lerp( GradientZone0175_g485 , GradientZone0282_g485 , (float)saturate( GlowMaskRIndex48_g485 ));
			float2 lerpResult216_g485 = lerp( lerpResult170_g485 , GradientZone03122_g485 , (float)saturate( ( GlowMaskRIndex48_g485 - 1 ) ));
			float2 lerpResult263_g485 = lerp( lerpResult216_g485 , Zone01138_g485 , (float)saturate( ( GlowMaskRIndex48_g485 - 2 ) ));
			float2 lerpResult298_g485 = lerp( lerpResult263_g485 , Zone02188_g485 , (float)saturate( ( GlowMaskRIndex48_g485 - 3 ) ));
			float2 lerpResult338_g485 = lerp( lerpResult298_g485 , Zone03224_g485 , (float)saturate( ( GlowMaskRIndex48_g485 - 4 ) ));
			float2 lerpResult355_g485 = lerp( lerpResult338_g485 , Zone04291_g485 , (float)saturate( ( GlowMaskRIndex48_g485 - 5 ) ));
			float2 GlowMaskZoneRUV376_g485 = lerpResult355_g485;
			float temp_output_424_0_g485 = ( 1.0 - _EnableGlowMaskR );
			float3 lerpResult175_g485 = lerp( DebugGradient1111_g485 , DebugGradient2110_g485 , (float)saturate( GlowMaskRIndex48_g485 ));
			float3 lerpResult233_g485 = lerp( lerpResult175_g485 , DebugGradient3173_g485 , (float)saturate( ( GlowMaskRIndex48_g485 - 1 ) ));
			float3 lerpResult305_g485 = lerp( lerpResult233_g485 , DebugZone1195_g485 , (float)saturate( ( GlowMaskRIndex48_g485 - 2 ) ));
			float3 lerpResult321_g485 = lerp( lerpResult305_g485 , DebugZone2250_g485 , (float)saturate( ( GlowMaskRIndex48_g485 - 3 ) ));
			float3 lerpResult363_g485 = lerp( lerpResult321_g485 , DebugZone3309_g485 , (float)saturate( ( GlowMaskRIndex48_g485 - 4 ) ));
			float3 lerpResult387_g485 = lerp( lerpResult363_g485 , DebugZone4332_g485 , (float)saturate( ( GlowMaskRIndex48_g485 - 5 ) ));
			float EnableGlowMaskR682_g485 = temp_output_424_0_g485;
			float3 DebugGlowMaskR397_g485 = saturate( ( lerpResult387_g485 + EnableGlowMaskR682_g485 ) );
			float4 lerpResult633_g485 = lerp( saturate( ( tex2Dlod( _Stored, float4( GlowMaskZoneRUV376_g485, 0, 0.0) ) + temp_output_424_0_g485 + StoredTextureTog669_g485 ) ) , float4( DebugGlowMaskR397_g485 , 0.0 ) , DebugSwitch628_g485);
			float2 uv_GlowMaskRGB = i.uv_texcoord * _GlowMaskRGB_ST.xy + _GlowMaskRGB_ST.zw;
			float3 GlowMask605_g485 = (tex2D( _GlowMaskRGB, uv_GlowMaskRGB ).rgb).xyz;
			float4 GlowMaskZoneRColor468_g485 = ( lerpResult633_g485 * _GlowMaskTintR * GlowMask605_g485.x );
			int ReactivityIndexR469_g485 = _ReacitvityR;
			float4 lerpResult539_g485 = lerp( GlowMaskZoneRColor468_g485 , ( GlowMaskZoneRColor468_g485 * LowBlink431_g485 ) , (float)saturate( ReactivityIndexR469_g485 ));
			float4 lerpResult577_g485 = lerp( lerpResult539_g485 , ( GlowMaskZoneRColor468_g485 * LowPulse493_g485 ) , (float)saturate( ( ReactivityIndexR469_g485 - 1 ) ));
			float4 lerpResult588_g485 = lerp( lerpResult577_g485 , ( GlowMaskZoneRColor468_g485 * HighBlink464_g485 ) , (float)saturate( ( ReactivityIndexR469_g485 - 2 ) ));
			float4 lerpResult595_g485 = lerp( lerpResult588_g485 , ( GlowMaskZoneRColor468_g485 * HighPulse556_g485 ) , (float)saturate( ( ReactivityIndexR469_g485 - 3 ) ));
			float4 FinalGlowR599_g485 = lerpResult595_g485;
			int GlowMaskGIndex45_g485 = _GlowMaskZoneG;
			float2 lerpResult155_g485 = lerp( GradientZone0175_g485 , GradientZone0282_g485 , (float)saturate( GlowMaskGIndex45_g485 ));
			float2 lerpResult222_g485 = lerp( lerpResult155_g485 , GradientZone03122_g485 , (float)saturate( ( GlowMaskGIndex45_g485 - 1 ) ));
			float2 lerpResult230_g485 = lerp( lerpResult222_g485 , Zone01138_g485 , (float)saturate( ( GlowMaskGIndex45_g485 - 2 ) ));
			float2 lerpResult300_g485 = lerp( lerpResult230_g485 , Zone02188_g485 , (float)saturate( ( GlowMaskGIndex45_g485 - 3 ) ));
			float2 lerpResult330_g485 = lerp( lerpResult300_g485 , Zone03224_g485 , (float)saturate( ( GlowMaskGIndex45_g485 - 4 ) ));
			float2 lerpResult367_g485 = lerp( lerpResult330_g485 , Zone04291_g485 , (float)saturate( ( GlowMaskGIndex45_g485 - 5 ) ));
			float2 GlowMaskZoneGUV385_g485 = lerpResult367_g485;
			float temp_output_419_0_g485 = ( 1.0 - _EnableGlowMaskG );
			float3 lerpResult212_g485 = lerp( DebugGradient1111_g485 , DebugGradient2110_g485 , (float)saturate( GlowMaskGIndex45_g485 ));
			float3 lerpResult236_g485 = lerp( lerpResult212_g485 , DebugGradient3173_g485 , (float)saturate( ( GlowMaskGIndex45_g485 - 1 ) ));
			float3 lerpResult296_g485 = lerp( lerpResult236_g485 , DebugZone1195_g485 , (float)saturate( ( GlowMaskGIndex45_g485 - 2 ) ));
			float3 lerpResult323_g485 = lerp( lerpResult296_g485 , DebugZone2250_g485 , (float)saturate( ( GlowMaskGIndex45_g485 - 3 ) ));
			float3 lerpResult354_g485 = lerp( lerpResult323_g485 , DebugZone3309_g485 , (float)saturate( ( GlowMaskGIndex45_g485 - 4 ) ));
			float3 lerpResult388_g485 = lerp( lerpResult354_g485 , DebugZone4332_g485 , (float)saturate( ( GlowMaskGIndex45_g485 - 5 ) ));
			float EnableGlowMaskG681_g485 = temp_output_419_0_g485;
			float3 DebugGlowMaskG396_g485 = saturate( ( lerpResult388_g485 + EnableGlowMaskG681_g485 ) );
			float4 lerpResult630_g485 = lerp( saturate( ( tex2Dlod( _Stored, float4( GlowMaskZoneGUV385_g485, 0, 0.0) ) + temp_output_419_0_g485 + StoredTextureTog669_g485 ) ) , float4( DebugGlowMaskG396_g485 , 0.0 ) , DebugSwitch628_g485);
			float4 GlowMaskZoneGColor472_g485 = ( lerpResult630_g485 * _GlowMaskTintG * GlowMask605_g485.y );
			int ReactivityIndexG467_g485 = _ReacitvityG;
			float4 lerpResult551_g485 = lerp( GlowMaskZoneGColor472_g485 , ( GlowMaskZoneGColor472_g485 * LowBlink431_g485 ) , (float)saturate( ReactivityIndexG467_g485 ));
			float4 lerpResult564_g485 = lerp( lerpResult551_g485 , ( GlowMaskZoneGColor472_g485 * LowPulse493_g485 ) , (float)saturate( ( ReactivityIndexG467_g485 - 1 ) ));
			float4 lerpResult585_g485 = lerp( lerpResult564_g485 , ( GlowMaskZoneGColor472_g485 * HighBlink464_g485 ) , (float)saturate( ( ReactivityIndexG467_g485 - 2 ) ));
			float4 lerpResult593_g485 = lerp( lerpResult585_g485 , ( GlowMaskZoneGColor472_g485 * HighPulse556_g485 ) , (float)saturate( ( ReactivityIndexG467_g485 - 3 ) ));
			float4 FinalGlowG598_g485 = lerpResult593_g485;
			int GlowMaskBIndex50_g485 = _GlowMaskZoneB;
			float2 lerpResult157_g485 = lerp( GradientZone0175_g485 , GradientZone0282_g485 , (float)saturate( GlowMaskBIndex50_g485 ));
			float2 lerpResult205_g485 = lerp( lerpResult157_g485 , GradientZone03122_g485 , (float)saturate( ( GlowMaskBIndex50_g485 - 1 ) ));
			float2 lerpResult262_g485 = lerp( lerpResult205_g485 , Zone01138_g485 , (float)saturate( ( GlowMaskBIndex50_g485 - 2 ) ));
			float2 lerpResult311_g485 = lerp( lerpResult262_g485 , Zone02188_g485 , (float)saturate( ( GlowMaskBIndex50_g485 - 3 ) ));
			float2 lerpResult336_g485 = lerp( lerpResult311_g485 , Zone03224_g485 , (float)saturate( ( GlowMaskBIndex50_g485 - 4 ) ));
			float2 lerpResult370_g485 = lerp( lerpResult336_g485 , Zone04291_g485 , (float)saturate( ( GlowMaskBIndex50_g485 - 5 ) ));
			float2 GlowMaskZoneBUV383_g485 = lerpResult370_g485;
			float temp_output_421_0_g485 = ( 1.0 - _EnableGlowMaskB );
			float3 lerpResult197_g485 = lerp( DebugGradient1111_g485 , DebugGradient2110_g485 , (float)saturate( GlowMaskBIndex50_g485 ));
			float3 lerpResult237_g485 = lerp( lerpResult197_g485 , DebugGradient3173_g485 , (float)saturate( ( GlowMaskBIndex50_g485 - 1 ) ));
			float3 lerpResult287_g485 = lerp( lerpResult237_g485 , DebugZone1195_g485 , (float)saturate( ( GlowMaskBIndex50_g485 - 2 ) ));
			float3 lerpResult339_g485 = lerp( lerpResult287_g485 , DebugZone2250_g485 , (float)saturate( ( GlowMaskBIndex50_g485 - 3 ) ));
			float3 lerpResult360_g485 = lerp( lerpResult339_g485 , DebugZone3309_g485 , (float)saturate( ( GlowMaskBIndex50_g485 - 4 ) ));
			float3 lerpResult384_g485 = lerp( lerpResult360_g485 , DebugZone4332_g485 , (float)saturate( ( GlowMaskBIndex50_g485 - 5 ) ));
			float EnableGlowMaskB680_g485 = temp_output_421_0_g485;
			float3 DebugGlowMaskB401_g485 = saturate( ( lerpResult384_g485 + EnableGlowMaskB680_g485 ) );
			float4 lerpResult626_g485 = lerp( saturate( ( tex2Dlod( _Stored, float4( GlowMaskZoneBUV383_g485, 0, 0.0) ) + temp_output_421_0_g485 + StoredTextureTog669_g485 ) ) , float4( DebugGlowMaskB401_g485 , 0.0 ) , DebugSwitch628_g485);
			float4 GlowMaskZoneBColor466_g485 = ( lerpResult626_g485 * _GlowMaskTintB * GlowMask605_g485.z );
			int ReactivityIndexB480_g485 = _ReacitvityB;
			float4 lerpResult553_g485 = lerp( GlowMaskZoneBColor466_g485 , ( GlowMaskZoneBColor466_g485 * LowBlink431_g485 ) , (float)saturate( ReactivityIndexB480_g485 ));
			float4 lerpResult574_g485 = lerp( lerpResult553_g485 , ( GlowMaskZoneBColor466_g485 * LowPulse493_g485 ) , (float)saturate( ( ReactivityIndexB480_g485 - 1 ) ));
			float4 lerpResult591_g485 = lerp( lerpResult574_g485 , ( GlowMaskZoneBColor466_g485 * HighBlink464_g485 ) , (float)saturate( ( ReactivityIndexB480_g485 - 2 ) ));
			float4 lerpResult594_g485 = lerp( lerpResult591_g485 , ( GlowMaskZoneBColor466_g485 * HighPulse556_g485 ) , (float)saturate( ( ReactivityIndexB480_g485 - 3 ) ));
			float4 FinalGlowB597_g485 = lerpResult594_g485;
			float4 Emission1488 = ( FinalGlowEmission600_g485 + FinalGlowR599_g485 + FinalGlowG598_g485 + FinalGlowB597_g485 );
...
/*ASEBEGIN
Version=18906
566;670.6667;1891;724;-3507.907;-4022.23;1.301971;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;283;1316.517,7391.053;Inherit;False;2051.217;3418.291;;9;1521;226;244;111;227;28;87;65;2081;Lighting Styles;0.2658419,0.9716981,0.3154366,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;538;10203.23,518.9999;Inherit;False;2345.553;2830.088;;13;729;943;1655;549;785;352;27;728;2062;2063;2064;2065;2066;Lighting Calculations;1,0.9828576,0.1981132,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;57;4260.069,4313.341;Inherit;False;1480.991;334.9148;Distance Blending;11;40;37;38;52;44;36;42;35;34;1453;2088;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;2081;1370.306,10031.65;Inherit;False;1475.756;347.8193;Toon Lighting;7;2087;2086;2085;2084;2083;2082;1505;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;928;6801.586,7320.029;Inherit;False;3068.318;2460.014;;9;914;896;877;787;740;803;849;774;2070;Rimlight Styles;0.05079699,0,1,1;0;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2082;1577.869,10100.58;Inherit;False;286;BaseNdotL;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2083;1777.627,10272.4;Inherit;False;1497;ShadowLength;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;2084;1458.474,10202.53;Inherit;False;1502;ShadowOffset;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;2089;3106.452,6496.094;Inherit;False;682.3669;239.6001;Blend default lighting at distance;4;2093;2092;2091;2090;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;2086;2021.534,10201.59;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;16;False;3;FLOAT;6;False;4;FLOAT;64;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;2085;2047.417,10112.84;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2090;3154.452,6544.094;Inherit;False;23;NdotL;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;2088;5295.155,4508.807;Inherit;False;DistanceBlendAlpha;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;2087;2232.636,10108.69;Inherit;False;ExponentialSquared Blend;-1;;459;28efb435c6e4d7a48baa2d68777a317c;1,7,1;2;12;FLOAT;0;False;9;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;1505;2490.131,10085.26;Inherit;False;ToonLighting;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;2092;3330.452,6560.094;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2091;3234.452,6624.094;Inherit;False;2088;DistanceBlendAlpha;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1524;2198.472,10457.26;Inherit;False;ExponentialSquared Blend;-1;;460;28efb435c6e4d7a48baa2d68777a317c;1,7,1;2;12;FLOAT;0;False;9;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;2093;3618.453,6560.094;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1451;11554.56,1730.175;Inherit;False;ExponentialSquared Blend;-1;;461;28efb435c6e4d7a48baa2d68777a317c;1,7,1;2;12;FLOAT;0;False;9;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;961;15016.59,7188.257;Inherit;False;Step Antialiasing;-1;;462;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;985;15018.56,7548.203;Inherit;False;Step Antialiasing;-1;;463;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1053;15570.16,9026.35;Inherit;False;Step Antialiasing;-1;;464;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1031;15563.97,8653.84;Inherit;False;Step Antialiasing;-1;;465;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;750;8827.441,7434.029;Inherit;False;Step Antialiasing;-1;;469;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1017;15563.11,8284.372;Inherit;False;Step Antialiasing;-1;;468;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;999;15016.83,7907.567;Inherit;False;Step Antialiasing;-1;;471;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;819;8074.575,7821.111;Inherit;False;Step Antialiasing;-1;;472;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2053;12696.34,670.5984;Inherit;False;7;Normal;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;401;22895.03,7965.543;Inherit;False;Step Antialiasing;-1;;475;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.WorldNormalVector;2054;12853.34,670.5984;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.FunctionNode;921;7586.16,9389.22;Inherit;False;Step Antialiasing;-1;;474;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;441;23275.53,8345.855;Inherit;False;Step Antialiasing;-1;;476;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;909;8092.575,8982.958;Inherit;False;Step Antialiasing;-1;;477;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;2070;8375.615,9359.831;Inherit;False;1475.756;347.8193;Toon Rimlight;11;2080;2079;2078;2077;2076;2075;2074;2073;2072;2071;1559;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CustomExpressionNode;2055;13033.34,670.5984;Inherit;False;half4 skyData = UNITY_SAMPLE_TEXCUBE_LOD(unity_SpecCube0, uvw, 5)@ //('cubemap', 'sample coordinate', 'map-map level')$         half3 skyColor = DecodeHDR (skyData, unity_SpecCube0_HDR)@$         return half4(skyColor, 1.0)@;3;Create;1;True;uvw;FLOAT3;0,0,0;In;;Inherit;False;CustomReflectionProbeSample;True;False;0;;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;907;8138.373,9112.357;Inherit;False;769;BaseRimlight;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;528;22775.32,9913.095;Inherit;False;Step Antialiasing;-1;;478;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2071;8393.727,9521.621;Inherit;False;1561;RimlightOffset;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;2056;13303.82,665.7907;Inherit;False;CustomProbe;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;890;8061.209,8559.333;Inherit;False;Step Antialiasing;-1;;479;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2074;8782.937,9600.579;Inherit;False;1560;RimlightLength;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCRemapNode;2073;8597.63,9524.188;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;-1;False;2;FLOAT;5;False;3;FLOAT;0.3;False;4;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2072;8583.179,9428.758;Inherit;False;1744;BaseRimlightForToon;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;2069;16126.1,6829.634;Inherit;False;1497;ShadowLength;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;2062;10920.03,1437.054;Inherit;False;2056;CustomProbe;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;860;8115.768,8252.51;Inherit;False;Step Antialiasing;-1;;481;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0.56;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;509;23244.69,9507.333;Inherit;False;Step Antialiasing;-1;;480;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;2099;15989.45,6222.731;Inherit;False;682.3669;239.6001;Blend default lighting at distance;3;2102;2101;2100;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.LightAttenuation;2100;16138.54,6269.102;Inherit;False;0;1;FLOAT;0
Node;AmplifyShaderEditor.LightAttenuation;1847;16403.07,6612.18;Inherit;False;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;487;23175.55,9119.052;Inherit;False;Step Antialiasing;-1;;482;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2101;16116.45,6344.731;Inherit;False;2088;DistanceBlendAlpha;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;2067;16551.1,6834.634;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;16;False;3;FLOAT;1;False;4;FLOAT;0.66;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;2075;9052.727,9441.021;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;2076;9026.844,9529.771;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;16;False;3;FLOAT;6;False;4;FLOAT;32;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;2068;16358.1,6833.634;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;16;False;3;FLOAT;0.5;False;4;FLOAT;0.65;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;2063;11193.3,1433.858;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;465;23351.19,8762.227;Inherit;False;Step Antialiasing;-1;;483;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;1923;8673.683,7020.513;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;2098;9176.268,6512.192;Inherit;False;682.3669;239.6001;Blend default lighting at distance;4;2097;2096;2095;2094;;1,1,1,1;0;0
Node;AmplifyShaderEditor.FunctionNode;2078;9237.945,9436.87;Inherit;False;ExponentialSquared Blend;-1;;484;28efb435c6e4d7a48baa2d68777a317c;1,7,1;2;12;FLOAT;0;False;9;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;2065;11310.76,1431.867;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0.5,0.5,0.5;False;1;FLOAT3;0
Node;AmplifyShaderEditor.LerpOp;2102;16501.45,6284.034;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;2077;9345.979,9624.348;Inherit;False;165;SelectedLightingStyle;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2064;10922.7,1504.146;Inherit;False;1721;isLightMissing;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;2079;9648.163,9561.269;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;2066;11452.31,1403.335;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;1,1,1;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2094;9216.933,6551.842;Inherit;False;773;Rimlight;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;2097;9394.268,6564.192;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;2095;9303.268,6634.192;Inherit;False;2088;DistanceBlendAlpha;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;728;11831.2,1452.86;Inherit;False;IndirectDiffuse;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.CommentaryNode;943;11798.43,587.8798;Inherit;False;806.6416;384.319;Light Color;10;1706;942;941;939;1086;2057;2058;2059;2060;2061;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2058;12051.97,878.7961;Inherit;False;2056;CustomProbe;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.LerpOp;2096;9688.268,6573.494;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2057;11825.14,827.9532;Inherit;False;728;IndirectDiffuse;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;2059;12255.9,831.2762;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.CommentaryNode;2103;23762.84,6291.386;Inherit;False;682.3669;239.6001;Blend default lighting at distance;3;2106;2105;2104;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2060;11821.11,893.9343;Inherit;False;1721;isLightMissing;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;2061;12398.13,834.4724;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0.5,0.5,0.5;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;2105;23889.84,6413.386;Inherit;False;2088;DistanceBlendAlpha;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;2104;23908.62,6338.44;Inherit;False;324;DefaultSpecular;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;2106;24274.84,6352.688;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1659;14290.16,2925.887;Inherit;False;LumaGlowFunction;34;;485;b17985a035b3ebb42b5dfc7fc9435eb2;0;3;618;SAMPLER2D;0;False;612;FLOAT3;0,0,0;False;611;FLOAT3;0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.CommentaryNode;1235;15072.44,1469.517;Inherit;False;895.8398;535.298;Outline;6;932;931;929;1132;930;2045;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;931;15220.44,1907.077;Inherit;False;Property;_OutlineWidth;   Outline Width;32;0;Create;True;0;0;0;True;0;False;0;0.002;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;2047;14732.29,1263.097;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2045;15194.55,1760.338;Inherit;False;Property;_MaskClip;Mask Clip Value;61;0;Create;False;0;0;0;True;0;False;0.5;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;2052;15260.11,1244.159;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2051;14786.22,1364.109;Inherit;False;Property;_OutlineDepthFade;   Outline Depth Fade;56;0;Create;False;0;0;0;True;0;False;0.075;0.075;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.NormalVertexDataNode;2046;14550.29,1248.797;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.OutlineNode;929;15566.08,1643.841;Inherit;False;0;True;Masked;0;0;Front;3;0;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SmoothstepOpNode;2080;9486.793,9435.886;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0.8;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.DepthFade;2050;14972.01,1237.659;Inherit;False;True;False;False;2;1;FLOAT3;0,0,0;False;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;458;22743.1,8894.128;Inherit;False;40;DistanceBlend;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.PosVertexDataNode;2048;14552.89,1092.797;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;2049;14768.69,1133.097;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2043;14789.7,1632.705;Inherit;False;Property;_BlendModeIndex;BlendModeIndex;54;0;Create;True;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2107;4433.608,4194.09;Inherit;False;Property;_OutlineMaskClip;   Outline Mask Clip;55;0;Create;True;0;0;0;True;0;False;0.5;0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;11028.64,-2168.996;Float;False;True;-1;2;LegendsShaderGUI;0;0;CustomLighting;Furality/Legendary Shader/No Outline/Legendary Shader - No Outline;False;False;False;False;False;False;True;True;True;False;True;False;False;False;False;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;All;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;0;0;True;2042;-1;0;True;1742;0;0;0;False;0.1;False;-1;0;False;-1;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;2093;0;1787;0
WireConnection;2093;1;2092;0
WireConnection;2093;2;2091;0
...
WireConnection;2067;0;2069;0
WireConnection;2075;0;2072;0
WireConnection;2075;1;2073;0
WireConnection;861;0;860;0
WireConnection;861;1;858;0
WireConnection;2076;0;2074;0
WireConnection;2068;0;2069;0
...
WireConnection;2078;12;2075;0
WireConnection;2078;9;2076;0
WireConnection;2065;0;2063;0
WireConnection;2102;0;1837;0
WireConnection;2102;1;2100;0
WireConnection;2102;2;2101;0
...
WireConnection;1848;1;2068;0
WireConnection;1848;2;2067;0
...
WireConnection;2079;0;2078;0
WireConnection;2079;1;2077;0
...
WireConnection;2066;0;1419;0
WireConnection;2066;1;2065;0
WireConnection;2066;2;2064;0
...
WireConnection;2097;0;2094;0
WireConnection;728;0;2066;0
...
WireConnection;2059;0;2057;0
WireConnection;2059;1;2058;0
...
WireConnection;1706;1;2061;0
WireConnection;1706;2;2060;0
WireConnection;2106;0;2031;0
WireConnection;2106;1;2104;0
WireConnection;2106;2;2105;0
WireConnection;2033;0;2106;0
...
WireConnection;2050;1;2049;0
WireConnection;2050;0;2051;0
WireConnection;2049;0;2048;0
WireConnection;2049;1;2047;0
...
ASEEND*/
//CHKSM=422A2666EC7885AFBDFD79490FC324A85AA82F5D