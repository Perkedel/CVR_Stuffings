...
Shader "Furality/Legendary Shader/No Outline/Legendary Shader - No Outline Cutout"
{
	Properties
	{
	...
	SubShader
	{
		...
		float3 CustomReflectionProbeSample2047( float3 uvw )
		{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float temp_output_3_0_g462 = ( 0.0 - localRegularStar1024 );
			float StarShadows11021 = ( 1.0 - ( saturate( ( temp_output_3_0_g462 / fwidth( temp_output_3_0_g462 ) ) ) * ( 1.0 - ase_lightAtten ) ) );
			...
			float temp_output_3_0_g464 = ( 0.0 - ( ( Lines725 * 0.5 ) - ( 1.0 - ase_lightAtten ) ) );
			float LineShadows1003 = ( 1.0 - ( saturate( ( temp_output_3_0_g464 / fwidth( temp_output_3_0_g464 ) ) ) * ( 1.0 - ase_lightAtten ) ) );
			...
			float3 uvw2047 = (WorldNormalVector( i , Normal7 ));
			float3 localCustomReflectionProbeSample2047 = CustomReflectionProbeSample2047( uvw2047 );
			float3 CustomProbe2048 = localCustomReflectionProbeSample2047;
			float3 lerpResult2058 = lerp( temp_output_1419_0 , ( ( temp_output_1419_0 + CustomProbe2048 ) * float3( 0.5,0.5,0.5 ) ) , isLightMissing1721);
			float3 IndirectDiffuse728 = lerpResult2058;
			float3 lerpResult1706 = lerp( ( ase_lightColor.rgb * StylizedAttenuation1077 ) , ( ( IndirectDiffuse728 + CustomProbe2048 ) * float3( 0.5,0.5,0.5 ) ) , isLightMissing1721);
			...
			float temp_output_3_0_g466 = ( 0.0 - ( length( ( SpecularHalftoneUVS416 + float2( -0.5,-0.5 ) ) ) - HalftoneSpecular379 ) );
			float CircularSpecular404 = ( ( saturate( ( temp_output_3_0_g466 / fwidth( temp_output_3_0_g466 ) ) ) * 3.5 ) * ( DefaultSpecular324 + ( HalftoneSpecular379 * 2.0 ) ) * Smoothness354 );
			...
			float temp_output_3_0_g471 = ( 0.0 - ( ( ( max( max( break426.x , break426.y ) , max( break427.x , break427.y ) ) * 1.9 ) - 1.5 ) - HalftoneSpecular379 ) );
			float SquareSpecular444 = ( ( saturate( ( temp_output_3_0_g471 / fwidth( temp_output_3_0_g471 ) ) ) * 3.5 ) * ( DefaultSpecular324 + ( HalftoneSpecular379 * 2.0 ) ) * Smoothness354 );
			...
			float temp_output_3_0_g473 = ( 0.0 - localHexagon525 );
			float SpecularHexagon531 = ( ( saturate( ( temp_output_3_0_g473 / fwidth( temp_output_3_0_g473 ) ) ) * 3.5 ) * ( DefaultSpecular324 + ( HalftoneSpecular379 * 2.0 ) ) * Smoothness354 );
			...
			float temp_output_3_0_g477 = ( 0.0 - ( ( abs( sin( rotator455.x ) ) * 0.5 ) - HalftoneSpecular379 ) );
			float LinesSpecular467 = ( ( saturate( ( temp_output_3_0_g477 / fwidth( temp_output_3_0_g477 ) ) ) * 3.5 ) * ( DefaultSpecular324 + ( HalftoneSpecular379 * 2.0 ) ) * Smoothness354 );
			...
			float temp_output_3_0_g463 = ( 0.0 - ( length( ( RimlightHalftoneUVS784 + float2( -0.5,-0.5 ) ) ) - ( Rimlight773 + DistanceBlend40 ) ) );
			float BaseRimlight769 = ( temp_output_1451_0 * SelectedLightingStyle165 * 2.0 );
			float CircularRimlight786 = ( saturate( ( temp_output_3_0_g463 / fwidth( temp_output_3_0_g463 ) ) ) * BaseRimlight769 );
			...
			float temp_output_3_0_g465 = ( 0.0 - ( ( ( max( max( break807.x , break807.y ) , max( break806.x , break806.y ) ) * 2.0 ) - 1.5 ) - Rimlight773 ) );
			float SquareRimlight824 = ( saturate( ( temp_output_3_0_g465 / fwidth( temp_output_3_0_g465 ) ) ) * BaseRimlight769 );
			...
			float temp_output_3_0_g470 = ( 0.0 - localRegularStar905 );
			float Rimlight4SidedStar913 = ( saturate( ( temp_output_3_0_g470 / fwidth( temp_output_3_0_g470 ) ) ) * BaseRimlight769 );
			...
			float saferPower2_g478 = max( ( 1.0 / 2.71828 ) , 0.0001 );
			...
			float saferPower1_g478 = max( ( -( 1.0 - (6.0 + (RimlightLength1560 - 0.0) * (32.0 - 6.0) / (16.0 - 0.0)) ) * ( BaseRimlightForToon1744 + (0.3 + (RimlightOffset1561 - -1.0) * (1.0 - 0.3) / (5.0 - -1.0)) ) ) , 0.0001 );
			float temp_output_2_0_g478 = pow( saferPower2_g478 , pow( saferPower1_g478 , 2.0 ) );
			float ToonRimlight2072 = ( ( 1.0 - temp_output_2_0_g478 ) * SelectedLightingStyle165 );
			float lerpResult1938 = lerp( lerpResult2091 , ToonRimlight2072 , saturate( ( RimlightStyleIndex1942 - 6.0 ) ));
			...
			c.a = 1;
			clip( AlbedoAlpha1495 - _MaskClip );
			return c;
		}
...
/*ASEBEGIN
Version=18906
566;670.6667;1891;724;-3577.363;-3875.383;1.54748;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;538;10203.23,518.9999;Inherit;False;2345.553;2830.088;;13;729;943;1655;549;785;352;27;728;2054;2055;2056;2057;2058;Lighting Calculations;1,0.9828576,0.1981132,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;928;6801.586,7320.029;Inherit;False;3068.318;2460.014;;9;914;896;877;787;740;803;849;774;2062;Rimlight Styles;0.05079699,0,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;2074;1371.031,10036.19;Inherit;False;1475.756;347.8193;Toon Lighting;7;2080;2079;2078;2077;2076;2075;1505;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2077;1459.199,10207.07;Inherit;False;1502;ShadowOffset;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;2076;1778.352,10276.94;Inherit;False;1497;ShadowLength;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;2075;1578.594,10105.12;Inherit;False;286;BaseNdotL;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;2082;3200,6480;Inherit;False;682.3669;239.6001;Blend default lighting at distance;4;2086;2085;2084;2083;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;2078;2048.142,10117.38;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;2079;2022.259,10206.13;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;16;False;3;FLOAT;6;False;4;FLOAT;64;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;2081;5375.654,4505.029;Inherit;False;DistanceBlendAlpha;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2083;3248,6528;Inherit;False;23;NdotL;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;2080;2233.361,10113.23;Inherit;False;ExponentialSquared Blend;-1;;453;28efb435c6e4d7a48baa2d68777a317c;1,7,1;2;12;FLOAT;0;False;9;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2084;3328,6608;Inherit;False;2081;DistanceBlendAlpha;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;2085;3424,6544;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;1505;2535.768,10094.45;Inherit;False;ToonLighting;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;2086;3712,6544;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1017;15563.11,8284.372;Inherit;False;Step Antialiasing;-1;;462;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;750;8827.441,7434.029;Inherit;False;Step Antialiasing;-1;;463;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2045;12713.61,614.2433;Inherit;False;7;Normal;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;999;15016.83,7907.567;Inherit;False;Step Antialiasing;-1;;464;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;819;8074.575,7821.111;Inherit;False;Step Antialiasing;-1;;465;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;401;22895.03,7965.543;Inherit;False;Step Antialiasing;-1;;466;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.WorldNormalVector;2046;12870.61,614.2433;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.CustomExpressionNode;2047;13050.61,614.2433;Inherit;False;half4 skyData = UNITY_SAMPLE_TEXCUBE_LOD(unity_SpecCube0, uvw, 5)@ //('cubemap', 'sample coordinate', 'map-map level')$         half3 skyColor = DecodeHDR (skyData, unity_SpecCube0_HDR)@$         return half4(skyColor, 1.0)@;3;Create;1;True;uvw;FLOAT3;0,0,0;In;;Inherit;False;CustomReflectionProbeSample;True;False;0;;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;441;23275.53,8345.855;Inherit;False;Step Antialiasing;-1;;471;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;2062;8369.93,9346.084;Inherit;False;1475.756;347.8193;Toon Rimlight;11;2073;2072;2071;2070;2069;2068;2067;2066;2065;2064;2063;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.FunctionNode;909;8092.575,8982.958;Inherit;False;Step Antialiasing;-1;;470;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2063;8388.041,9507.874;Inherit;False;1561;RimlightOffset;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;2048;13321.09,609.4356;Inherit;False;CustomProbe;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;528;22775.32,9913.095;Inherit;False;Step Antialiasing;-1;;473;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2054;10922.57,1445.407;Inherit;False;2048;CustomProbe;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;2065;8591.944,9510.44;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;-1;False;2;FLOAT;5;False;3;FLOAT;0.3;False;4;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;2064;8577.493,9415.011;Inherit;False;1744;BaseRimlightForToon;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2061;16203.41,6817.542;Inherit;False;1497;ShadowLength;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;2092;16083,6206.637;Inherit;False;682.3669;239.6001;Blend default lighting at distance;3;2095;2094;2093;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2066;8777.251,9586.832;Inherit;False;1560;RimlightLength;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;2067;9047.041,9427.273;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;2059;16628.41,6822.542;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;16;False;3;FLOAT;1;False;4;FLOAT;0.66;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;2060;16435.41,6821.542;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;16;False;3;FLOAT;0.5;False;4;FLOAT;0.65;False;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCRemapNode;2068;9021.158,9516.023;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;16;False;3;FLOAT;6;False;4;FLOAT;32;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2093;16210,6328.637;Inherit;False;2081;DistanceBlendAlpha;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.LightAttenuation;2094;16232.09,6253.008;Inherit;False;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;2055;11195.84,1442.211;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;465;23351.19,8762.227;Inherit;False;Step Antialiasing;-1;;477;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;2087;9269.813,6496.098;Inherit;False;682.3669;239.6001;Blend default lighting at distance;4;2091;2090;2089;2088;;1,1,1,1;0;0
Node;AmplifyShaderEditor.FunctionNode;2070;9232.26,9423.123;Inherit;False;ExponentialSquared Blend;-1;;478;28efb435c6e4d7a48baa2d68777a317c;1,7,1;2;12;FLOAT;0;False;9;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;2095;16595,6267.94;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2069;9340.293,9610.601;Inherit;False;165;SelectedLightingStyle;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;2057;11313.3,1440.22;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0.5,0.5,0.5;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2056;10925.24,1512.499;Inherit;False;1721;isLightMissing;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2088;9310.479,6535.748;Inherit;False;773;Rimlight;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;2071;9642.478,9547.521;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;2058;11454.85,1411.688;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;1,1,1;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SaturateNode;2090;9487.813,6548.098;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;943;11798.43,587.8798;Inherit;False;806.6416;384.319;Light Color;10;1706;942;941;939;1086;2049;2050;2051;2052;2053;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2089;9396.813,6618.098;Inherit;False;2081;DistanceBlendAlpha;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;728;11903.65,1434.746;Inherit;False;IndirectDiffuse;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;2072;9641.697,9418.112;Inherit;False;ToonRimlight;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2049;11822.57,829.1804;Inherit;False;728;IndirectDiffuse;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.LerpOp;2091;9781.813,6557.4;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2050;12049.4,880.0233;Inherit;False;2048;CustomProbe;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;1562;9761.18,6924.309;Inherit;False;2072;ToonRimlight;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;2051;12253.33,832.5034;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.CommentaryNode;2096;23856.39,6275.292;Inherit;False;682.3669;239.6001;Blend default lighting at distance;3;2099;2098;2097;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2097;24002.17,6322.346;Inherit;False;324;DefaultSpecular;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2098;23983.39,6397.292;Inherit;False;2081;DistanceBlendAlpha;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2052;11818.54,895.1616;Inherit;False;1721;isLightMissing;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;2053;12395.56,835.6996;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0.5,0.5,0.5;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.LerpOp;2099;24368.39,6336.594;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;1235;15072.44,1469.517;Inherit;False;895.8398;535.298;Outline;7;932;931;1743;1742;929;1132;930;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SmoothstepOpNode;2073;9481.107,9422.139;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0.8;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;1743;15320.71,1709.591;Inherit;False;1495;AlbedoAlpha;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2044;15112.35,1324.491;Inherit;False;Property;_OutlineDepthFade;   Outline Depth Fade;56;0;Create;False;0;0;0;True;0;False;0.075;0.075;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1742;15094.97,1682.001;Inherit;False;Property;_MaskClip;Mask Clip Value;60;0;Create;False;0;0;0;True;0;False;0.5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;84;2059.724,8397.891;Inherit;False;40;DistanceBlend;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2100;4476.449,4157.024;Inherit;False;Property;_OutlineMaskClip;   Outline Mask Clip;55;0;Create;True;0;0;0;True;0;False;0.5;0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;11028.64,-2168.996;Float;False;True;-1;2;LegendsShaderGUI;0;0;CustomLighting;Furality/Legendary Shader/No Outline/Legendary Shader - No Outline Cutout;False;False;False;False;False;False;True;True;True;False;True;False;False;False;False;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Masked;0.5;True;True;0;False;TransparentCutout;;AlphaTest;All;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;0;0;True;933;-1;0;True;1742;0;0;0;False;0.1;False;-1;0;False;-1;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;2086;1;2085;0
WireConnection;2086;2;2084;0
...
WireConnection;2067;0;2064;0
WireConnection;2067;1;2065;0
...
WireConnection;2059;0;2061;0
WireConnection;2000;0;2036;0
WireConnection;2060;0;2061;0
WireConnection;2068;0;2066;0
WireConnection;1476;0;1399;1
WireConnection;487;1;486;0
WireConnection;2055;0;1419;0
WireConnection;2055;1;2054;0
...
WireConnection;2070;12;2067;0
WireConnection;2070;9;2068;0
WireConnection;531;0;1366;0
WireConnection;2095;0;1837;0
WireConnection;2095;1;2094;0
WireConnection;2095;2;2093;0
WireConnection;1923;0;1916;0
WireConnection;1848;0;1847;0
WireConnection;1848;1;2060;0
WireConnection;1848;2;2059;0
...
WireConnection;1706;1;2053;0
WireConnection;1706;2;2052;0
...
ASEEND*/
//CHKSM=82AD88865EDD3FEF416964BA48FF2FD4B0DF8109