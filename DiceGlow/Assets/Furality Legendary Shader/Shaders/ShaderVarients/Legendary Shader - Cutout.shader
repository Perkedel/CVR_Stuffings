...
Shader "Furality/Legendary Shader/Legendary Shader - Cutout"
{
	Properties
	{
	...
	SubShader
	{
		...
		void outlineVertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float temp_output_932_0 = ( _OutlineWidth * 0.01 );
			float3 vertexPos2049 = ( ase_vertex3Pos + ( ase_vertexNormal * temp_output_932_0 ) );
			float4 ase_screenPos2049 = ComputeScreenPos( UnityObjectToClipPos( vertexPos2049 ) );
			o.screenPosition2049 = ase_screenPos2049;
			float outlineVar = temp_output_932_0;
		...
		void outlineSurf( Input i, inout SurfaceOutput o )
		{
			...
			float4 ase_screenPos2049 = i.screenPosition2049;
			float4 ase_screenPosNorm2049 = ase_screenPos2049 / ase_screenPos2049.w;
			ase_screenPosNorm2049.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm2049.z : ase_screenPosNorm2049.z * 0.5 + 0.5;
			float screenDepth2049 = LinearEyeDepth(SAMPLE_DEPTH_TEXTURE( _CameraDepthTexture, ase_screenPosNorm2049.xy ));
			float distanceDepth2049 = ( screenDepth2049 - LinearEyeDepth( ase_screenPosNorm2049.z ) ) / ( _OutlineDepthFade );
			...
			float lerpResult2056 = lerp( ( AlbedoAlpha1495 * saturate( distanceDepth2049 ) ) , AlbedoAlpha1495 , isLightMissing1721);
			o.Emission = _OutlineColor.rgb;
			clip( lerpResult2056 - _OutlineMaskClip );
		}
		ENDCG
		...
		float3 CustomReflectionProbeSample2060( float3 uvw )
		{
		...
		{
			UNITY_INITIALIZE_OUTPUT( Input, o );
			float3 Outline1132 = 0;
			v.vertex.xyz += Outline1132;
			v.vertex.w = 1;
		}
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float DistanceBlendAlpha2094 = temp_output_38_0;
			float lerpResult2099 = lerp( lerpResult1787 , saturate( NdotL23 ) , DistanceBlendAlpha2094);
			float saferPower2_g449 = max( ( 1.0 / 2.71828 ) , 0.0001 );
			float ShadowLength1497 = _ShadowLength;
			float ShadowOffset1502 = _ShadowOffset;
			float saferPower1_g449 = max( ( -( 1.0 - (6.0 + (ShadowLength1497 - 0.0) * (64.0 - 6.0) / (16.0 - 0.0)) ) * ( BaseNdotL286 + ShadowOffset1502 ) ) , 0.0001 );
			float temp_output_2_0_g449 = pow( saferPower2_g449 , pow( saferPower1_g449 , 2.0 ) );
			float ToonLighting1505 = ( 1.0 - temp_output_2_0_g449 );
			float lerpResult1796 = lerp( lerpResult2099 , ToonLighting1505 , saturate( ( ShadowStyleIndex1758 - 6.0 ) ));
			float saferPower2_g450 = max( ( 1.0 / 2.71828 ) , 0.0001 );
			float saferPower1_g450 = max( ( -( 1.0 - (2.0 + (ShadowLength1497 - 0.0) * (16.0 - 2.0) / (16.0 - 0.0)) ) * ( (BaseNdotL286*0.5 + 0.5) + ShadowOffset1502 ) ) , 0.0001 );
			float temp_output_2_0_g450 = pow( saferPower2_g450 , pow( saferPower1_g450 , 2.0 ) );
			float HalfLambert1522 = ( 1.0 - temp_output_2_0_g450 );
			...
			float temp_output_3_0_g452 = ( 0.0 - ( Circles338 - ( 1.0 - ase_lightAtten ) ) );
			float CircularShadows967 = ( 1.0 - ( saturate( ( temp_output_3_0_g452 / fwidth( temp_output_3_0_g452 ) ) ) * ( 1.0 - ase_lightAtten ) ) );
			...
			float temp_output_3_0_g453 = ( 0.0 - ( ( Squares684 * 0.5 ) - ( 1.0 - ase_lightAtten ) ) );
			float SquareShadows988 = ( 1.0 - ( saturate( ( temp_output_3_0_g453 / fwidth( temp_output_3_0_g453 ) ) ) * ( 1.0 - ase_lightAtten ) ) );
			...
			float temp_output_3_0_g454 = ( 0.0 - localHexagon1064 );
			float HexagonalShadows1051 = ( 1.0 - ( saturate( ( temp_output_3_0_g454 / fwidth( temp_output_3_0_g454 ) ) ) * ( 1.0 - ase_lightAtten ) ) );
			...
			float temp_output_3_0_g455 = ( 0.0 - localRegularStar1038 );
			float StarShadows21034 = ( 1.0 - ( saturate( ( temp_output_3_0_g455 / fwidth( temp_output_3_0_g455 ) ) ) * ( 1.0 - ase_lightAtten ) ) );
			...
			float temp_output_3_0_g459 = ( 0.0 - localRegularStar1024 );
			float StarShadows11021 = ( 1.0 - ( saturate( ( temp_output_3_0_g459 / fwidth( temp_output_3_0_g459 ) ) ) * ( 1.0 - ase_lightAtten ) ) );
			...
			float temp_output_3_0_g462 = ( 0.0 - ( ( Lines725 * 0.5 ) - ( 1.0 - ase_lightAtten ) ) );
			float LineShadows1003 = ( 1.0 - ( saturate( ( temp_output_3_0_g462 / fwidth( temp_output_3_0_g462 ) ) ) * ( 1.0 - ase_lightAtten ) ) );
			float lerpResult1837 = lerp( lerpResult1836 , LineShadows1003 , saturate( ( ShadowStyleIndex1758 - 5.0 ) ));
			float lerpResult2109 = lerp( lerpResult1837 , ase_lightAtten , DistanceBlendAlpha2094);
			...
			float lerpResult1841 = lerp( lerpResult2109 , smoothstepResult1848 , saturate( ( ShadowStyleIndex1758 - 6.0 ) ));
			...
			float3 uvw2060 = (WorldNormalVector( i , Normal7 ));
			float3 localCustomReflectionProbeSample2060 = CustomReflectionProbeSample2060( uvw2060 );
			float3 CustomProbe2061 = localCustomReflectionProbeSample2060;
			float3 lerpResult2071 = lerp( temp_output_1419_0 , ( ( temp_output_1419_0 + CustomProbe2061 ) * float3( 0.5,0.5,0.5 ) ) , isLightMissing1721);
			float3 IndirectDiffuse728 = lerpResult2071;
			float3 lerpResult1706 = lerp( ( ase_lightColor.rgb * StylizedAttenuation1077 ) , ( ( IndirectDiffuse728 + CustomProbe2061 ) * float3( 0.5,0.5,0.5 ) ) , isLightMissing1721);
			...
			float temp_output_3_0_g465 = ( 0.0 - ( length( ( SpecularHalftoneUVS416 + float2( -0.5,-0.5 ) ) ) - HalftoneSpecular379 ) );
			float CircularSpecular404 = ( ( saturate( ( temp_output_3_0_g465 / fwidth( temp_output_3_0_g465 ) ) ) * 3.5 ) * ( DefaultSpecular324 + ( HalftoneSpecular379 * 2.0 ) ) * Smoothness354 );
			...
			float temp_output_3_0_g466 = ( 0.0 - ( ( ( max( max( break426.x , break426.y ) , max( break427.x , break427.y ) ) * 1.9 ) - 1.5 ) - HalftoneSpecular379 ) );
			float SquareSpecular444 = ( ( saturate( ( temp_output_3_0_g466 / fwidth( temp_output_3_0_g466 ) ) ) * 3.5 ) * ( DefaultSpecular324 + ( HalftoneSpecular379 * 2.0 ) ) * Smoothness354 );
			...
			float temp_output_3_0_g468 = ( 0.0 - localHexagon525 );
			float SpecularHexagon531 = ( ( saturate( ( temp_output_3_0_g468 / fwidth( temp_output_3_0_g468 ) ) ) * 3.5 ) * ( DefaultSpecular324 + ( HalftoneSpecular379 * 2.0 ) ) * Smoothness354 );
			...
			float temp_output_3_0_g470 = ( 0.0 - localRegularStar508 );
			float Specular4SidedStar513 = ( ( saturate( ( temp_output_3_0_g470 / fwidth( temp_output_3_0_g470 ) ) ) * 3.5 ) * ( DefaultSpecular324 + ( HalftoneSpecular379 * 2.0 ) ) * Smoothness354 );
			...
			float temp_output_3_0_g472 = ( 0.0 - localRegularStar486 );
			float Specular8SidedStar491 = ( ( saturate( ( temp_output_3_0_g472 / fwidth( temp_output_3_0_g472 ) ) ) * 3.5 ) * ( DefaultSpecular324 + ( HalftoneSpecular379 * 2.0 ) ) * Smoothness354 );
			...
			float temp_output_3_0_g473 = ( 0.0 - ( ( abs( sin( rotator455.x ) ) * 0.5 ) - HalftoneSpecular379 ) );
			float LinesSpecular467 = ( ( saturate( ( temp_output_3_0_g473 / fwidth( temp_output_3_0_g473 ) ) ) * 3.5 ) * ( DefaultSpecular324 + ( HalftoneSpecular379 * 2.0 ) ) * Smoothness354 );
			float lerpResult2031 = lerp( lerpResult2025 , LinesSpecular467 , saturate( ( SpecularStyleIndex1995 - 5.0 ) ));
			float lerpResult2114 = lerp( lerpResult2031 , DefaultSpecular324 , DistanceBlendAlpha2094);
			float ToonSpecular1545 = ( ( HalftoneSpecular379 * 3.5 ) * ( HalftoneSpecular379 * 2.0 ) );
			float lerpResult2033 = lerp( lerpResult2114 , ToonSpecular1545 , saturate( ( SpecularStyleIndex1995 - 6.0 ) ));
			float SelectedSpecularStyle388 = lerpResult2033;
			float saferPower2_g451 = max( ( 1.0 / 2.71828 ) , 0.0001 );
			...
			float saferPower1_g451 = max( ( -( 1.0 - _RimlightLength ) * ( -dotResult738 + _RimlightOffset ) ) , 0.0001 );
			float temp_output_2_0_g451 = pow( saferPower2_g451 , pow( saferPower1_g451 , 2.0 ) );
			float temp_output_1451_0 = ( 1.0 - temp_output_2_0_g451 );
			...
			float temp_output_3_0_g460 = ( 0.0 - ( length( ( RimlightHalftoneUVS784 + float2( -0.5,-0.5 ) ) ) - ( Rimlight773 + DistanceBlend40 ) ) );
			float BaseRimlight769 = ( temp_output_1451_0 * SelectedLightingStyle165 * 2.0 );
			float CircularRimlight786 = ( saturate( ( temp_output_3_0_g460 / fwidth( temp_output_3_0_g460 ) ) ) * BaseRimlight769 );
			...
			float temp_output_3_0_g463 = ( 0.0 - ( ( ( max( max( break807.x , break807.y ) , max( break806.x , break806.y ) ) * 2.0 ) - 1.5 ) - Rimlight773 ) );
			float SquareRimlight824 = ( saturate( ( temp_output_3_0_g463 / fwidth( temp_output_3_0_g463 ) ) ) * BaseRimlight769 );
			...
			float temp_output_3_0_g464 = ( 0.0 - localHexagon919 );
			float RimlightHexagon927 = ( saturate( ( temp_output_3_0_g464 / fwidth( temp_output_3_0_g464 ) ) ) * BaseRimlight769 );
			...
			float temp_output_3_0_g467 = ( 0.0 - localRegularStar905 );
			float Rimlight4SidedStar913 = ( saturate( ( temp_output_3_0_g467 / fwidth( temp_output_3_0_g467 ) ) ) * BaseRimlight769 );
			...
			float temp_output_3_0_g469 = ( 0.0 - localRegularStar888 );
			float Rimlight8SidedStar894 = ( saturate( ( temp_output_3_0_g469 / fwidth( temp_output_3_0_g469 ) ) ) * BaseRimlight769 );
			...
			float temp_output_3_0_g471 = ( 0.56 - ( abs( sin( rotator868.x ) ) - Rimlight773 ) );
			float RimlightLines862 = ( saturate( ( temp_output_3_0_g471 / fwidth( temp_output_3_0_g471 ) ) ) * BaseRimlight769 );
			float lerpResult1935 = lerp( lerpResult1926 , RimlightLines862 , saturate( ( RimlightStyleIndex1942 - 5.0 ) ));
			float lerpResult2104 = lerp( lerpResult1935 , saturate( Rimlight773 ) , DistanceBlendAlpha2094);
			float saferPower2_g474 = max( ( 1.0 / 2.71828 ) , 0.0001 );
			...
			float saferPower1_g474 = max( ( -( 1.0 - (6.0 + (RimlightLength1560 - 0.0) * (32.0 - 6.0) / (16.0 - 0.0)) ) * ( BaseRimlightForToon1744 + (0.3 + (RimlightOffset1561 - -1.0) * (1.0 - 0.3) / (5.0 - -1.0)) ) ) , 0.0001 );
			float temp_output_2_0_g474 = pow( saferPower2_g474 , pow( saferPower1_g474 , 2.0 ) );
			float ToonRimlight2085 = ( ( 1.0 - temp_output_2_0_g474 ) * SelectedLightingStyle165 );
			float lerpResult1938 = lerp( lerpResult2104 , ToonRimlight2085 , saturate( ( RimlightStyleIndex1942 - 6.0 ) ));
			...
			c.a = 1;
			clip( AlbedoAlpha1495 - _OutlineMaskClip );
			return c;
		}
		...
		void surf( Input i , inout SurfaceOutputCustomLightingCustom o )
		{
			...
			float cos695_g475 = cos( radians( _GradientDirection ) );
			float sin695_g475 = sin( radians( _GradientDirection ) );
			float2 rotator695_g475 = mul( i.uv_texcoord - float2( 0.5,0.5 ) , float2x2( cos695_g475 , -sin695_g475 , sin695_g475 , cos695_g475 )) + float2( 0.5,0.5 );
			float2 GradientUVs698_g475 = rotator695_g475;
			float4 _GradientZone2 = float4(9.4,0,0.57,0.49);
			float2 appendResult34_g475 = (float2(( 1.0 / _GradientZone2.x ) , 0.0));
			float2 appendResult42_g475 = (float2(_GradientZone2.z , _GradientZone2.w));
			float2 clampResult707_g475 = clamp( (GradientUVs698_g475*appendResult34_g475 + appendResult42_g475) , float2( 0.571,0 ) , float2( 0.676,1 ) );
			float2 GradientZone0175_g475 = clampResult707_g475;
			float4 _GradientZone3 = float4(9.4,0,0.6805,0.49);
			float2 appendResult38_g475 = (float2(( 1.0 / _GradientZone3.x ) , 0.0));
			float2 appendResult41_g475 = (float2(_GradientZone3.z , _GradientZone3.w));
			float2 clampResult710_g475 = clamp( (GradientUVs698_g475*appendResult38_g475 + appendResult41_g475) , float2( 0.681,0 ) , float2( 0.786,1 ) );
			float2 GradientZone0282_g475 = clampResult710_g475;
			int EmissionZoneIndex47_g475 = _EmissionZone;
			float2 lerpResult169_g475 = lerp( GradientZone0175_g475 , GradientZone0282_g475 , (float)saturate( EmissionZoneIndex47_g475 ));
			float4 _GradientZone4 = float4(9.4,0,0.791,0.49);
			float2 appendResult57_g475 = (float2(( 1.0 / _GradientZone4.x ) , 0.0));
			float2 appendResult52_g475 = (float2(_GradientZone4.z , _GradientZone4.w));
			float2 clampResult711_g475 = clamp( (GradientUVs698_g475*appendResult57_g475 + appendResult52_g475) , float2( 0.792,0 ) , float2( 0.896,1 ) );
			float2 GradientZone03122_g475 = clampResult711_g475;
			float2 lerpResult214_g475 = lerp( lerpResult169_g475 , GradientZone03122_g475 , (float)saturate( ( EmissionZoneIndex47_g475 - 1 ) ));
			float2 OriginalOffset44_g475 = float2( 0.1,0.471 );
			float2 Zone01138_g475 = ( float2( 0.955,0.992 ) - OriginalOffset44_g475 );
			float2 lerpResult249_g475 = lerp( lerpResult214_g475 , Zone01138_g475 , (float)saturate( ( EmissionZoneIndex47_g475 - 2 ) ));
			float2 Zone02188_g475 = ( float2( 0.964,0.992 ) - OriginalOffset44_g475 );
			float2 lerpResult286_g475 = lerp( lerpResult249_g475 , Zone02188_g475 , (float)saturate( ( EmissionZoneIndex47_g475 - 3 ) ));
			float2 Zone03224_g475 = ( float2( 0.955,0.978 ) - OriginalOffset44_g475 );
			float2 lerpResult343_g475 = lerp( lerpResult286_g475 , Zone03224_g475 , (float)saturate( ( EmissionZoneIndex47_g475 - 4 ) ));
			float2 Zone04291_g475 = ( float2( 0.964,0.978 ) - OriginalOffset44_g475 );
			float2 lerpResult364_g475 = lerp( lerpResult343_g475 , Zone04291_g475 , (float)saturate( ( EmissionZoneIndex47_g475 - 5 ) ));
			float2 EmissionZoneUV375_g475 = lerpResult364_g475;
			float temp_output_423_0_g475 = ( 1.0 - _EnableEmissionGlow );
			float StoredTextureTog669_g475 = step( max( _Stored_TexelSize.z , _Stored_TexelSize.w ) , 500.0 );
			float temp_output_712_0_g475 = saturate( ( 1.0 - abs( sin( ( GradientUVs698_g475.x + _Time.y ) ) ) ) );
			float3 appendResult65_g475 = (float3(temp_output_712_0_g475 , temp_output_712_0_g475 , temp_output_712_0_g475));
			float3 DebugGradient1111_g475 = appendResult65_g475;
			float temp_output_713_0_g475 = saturate( ( 1.0 - abs( sin( ( GradientUVs698_g475.x + _Time.y + 0.3 ) ) ) ) );
			float3 appendResult72_g475 = (float3(temp_output_713_0_g475 , temp_output_713_0_g475 , 0.0));
			float3 DebugGradient2110_g475 = appendResult72_g475;
			float3 lerpResult181_g475 = lerp( DebugGradient1111_g475 , DebugGradient2110_g475 , (float)saturate( EmissionZoneIndex47_g475 ));
			float temp_output_714_0_g475 = saturate( ( 1.0 - abs( sin( ( GradientUVs698_g475.x + _Time.y + 0.6 ) ) ) ) );
			float3 appendResult96_g475 = (float3(0.0 , temp_output_714_0_g475 , temp_output_714_0_g475));
			float3 DebugGradient3173_g475 = appendResult96_g475;
			float3 lerpResult244_g475 = lerp( lerpResult181_g475 , DebugGradient3173_g475 , (float)saturate( ( EmissionZoneIndex47_g475 - 1 ) ));
			float3 appendResult139_g475 = (float3(0.0 , 0.0 , saturate( ( 1.0 - abs( sin( _Time.y ) ) ) )));
			float3 DebugZone1195_g475 = appendResult139_g475;
			float3 lerpResult278_g475 = lerp( lerpResult244_g475 , DebugZone1195_g475 , (float)saturate( ( EmissionZoneIndex47_g475 - 2 ) ));
			float temp_output_716_0_g475 = saturate( ( 1.0 - abs( sin( ( _Time.y + 0.2 ) ) ) ) );
			float3 appendResult192_g475 = (float3(temp_output_716_0_g475 , temp_output_716_0_g475 , temp_output_716_0_g475));
			float3 DebugZone2250_g475 = appendResult192_g475;
			float3 lerpResult352_g475 = lerp( lerpResult278_g475 , DebugZone2250_g475 , (float)saturate( ( EmissionZoneIndex47_g475 - 3 ) ));
			float3 appendResult259_g475 = (float3(saturate( ( 1.0 - abs( sin( ( _Time.y + 0.4 ) ) ) ) ) , 0.0 , 0.0));
			float3 DebugZone3309_g475 = appendResult259_g475;
			float3 lerpResult362_g475 = lerp( lerpResult352_g475 , DebugZone3309_g475 , (float)saturate( ( EmissionZoneIndex47_g475 - 4 ) ));
			float3 appendResult306_g475 = (float3(0.0 , saturate( ( 1.0 - abs( sin( ( _Time.y + 0.6 ) ) ) ) ) , 0.0));
			float3 DebugZone4332_g475 = appendResult306_g475;
			float3 lerpResult379_g475 = lerp( lerpResult362_g475 , DebugZone4332_g475 , (float)saturate( ( EmissionZoneIndex47_g475 - 5 ) ));
			float EnableGlowMaskEmission683_g475 = temp_output_423_0_g475;
			float3 DebugEmissionColor399_g475 = saturate( ( lerpResult379_g475 + EnableGlowMaskEmission683_g475 ) );
			float DebugSwitch628_g475 = _DebugMode;
			float4 lerpResult634_g475 = lerp( saturate( ( tex2Dlod( _Stored, float4( EmissionZoneUV375_g475, 0, 0.0) ) + temp_output_423_0_g475 + StoredTextureTog669_g475 ) ) , float4( DebugEmissionColor399_g475 , 0.0 ) , DebugSwitch628_g475);
			...
			float3 Emission436_g475 = ( tex2D( _Emission, panner1666 ) * _EmissionColor * tex2D( _EmissionMask, uv_EmissionMask ).r ).rgb;
			float4 EmissionGlowColor471_g475 = ( lerpResult634_g475 * float4( Emission436_g475 , 0.0 ) );
			float2 ReactiveZone365_g475 = ( float2( 0.673,0.985 ) - OriginalOffset44_g475 );
			float mulTime293_g475 = _Time.y * 13.0;
			float3 appendResult390_g475 = (float3(saturate( sin( mulTime293_g475 ) ) , saturate( sin( ( mulTime293_g475 + 0.5 ) ) ) , 0.0));
			float4 lerpResult637_g475 = lerp( saturate( ( StoredTextureTog669_g475 + tex2D( _Stored, ReactiveZone365_g475 ) ) ) , float4( appendResult390_g475 , 0.0 ) , DebugSwitch628_g475);
			float4 break417_g475 = lerpResult637_g475;
			float LowBlink431_g475 = break417_g475.r;
			int ReactivityIndexEmission470_g475 = _EmissionReactivity;
			float4 lerpResult532_g475 = lerp( EmissionGlowColor471_g475 , ( EmissionGlowColor471_g475 * LowBlink431_g475 ) , (float)saturate( ReactivityIndexEmission470_g475 ));
			float cos437_g475 = cos( radians( _LowsPulseDirection ) );
			float sin437_g475 = sin( radians( _LowsPulseDirection ) );
			float2 rotator437_g475 = mul( i.uv_texcoord - float2( 0.5,0.5 ) , float2x2( cos437_g475 , -sin437_g475 , sin437_g475 , cos437_g475 )) + float2( 0.5,0.5 );
			float LowPulse493_g475 = saturate( ( rotator437_g475.y - ( 1.0 - LowBlink431_g475 ) ) );
			float4 lerpResult580_g475 = lerp( lerpResult532_g475 , ( EmissionGlowColor471_g475 * LowPulse493_g475 ) , (float)saturate( ( ReactivityIndexEmission470_g475 - 1 ) ));
			float HighBlink464_g475 = break417_g475.g;
			float4 lerpResult590_g475 = lerp( lerpResult580_g475 , ( EmissionGlowColor471_g475 * HighBlink464_g475 ) , (float)saturate( ( ReactivityIndexEmission470_g475 - 2 ) ));
			float cos456_g475 = cos( radians( _HighsPulseDirection ) );
			float sin456_g475 = sin( radians( _HighsPulseDirection ) );
			float2 rotator456_g475 = mul( i.uv_texcoord - float2( 0.5,0.5 ) , float2x2( cos456_g475 , -sin456_g475 , sin456_g475 , cos456_g475 )) + float2( 0.5,0.5 );
			float HighPulse556_g475 = saturate( ( rotator456_g475.y - ( 1.0 - HighBlink464_g475 ) ) );
			float4 lerpResult596_g475 = lerp( lerpResult590_g475 , ( EmissionGlowColor471_g475 * HighPulse556_g475 ) , (float)saturate( ( ReactivityIndexEmission470_g475 - 3 ) ));
			float4 FinalGlowEmission600_g475 = lerpResult596_g475;
			int GlowMaskRIndex48_g475 = _GlowMaskZoneR;
			float2 lerpResult170_g475 = lerp( GradientZone0175_g475 , GradientZone0282_g475 , (float)saturate( GlowMaskRIndex48_g475 ));
			float2 lerpResult216_g475 = lerp( lerpResult170_g475 , GradientZone03122_g475 , (float)saturate( ( GlowMaskRIndex48_g475 - 1 ) ));
			float2 lerpResult263_g475 = lerp( lerpResult216_g475 , Zone01138_g475 , (float)saturate( ( GlowMaskRIndex48_g475 - 2 ) ));
			float2 lerpResult298_g475 = lerp( lerpResult263_g475 , Zone02188_g475 , (float)saturate( ( GlowMaskRIndex48_g475 - 3 ) ));
			float2 lerpResult338_g475 = lerp( lerpResult298_g475 , Zone03224_g475 , (float)saturate( ( GlowMaskRIndex48_g475 - 4 ) ));
			float2 lerpResult355_g475 = lerp( lerpResult338_g475 , Zone04291_g475 , (float)saturate( ( GlowMaskRIndex48_g475 - 5 ) ));
			float2 GlowMaskZoneRUV376_g475 = lerpResult355_g475;
			float temp_output_424_0_g475 = ( 1.0 - _EnableGlowMaskR );
			float3 lerpResult175_g475 = lerp( DebugGradient1111_g475 , DebugGradient2110_g475 , (float)saturate( GlowMaskRIndex48_g475 ));
			float3 lerpResult233_g475 = lerp( lerpResult175_g475 , DebugGradient3173_g475 , (float)saturate( ( GlowMaskRIndex48_g475 - 1 ) ));
			float3 lerpResult305_g475 = lerp( lerpResult233_g475 , DebugZone1195_g475 , (float)saturate( ( GlowMaskRIndex48_g475 - 2 ) ));
			float3 lerpResult321_g475 = lerp( lerpResult305_g475 , DebugZone2250_g475 , (float)saturate( ( GlowMaskRIndex48_g475 - 3 ) ));
			float3 lerpResult363_g475 = lerp( lerpResult321_g475 , DebugZone3309_g475 , (float)saturate( ( GlowMaskRIndex48_g475 - 4 ) ));
			float3 lerpResult387_g475 = lerp( lerpResult363_g475 , DebugZone4332_g475 , (float)saturate( ( GlowMaskRIndex48_g475 - 5 ) ));
			float EnableGlowMaskR682_g475 = temp_output_424_0_g475;
			float3 DebugGlowMaskR397_g475 = saturate( ( lerpResult387_g475 + EnableGlowMaskR682_g475 ) );
			float4 lerpResult633_g475 = lerp( saturate( ( tex2Dlod( _Stored, float4( GlowMaskZoneRUV376_g475, 0, 0.0) ) + temp_output_424_0_g475 + StoredTextureTog669_g475 ) ) , float4( DebugGlowMaskR397_g475 , 0.0 ) , DebugSwitch628_g475);
			float2 uv_GlowMaskRGB = i.uv_texcoord * _GlowMaskRGB_ST.xy + _GlowMaskRGB_ST.zw;
			float3 GlowMask605_g475 = (tex2D( _GlowMaskRGB, uv_GlowMaskRGB ).rgb).xyz;
			float4 GlowMaskZoneRColor468_g475 = ( lerpResult633_g475 * _GlowMaskTintR * GlowMask605_g475.x );
			int ReactivityIndexR469_g475 = _ReacitvityR;
			float4 lerpResult539_g475 = lerp( GlowMaskZoneRColor468_g475 , ( GlowMaskZoneRColor468_g475 * LowBlink431_g475 ) , (float)saturate( ReactivityIndexR469_g475 ));
			float4 lerpResult577_g475 = lerp( lerpResult539_g475 , ( GlowMaskZoneRColor468_g475 * LowPulse493_g475 ) , (float)saturate( ( ReactivityIndexR469_g475 - 1 ) ));
			float4 lerpResult588_g475 = lerp( lerpResult577_g475 , ( GlowMaskZoneRColor468_g475 * HighBlink464_g475 ) , (float)saturate( ( ReactivityIndexR469_g475 - 2 ) ));
			float4 lerpResult595_g475 = lerp( lerpResult588_g475 , ( GlowMaskZoneRColor468_g475 * HighPulse556_g475 ) , (float)saturate( ( ReactivityIndexR469_g475 - 3 ) ));
			float4 FinalGlowR599_g475 = lerpResult595_g475;
			int GlowMaskGIndex45_g475 = _GlowMaskZoneG;
			float2 lerpResult155_g475 = lerp( GradientZone0175_g475 , GradientZone0282_g475 , (float)saturate( GlowMaskGIndex45_g475 ));
			float2 lerpResult222_g475 = lerp( lerpResult155_g475 , GradientZone03122_g475 , (float)saturate( ( GlowMaskGIndex45_g475 - 1 ) ));
			float2 lerpResult230_g475 = lerp( lerpResult222_g475 , Zone01138_g475 , (float)saturate( ( GlowMaskGIndex45_g475 - 2 ) ));
			float2 lerpResult300_g475 = lerp( lerpResult230_g475 , Zone02188_g475 , (float)saturate( ( GlowMaskGIndex45_g475 - 3 ) ));
			float2 lerpResult330_g475 = lerp( lerpResult300_g475 , Zone03224_g475 , (float)saturate( ( GlowMaskGIndex45_g475 - 4 ) ));
			float2 lerpResult367_g475 = lerp( lerpResult330_g475 , Zone04291_g475 , (float)saturate( ( GlowMaskGIndex45_g475 - 5 ) ));
			float2 GlowMaskZoneGUV385_g475 = lerpResult367_g475;
			float temp_output_419_0_g475 = ( 1.0 - _EnableGlowMaskG );
			float3 lerpResult212_g475 = lerp( DebugGradient1111_g475 , DebugGradient2110_g475 , (float)saturate( GlowMaskGIndex45_g475 ));
			float3 lerpResult236_g475 = lerp( lerpResult212_g475 , DebugGradient3173_g475 , (float)saturate( ( GlowMaskGIndex45_g475 - 1 ) ));
			float3 lerpResult296_g475 = lerp( lerpResult236_g475 , DebugZone1195_g475 , (float)saturate( ( GlowMaskGIndex45_g475 - 2 ) ));
			float3 lerpResult323_g475 = lerp( lerpResult296_g475 , DebugZone2250_g475 , (float)saturate( ( GlowMaskGIndex45_g475 - 3 ) ));
			float3 lerpResult354_g475 = lerp( lerpResult323_g475 , DebugZone3309_g475 , (float)saturate( ( GlowMaskGIndex45_g475 - 4 ) ));
			float3 lerpResult388_g475 = lerp( lerpResult354_g475 , DebugZone4332_g475 , (float)saturate( ( GlowMaskGIndex45_g475 - 5 ) ));
			float EnableGlowMaskG681_g475 = temp_output_419_0_g475;
			float3 DebugGlowMaskG396_g475 = saturate( ( lerpResult388_g475 + EnableGlowMaskG681_g475 ) );
			float4 lerpResult630_g475 = lerp( saturate( ( tex2Dlod( _Stored, float4( GlowMaskZoneGUV385_g475, 0, 0.0) ) + temp_output_419_0_g475 + StoredTextureTog669_g475 ) ) , float4( DebugGlowMaskG396_g475 , 0.0 ) , DebugSwitch628_g475);
			float4 GlowMaskZoneGColor472_g475 = ( lerpResult630_g475 * _GlowMaskTintG * GlowMask605_g475.y );
			int ReactivityIndexG467_g475 = _ReacitvityG;
			float4 lerpResult551_g475 = lerp( GlowMaskZoneGColor472_g475 , ( GlowMaskZoneGColor472_g475 * LowBlink431_g475 ) , (float)saturate( ReactivityIndexG467_g475 ));
			float4 lerpResult564_g475 = lerp( lerpResult551_g475 , ( GlowMaskZoneGColor472_g475 * LowPulse493_g475 ) , (float)saturate( ( ReactivityIndexG467_g475 - 1 ) ));
			float4 lerpResult585_g475 = lerp( lerpResult564_g475 , ( GlowMaskZoneGColor472_g475 * HighBlink464_g475 ) , (float)saturate( ( ReactivityIndexG467_g475 - 2 ) ));
			float4 lerpResult593_g475 = lerp( lerpResult585_g475 , ( GlowMaskZoneGColor472_g475 * HighPulse556_g475 ) , (float)saturate( ( ReactivityIndexG467_g475 - 3 ) ));
			float4 FinalGlowG598_g475 = lerpResult593_g475;
			int GlowMaskBIndex50_g475 = _GlowMaskZoneB;
			float2 lerpResult157_g475 = lerp( GradientZone0175_g475 , GradientZone0282_g475 , (float)saturate( GlowMaskBIndex50_g475 ));
			float2 lerpResult205_g475 = lerp( lerpResult157_g475 , GradientZone03122_g475 , (float)saturate( ( GlowMaskBIndex50_g475 - 1 ) ));
			float2 lerpResult262_g475 = lerp( lerpResult205_g475 , Zone01138_g475 , (float)saturate( ( GlowMaskBIndex50_g475 - 2 ) ));
			float2 lerpResult311_g475 = lerp( lerpResult262_g475 , Zone02188_g475 , (float)saturate( ( GlowMaskBIndex50_g475 - 3 ) ));
			float2 lerpResult336_g475 = lerp( lerpResult311_g475 , Zone03224_g475 , (float)saturate( ( GlowMaskBIndex50_g475 - 4 ) ));
			float2 lerpResult370_g475 = lerp( lerpResult336_g475 , Zone04291_g475 , (float)saturate( ( GlowMaskBIndex50_g475 - 5 ) ));
			float2 GlowMaskZoneBUV383_g475 = lerpResult370_g475;
			float temp_output_421_0_g475 = ( 1.0 - _EnableGlowMaskB );
			float3 lerpResult197_g475 = lerp( DebugGradient1111_g475 , DebugGradient2110_g475 , (float)saturate( GlowMaskBIndex50_g475 ));
			float3 lerpResult237_g475 = lerp( lerpResult197_g475 , DebugGradient3173_g475 , (float)saturate( ( GlowMaskBIndex50_g475 - 1 ) ));
			float3 lerpResult287_g475 = lerp( lerpResult237_g475 , DebugZone1195_g475 , (float)saturate( ( GlowMaskBIndex50_g475 - 2 ) ));
			float3 lerpResult339_g475 = lerp( lerpResult287_g475 , DebugZone2250_g475 , (float)saturate( ( GlowMaskBIndex50_g475 - 3 ) ));
			float3 lerpResult360_g475 = lerp( lerpResult339_g475 , DebugZone3309_g475 , (float)saturate( ( GlowMaskBIndex50_g475 - 4 ) ));
			float3 lerpResult384_g475 = lerp( lerpResult360_g475 , DebugZone4332_g475 , (float)saturate( ( GlowMaskBIndex50_g475 - 5 ) ));
			float EnableGlowMaskB680_g475 = temp_output_421_0_g475;
			float3 DebugGlowMaskB401_g475 = saturate( ( lerpResult384_g475 + EnableGlowMaskB680_g475 ) );
			float4 lerpResult626_g475 = lerp( saturate( ( tex2Dlod( _Stored, float4( GlowMaskZoneBUV383_g475, 0, 0.0) ) + temp_output_421_0_g475 + StoredTextureTog669_g475 ) ) , float4( DebugGlowMaskB401_g475 , 0.0 ) , DebugSwitch628_g475);
			float4 GlowMaskZoneBColor466_g475 = ( lerpResult626_g475 * _GlowMaskTintB * GlowMask605_g475.z );
			int ReactivityIndexB480_g475 = _ReacitvityB;
			float4 lerpResult553_g475 = lerp( GlowMaskZoneBColor466_g475 , ( GlowMaskZoneBColor466_g475 * LowBlink431_g475 ) , (float)saturate( ReactivityIndexB480_g475 ));
			float4 lerpResult574_g475 = lerp( lerpResult553_g475 , ( GlowMaskZoneBColor466_g475 * LowPulse493_g475 ) , (float)saturate( ( ReactivityIndexB480_g475 - 1 ) ));
			float4 lerpResult591_g475 = lerp( lerpResult574_g475 , ( GlowMaskZoneBColor466_g475 * HighBlink464_g475 ) , (float)saturate( ( ReactivityIndexB480_g475 - 2 ) ));
			float4 lerpResult594_g475 = lerp( lerpResult591_g475 , ( GlowMaskZoneBColor466_g475 * HighPulse556_g475 ) , (float)saturate( ( ReactivityIndexB480_g475 - 3 ) ));
			float4 FinalGlowB597_g475 = lerpResult594_g475;
			float4 Emission1488 = ( FinalGlowEmission600_g475 + FinalGlowR599_g475 + FinalGlowG598_g475 + FinalGlowB597_g475 );
...
/*ASEBEGIN
Version=18906
566;670.6667;1891;724;-14771.03;-1315.078;1.499115;True;False
Node;AmplifyShaderEditor.CommentaryNode;285;12791.42,1480.654;Inherit;False;2194.738;2092.908;Texture Assignment;75;1657;1495;1658;1660;1661;933;1494;1488;1659;1634;1650;1624;1664;1649;1484;1665;1483;1663;1666;1669;1482;1662;1668;1477;1667;1417;1672;1416;1410;33;1113;1412;1409;1299;1689;1411;1473;31;1680;1408;1493;1298;1401;1671;32;1670;1476;1104;354;1406;1407;1405;304;1399;1403;1398;1404;1397;1402;1400;1396;30;29;7;936;935;4;934;5;1564;6;3;2042;2117;2118;Texture Assignment;0.8455408,0.2776789,0.9811321,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;283;1316.517,7391.053;Inherit;False;2051.217;3418.291;;9;1521;226;244;111;227;28;87;65;2087;Lighting Styles;0.2658419,0.9716981,0.3154366,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;538;10203.23,518.9999;Inherit;False;2345.553;2830.088;;13;729;943;1655;549;785;352;27;728;2067;2068;2069;2070;2071;Lighting Calculations;1,0.9828576,0.1981132,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;57;4260.069,4313.341;Inherit;False;1480.991;334.9148;Distance Blending;11;40;37;38;52;44;36;42;35;34;1453;2094;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;928;6801.586,7320.029;Inherit;False;3068.318;2460.014;;9;914;896;877;787;740;803;849;774;2075;Rimlight Styles;0.05079699,0,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;2087;1384.282,10042.77;Inherit;False;1475.756;347.8193;Toon Lighting;7;2093;2092;2091;2090;2089;2088;1505;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2089;1791.603,10283.52;Inherit;False;1497;ShadowLength;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2088;1591.845,10111.71;Inherit;False;286;BaseNdotL;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2090;1472.45,10213.65;Inherit;False;1502;ShadowOffset;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;2095;3112.661,6519.374;Inherit;False;682.3669;239.6001;Blend default lighting at distance;4;2099;2098;2097;2096;;1,1,1,1;0;0
Node;AmplifyShaderEditor.TFHCRemapNode;2092;2035.51,10212.71;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;16;False;3;FLOAT;6;False;4;FLOAT;64;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;2091;2061.393,10123.96;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2096;3162.661,6569.374;Inherit;False;23;NdotL;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;2093;2246.612,10119.81;Inherit;False;ExponentialSquared Blend;-1;;449;28efb435c6e4d7a48baa2d68777a317c;1,7,1;2;12;FLOAT;0;False;9;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;2094;5350.85,4501.719;Inherit;False;DistanceBlendAlpha;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;1505;2630.97,10118.25;Inherit;False;ToonLighting;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;2097;3330.661,6571.374;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;2098;3239.661,6641.374;Inherit;False;2094;DistanceBlendAlpha;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1524;2198.472,10457.26;Inherit;False;ExponentialSquared Blend;-1;;450;28efb435c6e4d7a48baa2d68777a317c;1,7,1;2;12;FLOAT;0;False;9;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;2099;3624.662,6580.676;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1451;11554.56,1730.175;Inherit;False;ExponentialSquared Blend;-1;;451;28efb435c6e4d7a48baa2d68777a317c;1,7,1;2;12;FLOAT;0;False;9;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;961;15016.59,7188.257;Inherit;False;Step Antialiasing;-1;;452;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;985;15018.56,7548.203;Inherit;False;Step Antialiasing;-1;;453;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1053;15570.16,9026.35;Inherit;False;Step Antialiasing;-1;;454;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1031;15563.97,8653.84;Inherit;False;Step Antialiasing;-1;;455;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;750;8827.441,7434.029;Inherit;False;Step Antialiasing;-1;;460;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1017;15563.11,8284.372;Inherit;False;Step Antialiasing;-1;;459;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2058;12662.37,707.3972;Inherit;False;7;Normal;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;819;8074.575,7821.111;Inherit;False;Step Antialiasing;-1;;463;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;999;15016.83,7907.567;Inherit;False;Step Antialiasing;-1;;462;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;401;22895.03,7965.543;Inherit;False;Step Antialiasing;-1;;465;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.WorldNormalVector;2059;12819.37,707.3972;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.FunctionNode;921;7586.16,9389.22;Inherit;False;Step Antialiasing;-1;;464;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CustomExpressionNode;2060;12999.37,707.3972;Inherit;False;half4 skyData = UNITY_SAMPLE_TEXCUBE_LOD(unity_SpecCube0, uvw, 5)@ //('cubemap', 'sample coordinate', 'map-map level')$         half3 skyColor = DecodeHDR (skyData, unity_SpecCube0_HDR)@$         return half4(skyColor, 1.0)@;3;Create;1;True;uvw;FLOAT3;0,0,0;In;;Inherit;False;CustomReflectionProbeSample;True;False;0;;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.CommentaryNode;2075;8374.878,9342.342;Inherit;False;1475.756;347.8193;Toon Rimlight;11;2086;2085;2084;2083;2082;2081;2080;2079;2078;2077;2076;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.FunctionNode;909;8092.575,8982.958;Inherit;False;Step Antialiasing;-1;;467;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;441;23275.53,8345.855;Inherit;False;Step Antialiasing;-1;;466;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;2061;13269.85,702.5895;Inherit;False;CustomProbe;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;890;8061.209,8559.333;Inherit;False;Step Antialiasing;-1;;469;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;528;22775.32,9913.095;Inherit;False;Step Antialiasing;-1;;468;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2076;8392.989,9504.132;Inherit;False;1561;RimlightOffset;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;860;8115.768,8252.51;Inherit;False;Step Antialiasing;-1;;471;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0.56;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;2067;10945.7,1446.288;Inherit;False;2061;CustomProbe;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.CommentaryNode;2106;16035.48,6178.652;Inherit;False;682.3669;239.6001;Blend default lighting at distance;3;2109;2108;2111;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;2078;8596.892,9506.698;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;-1;False;2;FLOAT;5;False;3;FLOAT;0.3;False;4;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;2074;16108.27,6848.729;Inherit;False;1497;ShadowLength;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;2079;8782.198,9583.09;Inherit;False;1560;RimlightLength;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2077;8582.44,9411.269;Inherit;False;1744;BaseRimlightForToon;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;509;23244.69,9507.333;Inherit;False;Step Antialiasing;-1;;470;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LightAttenuation;2111;16184.57,6225.023;Inherit;False;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1670;14357.54,1803.801;Inherit;False;Property;_Workflow;Workflow;61;1;[Enum];Create;True;0;2;Metallic;0;Specular;1;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;2108;16162.48,6300.652;Inherit;False;2094;DistanceBlendAlpha;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;2081;9026.105,9512.281;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;16;False;3;FLOAT;6;False;4;FLOAT;32;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;2068;11218.97,1443.092;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;2080;9051.988,9423.531;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;487;23175.55,9119.052;Inherit;False;Step Antialiasing;-1;;472;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCRemapNode;2072;16533.27,6853.729;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;16;False;3;FLOAT;1;False;4;FLOAT;0.66;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;2073;16340.27,6852.729;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;16;False;3;FLOAT;0.5;False;4;FLOAT;0.65;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;2070;11336.43,1441.101;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0.5,0.5,0.5;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SaturateNode;1838;16629.5,6707.85;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;2109;16547.48,6239.955;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;2083;9237.207,9419.381;Inherit;False;ExponentialSquared Blend;-1;;474;28efb435c6e4d7a48baa2d68777a317c;1,7,1;2;12;FLOAT;0;False;9;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2069;10948.37,1513.38;Inherit;False;1721;isLightMissing;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;465;23351.19,8762.227;Inherit;False;Step Antialiasing;-1;;473;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;2082;9345.24,9606.858;Inherit;False;165;SelectedLightingStyle;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;2100;9206.707,6478.904;Inherit;False;682.3669;239.6001;Blend default lighting at distance;4;2104;2103;2102;2105;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;2084;9647.425,9543.778;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;2105;9247.374,6518.554;Inherit;False;773;Rimlight;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;2071;11477.98,1412.569;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;1,1,1;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SaturateNode;2102;9424.707,6530.904;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;728;11778.74,1420.269;Inherit;False;IndirectDiffuse;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;2085;9646.645,9414.37;Inherit;False;ToonRimlight;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2103;9333.707,6600.904;Inherit;False;2094;DistanceBlendAlpha;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;943;11798.43,587.8798;Inherit;False;806.6416;384.319;Light Color;10;1706;942;941;939;1086;2062;2063;2064;2065;2066;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2062;11832.58,836.7317;Inherit;False;728;IndirectDiffuse;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;1562;9761.18,6924.309;Inherit;False;2085;ToonRimlight;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;2104;9718.708,6540.206;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2063;12059.41,887.5745;Inherit;False;2061;CustomProbe;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;931;15203.44,2191.477;Inherit;False;Property;_OutlineWidth;   Outline Width;32;0;Create;True;0;0;0;False;0;False;0.15;0.002;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;2064;12263.34,840.0546;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;932;15370.36,2194.215;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.01;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;2112;23890.47,6271.161;Inherit;False;682.3669;239.6001;Blend default lighting at distance;3;2114;2113;2116;;1,1,1,1;0;0
Node;AmplifyShaderEditor.GetLocalVarNode;1112;10448.58,2401.302;Inherit;False;1113;Metallic;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.NormalVertexDataNode;2051;15119.79,1821.488;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.GetLocalVarNode;2116;24036.25,6318.216;Inherit;False;324;DefaultSpecular;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2113;24017.47,6393.161;Inherit;False;2094;DistanceBlendAlpha;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.PosVertexDataNode;2050;15122.39,1665.488;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;2066;12405.57,843.2508;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0.5,0.5,0.5;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2065;11828.55,902.7127;Inherit;False;1721;isLightMissing;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;2053;15301.79,1835.788;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.LerpOp;2114;24402.47,6332.464;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;2052;15338.19,1705.788;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2054;15355.72,1936.8;Inherit;False;Property;_OutlineDepthFade;   Outline Depth Fade;56;0;Create;False;0;0;0;False;0;False;0.075;0.075;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;1495;14740.2,1943.467;Inherit;False;AlbedoAlpha;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;1235;15602.84,1494.217;Inherit;False;895.8398;535.298;Outline;7;1743;930;2046;2044;2056;2057;2119;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.DepthFade;2049;15541.51,1810.35;Inherit;False;True;False;False;2;1;FLOAT3;0,0,0;False;0;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;2044;15829.61,1816.85;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;1743;15592.07,1710.286;Inherit;False;1495;AlbedoAlpha;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;2046;16040.7,1664.198;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2057;15853.62,1900.4;Inherit;False;1721;isLightMissing;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;2056;16251.97,1743.806;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;930;15714.95,1527.317;Inherit;False;Property;_OutlineColor;   Outline Color;31;0;Create;True;1;Outline Settings;0;0;False;0;False;0,0,0,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;1659;14290.16,2925.887;Inherit;False;LumaGlowFunction;34;;475;b17985a035b3ebb42b5dfc7fc9435eb2;0;3;618;SAMPLER2D;0;False;612;FLOAT3;0,0,0;False;611;FLOAT3;0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.OutlineNode;929;16535.68,1699.341;Inherit;False;0;True;Masked;0;0;Front;3;0;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;1132;16746.88,1723.866;Inherit;False;Outline;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SaturateNode;2118;14597.9,1951.942;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;2117;14479.19,1949.544;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2042;14768.12,1527.162;Inherit;False;Property;_BlendModeIndex;BlendModeIndex;55;0;Create;False;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1742;15425.12,1548.418;Inherit;False;Property;_MaskClip;Mask Clip Value;60;0;Create;False;0;0;0;True;0;False;0.5;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;1496;10830.02,-2038.963;Inherit;False;1495;AlbedoAlpha;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SmoothstepOpNode;2086;9486.055,9418.396;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0.8;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2119;16285.53,1933.979;Inherit;False;Property;_OutlineMaskClip;   Outline Mask Clip;54;0;Create;True;0;0;0;True;0;False;0.5;0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;11028.64,-2168.996;Float;False;True;-1;2;LegendsShaderGUI;0;0;CustomLighting;Furality/Legendary Shader/Legendary Shader - Cutout;False;False;False;False;False;False;True;True;True;False;True;False;False;False;False;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Masked;0.5;True;True;0;False;TransparentCutout;;AlphaTest;All;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;0;0;True;933;-1;0;True;2119;0;0;0;False;0.1;False;-1;0;False;-1;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;1505;0;2093;0
WireConnection;2097;0;2096;0
...
WireConnection;2099;0;1787;0
WireConnection;2099;1;2097;0
WireConnection;2099;2;2098;0
...
WireConnection;2080;0;2077;0
WireConnection;2080;1;2078;0
...
WireConnection;2072;0;2074;0
WireConnection;2073;0;2074;0
...
WireConnection;1848;1;2073;0
WireConnection;1848;2;2072;0
WireConnection;2005;0;1472;0
WireConnection;2005;1;386;0
WireConnection;2005;2;2001;0
WireConnection;1671;0;1670;0
WireConnection;2070;0;2068;0
WireConnection;1838;0;1834;0
WireConnection;2109;0;1837;0
WireConnection;2109;1;2111;0
WireConnection;2109;2;2108;0
WireConnection;2083;12;2080;0
WireConnection;2083;9;2081;0
...
WireConnection;2084;1;2082;0
WireConnection;2071;0;1419;0
WireConnection;2071;1;2070;0
WireConnection;2071;2;2069;0
WireConnection;1841;0;2109;0
...
WireConnection;2104;0;1935;0
WireConnection;2104;1;2102;0
WireConnection;2104;2;2103;0
...
WireConnection;2064;0;2062;0
WireConnection;2064;1;2063;0
WireConnection;1937;0;1934;0
WireConnection;1938;0;2104;0
...
WireConnection;2053;0;2051;0
WireConnection;2053;1;932;0
WireConnection;796;0;1939;0
WireConnection;544;0;545;0
WireConnection;544;1;1117;0
WireConnection;544;2;1196;0
WireConnection;2114;0;2031;0
WireConnection;2114;1;2116;0
WireConnection;2114;2;2113;0
WireConnection;1377;0;1307;2
WireConnection;2052;0;2050;0
WireConnection;2052;1;2053;0
WireConnection;1494;0;33;0
WireConnection;1706;0;941;0
WireConnection;1706;1;2066;0
WireConnection;1706;2;2065;0
...
WireConnection;2033;0;2114;0
WireConnection;2033;1;1546;0
WireConnection;2033;2;2030;0
WireConnection;2049;1;2052;0
WireConnection;2049;0;2054;0
WireConnection;1694;0;1307;1
WireConnection;1694;1;1693;0
WireConnection;2044;0;2049;0
...
WireConnection;2046;0;1743;0
WireConnection;2046;1;2044;0
...
WireConnection;2056;0;2046;0
WireConnection;2056;1;1743;0
WireConnection;2056;2;2057;0
...
WireConnection;0;10;1496;0
WireConnection;0;13;1323;0
WireConnection;0;11;1133;0
ASEEND*/
//CHKSM=DAECF013D4731C5FE48AD4B2FA9EF96A58FDE473