...
Shader "Furality/Legendary Shader/Legendary Shader - Transparent"
{
	Properties
	{
	...
	SubShader
	{
		...
		void outlineSurf( Input i, inout SurfaceOutput o )
		{
			...
			o.Alpha = ( _OutlineColor.a * AlbedoAlpha1495 );
		}
		ENDCG
		...
		float3 CustomReflectionProbeSample2054( float3 uvw )
		{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float DistanceBlendAlpha2106 = temp_output_38_0;
			float lerpResult2092 = lerp( lerpResult1787 , saturate( NdotL23 ) , DistanceBlendAlpha2106);
			...
			float lerpResult1796 = lerp( lerpResult2092 , ToonLighting1505 , saturate( ( ShadowStyleIndex1758 - 6.0 ) ));
			...
			float temp_output_3_0_g467 = ( 0.0 - ( ( Lines725 * 0.5 ) - ( 1.0 - ase_lightAtten ) ) );
			float LineShadows1003 = ( 1.0 - ( saturate( ( temp_output_3_0_g467 / fwidth( temp_output_3_0_g467 ) ) ) * ( 1.0 - ase_lightAtten ) ) );
			float lerpResult1837 = lerp( lerpResult1836 , LineShadows1003 , saturate( ( ShadowStyleIndex1758 - 5.0 ) ));
			float lerpResult2101 = lerp( lerpResult1837 , ase_lightAtten , DistanceBlendAlpha2106);
			...
			float lerpResult1841 = lerp( lerpResult2101 , smoothstepResult1848 , saturate( ( ShadowStyleIndex1758 - 6.0 ) ));
			...
			float3 uvw2054 = (WorldNormalVector( i , Normal7 ));
			float3 localCustomReflectionProbeSample2054 = CustomReflectionProbeSample2054( uvw2054 );
			float3 CustomProbe2055 = localCustomReflectionProbeSample2054;
			float3 lerpResult2066 = lerp( temp_output_1419_0 , ( ( temp_output_1419_0 + CustomProbe2055 ) * float3( 0.5,0.5,0.5 ) ) , isLightMissing1721);
			float3 IndirectDiffuse728 = lerpResult2066;
			float3 lerpResult1706 = lerp( ( ase_lightColor.rgb * StylizedAttenuation1077 ) , ( ( IndirectDiffuse728 + CustomProbe2055 ) * float3( 0.5,0.5,0.5 ) ) , isLightMissing1721);
			...
			float temp_output_3_0_g472 = ( 0.0 - localHexagon525 );
			float SpecularHexagon531 = ( ( saturate( ( temp_output_3_0_g472 / fwidth( temp_output_3_0_g472 ) ) ) * 3.5 ) * ( DefaultSpecular324 + ( HalftoneSpecular379 * 2.0 ) ) * Smoothness354 );
			...
			float temp_output_3_0_g476 = ( 0.0 - localRegularStar508 );
			float Specular4SidedStar513 = ( ( saturate( ( temp_output_3_0_g476 / fwidth( temp_output_3_0_g476 ) ) ) * 3.5 ) * ( DefaultSpecular324 + ( HalftoneSpecular379 * 2.0 ) ) * Smoothness354 );
			...
			float temp_output_3_0_g477 = ( 0.0 - localRegularStar486 );
			float Specular8SidedStar491 = ( ( saturate( ( temp_output_3_0_g477 / fwidth( temp_output_3_0_g477 ) ) ) * 3.5 ) * ( DefaultSpecular324 + ( HalftoneSpecular379 * 2.0 ) ) * Smoothness354 );
			...
			float lerpResult2105 = lerp( lerpResult2031 , DefaultSpecular324 , DistanceBlendAlpha2106);
			float ToonSpecular1545 = ( ( HalftoneSpecular379 * 3.5 ) * ( HalftoneSpecular379 * 2.0 ) );
			float lerpResult2033 = lerp( lerpResult2105 , ToonSpecular1545 , saturate( ( SpecularStyleIndex1995 - 6.0 ) ));
			...
			float temp_output_3_0_g462 = ( 0.0 - ( length( ( RimlightHalftoneUVS784 + float2( -0.5,-0.5 ) ) ) - Rimlight773 ) );
			...
			float temp_output_3_0_g469 = ( 0.0 - localHexagon919 );
			float RimlightHexagon927 = ( saturate( ( temp_output_3_0_g469 / fwidth( temp_output_3_0_g469 ) ) ) * BaseRimlight769 );
			...
			float temp_output_3_0_g471 = ( 0.0 - localRegularStar905 );
			float Rimlight4SidedStar913 = ( saturate( ( temp_output_3_0_g471 / fwidth( temp_output_3_0_g471 ) ) ) * BaseRimlight769 );
			...
			float temp_output_3_0_g473 = ( 0.0 - localRegularStar888 );
			float Rimlight8SidedStar894 = ( saturate( ( temp_output_3_0_g473 / fwidth( temp_output_3_0_g473 ) ) ) * BaseRimlight769 );
			...
			float lerpResult2095 = lerp( lerpResult1935 , saturate( Rimlight773 ) , DistanceBlendAlpha2106);
			float saferPower2_g479 = max( ( 1.0 / 2.71828 ) , 0.0001 );
			...
			float saferPower1_g479 = max( ( -( 1.0 - (6.0 + (RimlightLength1560 - 0.0) * (32.0 - 6.0) / (16.0 - 0.0)) ) * ( BaseRimlightForToon1744 + (0.3 + (RimlightOffset1561 - -1.0) * (1.0 - 0.3) / (5.0 - -1.0)) ) ) , 0.0001 );
			float temp_output_2_0_g479 = pow( saferPower2_g479 , pow( saferPower1_g479 , 2.0 ) );
			float ToonRimlight1559 = ( ( 1.0 - temp_output_2_0_g479 ) * SelectedLightingStyle165 );
			float lerpResult1938 = lerp( lerpResult2095 , ToonRimlight1559 , saturate( ( RimlightStyleIndex1942 - 6.0 ) ));
		...
		void surf( Input i , inout SurfaceOutputCustomLightingCustom o )
		{
			...
			float cos695_g480 = cos( radians( _GradientDirection ) );
			float sin695_g480 = sin( radians( _GradientDirection ) );
			float2 rotator695_g480 = mul( i.uv_texcoord - float2( 0.5,0.5 ) , float2x2( cos695_g480 , -sin695_g480 , sin695_g480 , cos695_g480 )) + float2( 0.5,0.5 );
			float2 GradientUVs698_g480 = rotator695_g480;
			float4 _GradientZone2 = float4(9.4,0,0.57,0.49);
			float2 appendResult34_g480 = (float2(( 1.0 / _GradientZone2.x ) , 0.0));
			float2 appendResult42_g480 = (float2(_GradientZone2.z , _GradientZone2.w));
			float2 clampResult707_g480 = clamp( (GradientUVs698_g480*appendResult34_g480 + appendResult42_g480) , float2( 0.571,0 ) , float2( 0.676,1 ) );
			float2 GradientZone0175_g480 = clampResult707_g480;
			float4 _GradientZone3 = float4(9.4,0,0.6805,0.49);
			float2 appendResult38_g480 = (float2(( 1.0 / _GradientZone3.x ) , 0.0));
			float2 appendResult41_g480 = (float2(_GradientZone3.z , _GradientZone3.w));
			float2 clampResult710_g480 = clamp( (GradientUVs698_g480*appendResult38_g480 + appendResult41_g480) , float2( 0.681,0 ) , float2( 0.786,1 ) );
			float2 GradientZone0282_g480 = clampResult710_g480;
			int EmissionZoneIndex47_g480 = _EmissionZone;
			float2 lerpResult169_g480 = lerp( GradientZone0175_g480 , GradientZone0282_g480 , (float)saturate( EmissionZoneIndex47_g480 ));
			float4 _GradientZone4 = float4(9.4,0,0.791,0.49);
			float2 appendResult57_g480 = (float2(( 1.0 / _GradientZone4.x ) , 0.0));
			float2 appendResult52_g480 = (float2(_GradientZone4.z , _GradientZone4.w));
			float2 clampResult711_g480 = clamp( (GradientUVs698_g480*appendResult57_g480 + appendResult52_g480) , float2( 0.792,0 ) , float2( 0.896,1 ) );
			float2 GradientZone03122_g480 = clampResult711_g480;
			float2 lerpResult214_g480 = lerp( lerpResult169_g480 , GradientZone03122_g480 , (float)saturate( ( EmissionZoneIndex47_g480 - 1 ) ));
			float2 OriginalOffset44_g480 = float2( 0.1,0.471 );
			float2 Zone01138_g480 = ( float2( 0.955,0.992 ) - OriginalOffset44_g480 );
			float2 lerpResult249_g480 = lerp( lerpResult214_g480 , Zone01138_g480 , (float)saturate( ( EmissionZoneIndex47_g480 - 2 ) ));
			float2 Zone02188_g480 = ( float2( 0.964,0.992 ) - OriginalOffset44_g480 );
			float2 lerpResult286_g480 = lerp( lerpResult249_g480 , Zone02188_g480 , (float)saturate( ( EmissionZoneIndex47_g480 - 3 ) ));
			float2 Zone03224_g480 = ( float2( 0.955,0.978 ) - OriginalOffset44_g480 );
			float2 lerpResult343_g480 = lerp( lerpResult286_g480 , Zone03224_g480 , (float)saturate( ( EmissionZoneIndex47_g480 - 4 ) ));
			float2 Zone04291_g480 = ( float2( 0.964,0.978 ) - OriginalOffset44_g480 );
			float2 lerpResult364_g480 = lerp( lerpResult343_g480 , Zone04291_g480 , (float)saturate( ( EmissionZoneIndex47_g480 - 5 ) ));
			float2 EmissionZoneUV375_g480 = lerpResult364_g480;
			float temp_output_423_0_g480 = ( 1.0 - _EnableEmissionGlow );
			float StoredTextureTog669_g480 = step( max( _Stored_TexelSize.z , _Stored_TexelSize.w ) , 500.0 );
			float temp_output_712_0_g480 = saturate( ( 1.0 - abs( sin( ( GradientUVs698_g480.x + _Time.y ) ) ) ) );
			float3 appendResult65_g480 = (float3(temp_output_712_0_g480 , temp_output_712_0_g480 , temp_output_712_0_g480));
			float3 DebugGradient1111_g480 = appendResult65_g480;
			float temp_output_713_0_g480 = saturate( ( 1.0 - abs( sin( ( GradientUVs698_g480.x + _Time.y + 0.3 ) ) ) ) );
			float3 appendResult72_g480 = (float3(temp_output_713_0_g480 , temp_output_713_0_g480 , 0.0));
			float3 DebugGradient2110_g480 = appendResult72_g480;
			float3 lerpResult181_g480 = lerp( DebugGradient1111_g480 , DebugGradient2110_g480 , (float)saturate( EmissionZoneIndex47_g480 ));
			float temp_output_714_0_g480 = saturate( ( 1.0 - abs( sin( ( GradientUVs698_g480.x + _Time.y + 0.6 ) ) ) ) );
			float3 appendResult96_g480 = (float3(0.0 , temp_output_714_0_g480 , temp_output_714_0_g480));
			float3 DebugGradient3173_g480 = appendResult96_g480;
			float3 lerpResult244_g480 = lerp( lerpResult181_g480 , DebugGradient3173_g480 , (float)saturate( ( EmissionZoneIndex47_g480 - 1 ) ));
			float3 appendResult139_g480 = (float3(0.0 , 0.0 , saturate( ( 1.0 - abs( sin( _Time.y ) ) ) )));
			float3 DebugZone1195_g480 = appendResult139_g480;
			float3 lerpResult278_g480 = lerp( lerpResult244_g480 , DebugZone1195_g480 , (float)saturate( ( EmissionZoneIndex47_g480 - 2 ) ));
			float temp_output_716_0_g480 = saturate( ( 1.0 - abs( sin( ( _Time.y + 0.2 ) ) ) ) );
			float3 appendResult192_g480 = (float3(temp_output_716_0_g480 , temp_output_716_0_g480 , temp_output_716_0_g480));
			float3 DebugZone2250_g480 = appendResult192_g480;
			float3 lerpResult352_g480 = lerp( lerpResult278_g480 , DebugZone2250_g480 , (float)saturate( ( EmissionZoneIndex47_g480 - 3 ) ));
			float3 appendResult259_g480 = (float3(saturate( ( 1.0 - abs( sin( ( _Time.y + 0.4 ) ) ) ) ) , 0.0 , 0.0));
			float3 DebugZone3309_g480 = appendResult259_g480;
			float3 lerpResult362_g480 = lerp( lerpResult352_g480 , DebugZone3309_g480 , (float)saturate( ( EmissionZoneIndex47_g480 - 4 ) ));
			float3 appendResult306_g480 = (float3(0.0 , saturate( ( 1.0 - abs( sin( ( _Time.y + 0.6 ) ) ) ) ) , 0.0));
			float3 DebugZone4332_g480 = appendResult306_g480;
			float3 lerpResult379_g480 = lerp( lerpResult362_g480 , DebugZone4332_g480 , (float)saturate( ( EmissionZoneIndex47_g480 - 5 ) ));
			float EnableGlowMaskEmission683_g480 = temp_output_423_0_g480;
			float3 DebugEmissionColor399_g480 = saturate( ( lerpResult379_g480 + EnableGlowMaskEmission683_g480 ) );
			float DebugSwitch628_g480 = _DebugMode;
			float4 lerpResult634_g480 = lerp( saturate( ( tex2Dlod( _Stored, float4( EmissionZoneUV375_g480, 0, 0.0) ) + temp_output_423_0_g480 + StoredTextureTog669_g480 ) ) , float4( DebugEmissionColor399_g480 , 0.0 ) , DebugSwitch628_g480);
			...
			float3 Emission436_g480 = ( tex2D( _Emission, panner1666 ) * _EmissionColor * tex2D( _EmissionMask, uv_EmissionMask ).r ).rgb;
			float4 EmissionGlowColor471_g480 = ( lerpResult634_g480 * float4( Emission436_g480 , 0.0 ) );
			float2 ReactiveZone365_g480 = ( float2( 0.673,0.985 ) - OriginalOffset44_g480 );
			float mulTime293_g480 = _Time.y * 13.0;
			float3 appendResult390_g480 = (float3(saturate( sin( mulTime293_g480 ) ) , saturate( sin( ( mulTime293_g480 + 0.5 ) ) ) , 0.0));
			float4 lerpResult637_g480 = lerp( saturate( ( StoredTextureTog669_g480 + tex2D( _Stored, ReactiveZone365_g480 ) ) ) , float4( appendResult390_g480 , 0.0 ) , DebugSwitch628_g480);
			float4 break417_g480 = lerpResult637_g480;
			float LowBlink431_g480 = break417_g480.r;
			int ReactivityIndexEmission470_g480 = _EmissionReactivity;
			float4 lerpResult532_g480 = lerp( EmissionGlowColor471_g480 , ( EmissionGlowColor471_g480 * LowBlink431_g480 ) , (float)saturate( ReactivityIndexEmission470_g480 ));
			float cos437_g480 = cos( radians( _LowsPulseDirection ) );
			float sin437_g480 = sin( radians( _LowsPulseDirection ) );
			float2 rotator437_g480 = mul( i.uv_texcoord - float2( 0.5,0.5 ) , float2x2( cos437_g480 , -sin437_g480 , sin437_g480 , cos437_g480 )) + float2( 0.5,0.5 );
			float LowPulse493_g480 = saturate( ( rotator437_g480.y - ( 1.0 - LowBlink431_g480 ) ) );
			float4 lerpResult580_g480 = lerp( lerpResult532_g480 , ( EmissionGlowColor471_g480 * LowPulse493_g480 ) , (float)saturate( ( ReactivityIndexEmission470_g480 - 1 ) ));
			float HighBlink464_g480 = break417_g480.g;
			float4 lerpResult590_g480 = lerp( lerpResult580_g480 , ( EmissionGlowColor471_g480 * HighBlink464_g480 ) , (float)saturate( ( ReactivityIndexEmission470_g480 - 2 ) ));
			float cos456_g480 = cos( radians( _HighsPulseDirection ) );
			float sin456_g480 = sin( radians( _HighsPulseDirection ) );
			float2 rotator456_g480 = mul( i.uv_texcoord - float2( 0.5,0.5 ) , float2x2( cos456_g480 , -sin456_g480 , sin456_g480 , cos456_g480 )) + float2( 0.5,0.5 );
			float HighPulse556_g480 = saturate( ( rotator456_g480.y - ( 1.0 - HighBlink464_g480 ) ) );
			float4 lerpResult596_g480 = lerp( lerpResult590_g480 , ( EmissionGlowColor471_g480 * HighPulse556_g480 ) , (float)saturate( ( ReactivityIndexEmission470_g480 - 3 ) ));
			float4 FinalGlowEmission600_g480 = lerpResult596_g480;
			int GlowMaskRIndex48_g480 = _GlowMaskZoneR;
			float2 lerpResult170_g480 = lerp( GradientZone0175_g480 , GradientZone0282_g480 , (float)saturate( GlowMaskRIndex48_g480 ));
			float2 lerpResult216_g480 = lerp( lerpResult170_g480 , GradientZone03122_g480 , (float)saturate( ( GlowMaskRIndex48_g480 - 1 ) ));
			float2 lerpResult263_g480 = lerp( lerpResult216_g480 , Zone01138_g480 , (float)saturate( ( GlowMaskRIndex48_g480 - 2 ) ));
			float2 lerpResult298_g480 = lerp( lerpResult263_g480 , Zone02188_g480 , (float)saturate( ( GlowMaskRIndex48_g480 - 3 ) ));
			float2 lerpResult338_g480 = lerp( lerpResult298_g480 , Zone03224_g480 , (float)saturate( ( GlowMaskRIndex48_g480 - 4 ) ));
			float2 lerpResult355_g480 = lerp( lerpResult338_g480 , Zone04291_g480 , (float)saturate( ( GlowMaskRIndex48_g480 - 5 ) ));
			float2 GlowMaskZoneRUV376_g480 = lerpResult355_g480;
			float temp_output_424_0_g480 = ( 1.0 - _EnableGlowMaskR );
			float3 lerpResult175_g480 = lerp( DebugGradient1111_g480 , DebugGradient2110_g480 , (float)saturate( GlowMaskRIndex48_g480 ));
			float3 lerpResult233_g480 = lerp( lerpResult175_g480 , DebugGradient3173_g480 , (float)saturate( ( GlowMaskRIndex48_g480 - 1 ) ));
			float3 lerpResult305_g480 = lerp( lerpResult233_g480 , DebugZone1195_g480 , (float)saturate( ( GlowMaskRIndex48_g480 - 2 ) ));
			float3 lerpResult321_g480 = lerp( lerpResult305_g480 , DebugZone2250_g480 , (float)saturate( ( GlowMaskRIndex48_g480 - 3 ) ));
			float3 lerpResult363_g480 = lerp( lerpResult321_g480 , DebugZone3309_g480 , (float)saturate( ( GlowMaskRIndex48_g480 - 4 ) ));
			float3 lerpResult387_g480 = lerp( lerpResult363_g480 , DebugZone4332_g480 , (float)saturate( ( GlowMaskRIndex48_g480 - 5 ) ));
			float EnableGlowMaskR682_g480 = temp_output_424_0_g480;
			float3 DebugGlowMaskR397_g480 = saturate( ( lerpResult387_g480 + EnableGlowMaskR682_g480 ) );
			float4 lerpResult633_g480 = lerp( saturate( ( tex2Dlod( _Stored, float4( GlowMaskZoneRUV376_g480, 0, 0.0) ) + temp_output_424_0_g480 + StoredTextureTog669_g480 ) ) , float4( DebugGlowMaskR397_g480 , 0.0 ) , DebugSwitch628_g480);
			float2 uv_GlowMaskRGB = i.uv_texcoord * _GlowMaskRGB_ST.xy + _GlowMaskRGB_ST.zw;
			float3 GlowMask605_g480 = (tex2D( _GlowMaskRGB, uv_GlowMaskRGB ).rgb).xyz;
			float4 GlowMaskZoneRColor468_g480 = ( lerpResult633_g480 * _GlowMaskTintR * GlowMask605_g480.x );
			int ReactivityIndexR469_g480 = _ReacitvityR;
			float4 lerpResult539_g480 = lerp( GlowMaskZoneRColor468_g480 , ( GlowMaskZoneRColor468_g480 * LowBlink431_g480 ) , (float)saturate( ReactivityIndexR469_g480 ));
			float4 lerpResult577_g480 = lerp( lerpResult539_g480 , ( GlowMaskZoneRColor468_g480 * LowPulse493_g480 ) , (float)saturate( ( ReactivityIndexR469_g480 - 1 ) ));
			float4 lerpResult588_g480 = lerp( lerpResult577_g480 , ( GlowMaskZoneRColor468_g480 * HighBlink464_g480 ) , (float)saturate( ( ReactivityIndexR469_g480 - 2 ) ));
			float4 lerpResult595_g480 = lerp( lerpResult588_g480 , ( GlowMaskZoneRColor468_g480 * HighPulse556_g480 ) , (float)saturate( ( ReactivityIndexR469_g480 - 3 ) ));
			float4 FinalGlowR599_g480 = lerpResult595_g480;
			int GlowMaskGIndex45_g480 = _GlowMaskZoneG;
			float2 lerpResult155_g480 = lerp( GradientZone0175_g480 , GradientZone0282_g480 , (float)saturate( GlowMaskGIndex45_g480 ));
			float2 lerpResult222_g480 = lerp( lerpResult155_g480 , GradientZone03122_g480 , (float)saturate( ( GlowMaskGIndex45_g480 - 1 ) ));
			float2 lerpResult230_g480 = lerp( lerpResult222_g480 , Zone01138_g480 , (float)saturate( ( GlowMaskGIndex45_g480 - 2 ) ));
			float2 lerpResult300_g480 = lerp( lerpResult230_g480 , Zone02188_g480 , (float)saturate( ( GlowMaskGIndex45_g480 - 3 ) ));
			float2 lerpResult330_g480 = lerp( lerpResult300_g480 , Zone03224_g480 , (float)saturate( ( GlowMaskGIndex45_g480 - 4 ) ));
			float2 lerpResult367_g480 = lerp( lerpResult330_g480 , Zone04291_g480 , (float)saturate( ( GlowMaskGIndex45_g480 - 5 ) ));
			float2 GlowMaskZoneGUV385_g480 = lerpResult367_g480;
			float temp_output_419_0_g480 = ( 1.0 - _EnableGlowMaskG );
			float3 lerpResult212_g480 = lerp( DebugGradient1111_g480 , DebugGradient2110_g480 , (float)saturate( GlowMaskGIndex45_g480 ));
			float3 lerpResult236_g480 = lerp( lerpResult212_g480 , DebugGradient3173_g480 , (float)saturate( ( GlowMaskGIndex45_g480 - 1 ) ));
			float3 lerpResult296_g480 = lerp( lerpResult236_g480 , DebugZone1195_g480 , (float)saturate( ( GlowMaskGIndex45_g480 - 2 ) ));
			float3 lerpResult323_g480 = lerp( lerpResult296_g480 , DebugZone2250_g480 , (float)saturate( ( GlowMaskGIndex45_g480 - 3 ) ));
			float3 lerpResult354_g480 = lerp( lerpResult323_g480 , DebugZone3309_g480 , (float)saturate( ( GlowMaskGIndex45_g480 - 4 ) ));
			float3 lerpResult388_g480 = lerp( lerpResult354_g480 , DebugZone4332_g480 , (float)saturate( ( GlowMaskGIndex45_g480 - 5 ) ));
			float EnableGlowMaskG681_g480 = temp_output_419_0_g480;
			float3 DebugGlowMaskG396_g480 = saturate( ( lerpResult388_g480 + EnableGlowMaskG681_g480 ) );
			float4 lerpResult630_g480 = lerp( saturate( ( tex2Dlod( _Stored, float4( GlowMaskZoneGUV385_g480, 0, 0.0) ) + temp_output_419_0_g480 + StoredTextureTog669_g480 ) ) , float4( DebugGlowMaskG396_g480 , 0.0 ) , DebugSwitch628_g480);
			float4 GlowMaskZoneGColor472_g480 = ( lerpResult630_g480 * _GlowMaskTintG * GlowMask605_g480.y );
			int ReactivityIndexG467_g480 = _ReacitvityG;
			float4 lerpResult551_g480 = lerp( GlowMaskZoneGColor472_g480 , ( GlowMaskZoneGColor472_g480 * LowBlink431_g480 ) , (float)saturate( ReactivityIndexG467_g480 ));
			float4 lerpResult564_g480 = lerp( lerpResult551_g480 , ( GlowMaskZoneGColor472_g480 * LowPulse493_g480 ) , (float)saturate( ( ReactivityIndexG467_g480 - 1 ) ));
			float4 lerpResult585_g480 = lerp( lerpResult564_g480 , ( GlowMaskZoneGColor472_g480 * HighBlink464_g480 ) , (float)saturate( ( ReactivityIndexG467_g480 - 2 ) ));
			float4 lerpResult593_g480 = lerp( lerpResult585_g480 , ( GlowMaskZoneGColor472_g480 * HighPulse556_g480 ) , (float)saturate( ( ReactivityIndexG467_g480 - 3 ) ));
			float4 FinalGlowG598_g480 = lerpResult593_g480;
			int GlowMaskBIndex50_g480 = _GlowMaskZoneB;
			float2 lerpResult157_g480 = lerp( GradientZone0175_g480 , GradientZone0282_g480 , (float)saturate( GlowMaskBIndex50_g480 ));
			float2 lerpResult205_g480 = lerp( lerpResult157_g480 , GradientZone03122_g480 , (float)saturate( ( GlowMaskBIndex50_g480 - 1 ) ));
			float2 lerpResult262_g480 = lerp( lerpResult205_g480 , Zone01138_g480 , (float)saturate( ( GlowMaskBIndex50_g480 - 2 ) ));
			float2 lerpResult311_g480 = lerp( lerpResult262_g480 , Zone02188_g480 , (float)saturate( ( GlowMaskBIndex50_g480 - 3 ) ));
			float2 lerpResult336_g480 = lerp( lerpResult311_g480 , Zone03224_g480 , (float)saturate( ( GlowMaskBIndex50_g480 - 4 ) ));
			float2 lerpResult370_g480 = lerp( lerpResult336_g480 , Zone04291_g480 , (float)saturate( ( GlowMaskBIndex50_g480 - 5 ) ));
			float2 GlowMaskZoneBUV383_g480 = lerpResult370_g480;
			float temp_output_421_0_g480 = ( 1.0 - _EnableGlowMaskB );
			float3 lerpResult197_g480 = lerp( DebugGradient1111_g480 , DebugGradient2110_g480 , (float)saturate( GlowMaskBIndex50_g480 ));
			float3 lerpResult237_g480 = lerp( lerpResult197_g480 , DebugGradient3173_g480 , (float)saturate( ( GlowMaskBIndex50_g480 - 1 ) ));
			float3 lerpResult287_g480 = lerp( lerpResult237_g480 , DebugZone1195_g480 , (float)saturate( ( GlowMaskBIndex50_g480 - 2 ) ));
			float3 lerpResult339_g480 = lerp( lerpResult287_g480 , DebugZone2250_g480 , (float)saturate( ( GlowMaskBIndex50_g480 - 3 ) ));
			float3 lerpResult360_g480 = lerp( lerpResult339_g480 , DebugZone3309_g480 , (float)saturate( ( GlowMaskBIndex50_g480 - 4 ) ));
			float3 lerpResult384_g480 = lerp( lerpResult360_g480 , DebugZone4332_g480 , (float)saturate( ( GlowMaskBIndex50_g480 - 5 ) ));
			float EnableGlowMaskB680_g480 = temp_output_421_0_g480;
			float3 DebugGlowMaskB401_g480 = saturate( ( lerpResult384_g480 + EnableGlowMaskB680_g480 ) );
			float4 lerpResult626_g480 = lerp( saturate( ( tex2Dlod( _Stored, float4( GlowMaskZoneBUV383_g480, 0, 0.0) ) + temp_output_421_0_g480 + StoredTextureTog669_g480 ) ) , float4( DebugGlowMaskB401_g480 , 0.0 ) , DebugSwitch628_g480);
			float4 GlowMaskZoneBColor466_g480 = ( lerpResult626_g480 * _GlowMaskTintB * GlowMask605_g480.z );
			int ReactivityIndexB480_g480 = _ReacitvityB;
			float4 lerpResult553_g480 = lerp( GlowMaskZoneBColor466_g480 , ( GlowMaskZoneBColor466_g480 * LowBlink431_g480 ) , (float)saturate( ReactivityIndexB480_g480 ));
			float4 lerpResult574_g480 = lerp( lerpResult553_g480 , ( GlowMaskZoneBColor466_g480 * LowPulse493_g480 ) , (float)saturate( ( ReactivityIndexB480_g480 - 1 ) ));
			float4 lerpResult591_g480 = lerp( lerpResult574_g480 , ( GlowMaskZoneBColor466_g480 * HighBlink464_g480 ) , (float)saturate( ( ReactivityIndexB480_g480 - 2 ) ));
			float4 lerpResult594_g480 = lerp( lerpResult591_g480 , ( GlowMaskZoneBColor466_g480 * HighPulse556_g480 ) , (float)saturate( ( ReactivityIndexB480_g480 - 3 ) ));
			float4 FinalGlowB597_g480 = lerpResult594_g480;
			float4 Emission1488 = ( FinalGlowEmission600_g480 + FinalGlowR599_g480 + FinalGlowG598_g480 + FinalGlowB597_g480 );
			o.Emission = Emission1488.rgb;
		}

		ENDCG
		CGPROGRAM
		#pragma surface surf StandardCustomLighting alpha:fade keepalpha fullforwardshadows nolightmap  nodynlightmap nodirlightmap nometa vertex:vertexDataFunc 
...
/*ASEBEGIN
Version=18906
566;670.6667;1891;724;-3741.291;-4198.104;1;True;False
Node;AmplifyShaderEditor.CommentaryNode;285;12791.42,1480.654;Inherit;False;2194.738;2092.908;Texture Assignment;74;1657;1495;1658;1660;1661;933;1494;1488;1659;1634;1650;1624;1664;1649;1484;1665;1483;1663;1666;1669;1482;1662;1668;1477;1667;1417;1672;1416;1410;33;1113;1412;1409;1299;1689;1411;1473;31;1680;1408;1493;1298;1401;1671;32;1670;1476;1104;354;1406;1407;1405;304;1399;1403;1398;1404;1397;1402;1400;1396;30;29;7;936;935;4;934;5;1564;6;3;2042;2044;Texture Assignment;0.8455408,0.2776789,0.9811321,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;538;10203.23,518.9999;Inherit;False;2345.553;2830.088;;13;729;943;1655;549;785;352;27;2059;728;2063;2064;2065;2066;Lighting Calculations;1,0.9828576,0.1981132,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;57;4260.069,4313.341;Inherit;False;1480.991;334.9148;Distance Blending;11;40;37;38;52;44;36;42;35;34;1453;2106;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;2081;1368.045,10038.99;Inherit;False;1475.756;347.8193;Toon Lighting;7;2087;2086;2085;2084;2083;2082;1505;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2082;1575.608,10107.92;Inherit;False;286;BaseNdotL;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2083;1775.366,10279.74;Inherit;False;1497;ShadowLength;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2084;1456.213,10209.87;Inherit;False;1502;ShadowOffset;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;2086;2019.273,10208.93;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;16;False;3;FLOAT;6;False;4;FLOAT;64;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;2088;3126.539,6453.452;Inherit;False;682.3669;239.6001;Blend default lighting at distance;4;2092;2091;2090;2089;;1,1,1,1;0;0
Node;AmplifyShaderEditor.SaturateNode;38;5179.829,4405.451;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;2085;2045.156,10120.18;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2089;3174.539,6501.452;Inherit;False;23;NdotL;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;2087;2230.375,10116.03;Inherit;False;ExponentialSquared Blend;-1;;453;28efb435c6e4d7a48baa2d68777a317c;1,7,1;2;12;FLOAT;0;False;9;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;2106;5347.24,4515.419;Inherit;False;DistanceBlendAlpha;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2090;3254.539,6581.452;Inherit;False;2106;DistanceBlendAlpha;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;2091;3350.539,6517.452;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;2092;3638.539,6517.452;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;999;15016.83,7907.567;Inherit;False;Step Antialiasing;-1;;467;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2052;12643.84,709.7734;Inherit;False;7;Normal;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.WorldNormalVector;2053;12800.84,709.7734;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.CommentaryNode;729;10268.55,1397.536;Inherit;False;785.5322;163.8323;Indirect Diffuse Light;5;1419;1420;726;727;2062;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.FunctionNode;921;7586.16,9389.22;Inherit;False;Step Antialiasing;-1;;469;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;909;8092.575,8982.958;Inherit;False;Step Antialiasing;-1;;471;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;2070;8365.07,9344.202;Inherit;False;1475.756;347.8193;Toon Rimlight;11;2080;2079;2078;2077;2076;2075;2074;2073;2072;2071;1559;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CustomExpressionNode;2054;12980.84,709.7734;Inherit;False;half4 skyData = UNITY_SAMPLE_TEXCUBE_LOD(unity_SpecCube0, uvw, 5)@ //('cubemap', 'sample coordinate', 'map-map level')$         half3 skyColor = DecodeHDR (skyData, unity_SpecCube0_HDR)@$         return half4(skyColor, 1.0)@;3;Create;1;True;uvw;FLOAT3;0,0,0;In;;Inherit;False;CustomReflectionProbeSample;True;False;0;;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2071;8383.182,9505.992;Inherit;False;1561;RimlightOffset;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;890;8061.209,8559.333;Inherit;False;Step Antialiasing;-1;;473;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;528;22775.32,9913.095;Inherit;False;Step Antialiasing;-1;;472;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;2055;13251.32,704.9657;Inherit;False;CustomProbe;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;2073;8587.084,9508.559;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;-1;False;2;FLOAT;5;False;3;FLOAT;0.3;False;4;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;509;23244.69,9507.333;Inherit;False;Step Antialiasing;-1;;476;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2062;10897.11,1447.688;Inherit;False;2055;CustomProbe;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;2069;16230.35,6905.563;Inherit;False;1497;ShadowLength;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2074;8772.391,9584.95;Inherit;False;1560;RimlightLength;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;2098;16009.54,6180.089;Inherit;False;682.3669;239.6001;Blend default lighting at distance;3;2101;2099;2108;;1,1,1,1;0;0
Node;AmplifyShaderEditor.GetLocalVarNode;2072;8572.633,9413.129;Inherit;False;1744;BaseRimlightForToon;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;2075;9042.181,9425.392;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCRemapNode;2076;9016.298,9514.142;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;16;False;3;FLOAT;6;False;4;FLOAT;32;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;2063;11170.38,1444.492;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2108;16162.6,6298.889;Inherit;False;2106;DistanceBlendAlpha;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.LightAttenuation;2099;16158.63,6226.46;Inherit;False;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;2068;16462.35,6909.563;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;16;False;3;FLOAT;0.5;False;4;FLOAT;0.65;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;2067;16655.35,6910.563;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;16;False;3;FLOAT;1;False;4;FLOAT;0.66;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;487;23175.55,9119.052;Inherit;False;Step Antialiasing;-1;;477;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;2078;9227.399,9421.241;Inherit;False;ExponentialSquared Blend;-1;;479;28efb435c6e4d7a48baa2d68777a317c;1,7,1;2;12;FLOAT;0;False;9;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;2097;9196.354,6469.55;Inherit;False;682.3669;239.6001;Blend default lighting at distance;4;2096;2095;2093;2107;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.LerpOp;2101;16521.54,6241.392;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;2065;11287.84,1442.501;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0.5,0.5,0.5;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2077;9335.433,9608.719;Inherit;False;165;SelectedLightingStyle;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2064;10899.78,1514.78;Inherit;False;1721;isLightMissing;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2093;9237.02,6509.2;Inherit;False;773;Rimlight;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;2066;11429.39,1413.969;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;1,1,1;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;2079;9637.617,9545.64;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2107;9330.133,6608.061;Inherit;False;2106;DistanceBlendAlpha;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;2096;9414.354,6521.55;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;728;11610.25,1403.32;Inherit;False;IndirectDiffuse;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.CommentaryNode;943;11798.43,587.8798;Inherit;False;806.6416;384.319;Light Color;9;1706;942;941;939;1086;2056;2057;2058;2060;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2057;12066,892.114;Inherit;False;2055;CustomProbe;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;1369;10279.77,2498.378;Inherit;False;354;Smoothness;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;2095;9708.354,6530.852;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2056;11839.17,841.2712;Inherit;False;728;IndirectDiffuse;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.CommentaryNode;2102;23782.94,6248.744;Inherit;False;682.3669;239.6001;Blend default lighting at distance;3;2105;2103;2109;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;2058;12269.93,844.5941;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SaturateNode;1937;10369.68,7004.513;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;2103;23928.72,6295.798;Inherit;False;324;DefaultSpecular;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2059;11835.14,907.2522;Inherit;False;1721;isLightMissing;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;2109;23940.93,6386.984;Inherit;False;2106;DistanceBlendAlpha;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;2060;12412.16,847.7903;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0.5,0.5,0.5;False;1;FLOAT3;0
Node;AmplifyShaderEditor.LerpOp;2105;24294.94,6310.046;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;931;15220.44,1907.077;Inherit;False;Property;_OutlineWidth;   Outline Width;32;0;Create;True;0;0;0;False;0;False;0.15;0.002;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;930;15108.95,1525.517;Inherit;False;Property;_OutlineColor;   Outline Color;31;0;Create;True;1;Outline Settings;0;0;False;0;False;0,0,0,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;1659;14290.16,2925.887;Inherit;False;LumaGlowFunction;34;;480;b17985a035b3ebb42b5dfc7fc9435eb2;0;3;618;SAMPLER2D;0;False;612;FLOAT3;0,0,0;False;611;FLOAT3;0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2050;14813.56,1390.17;Inherit;False;Property;_OutlineDepthFade;   Outline Depth Fade;56;0;Create;False;0;0;0;True;0;False;0.075;0.075;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;2051;15287.45,1270.219;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.NormalVertexDataNode;2045;14577.63,1274.858;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SmoothstepOpNode;2080;9476.247,9420.257;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0.8;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.DepthFade;2049;14999.35,1263.719;Inherit;False;True;False;False;2;1;FLOAT3;0,0,0;False;0;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;2046;14759.63,1289.157;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleAddOpNode;2048;14796.03,1159.157;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.PosVertexDataNode;2047;14580.23,1118.858;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;2110;4630.291,4744.104;Inherit;False;Property;_OutlineMaskClip;   Outline Mask Clip;55;0;Create;True;0;0;0;True;0;False;0.5;0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;11028.64,-2168.996;Float;False;True;-1;2;LegendsShaderGUI;0;0;CustomLighting;Furality/Legendary Shader/Legendary Shader - Transparent;False;False;False;False;False;False;True;True;True;False;True;False;False;False;True;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;True;0;Transparent;0.5;True;True;0;False;Transparent;;Transparent;All;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;2;5;False;-1;10;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;0;0;True;933;-1;0;True;1742;0;0;0;False;0.1;False;-1;0;False;-1;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;2092;0;1787;0
WireConnection;2092;1;2091;0
WireConnection;2092;2;2090;0
...
WireConnection;2101;0;1837;0
WireConnection;2101;1;2099;0
WireConnection;2101;2;2108;0
...
WireConnection;2095;0;1935;0
WireConnection;2095;1;2096;0
WireConnection;2095;2;2107;0
...
WireConnection;2060;0;2058;0
WireConnection;2105;0;2031;0
WireConnection;2105;1;2103;0
WireConnection;2105;2;2109;0
...
WireConnection;1706;1;2060;0
WireConnection;1706;2;2059;0
...
ASEEND*/
//CHKSM=A70BA57DD4988E02DD8C9A0FD4238B0DC63CD5CF