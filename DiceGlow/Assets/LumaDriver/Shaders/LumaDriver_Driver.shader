Shader "LumaDriver/Driver"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma target 3.0
            #define _SelfTexture2D _MainTex
            ...
            float4 frag(v2f IN) : COLOR {
                if (_IsEnabled == 1) {
                    ...
                    if (IN.uv.x < 1.0 / 512 && IN.uv.y < 1.0 / 288) {
                        fixed isOn = 0;
                    ...
                    else if (_LumaPixel == 1 && IN.uv.x > 0.625 && IN.uv.x < 0.633307 && IN.uv.y > 0.50423 && IN.uv.y < 0.51834) {
                        return fixed4(1, 0, 0, 1);
                    }

                    // Luma Zone Pixels
                    else if (IN.uv.x > 0.85182 && IN.uv.x < 0.86823 && IN.uv.y > 0.5 && IN.uv.y < 0.52916) {
                        ...
                        // ZONE 1 - Upper Left
                        if (IN.uv.x > 0.85182 && IN.uv.x < 0.8599 && IN.uv.y > 0.51411 && IN.uv.y < 0.52916) {
                            if (_DebugZone == 1)
                                return fixed4(1, 0, 0, 1);
                        ...
                        // ZONE 2 - Lower Left
                        else if (IN.uv.x > 0.85182 && IN.uv.x < 0.8599 && IN.uv.y > 0.5 && IN.uv.y < 0.51411) {
                            if (_DebugZone == 1)
                        ...
                        // ZONE 3 - Upper Right
                        else if (IN.uv.x > 0.8599 && IN.uv.x < 0.86823 && IN.uv.y > 0.51411 && IN.uv.y < 0.52916) {
                            if (_DebugZone == 1)
                        ...
                        // ZONE 4 - Lower Right
                        else if (IN.uv.x > 0.8599 && IN.uv.x < 0.86823 && IN.uv.y > 0.5 && IN.uv.y < 0.51411) {
                            if (_DebugZone == 1)
                    ...
                    // Gradient 1
                    else if (IN.uv.x > 0.56979 && IN.uv.x < 0.67708 && IN.uv.y > 0.48672 && IN.uv.y < 0.49922) {
                        bool isALOn = isALActive();
                        bool isDMXOn = isDMXActive();

                        float ratio = (IN.uv.x - 0.56979) / 0.10729;
                        ...
                        return getGradientOutput(isALOn, isDMXOn, IN.uv.x, rgb, rgbA, rgbB, rgbC, ratio, time, val, midStop, _FadingG1, _ShiftG1StopA, _ShiftG1StopB, _ShiftG1StopC, _ALccG1, _DMXccG1Enable, _DMXintG1, 5, _ColorOverrideG1, fixed3(1, 0, 0));
                    }

                    // Gradient 2
                    else if (IN.uv.x > 0.68021 && IN.uv.x < 0.7875 && IN.uv.y > 0.48672 && IN.uv.y < 0.49922) {
                        bool isALOn = isALActive();
                        bool isDMXOn = isDMXActive();

                        float ratio = (IN.uv.x - 0.68021) / 0.10729;
                        ...
                        return getGradientOutput(isALOn, isDMXOn, IN.uv.x, rgb, rgbA, rgbB, rgbC, ratio, time, val, midStop, _FadingG2, _ShiftG2StopA, _ShiftG2StopB, _ShiftG2StopC, _ALccG2, _DMXccG2Enable, _DMXintG2, 6, _ColorOverrideG2, fixed3(0, 1, 0));
                    }

                    // Gradient 3
                    else if (IN.uv.x > 0.79063 && IN.uv.x < 0.89792 && IN.uv.y > 0.48672 && IN.uv.y < 0.49922) {
                        bool isALOn = isALActive();
                        bool isDMXOn = isDMXActive();

                        float ratio = (IN.uv.x - 0.79063) / 0.10729;
                        ...
                        return getGradientOutput(isALOn, isDMXOn, IN.uv.x, rgb, rgbA, rgbB, rgbC, ratio, time, val, midStop, _FadingG3, _ShiftG3StopA, _ShiftG3StopB, _ShiftG3StopC, _ALccG3, _DMXccG3Enable, _DMXintG3, 7, _ColorOverrideG3, fixed3(0, 0, 1));
                    }

                    // Audio Reactive Pixel
                    if (IN.uv.x > 0.56979 && IN.uv.x < 0.58594 && IN.uv.y > 0.5 && IN.uv.y < 0.52916) {
                        bool isALOn = isALActive();
