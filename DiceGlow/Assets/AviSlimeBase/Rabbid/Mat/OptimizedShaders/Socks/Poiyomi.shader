Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi Toon/b46ab2d1b4a1e4949826ccd778da8f2a"
{
	Properties
	{
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				switch(float(0))
				{
					case 0:
					{
						...
						matcapUV = noSknewViewNormal.rg * float(0.39) + 0.5;
						break;
					}
					case 1:
					{
						...
						matcapUV = float2(dot(worldViewRight, normal0), dot(worldViewUp, normal0)) * float(0.39) + 0.5;
						break;
					}
					case 2:
					{
				...
				blendMatcap(poiLight, poiFragData, float(1), float(0), float(0), float(0), float(0), matcap, matcapMask, float(0), float(0)
				#ifdef POI_BLACKLIGHT
