Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi Toon/96fccab8e1ffa494ca4c2be406a0e871"
{
	Properties
	{
 ...
 #define PROP_RIMTEX 
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(1,1,1,0.5647059).rgb, float(0));
				poiFragData.alpha = mainTexture.a * float4(1,1,1,0.5647059).a;
