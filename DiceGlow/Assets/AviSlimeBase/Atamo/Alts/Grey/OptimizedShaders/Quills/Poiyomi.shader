Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi Toon/be3c612120d19c044ab048bf946b544e"
{
	Properties
	{
 ...
 #define PROP_RIMTEX 
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(1,1,1,0.8235294).rgb, float(0));
				poiFragData.alpha = mainTexture.a * float4(1,1,1,0.8235294).a;
