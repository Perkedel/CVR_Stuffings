...
// JOELwindows7: The latest version removed Video decal options, the latest now is Decal but those are exclusively ASE functions. lemme bring back old file one commit before it this.
// https://github.com/VoyVivika/VivikaShader/commit/32fabbbc2e128af71fb06a0f07afb3efbc610b00 
Shader "VoyVivika/VivikaShaderLegacy"
{
	Properties
	{
