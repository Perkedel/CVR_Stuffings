    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                return fixed4((1.0 - lerp( _OutlineColor.rgb, (_Diffuse_var.rgb*(_OutlineColor.rgb*_OutlineBrightness)), _OutlineTinting )),0);
            }
            ENDCG
        }
        Pass {
