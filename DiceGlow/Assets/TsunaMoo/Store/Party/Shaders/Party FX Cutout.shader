...
Shader "TsunaMoo/Party FX Cutout"
{
	Properties
	{
	...
	SubShader
	{
		...
		half2 UVSelector9_g368( int Set, half2 UV0, half2 UV1, half2 UV2, half2 UV3, half2 UV4, half2 UV5, half2 UV6 )
		{
			float2 UvSet[7];
			UvSet[0] = UV0;
			UvSet[1] = UV1;
		...
		half2 UVSelector9_g294( int Set, half2 UV0, half2 UV1, half2 UV2, half2 UV3, half2 UV4, half2 UV5, half2 UV6 )
		{
			float2 UvSet[7];
			UvSet[0] = UV0;
			UvSet[1] = UV1;
		...
		inline half AudioLinkLerp3_g350( int Band, half Delay )
		{
			return AudioLinkLerp( ALPASS_AUDIOLINK + float2( Delay, Band ) ).r;
		}


		half2 UVSelector9_g357( int Set, half2 UV0, half2 UV1, half2 UV2, half2 UV3, half2 UV4, half2 UV5, half2 UV6 )
		{
			float2 UvSet[7];
			UvSet[0] = UV0;
			UvSet[1] = UV1;
		...
		half2 UVSelector9_g364( int Set, half2 UV0, half2 UV1, half2 UV2, half2 UV3, half2 UV4, half2 UV5, half2 UV6 )
		{
			float2 UvSet[7];
			UvSet[0] = UV0;
			UvSet[1] = UV1;
		...
		inline half AudioLinkLerp3_g351( int Band, half Delay )
		{
			return AudioLinkLerp( ALPASS_AUDIOLINK + float2( Delay, Band ) ).r;
		}
		...
		half2 UVSelector9_g365( int Set, half2 UV0, half2 UV1, half2 UV2, half2 UV3, half2 UV4, half2 UV5, half2 UV6 )
		{
			float2 UvSet[7];
			UvSet[0] = UV0;
			UvSet[1] = UV1;
		...
		half2 UVSelector9_g297( int Set, half2 UV0, half2 UV1, half2 UV2, half2 UV3, half2 UV4, half2 UV5, half2 UV6 )
		{
			float2 UvSet[7];
			UvSet[0] = UV0;
			UvSet[1] = UV1;
		...
		inline half AudioLinkLerp3_g352( int Band, half Delay )
		{
			return AudioLinkLerp( ALPASS_AUDIOLINK + float2( Delay, Band ) ).r;
		}


		half2 UVSelector9_g356( int Set, half2 UV0, half2 UV1, half2 UV2, half2 UV3, half2 UV4, half2 UV5, half2 UV6 )
		{
			float2 UvSet[7];
			UvSet[0] = UV0;
			UvSet[1] = UV1;
		...
		half2 UVSelector9_g296( int Set, half2 UV0, half2 UV1, half2 UV2, half2 UV3, half2 UV4, half2 UV5, half2 UV6 )
		{
			float2 UvSet[7];
			UvSet[0] = UV0;
			UvSet[1] = UV1;
		...
		inline half AudioLinkLerp3_g349( int Band, half Delay )
		{
			return AudioLinkLerp( ALPASS_AUDIOLINK + float2( Delay, Band ) ).r;
		}


		half2 UVSelector9_g366( int Set, half2 UV0, half2 UV1, half2 UV2, half2 UV3, half2 UV4, half2 UV5, half2 UV6 )
		{
			float2 UvSet[7];
			UvSet[0] = UV0;
			UvSet[1] = UV1;
		...
		half2 UVSelector9_g347( int Set, half2 UV0, half2 UV1, half2 UV2, half2 UV3, half2 UV4, half2 UV5, half2 UV6 )
		{
			float2 UvSet[7];
			UvSet[0] = UV0;
			UvSet[1] = UV1;
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			int Set9_g368 = _UVNoiseMask;
			half2 UV09_g368 = v.texcoord.xy;
			half2 UV19_g368 = v.texcoord1.xy;
			half2 UV29_g368 = v.texcoord2.xy;
			half2 UV39_g368 = v.texcoord3.xy;
			half2 appendResult40_g368 = (half2(ase_worldPos.x , 0.0));
			half2 UV49_g368 = appendResult40_g368;
			half2 appendResult41_g368 = (half2(ase_worldPos.x , 0.0));
			half2 UV59_g368 = appendResult41_g368;
			half2 appendResult42_g368 = (half2(0.0 , 0.0));
			half2 UV69_g368 = appendResult42_g368;
			half2 localUVSelector9_g368 = UVSelector9_g368( Set9_g368 , UV09_g368 , UV19_g368 , UV29_g368 , UV39_g368 , UV49_g368 , UV59_g368 , UV69_g368 );
			#ifdef _VertNoise_ON
				half4 staticSwitch1077 = ( ( (-1.0 + (simplePerlin3D660 - 0.0) * (1.0 - -1.0) / (1.0 - 0.0)) * _NoiseStength ) * SAMPLE_TEXTURE2D_LOD( _VertexNoiseMask, sampler_linear_repeat, ( _OffsetNoiseMask + ( _TilingNoiseMask * localUVSelector9_g368 ) ), 0.0 ) );
			#else
				half4 staticSwitch1077 = float4( 0,0,0,0 );
			#endif
			half4 WorldNoise672 = staticSwitch1077;
			int Band3_g350 = 0;
			int Set9_g294 = _Band0UV;
			half2 UV09_g294 = v.texcoord.xy;
			half2 UV19_g294 = v.texcoord1.xy;
			half2 UV29_g294 = v.texcoord2.xy;
			half2 UV39_g294 = v.texcoord3.xy;
			half2 appendResult40_g294 = (half2(ase_worldPos.x , 0.0));
			half2 UV49_g294 = appendResult40_g294;
			half2 appendResult41_g294 = (half2(ase_worldPos.x , 0.0));
			half2 UV59_g294 = appendResult41_g294;
			half2 appendResult42_g294 = (half2(0.0 , 0.0));
			half2 UV69_g294 = appendResult42_g294;
			half2 localUVSelector9_g294 = UVSelector9_g294( Set9_g294 , UV09_g294 , UV19_g294 , UV29_g294 , UV39_g294 , UV49_g294 , UV59_g294 , UV69_g294 );
			half2 temp_output_696_0 = ( _Band0Offset + ( _Band0Tiling * localUVSelector9_g294 ) );
			half2 break6_g305 = (float2( 0,0 ) + (temp_output_696_0 - float2( 0,0 )) * (float2( 0.9,1 ) - float2( 0,0 )) / (float2( 1,1 ) - float2( 0,0 )));
			half temp_output_5_0_g305 = ( break6_g305.x - 0.5 );
			...
			half temp_output_2_0_g305 = ifLocalVar1090;
			half temp_output_3_0_g305 = cos( temp_output_2_0_g305 );
			half temp_output_8_0_g305 = sin( temp_output_2_0_g305 );
			half temp_output_20_0_g305 = ( 1.0 / ( abs( temp_output_3_0_g305 ) + abs( temp_output_8_0_g305 ) ) );
			half temp_output_7_0_g305 = ( break6_g305.y - 0.5 );
			half2 appendResult16_g305 = (half2(( ( ( temp_output_5_0_g305 * temp_output_3_0_g305 * temp_output_20_0_g305 ) + ( temp_output_7_0_g305 * temp_output_8_0_g305 * temp_output_20_0_g305 ) ) + 0.5 ) , ( ( ( temp_output_7_0_g305 * temp_output_3_0_g305 * temp_output_20_0_g305 ) - ( temp_output_5_0_g305 * temp_output_8_0_g305 * temp_output_20_0_g305 ) ) + 0.5 )));
			half Delay3_g350 = ( ( (_Band0Delay + (( appendResult16_g305.x * _Band0Pulse ) - 0.0) * (1.0 - _Band0Delay) / (1.0 - 0.0)) % 1.0 ) * 128.0 );
			half localAudioLinkLerp3_g350 = AudioLinkLerp3_g350( Band3_g350 , Delay3_g350 );
			half temp_output_708_0 = localAudioLinkLerp3_g350;
			...
			int Set9_g357 = _Band0MaskUV;
			half2 UV09_g357 = v.texcoord.xy;
			half2 UV19_g357 = v.texcoord1.xy;
			half2 UV29_g357 = v.texcoord2.xy;
			half2 UV39_g357 = v.texcoord3.xy;
			half2 appendResult40_g357 = (half2(ase_worldPos.x , 0.0));
			half2 UV49_g357 = appendResult40_g357;
			half2 appendResult41_g357 = (half2(ase_worldPos.x , 0.0));
			half2 UV59_g357 = appendResult41_g357;
			half2 appendResult42_g357 = (half2(0.0 , 0.0));
			half2 UV69_g357 = appendResult42_g357;
			half2 localUVSelector9_g357 = UVSelector9_g357( Set9_g357 , UV09_g357 , UV19_g357 , UV29_g357 , UV39_g357 , UV49_g357 , UV59_g357 , UV69_g357 );
			half4 tex2DNode736 = SAMPLE_TEXTURE2D_LOD( _Band0Mask, sampler_linear_repeat, ( _Band0MaskOffset + ( _Band0MaskTiling * localUVSelector9_g357 ) ), 0.0 );
			#ifdef _B0_ON
			...
			int Set9_g364 = _Shake0UV;
			half2 UV09_g364 = v.texcoord.xy;
			half2 UV19_g364 = v.texcoord1.xy;
			half2 UV29_g364 = v.texcoord2.xy;
			half2 UV39_g364 = v.texcoord3.xy;
			half2 appendResult40_g364 = (half2(ase_worldPos.x , 0.0));
			half2 UV49_g364 = appendResult40_g364;
			half2 appendResult41_g364 = (half2(ase_worldPos.x , 0.0));
			half2 UV59_g364 = appendResult41_g364;
			half2 appendResult42_g364 = (half2(0.0 , 0.0));
			half2 UV69_g364 = appendResult42_g364;
			half2 localUVSelector9_g364 = UVSelector9_g364( Set9_g364 , UV09_g364 , UV19_g364 , UV29_g364 , UV39_g364 , UV49_g364 , UV59_g364 , UV69_g364 );
			half4 ifLocalVar1097 = 0;
			if( _UseShake0 == 1.0 )
				ifLocalVar1097 = ( ( Band0Amp720 * _Shake0Intensity * half4( ifLocalVar722 , 0.0 ) ) * SAMPLE_TEXTURE2D_LOD( _Shake0Mask, sampler_linear_repeat, ( _Shake0Offset + ( _Shake0Tiling * localUVSelector9_g364 ) ), 0.0 ) );
			#ifdef _B0_ON
			...
			half2 temp_output_810_0 = ( _Band1Offset + ( _Band1Tiling * localUVSelector9_g295 ) );
			half2 break6_g304 = (float2( 0,0 ) + (temp_output_810_0 - float2( 0,0 )) * (float2( 0.9,1 ) - float2( 0,0 )) / (float2( 1,1 ) - float2( 0,0 )));
			half temp_output_5_0_g304 = ( break6_g304.x - 0.5 );
			...
			half temp_output_2_0_g304 = ifLocalVar1088;
			half temp_output_3_0_g304 = cos( temp_output_2_0_g304 );
			half temp_output_8_0_g304 = sin( temp_output_2_0_g304 );
			half temp_output_20_0_g304 = ( 1.0 / ( abs( temp_output_3_0_g304 ) + abs( temp_output_8_0_g304 ) ) );
			half temp_output_7_0_g304 = ( break6_g304.y - 0.5 );
			half2 appendResult16_g304 = (half2(( ( ( temp_output_5_0_g304 * temp_output_3_0_g304 * temp_output_20_0_g304 ) + ( temp_output_7_0_g304 * temp_output_8_0_g304 * temp_output_20_0_g304 ) ) + 0.5 ) , ( ( ( temp_output_7_0_g304 * temp_output_3_0_g304 * temp_output_20_0_g304 ) - ( temp_output_5_0_g304 * temp_output_8_0_g304 * temp_output_20_0_g304 ) ) + 0.5 )));
			half Delay3_g351 = ( ( (_Band1Delay + (( appendResult16_g304.x * _Band1Pulse ) - 0.0) * (1.0 - _Band1Delay) / (1.0 - 0.0)) % 1.0 ) * 128.0 );
			half localAudioLinkLerp3_g351 = AudioLinkLerp3_g351( Band3_g351 , Delay3_g351 );
			half temp_output_772_0 = localAudioLinkLerp3_g351;
			...
			half4 tex2DNode784 = SAMPLE_TEXTURE2D_LOD( _Band1Mask, sampler_linear_repeat, ( _Band1MaskOffset + ( _Band1MaskTiling * localUVSelector9_g358 ) ), 0.0 );
			#ifdef _B1_ON
			...
			int Set9_g365 = _Shake1UV;
			half2 UV09_g365 = v.texcoord.xy;
			half2 UV19_g365 = v.texcoord1.xy;
			half2 UV29_g365 = v.texcoord2.xy;
			half2 UV39_g365 = v.texcoord3.xy;
			half2 appendResult40_g365 = (half2(ase_worldPos.x , 0.0));
			half2 UV49_g365 = appendResult40_g365;
			half2 appendResult41_g365 = (half2(ase_worldPos.x , 0.0));
			half2 UV59_g365 = appendResult41_g365;
			half2 appendResult42_g365 = (half2(0.0 , 0.0));
			half2 UV69_g365 = appendResult42_g365;
			half2 localUVSelector9_g365 = UVSelector9_g365( Set9_g365 , UV09_g365 , UV19_g365 , UV29_g365 , UV39_g365 , UV49_g365 , UV59_g365 , UV69_g365 );
			half4 ifLocalVar1094 = 0;
			if( _UseShake1 == 1.0 )
				ifLocalVar1094 = ( ( Band1Amp768 * _Shake1Intensity * half4( ifLocalVar764 , 0.0 ) ) * SAMPLE_TEXTURE2D_LOD( _Shake1Mask, sampler_linear_repeat, ( _Shake1Offset + ( _Shake1Tiling * localUVSelector9_g365 ) ), 0.0 ) );
			#ifdef _B1_ON
			...
			int Band3_g352 = 2;
			int Set9_g297 = _Band2UV;
			half2 UV09_g297 = v.texcoord.xy;
			half2 UV19_g297 = v.texcoord1.xy;
			half2 UV29_g297 = v.texcoord2.xy;
			half2 UV39_g297 = v.texcoord3.xy;
			half2 appendResult40_g297 = (half2(ase_worldPos.x , 0.0));
			half2 UV49_g297 = appendResult40_g297;
			half2 appendResult41_g297 = (half2(ase_worldPos.x , 0.0));
			half2 UV59_g297 = appendResult41_g297;
			half2 appendResult42_g297 = (half2(0.0 , 0.0));
			half2 UV69_g297 = appendResult42_g297;
			half2 localUVSelector9_g297 = UVSelector9_g297( Set9_g297 , UV09_g297 , UV19_g297 , UV29_g297 , UV39_g297 , UV49_g297 , UV59_g297 , UV69_g297 );
			half2 temp_output_860_0 = ( _Band2Offset + ( _Band2Tiling * localUVSelector9_g297 ) );
			half2 break6_g307 = (float2( 0,0 ) + (temp_output_860_0 - float2( 0,0 )) * (float2( 0.9,1 ) - float2( 0,0 )) / (float2( 1,1 ) - float2( 0,0 )));
			half temp_output_5_0_g307 = ( break6_g307.x - 0.5 );
			...
			half temp_output_2_0_g307 = ifLocalVar1087;
			half temp_output_3_0_g307 = cos( temp_output_2_0_g307 );
			half temp_output_8_0_g307 = sin( temp_output_2_0_g307 );
			half temp_output_20_0_g307 = ( 1.0 / ( abs( temp_output_3_0_g307 ) + abs( temp_output_8_0_g307 ) ) );
			half temp_output_7_0_g307 = ( break6_g307.y - 0.5 );
			half2 appendResult16_g307 = (half2(( ( ( temp_output_5_0_g307 * temp_output_3_0_g307 * temp_output_20_0_g307 ) + ( temp_output_7_0_g307 * temp_output_8_0_g307 * temp_output_20_0_g307 ) ) + 0.5 ) , ( ( ( temp_output_7_0_g307 * temp_output_3_0_g307 * temp_output_20_0_g307 ) - ( temp_output_5_0_g307 * temp_output_8_0_g307 * temp_output_20_0_g307 ) ) + 0.5 )));
			half Delay3_g352 = ( ( (_Band2Delay + (( appendResult16_g307.x * _Band2Pulse ) - 0.0) * (1.0 - _Band2Delay) / (1.0 - 0.0)) % 1.0 ) * 128.0 );
			half localAudioLinkLerp3_g352 = AudioLinkLerp3_g352( Band3_g352 , Delay3_g352 );
			half temp_output_869_0 = localAudioLinkLerp3_g352;
			...
			int Set9_g356 = _Band2MaskUV;
			half2 UV09_g356 = v.texcoord.xy;
			half2 UV19_g356 = v.texcoord1.xy;
			half2 UV29_g356 = v.texcoord2.xy;
			half2 UV39_g356 = v.texcoord3.xy;
			half2 appendResult40_g356 = (half2(ase_worldPos.x , 0.0));
			half2 UV49_g356 = appendResult40_g356;
			half2 appendResult41_g356 = (half2(ase_worldPos.x , 0.0));
			half2 UV59_g356 = appendResult41_g356;
			half2 appendResult42_g356 = (half2(0.0 , 0.0));
			half2 UV69_g356 = appendResult42_g356;
			half2 localUVSelector9_g356 = UVSelector9_g356( Set9_g356 , UV09_g356 , UV19_g356 , UV29_g356 , UV39_g356 , UV49_g356 , UV59_g356 , UV69_g356 );
			half4 tex2DNode893 = SAMPLE_TEXTURE2D_LOD( _Band2Mask, sampler_linear_repeat, ( _Band2MaskOffset + ( _Band2MaskTiling * localUVSelector9_g356 ) ), 0.0 );
			#ifdef _B2_ON
			...
			if( _UseShake2 == 1.0 )
				ifLocalVar1099 = ( ( Band2Amp875 * _Shake2Intensity * half4( ifLocalVar899 , 0.0 ) ) * SAMPLE_TEXTURE2D_LOD( _Shake2Mask, sampler_linear_repeat, ( _Shake2Offset + ( _Shake2Tiling * localUVSelector9_g363 ) ), 0.0 ) );
			#ifdef _B2_ON
			...
			half4 tex2DNode961 = SAMPLE_TEXTURE2D_LOD( _Band3Mask, sampler_linear_repeat, ( _Band3MaskOffset + ( _Band3MaskTiling * localUVSelector9_g359 ) ), 0.0 );
			int Band3_g349 = 3;
			int Set9_g296 = _Band3UV;
			half2 UV09_g296 = v.texcoord.xy;
			half2 UV19_g296 = v.texcoord1.xy;
			half2 UV29_g296 = v.texcoord2.xy;
			half2 UV39_g296 = v.texcoord3.xy;
			half2 appendResult40_g296 = (half2(ase_worldPos.x , 0.0));
			half2 UV49_g296 = appendResult40_g296;
			half2 appendResult41_g296 = (half2(ase_worldPos.x , 0.0));
			half2 UV59_g296 = appendResult41_g296;
			half2 appendResult42_g296 = (half2(0.0 , 0.0));
			half2 UV69_g296 = appendResult42_g296;
			half2 localUVSelector9_g296 = UVSelector9_g296( Set9_g296 , UV09_g296 , UV19_g296 , UV29_g296 , UV39_g296 , UV49_g296 , UV59_g296 , UV69_g296 );
			half2 temp_output_930_0 = ( _Band3Offset + ( _Band3Tiling * localUVSelector9_g296 ) );
			half2 break6_g306 = (float2( 0,0 ) + (temp_output_930_0 - float2( 0,0 )) * (float2( 0.9,1 ) - float2( 0,0 )) / (float2( 1,1 ) - float2( 0,0 )));
			half temp_output_5_0_g306 = ( break6_g306.x - 0.5 );
			...
			half temp_output_2_0_g306 = ifLocalVar1084;
			half temp_output_3_0_g306 = cos( temp_output_2_0_g306 );
			half temp_output_8_0_g306 = sin( temp_output_2_0_g306 );
			half temp_output_20_0_g306 = ( 1.0 / ( abs( temp_output_3_0_g306 ) + abs( temp_output_8_0_g306 ) ) );
			half temp_output_7_0_g306 = ( break6_g306.y - 0.5 );
			half2 appendResult16_g306 = (half2(( ( ( temp_output_5_0_g306 * temp_output_3_0_g306 * temp_output_20_0_g306 ) + ( temp_output_7_0_g306 * temp_output_8_0_g306 * temp_output_20_0_g306 ) ) + 0.5 ) , ( ( ( temp_output_7_0_g306 * temp_output_3_0_g306 * temp_output_20_0_g306 ) - ( temp_output_5_0_g306 * temp_output_8_0_g306 * temp_output_20_0_g306 ) ) + 0.5 )));
			half Delay3_g349 = ( ( (_Band3Delay + (( appendResult16_g306.x * _Band3Pulse ) - 0.0) * (1.0 - _Band3Delay) / (1.0 - 0.0)) % 1.0 ) * 128.0 );
			half localAudioLinkLerp3_g349 = AudioLinkLerp3_g349( Band3_g349 , Delay3_g349 );
			half temp_output_939_0 = localAudioLinkLerp3_g349;
			...
			int Set9_g366 = _Shake3UV;
			half2 UV09_g366 = v.texcoord.xy;
			half2 UV19_g366 = v.texcoord1.xy;
			half2 UV29_g366 = v.texcoord2.xy;
			half2 UV39_g366 = v.texcoord3.xy;
			half2 appendResult40_g366 = (half2(ase_worldPos.x , 0.0));
			half2 UV49_g366 = appendResult40_g366;
			half2 appendResult41_g366 = (half2(ase_worldPos.x , 0.0));
			half2 UV59_g366 = appendResult41_g366;
			half2 appendResult42_g366 = (half2(0.0 , 0.0));
			half2 UV69_g366 = appendResult42_g366;
			half2 localUVSelector9_g366 = UVSelector9_g366( Set9_g366 , UV09_g366 , UV19_g366 , UV29_g366 , UV39_g366 , UV49_g366 , UV59_g366 , UV69_g366 );
			half4 ifLocalVar1101 = 0;
			if( _UseShake3 == 1.0 )
				ifLocalVar1101 = ( ( Band3Amp945 * _Shake3Intensity * half4( ifLocalVar965 , 0.0 ) ) * SAMPLE_TEXTURE2D_LOD( _Shake3Mask, sampler_linear_repeat, ( _Shake3Offset + ( _Shake3Tiling * localUVSelector9_g366 ) ), 0.0 ) );
			#ifdef _B3_ON
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			int Set9_g347 = _UVMain;
			half2 UV09_g347 = i.uv_texcoord;
			half2 UV19_g347 = i.uv2_texcoord2;
			half2 UV29_g347 = i.uv3_texcoord3;
			half2 UV39_g347 = i.uv4_texcoord4;
			float3 ase_worldPos = i.worldPos;
			half2 appendResult40_g347 = (half2(ase_worldPos.x , 0.0));
			half2 UV49_g347 = appendResult40_g347;
			half2 appendResult41_g347 = (half2(ase_worldPos.x , 0.0));
			half2 UV59_g347 = appendResult41_g347;
			half2 appendResult42_g347 = (half2(0.0 , 0.0));
			half2 UV69_g347 = appendResult42_g347;
			half2 localUVSelector9_g347 = UVSelector9_g347( Set9_g347 , UV09_g347 , UV19_g347 , UV29_g347 , UV39_g347 , UV49_g347 , UV59_g347 , UV69_g347 );
			half2 MainUV339 = ( ( appendResult420 + _Offset ) + ( _Tiling * localUVSelector9_g347 ) );
			#ifdef _NormalMap_ON
			...
			half4 tex2DNode51 = SAMPLE_TEXTURE2D( _MainTex, sampler_linear_repeat, MainUV339 );
			half4 Albedo351 = ( _Color * tex2DNode51 );
			half3 hsvTorgb1103 = RGBToHSV( Albedo351.rgb );
			half mulTime1135 = _Time.y * _HueTime;
			half3 hsvTorgb1104 = HSVToRGB( half3(( hsvTorgb1103.x + _HueModifier + mulTime1135 ),hsvTorgb1103.y,hsvTorgb1103.z) );
			...
			half3 hsvTorgb301 = RGBToHSV( ( _EffectColor * SAMPLE_TEXTURE2D( _EffectAlbedoMap, sampler_linear_repeat, ( ( appendResult573 + _OffsetEff ) + ( _TilingEff * localUVSelector9_g353 ) ) ) ).rgb );
			...
			if( _UseEmissionMapasMask >= 1.0 )
				...
				ifLocalVar310 = SAMPLE_TEXTURE2D( _EffectMask, sampler_linear_repeat, ( ( appendResult568 + _OffsetEffMask ) + ( _TilingEffMask * localUVSelector9_g354 ) ) );
			...
			half3 temp_output_1_0_g360 = newWorldNormal402;
			half3 temp_output_4_0_g360 = ddx( temp_output_1_0_g360 );
			half dotResult6_g360 = dot( temp_output_4_0_g360 , temp_output_4_0_g360 );
			half3 temp_output_5_0_g360 = ddy( temp_output_1_0_g360 );
			half dotResult8_g360 = dot( temp_output_5_0_g360 , temp_output_5_0_g360 );
			half4 lerpResult424 = lerp( ( clampResult390 * _RimColor ) , float4( 0,0,0,0 ) , sqrt( sqrt( saturate( min( ( ( ( dotResult6_g360 + dotResult8_g360 ) * _AntiAliasingVariance ) * 2.0 ) , _AntiAliasingThreshold ) ) ) ));
			...
			if( _Band1BarAmp == 1.0 )
				...
				ifLocalVar1039 = temp_output_772_0;
			int Set9_g358 = _Band1MaskUV;
			half2 UV09_g358 = i.uv_texcoord;
			half2 UV19_g358 = i.uv2_texcoord2;
			half2 UV29_g358 = i.uv3_texcoord3;
			half2 UV39_g358 = i.uv4_texcoord4;
			half2 appendResult40_g358 = (half2(ase_worldPos.x , 0.0));
			half2 UV49_g358 = appendResult40_g358;
			half2 appendResult41_g358 = (half2(ase_worldPos.x , 0.0));
			half2 UV59_g358 = appendResult41_g358;
			...
			half2 UV69_g358 = appendResult42_g358;
			half2 localUVSelector9_g358 = UVSelector9_g358( Set9_g358 , UV09_g358 , UV19_g358 , UV29_g358 , UV39_g358 , UV49_g358 , UV59_g358 , UV69_g358 );
			half4 tex2DNode784 = SAMPLE_TEXTURE2D( _Band1Mask, sampler_linear_repeat, ( _Band1MaskOffset + ( _Band1MaskTiling * localUVSelector9_g358 ) ) );
			#ifdef _B1_ON
			...
			int Set9_g294 = _Band0UV;
			half2 UV09_g294 = i.uv_texcoord;
			half2 UV19_g294 = i.uv2_texcoord2;
			half2 UV29_g294 = i.uv3_texcoord3;
			half2 UV39_g294 = i.uv4_texcoord4;
			half2 appendResult40_g294 = (half2(ase_worldPos.x , 0.0));
			half2 UV49_g294 = appendResult40_g294;
			half2 appendResult41_g294 = (half2(ase_worldPos.x , 0.0));
			half2 UV59_g294 = appendResult41_g294;
			...
			if( _Band0BarAmp == 1.0 )
				...
				ifLocalVar1002 = temp_output_708_0;
			int Set9_g357 = _Band0MaskUV;
			half2 UV09_g357 = i.uv_texcoord;
			half2 UV19_g357 = i.uv2_texcoord2;
			half2 UV29_g357 = i.uv3_texcoord3;
			half2 UV39_g357 = i.uv4_texcoord4;
			half2 appendResult40_g357 = (half2(ase_worldPos.x , 0.0));
			half2 UV49_g357 = appendResult40_g357;
			half2 appendResult41_g357 = (half2(ase_worldPos.x , 0.0));
			half2 UV59_g357 = appendResult41_g357;
			...
			half2 UV69_g357 = appendResult42_g357;
			half2 localUVSelector9_g357 = UVSelector9_g357( Set9_g357 , UV09_g357 , UV19_g357 , UV29_g357 , UV39_g357 , UV49_g357 , UV59_g357 , UV69_g357 );
			half4 tex2DNode736 = SAMPLE_TEXTURE2D( _Band0Mask, sampler_linear_repeat, ( _Band0MaskOffset + ( _Band0MaskTiling * localUVSelector9_g357 ) ) );
			#ifdef _B0_ON
			...
			int Set9_g297 = _Band2UV;
			half2 UV09_g297 = i.uv_texcoord;
			half2 UV19_g297 = i.uv2_texcoord2;
			half2 UV29_g297 = i.uv3_texcoord3;
			half2 UV39_g297 = i.uv4_texcoord4;
			half2 appendResult40_g297 = (half2(ase_worldPos.x , 0.0));
			half2 UV49_g297 = appendResult40_g297;
			half2 appendResult41_g297 = (half2(ase_worldPos.x , 0.0));
			half2 UV59_g297 = appendResult41_g297;
			...
			if( _Band2BarAmp == 1.0 )
				...
				ifLocalVar1042 = temp_output_869_0;
			int Set9_g356 = _Band2MaskUV;
			half2 UV09_g356 = i.uv_texcoord;
			half2 UV19_g356 = i.uv2_texcoord2;
			half2 UV29_g356 = i.uv3_texcoord3;
			half2 UV39_g356 = i.uv4_texcoord4;
			half2 appendResult40_g356 = (half2(ase_worldPos.x , 0.0));
			half2 UV49_g356 = appendResult40_g356;
			half2 appendResult41_g356 = (half2(ase_worldPos.x , 0.0));
			half2 UV59_g356 = appendResult41_g356;
			...
			half2 UV69_g356 = appendResult42_g356;
			half2 localUVSelector9_g356 = UVSelector9_g356( Set9_g356 , UV09_g356 , UV19_g356 , UV29_g356 , UV39_g356 , UV49_g356 , UV59_g356 , UV69_g356 );
			half4 tex2DNode893 = SAMPLE_TEXTURE2D( _Band2Mask, sampler_linear_repeat, ( _Band2MaskOffset + ( _Band2MaskTiling * localUVSelector9_g356 ) ) );
			#ifdef _B2_ON
			...
			int Set9_g296 = _Band3UV;
			half2 UV09_g296 = i.uv_texcoord;
			half2 UV19_g296 = i.uv2_texcoord2;
			half2 UV29_g296 = i.uv3_texcoord3;
			half2 UV39_g296 = i.uv4_texcoord4;
			half2 appendResult40_g296 = (half2(ase_worldPos.x , 0.0));
			half2 UV49_g296 = appendResult40_g296;
			half2 appendResult41_g296 = (half2(ase_worldPos.x , 0.0));
			half2 UV59_g296 = appendResult41_g296;
			...
			if( _Band3BarAmp == 1.0 )
				...
				ifLocalVar1045 = temp_output_939_0;
			int Set9_g359 = _Band3MaskUV;
			half2 UV09_g359 = i.uv_texcoord;
			half2 UV19_g359 = i.uv2_texcoord2;
			half2 UV29_g359 = i.uv3_texcoord3;
			half2 UV39_g359 = i.uv4_texcoord4;
			half2 appendResult40_g359 = (half2(ase_worldPos.x , 0.0));
			half2 UV49_g359 = appendResult40_g359;
			half2 appendResult41_g359 = (half2(ase_worldPos.x , 0.0));
			half2 UV59_g359 = appendResult41_g359;
			...
			half2 UV69_g359 = appendResult42_g359;
			half2 localUVSelector9_g359 = UVSelector9_g359( Set9_g359 , UV09_g359 , UV19_g359 , UV29_g359 , UV39_g359 , UV49_g359 , UV59_g359 , UV69_g359 );
			half4 tex2DNode961 = SAMPLE_TEXTURE2D( _Band3Mask, sampler_linear_repeat, ( _Band3MaskOffset + ( _Band3MaskTiling * localUVSelector9_g359 ) ) );
			#ifdef _B3_ON
			...
			half3 hsvTorgb1106 = HSVToRGB( half3(( hsvTorgb1105.x + _HueModifier + mulTime1135 ),hsvTorgb1105.y,hsvTorgb1105.z) );
			o.Emission = hsvTorgb1106;
			half4 tex2DNode59 = SAMPLE_TEXTURE2D( _MetallicGlossMap, sampler_linear_repeat, MainUV339 );
			half3 ase_worldNormal = WorldNormalVector( i, half3( 0, 0, 1 ) );
			half3 temp_output_1_0_g367 = ase_worldNormal;
			half3 temp_output_4_0_g367 = ddx( temp_output_1_0_g367 );
			half dotResult6_g367 = dot( temp_output_4_0_g367 , temp_output_4_0_g367 );
			half3 temp_output_5_0_g367 = ddy( temp_output_1_0_g367 );
			half dotResult8_g367 = dot( temp_output_5_0_g367 , temp_output_5_0_g367 );
			half lerpResult443 = lerp( _Glossiness , 0.0 , sqrt( sqrt( saturate( min( ( ( ( dotResult6_g367 + dotResult8_g367 ) * _AntiAliasingVarianceSm ) * 2.0 ) , _AntiAliasingThresholdSm ) ) ) ));
			...
			o.Alpha = 1;
			clip( ( tex2DNode51.a * _Color.a ) - _Cutoff );
		}
...
/*ASEBEGIN
Version=18935
333.6;78.4;2232;1533;5109.559;8983.9;6.221603;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;688;-4599.042,-6198.652;Inherit;False;Property;_Band0PulseRotation;Rotation;76;0;Create;False;0;0;0;False;0;False;0;0;0;360;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;794;-4581.715,-3963.281;Inherit;False;Property;_Band1PulseRotation;Rotation;105;0;Create;False;0;0;0;False;0;False;0;0;0;360;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;689;-4599.197,-6110.018;Inherit;False;Property;_Band0RotateSpeed;Speed--{condition_show:{type:PROPERTY_BOOL,data:_Band0RotationoverTime==1}};78;0;Create;False;0;0;0;False;0;False;1;0;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;795;-4581.871,-3874.645;Inherit;False;Property;_Band1RotateSpeed;Speed--{condition_show:{type:PROPERTY_BOOL,data:_Band1RotationoverTime==1}};107;0;Create;False;0;0;0;False;0;False;1;0;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;921;-4539.199,340.4003;Inherit;False;Property;_Band3PulseRotation;Rotation;162;0;Create;False;0;0;0;False;0;False;0;0;0;360;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;920;-4539.355,429.0364;Inherit;False;Property;_Band3RotateSpeed;Speed--{condition_show:{type:PROPERTY_BOOL,data:_Band3RotationoverTime==1}};164;0;Create;False;0;0;0;False;0;False;1;0;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;811;-4281.445,-3867.811;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;690;-4777.43,-6028.713;Inherit;False;Property;_Band0UV;UV;67;1;[HideInInspector];Create;False;0;10;UV0;0;UV1;1;UV2;2;UV3;3;World XY;4;World XZ;5;World YZ;6;Object XY;7;Object XZ;8;Object YZ;9;0;False;1;ThryWideEnum(UV0,0,UV1,1,UV2,2,UV3,3,World XY,4,World XZ,5,World YZ,6);False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.RangedFloatNode;852;-4554.233,-1713.225;Inherit;False;Property;_Band2RotateSpeed;Speed--{condition_show:{type:PROPERTY_BOOL,data:_Band2RotationoverTime==1}};64;0;Create;False;0;0;0;False;0;False;1;0;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;693;-4794.55,-6160.975;Inherit;False;Property;_Band0Offset;Offset;66;1;[HideInInspector];Create;False;0;0;0;False;1;Vector2;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleTimeNode;694;-4298.771,-6103.184;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;692;-4787.869,-6290.662;Inherit;False;Property;_Band0Tiling;Tiling;65;1;[HideInInspector];Create;False;0;0;0;False;1;Vector2;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;925;-4728.028,248.3896;Inherit;False;Property;_Band3Tiling;Tiling;151;1;[HideInInspector];Create;False;0;0;0;False;1;Vector2;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RadiansOpNode;691;-4271.758,-6181.864;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;796;-4760.104,-3793.339;Inherit;False;Property;_Band1UV;UV;96;1;[HideInInspector];Create;False;0;10;UV0;0;UV1;1;UV2;2;UV3;3;World XY;4;World XZ;5;World YZ;6;Object XY;7;Object XZ;8;Object YZ;9;0;False;1;ThryWideEnum(UV0,0,UV1,1,UV2,2,UV3,3,World XY,4,World XZ,5,World YZ,6);False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.Vector2Node;928;-4733.432,378.0786;Inherit;False;Property;_Band3Offset;Offset;152;1;[HideInInspector];Create;False;0;0;0;False;1;Vector2;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;798;-4770.543,-4055.29;Inherit;False;Property;_Band1Tiling;Tiling;94;1;[HideInInspector];Create;False;0;0;0;False;1;Vector2;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.IntNode;926;-4717.588,510.3404;Inherit;False;Property;_Band3UV;UV;153;1;[HideInInspector];Create;False;0;10;UV0;0;UV1;1;UV2;2;UV3;3;World XY;4;World XZ;5;World YZ;6;Object XY;7;Object XZ;8;Object YZ;9;0;False;1;ThryWideEnum(UV0,0,UV1,1,UV2,2,UV3,3,World XY,4,World XZ,5,World YZ,6);False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.RangedFloatNode;851;-4554.078,-1801.861;Inherit;False;Property;_Band2PulseRotation;Rotation;134;0;Create;False;0;0;0;False;0;False;0;0;0;360;0;1;FLOAT;0
Node;AmplifyShaderEditor.RadiansOpNode;922;-4211.916,357.1923;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;797;-4777.225,-3925.602;Inherit;False;Property;_Band1Offset;Offset;95;1;[HideInInspector];Create;False;0;0;0;False;1;Vector2;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.CommentaryNode;353;309.5103,-4822.507;Inherit;False;3151.7;441.8367;;17;93;420;419;417;415;418;327;53;351;92;52;339;293;428;51;645;1133;Albedo;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1085;-4128,224;Inherit;False;Property;_Band3RotationoverTime;Rotation over Time;163;1;[ToggleUI];Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;696;-4576.499,-6371.921;Inherit;False;UV Selector;-1;;294;d8047ff639977014ab6649a770bd5cd4;0;3;15;INT;0;False;16;FLOAT2;0,0;False;17;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode;810;-4559.172,-4136.55;Inherit;False;UV Selector;-1;;295;d8047ff639977014ab6649a770bd5cd4;0;3;15;INT;0;False;16;FLOAT2;0,0;False;17;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.Vector2Node;856;-4749.588,-1764.183;Inherit;False;Property;_Band2Offset;Offset;124;1;[HideInInspector];Create;False;0;0;0;False;1;Vector2;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.FunctionNode;930;-4516.655,167.1303;Inherit;False;UV Selector;-1;;296;d8047ff639977014ab6649a770bd5cd4;0;3;15;INT;0;False;16;FLOAT2;0,0;False;17;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RadiansOpNode;853;-4226.794,-1785.069;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;857;-4732.467,-1631.921;Inherit;False;Property;_Band2UV;UV;125;1;[HideInInspector];Create;False;0;10;UV0;0;UV1;1;UV2;2;UV3;3;World XY;4;World XZ;5;World YZ;6;Object XY;7;Object XZ;8;Object YZ;9;0;False;1;ThryWideEnum(UV0,0,UV1,1,UV2,2,UV3,3,World XY,4,World XZ,5,World YZ,6);False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.Vector2Node;859;-4742.907,-1893.873;Inherit;False;Property;_Band2Tiling;Tiling;123;1;[HideInInspector];Create;False;0;0;0;False;1;Vector2;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleTimeNode;854;-4253.806,-1706.391;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1089;-4300.662,-4017.65;Inherit;False;Property;_Band1RotationoverTime;Rotation over Time;106;1;[ToggleUI];Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1091;-4137.834,-6225.8;Inherit;False;Property;_Band0RotationoverTime;Rotation over Time;77;1;[ToggleUI];Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;417;338.2161,-4728.423;Inherit;False;Property;_MainScroll;Scroll;22;0;Create;False;0;0;0;False;1;Vector2;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;1086;-4151.626,-1910.554;Inherit;False;Property;_Band2RotationoverTime;Rotation over Time;135;1;[ToggleUI];Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;860;-4531.534,-1975.131;Inherit;False;UV Selector;-1;;297;d8047ff639977014ab6649a770bd5cd4;0;3;15;INT;0;False;16;FLOAT2;0,0;False;17;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;806;-3718.44,-4144.869;Inherit;True;RotateUVFill;-1;;304;459952d587cbfe742a7e7f4a8a0a4169;0;2;1;FLOAT2;0,0;False;2;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleTimeNode;418;609.2158,-4742.423;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;700;-3702.353,-6395.658;Inherit;False;RotateUVFill;-1;;305;459952d587cbfe742a7e7f4a8a0a4169;0;2;1;FLOAT2;0,0;False;2;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;931;-3670.51,177.2646;Inherit;True;RotateUVFill;-1;;306;459952d587cbfe742a7e7f4a8a0a4169;0;2;1;FLOAT2;0,0;False;2;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;701;-3573.129,-6131.287;Inherit;False;Property;_Band0Pulse;Pulse;74;0;Create;False;1;Pulse Across UVs;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;862;-3684.389,-1978.998;Inherit;True;RotateUVFill;-1;;307;459952d587cbfe742a7e7f4a8a0a4169;0;2;1;FLOAT2;0,0;False;2;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;703;-3571.968,-6035.516;Inherit;False;Property;_Band0Delay;Delay;73;0;Create;False;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;93;843.0436,-4594.829;Inherit;False;Property;_Offset;Offset;20;0;Create;True;0;0;0;False;1;Vector2;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;932;-3511.288,480.5374;Inherit;False;Property;_Band3Delay;Delay;159;0;Create;False;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;805;-3563.564,-3910.278;Inherit;False;Property;_Band1Pulse;Pulse;103;0;Create;False;1;Pulse Across UVs;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;933;-3522.211,393.4033;Inherit;False;Property;_Band3Pulse;Pulse;160;0;Create;False;1;Pulse Across UVs;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;792;-3557.642,-3823.142;Inherit;False;Property;_Band1Delay;Delay;102;0;Create;False;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;865;-3537.089,-1748.858;Inherit;False;Property;_Band2Pulse;Pulse;132;0;Create;False;1;Pulse Across UVs;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1126;-3257.527,-6099.911;Inherit;False;BandPulse;-1;;345;c478702160369ce4480fa2fb6d734ffa;0;3;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;1125;-3197.686,439.1446;Inherit;False;BandPulse;-1;;344;c478702160369ce4480fa2fb6d734ffa;0;3;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;863;-3530.004,-1661.724;Inherit;False;Property;_Band2Delay;Delay;131;0;Create;False;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1124;-3240.202,-3864.536;Inherit;False;BandPulse;-1;;346;c478702160369ce4480fa2fb6d734ffa;0;3;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;92;1198.033,-4756.578;Inherit;False;Property;_Tiling;Tiling;19;0;Create;True;0;0;0;False;2;Vector2;Space;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.IntNode;293;1110.807,-4492.527;Inherit;False;Property;_UVMain;UV;21;0;Create;False;0;4;UV0;0;UV1;1;UV2;2;UV3;3;0;False;1;ThryWideEnum(UV0,0,UV1,1,UV2,2,UV3,3,World XY,4,World XZ,5,World YZ,6);False;0;0;False;0;1;INT;0
...
Node;AmplifyShaderEditor.FunctionNode;645;1516.386,-4743.275;Inherit;False;UV Selector;-1;;347;d8047ff639977014ab6649a770bd5cd4;0;3;15;INT;0;False;16;FLOAT2;0,0;False;17;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;1127;-3212.564,-1703.117;Inherit;False;BandPulse;-1;;348;c478702160369ce4480fa2fb6d734ffa;0;3;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;570;373.2465,-1285.321;Inherit;False;Property;_ScrollEff;Scroll;31;1;[HideInInspector];Create;False;0;0;0;False;1;Vector2;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.FunctionNode;939;-2798.336,451.1675;Inherit;False;4BandAmplitudeLerp;-1;;349;3cf4b6e83381a9a4f84f8cf857bc3af5;0;2;2;INT;0;False;4;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;708;-2854.797,-6095.887;Inherit;False;4BandAmplitudeLerp;-1;;350;3cf4b6e83381a9a4f84f8cf857bc3af5;0;2;2;INT;0;False;4;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;772;-2840.852,-3852.513;Inherit;False;4BandAmplitudeLerp;-1;;351;3cf4b6e83381a9a4f84f8cf857bc3af5;0;2;2;INT;0;False;4;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;54;359.015,-2593.066;Inherit;False;Property;_NormalMapSlider;Normal Map Slider;15;1;[HideInInspector];Create;False;0;0;0;False;0;False;1;1;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;869;-2813.214,-1691.094;Inherit;False;4BandAmplitudeLerp;-1;;352;3cf4b6e83381a9a4f84f8cf857bc3af5;0;2;2;INT;0;False;4;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;263;850.6425,-1155.594;Inherit;False;Property;_OffsetEff;Offset;30;1;[HideInInspector];Create;False;0;0;0;False;1;Vector2;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;264;857.6425,-978.2061;Inherit;False;Property;_TilingEff;Tiling;29;1;[HideInInspector];Create;False;0;0;0;False;1;Vector2;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.StaticSwitch;1079;1026.552,-2628.31;Inherit;False;Property;_UseNormalMap;Enable Normal Map;13;0;Create;False;0;0;0;False;0;False;0;0;0;True;_NormalMap_ON;Toggle;2;Key0;Key1;Create;True;False;All;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;646;1192.539,-1114.024;Inherit;False;UV Selector;-1;;353;d8047ff639977014ab6649a770bd5cd4;0;3;15;INT;0;False;16;FLOAT2;0,0;False;17;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.Vector2Node;414;1147.351,-1371.141;Inherit;False;Property;_OffsetEffMask;Offset;36;1;[HideInInspector];Create;False;0;0;0;False;1;Vector2;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.SamplerNode;258;1462.555,-1149.228;Inherit;True;Property;_EffectAlbedoMap;Effect Albedo Map--{reference_property:_EffectColor,reference_properties:[_TilingEff,_OffsetEff,_ScrollEff,_UVEff]};27;1;[NoScaleOffset];Create;False;0;0;0;False;0;False;51;None;c258fb960e534b54e9e6e463bc4369b1;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.IntNode;412;1234.122,-1222.59;Inherit;False;Property;_UVEffMask;UV;37;1;[HideInInspector];Create;False;0;4;UV0;0;UV1;1;UV2;2;UV3;3;0;False;1;ThryWideEnum(UV0,0,UV1,1,UV2,2,UV3,3,World XY,4,World XZ,5,World YZ,6);False;0;1;False;0;1;INT;0
Node;AmplifyShaderEditor.ColorNode;308;1534.536,-1324.684;Inherit;False;Property;_EffectColor;Effect Color;17;2;[HideInInspector];[HDR];Create;False;0;0;0;False;1;hide_in_inspector;False;0,0,0,1;0.7169812,0.4633322,0.4633322,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;233;665.1648,-3374.1;Inherit;True;Property;_EmissionMap;Emission Map--{reference_property:_EmissionColor};18;2;[NoScaleOffset];[SingleLineTexture];Create;False;0;0;0;False;0;False;51;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;50;782.4487,-3156.41;Inherit;False;Property;_EmissionColor;Emission Color;16;2;[HideInInspector];[HDR];Create;False;0;0;0;False;0;False;0,0,0,1;0.7169812,0.4633322,0.4633322,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector2Node;413;1319.023,-1541.207;Inherit;False;Property;_TilingEffMask;Tiling;35;1;[HideInInspector];Create;False;0;0;0;False;1;Vector2;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;298;1793.701,-1085.211;Inherit;False;Property;_ShiftSpeed;Shift Speed;28;0;Create;True;0;0;0;False;0;False;1;0.25;-5;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;873;-3194.041,-1984.397;Inherit;True;Property;_Band2Albedo;Albedo Map--{reference_property:_Band2Color,reference_properties:[_Band2Tiling,_Band2Offset,_Band2UV]};121;2;[NoScaleOffset];[SingleLineTexture];Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;387;431.8955,-238.1965;Inherit;False;Property;_Power;Power;45;0;Create;True;0;0;0;False;0;False;1;6;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;647;1524.016,-1502.703;Inherit;False;UV Selector;-1;;354;d8047ff639977014ab6649a770bd5cd4;0;3;15;INT;0;False;16;FLOAT2;0,0;False;17;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.ColorNode;790;-2842.288,-4057.183;Inherit;False;Property;_Band1Color;Color;93;2;[HideInInspector];[HDR];Create;False;0;0;0;False;0;False;0,0,0,1;32,32,32,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;942;-2798.608,246.4965;Inherit;False;Property;_Band3Color;Color;150;2;[HideInInspector];[HDR];Create;False;0;0;0;False;0;False;0,0,0,1;32,32,32,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;783;-3221.679,-4145.817;Inherit;True;Property;_Band1Albedo;Albedo Map--{reference_property:_Band1Color,reference_properties:[_Band1Tiling,_Band1Offset,_Band1UV]};92;2;[NoScaleOffset];[SingleLineTexture];Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;872;-2813.486,-1895.765;Inherit;False;Property;_Band2Color;Color;122;2;[HideInInspector];[HDR];Create;False;0;0;0;False;0;False;0,0,0,1;32,32,32,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;710;-2859.614,-6292.562;Inherit;False;Property;_Band0Color;Color;63;2;[HideInInspector];[HDR];Create;False;0;0;0;False;0;False;0,0,0,1;32,32,32,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;711;-3231.854,-6383.572;Inherit;True;Property;_Band0Albedo;Albedo Map--{reference_property:_Band0Color,reference_properties:[_Band0Tiling,_Band0Offset,_Band0UV]};62;2;[NoScaleOffset];[SingleLineTexture];Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;941;-3179.163,157.8647;Inherit;True;Property;_Band3Albedo;Albedo Map--{reference_property:_Band3Color,reference_properties:[_Band3Tiling,_Band3Offset,_Band3UV]};149;2;[NoScaleOffset];[SingleLineTexture];Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;386;430.8954,-330.1966;Inherit;False;Property;_Scale;Scale;44;0;Create;True;0;0;0;False;0;False;1;0.48;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;388;428.0912,-423.7188;Inherit;False;Property;_Bias;Bias;43;0;Create;True;0;0;0;False;0;False;0;0;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;946;-2188.612,436.3655;Inherit;False;Property;_Band3MaskUV;UV;157;1;[HideInInspector];Create;False;0;10;UV0;0;UV1;1;UV2;2;UV3;3;World XY;4;World XZ;5;World YZ;6;Object XY;7;Object XZ;8;Object YZ;9;0;False;1;ThryWideEnum(UV0,0,UV1,1,UV2,2,UV3,3,World XY,4,World XZ,5,World YZ,6);False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.Vector2Node;948;-2348.623,523.0255;Inherit;False;Property;_Band3MaskTiling;Tiling;155;1;[HideInInspector];Create;False;0;0;0;False;1;Vector2;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;874;-2192.434,-1863.751;Inherit;False;Property;_Band2HueShift;Hue Shift;130;0;Create;False;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.IntNode;786;-2232.129,-3862.315;Inherit;False;Property;_Band1MaskUV;UV;100;1;[HideInInspector];Create;False;0;10;UV0;0;UV1;1;UV2;2;UV3;3;World XY;4;World XZ;5;World YZ;6;Object XY;7;Object XZ;8;Object YZ;9;0;False;1;ThryWideEnum(UV0,0,UV1,1,UV2,2,UV3,3,World XY,4,World XZ,5,World YZ,6);False;0;0;False;0;1;INT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;785;-2220.072,-4025.169;Inherit;False;Property;_Band1HueShift;Hue Shift;101;0;Create;False;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;947;-2192.957,518.3814;Inherit;False;Property;_Band3MaskOffset;Offset;156;1;[HideInInspector];Create;False;0;0;0;False;1;Vector2;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;787;-2239.473,-3783.317;Inherit;False;Property;_Band1MaskOffset;Offset;99;1;[HideInInspector];Create;False;0;0;0;False;1;Vector2;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.IntNode;877;-2194.491,-1703.896;Inherit;False;Property;_Band2MaskUV;UV;129;1;[HideInInspector];Create;False;0;10;UV0;0;UV1;1;UV2;2;UV3;3;World XY;4;World XZ;5;World YZ;6;Object XY;7;Object XZ;8;Object YZ;9;0;False;1;ThryWideEnum(UV0,0,UV1,1,UV2,2,UV3,3,World XY,4,World XZ,5,World YZ,6);False;0;0;False;0;1;INT;0
...
Node;AmplifyShaderEditor.SamplerNode;209;2038.336,-1373.991;Inherit;True;Property;_EffectMask;Effect Mask Map--{reference_properties:[_TilingEffMask,_OffsetEffMask,_ScrollEffMask,_UVEffMask]};33;2;[NoScaleOffset];[SingleLineTexture];Create;False;0;0;0;False;0;False;51;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;715;-2235.398,-6272.542;Inherit;False;Property;_Band0HueShift;Hue Shift;72;0;Create;False;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;728;-2405.464,-6061.03;Inherit;False;Property;_Band0MaskTiling;Tiling;69;1;[HideInInspector];Create;False;0;0;0;False;1;Vector2;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;944;-2177.556,278.5107;Inherit;False;Property;_Band3HueShift;Hue Shift;158;0;Create;False;0;0;0;False;0;False;0.420841;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;878;-2348.501,-1624.236;Inherit;False;Property;_Band2MaskTiling;Tiling;127;1;[HideInInspector];Create;False;0;0;0;False;1;Vector2;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;788;-2380.139,-3786.654;Inherit;False;Property;_Band1MaskTiling;Tiling;98;1;[HideInInspector];Create;False;0;0;0;False;1;Vector2;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.IntNode;725;-2250.455,-6107.69;Inherit;False;Property;_Band0MaskUV;UV;71;1;[HideInInspector];Create;False;0;10;UV0;0;UV1;1;UV2;2;UV3;3;World XY;4;World XZ;5;World YZ;6;Object XY;7;Object XZ;8;Object YZ;9;0;False;1;ThryWideEnum(UV0,0,UV1,1,UV2,2,UV3,3,World XY,4,World XZ,5,World YZ,6);False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.Vector2Node;881;-2203.835,-1626.88;Inherit;False;Property;_Band2MaskOffset;Offset;128;1;[HideInInspector];Create;False;0;0;0;False;1;Vector2;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;723;-2258.798,-6025.692;Inherit;False;Property;_Band0MaskOffset;Offset;70;1;[HideInInspector];Create;False;0;0;0;False;1;Vector2;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;422;1348.652,-342.4205;Inherit;False;Property;_AntiAliasingVariance;Anti Aliasing Variance;46;0;Create;True;0;0;0;False;0;False;5;1;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;884;-2056.865,-1669.134;Inherit;False;UV Selector;-1;;356;d8047ff639977014ab6649a770bd5cd4;0;3;15;INT;0;False;16;FLOAT2;0,0;False;17;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode;733;-2066.829,-6070.926;Inherit;False;UV Selector;-1;;357;d8047ff639977014ab6649a770bd5cd4;0;3;15;INT;0;False;16;FLOAT2;0,0;False;17;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.ColorNode;391;1068.949,-339.2581;Inherit;False;Property;_RimColor;Color;42;1;[HDR];Create;False;0;0;0;False;0;False;0,0,0,1;8.47419,0.1331024,0.4436749,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;755;-2084.503,-3830.552;Inherit;False;UV Selector;-1;;358;d8047ff639977014ab6649a770bd5cd4;0;3;15;INT;0;False;16;FLOAT2;0,0;False;17;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;421;1348.342,-254.3114;Inherit;False;Property;_AntiAliasingThreshold;Anti Aliasing Threshold;47;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1003;-2825.826,-5907.871;Inherit;False;Property;_Band0BarAmp;Bar Mode Pulse;75;1;[ToggleUI];Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;311;2252.03,-1481.086;Inherit;False;Property;_UseEmissionMapasMask;Use Emission Map as Mask;34;1;[ToggleUI];Create;False;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1043;-2558.437,-1800.766;Inherit;False;Property;_Band2BarAmp;Bar Mode Pulse;133;1;[ToggleUI];Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1040;-2587.721,-3952.681;Inherit;False;Property;_Band1BarAmp;Bar Mode Pulse;104;1;[ToggleUI];Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;442;1527.527,-529.012;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;1046;-2538.667,344.4219;Inherit;False;Property;_Band3BarAmp;Bar Mode Pulse;161;1;[ToggleUI];Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;953;-2041.986,473.1275;Inherit;False;UV Selector;-1;;359;d8047ff639977014ab6649a770bd5cd4;0;3;15;INT;0;False;16;FLOAT2;0,0;False;17;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SamplerNode;961;-1597.253,428.8465;Inherit;True;Property;_Band3Mask;Mask Map--{reference_properties:[_Band3MaskTiling,_Band3MaskOffset,_Band3MaskUV]};154;2;[NoScaleOffset];[SingleLineTexture];Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;736;-1660.301,-6111.415;Inherit;True;Property;_Band0Mask;Mask Map--{reference_properties:[_Band0MaskTiling,_Band0MaskOffset,_Band0MaskUV]};68;2;[NoScaleOffset];[SingleLineTexture];Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;446;1654.896,-336.5821;Inherit;False;GSAA;-1;;360;a3c5c6cf9d1dd744589a5e3146f5a3a1;0;3;1;FLOAT3;0,0,0;False;10;FLOAT;0;False;12;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;784;-1640.975,-3876.04;Inherit;True;Property;_Band1Mask;Mask Map--{reference_properties:[_Band1MaskTiling,_Band1MaskOffset,_Band1MaskUV]};97;2;[NoScaleOffset];[SingleLineTexture];Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;893;-1613.337,-1714.621;Inherit;True;Property;_Band2Mask;Mask Map--{reference_properties:[_Band2MaskTiling,_Band2MaskOffset,_Band2MaskUV]};126;2;[NoScaleOffset];[SingleLineTexture];Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;1093;2198.263,-586.2712;Inherit;False;Property;_EnableRimlight;Enable Rimlight;41;2;[HideInInspector];[ToggleUI];Create;False;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector3Node;667;435.1756,313.0659;Inherit;False;Property;_NoiseDirection;Directional Speed;57;0;Create;False;0;0;0;False;1;Vector3;False;1,1,1;1,1,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.StaticSwitch;1070;-1038.398,-1654.54;Inherit;False;Property;_UseBand8;Enable Band 2;120;0;Create;False;0;0;0;False;0;False;0;0;0;True;_B2_ON;Toggle;2;Key0;Key1;Reference;1069;True;False;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.StaticSwitch;1064;-1074.976,-6062.983;Inherit;False;Property;_UseBand4;Enable Band 0;61;0;Create;False;0;0;0;False;0;False;0;0;0;True;_B0_ON;Toggle;2;Key0;Key1;Reference;1063;True;False;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.CommentaryNode;1008;3925.017,-6644.813;Inherit;False;3192.067;1473.515;;4;476;830;1134;1135;Final Data;1,0.8339342,0,1;0;0
...
Node;AmplifyShaderEditor.StaticSwitch;1067;-1049.203,-3819.624;Inherit;False;Property;_UseBand6;Enable Band 1;91;0;Create;False;0;0;0;False;0;False;0;0;0;True;_B1_ON;Toggle;2;Key0;Key1;Reference;1066;True;False;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.StaticSwitch;1073;-1018.55,480.4369;Inherit;False;Property;_UseBand10;Enable Band 3;148;0;Create;False;0;0;0;False;0;False;0;0;0;True;_B3_ON;Toggle;2;Key0;Key1;Reference;1072;True;False;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.StaticSwitch;1069;-1042.398,-1908.54;Inherit;False;Property;_UseBand2;Enable Band 2;120;0;Create;False;0;0;0;False;1;HideInInspector;False;0;0;0;True;_B2_ON;Toggle;2;Key0;Key1;Create;True;False;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.StaticSwitch;1076;3192.45,-1476.977;Inherit;False;Property;_EnableEmissionEff;Enable Emission Effect;26;0;Create;False;0;0;0;False;1;HideInInspector;False;0;0;0;True;_EmissionEff_ON;Toggle;2;Key0;Key1;Create;True;False;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.StaticSwitch;1063;-1082.904,-6296.932;Inherit;False;Property;_UseBand0;Enable Band 0;61;0;Create;False;0;0;0;False;1;HideInInspector;False;0;0;0;True;_B0_ON;Toggle;2;Key0;Key1;Create;True;False;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.StaticSwitch;1072;-1021.55,263.437;Inherit;False;Property;_UseBand3;Enable Band 3;148;0;Create;False;0;0;0;False;1;HideInInspector;False;0;0;0;True;_B3_ON;Toggle;2;Key0;Key1;Create;True;False;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.StaticSwitch;1066;-1056.255,-4047.872;Inherit;False;Property;_UseBand1;Enable Band 1;91;0;Create;False;0;0;0;False;1;HideInInspector;False;0;0;0;True;_B1_ON;Toggle;2;Key0;Key1;Create;True;False;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.IntNode;779;-4747.665,-3181.562;Inherit;False;Property;_Shake1UV;UV;113;1;[HideInInspector];Create;False;0;9;UV0;0;UV1;1;UV2;2;UV3;3;World XY;4;World XZ;5;World YZ;6;Object XY;7;Object XZ;8;0;False;1;ThryWideEnum(UV0,0,UV1,1,UV2,2,UV3,3,World XY,4,World XZ,5,World YZ,6);False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.IntNode;954;-4704.151,1122.118;Inherit;False;Property;_Shake3UV;UV;170;1;[HideInInspector];Create;False;0;9;UV0;0;UV1;1;UV2;2;UV3;3;World XY;4;World XZ;5;World YZ;6;Object XY;7;Object XZ;8;0;False;1;ThryWideEnum(UV0,0,UV1,1,UV2,2,UV3,3,World XY,4,World XZ,5,World YZ,6);False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.GetLocalVarNode;827;4169.339,-5788.544;Inherit;False;720;Band0Amp;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.Vector2Node;888;-4717.608,-816.5236;Inherit;False;Property;_Shake2Offset;Offset;140;1;[HideInInspector];Create;False;0;0;0;False;1;Vector2;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;959;-4699.73,1331.739;Inherit;False;Property;_Shake3Offset;Offset;169;1;[HideInInspector];Create;False;0;0;0;False;1;Vector2;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;957;-4694.293,1195.805;Inherit;False;Property;_Shake3Tiling;Tiling;168;1;[HideInInspector];Create;False;0;0;0;False;1;Vector2;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;657;629.9982,358.9076;Inherit;False;Property;_NoiseScale;Scale;56;0;Create;False;0;0;0;False;0;False;5;6.31;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector3Node;886;-4596.946,-1258.328;Inherit;False;Property;_Shake2DirectionVector;Custom--{condition_show:{type:PROPERTY_BOOL,data:_Shake2DirectionSelect==1}};144;0;Create;False;0;0;0;False;1;Vector3;False;0,0,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.Vector2Node;719;-4760.569,-5208.683;Inherit;False;Property;_Shake0Offset;Offset;83;1;[HideInInspector];Create;False;0;0;0;False;1;Vector2;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;887;-4716.035,-949.8815;Inherit;False;Property;_Shake2Tiling;Tiling;139;1;[HideInInspector];Create;False;0;0;0;False;1;Vector2;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector3Node;956;-4579.068,889.9333;Inherit;False;Property;_Shake3DirectionVector;Custom--{condition_show:{type:PROPERTY_BOOL,data:_Shake3DirectionSelect==1}};173;0;Create;False;0;0;0;False;1;Vector3;False;0,0,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;813;-4320.741,-3434.817;Inherit;False;Property;_Shake1DirectionSelect;Direction;115;2;[IntRange];[Enum];Create;False;0;2;Normals;0;Custom;1;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;892;-4296.103,-1276.131;Inherit;False;Property;_Shake2DirectionSelect;Direction;143;1;[Enum];Create;False;0;2;Normals;0;Custom;1;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.IntNode;889;-4722.029,-1026.144;Inherit;False;Property;_Shake2UV;UV;141;1;[HideInInspector];Create;False;0;9;UV0;0;UV1;1;UV2;2;UV3;3;World XY;4;World XZ;5;World YZ;6;Object XY;7;Object XZ;8;0;False;1;ThryWideEnum(UV0,0,UV1,1,UV2,2,UV3,3,World XY,4,World XZ,5,World YZ,6);False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.IntNode;718;-4764.991,-5416.935;Inherit;False;Property;_Shake0UV;UV;84;1;[HideInInspector];Create;False;0;9;UV0;0;UV1;1;UV2;2;UV3;3;World XY;4;World XZ;5;World YZ;6;Object XY;7;Object XZ;8;0;False;1;ThryWideEnum(UV0,0,UV1,1,UV2,2,UV3,3,World XY,4,World XZ,5,World YZ,6);False;0;0;False;0;1;INT;0
...
Node;AmplifyShaderEditor.Vector2Node;803;-4743.244,-2973.31;Inherit;False;Property;_Shake1Offset;Offset;112;1;[HideInInspector];Create;False;0;0;0;False;1;Vector2;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;717;-4759.997,-5339.302;Inherit;False;Property;_Shake0Tiling;Tiling;82;1;[HideInInspector];Create;False;0;0;0;False;1;Vector2;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;958;-4278.225,872.1304;Inherit;False;Property;_Shake3DirectionSelect;Direction;172;1;[Enum];Create;False;0;2;Normals;0;Custom;1;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;804;-4741.671,-3103.928;Inherit;False;Property;_Shake1Tiling;Tiling;111;1;[HideInInspector];Create;False;0;0;0;False;1;Vector2;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector3Node;712;-4642.908,-5648.121;Inherit;False;Property;_Shake0DirectionVector;Custom--{condition_show:{type:PROPERTY_BOOL,data:_Shake0DirectionSelect==1}};87;0;Create;False;0;0;0;False;1;Vector3;False;0,0,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;714;-4352.067,-5668.924;Inherit;False;Property;_Shake0DirectionSelect;Direction;86;1;[Enum];Create;False;0;2;Normals;0;Custom;1;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector3Node;778;-4622.583,-3413.746;Inherit;False;Property;_Shake1DirectionVector;Custom--{condition_show:{type:PROPERTY_BOOL,data:_Shake1DirectionSelect==1}};116;0;Create;False;0;0;0;False;1;Vector3;False;0,0,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;802;-3782.858,-3366.146;Inherit;False;Property;_Shake1Intensity;Intensity;114;0;Create;False;0;0;0;False;0;False;0.05;1;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;437;365.415,-3740.733;Inherit;False;Property;_AntiAliasingVarianceSm;Anti Aliasing Variance;11;0;Create;False;0;0;0;False;0;False;5;0.01;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;897;-4545.211,-926.2936;Inherit;False;UV Selector;-1;;363;d8047ff639977014ab6649a770bd5cd4;0;3;15;INT;0;False;16;FLOAT2;0,0;False;17;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;729;-3800.184,-5601.519;Inherit;False;Property;_Shake0Intensity;Intensity;85;0;Create;False;0;0;0;False;0;False;0.05;1;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;724;-3701.132,-5688.068;Inherit;False;720;Band0Amp;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;721;-4588.175,-5317.085;Inherit;False;UV Selector;-1;;364;d8047ff639977014ab6649a770bd5cd4;0;3;15;INT;0;False;16;FLOAT2;0,0;False;17;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.Vector2Node;682;792.6887,470.0658;Inherit;False;Property;_TilingNoiseMask;Tiling;52;1;[HideInInspector];Create;False;0;0;0;False;1;Vector2;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;898;-3757.219,-1210.728;Inherit;False;Property;_Shake2Intensity;Intensity;142;0;Create;False;0;0;0;False;0;False;0.05;1;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;681;936.8162,571.0668;Inherit;False;Property;_OffsetNoiseMask;Offset;53;1;[HideInInspector];Create;False;0;0;0;False;1;Vector2;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.GetLocalVarNode;765;-3684.807,-3452.695;Inherit;False;768;Band1Amp;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;439;364.1954,-3652.388;Inherit;False;Property;_AntiAliasingThresholdSm;Anti Aliasing Threshold;12;0;Create;False;0;0;0;False;0;False;0.01;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;767;-4570.85,-3081.71;Inherit;False;UV Selector;-1;;365;d8047ff639977014ab6649a770bd5cd4;0;3;15;INT;0;False;16;FLOAT2;0,0;False;17;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.IntNode;679;1155.561,500.122;Inherit;False;Property;_UVNoiseMask;UV;54;1;[HideInInspector];Create;False;0;10;UV0;0;UV1;1;UV2;2;UV3;3;World XY;4;World XZ;5;World YZ;6;Object XY;7;Object XZ;8;Object YZ;9;0;False;1;ThryWideEnum(UV0,0,UV1,1,UV2,2,UV3,3,World XY,4,World XZ,5,World YZ,6);False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.GetLocalVarNode;838;4161.86,-6147.708;Inherit;False;904;Band2Color;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;966;-4527.333,1221.969;Inherit;False;UV Selector;-1;;366;d8047ff639977014ab6649a770bd5cd4;0;3;15;INT;0;False;16;FLOAT2;0,0;False;17;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;964;-3738.053,937.5344;Inherit;False;Property;_Shake3Intensity;Intensity;171;0;Create;False;0;0;0;False;0;False;0.05;1;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;842;4173.248,-5896.038;Inherit;False;395;Rimlight;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;680;1339.295,569.2529;Inherit;False;UV Selector;-1;;368;d8047ff639977014ab6649a770bd5cd4;0;3;15;INT;0;False;16;FLOAT2;0,0;False;17;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;662;1152.688,143.4477;Inherit;False;Property;_NoiseStength;Strength;55;0;Create;False;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;732;-4331.727,-5315.283;Inherit;True;Property;_Shake0Mask;Mask Map--{reference_properties:[_Shake0Tiling,_Shake0Offset,_Shake0UV]};81;2;[NoScaleOffset];[SingleLineTexture];Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;447;665.1736,-3849.251;Inherit;False;GSAA;-1;;367;a3c5c6cf9d1dd744589a5e3146f5a3a1;0;3;1;FLOAT3;0,0,0;False;10;FLOAT;0;False;12;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;901;-4288.762,-924.4913;Inherit;True;Property;_Shake2Mask;Mask Map--{reference_properties:[_Shake2Tiling,_Shake2Offset,_Shake2UV]};138;2;[NoScaleOffset];[SingleLineTexture];Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;969;-4270.883,1223.771;Inherit;True;Property;_Shake3Mask;Mask Map--{reference_properties:[_Shake3Tiling,_Shake3Offset,_Shake3UV]};167;2;[NoScaleOffset];[SingleLineTexture];Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;60;365.0643,-3835.484;Inherit;False;Property;_Glossiness;Smoothness;10;0;Create;False;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;782;-4314.401,-3079.908;Inherit;True;Property;_Shake1Mask;Mask Map--{reference_properties:[_Shake1Tiling,_Shake1Offset,_Shake1UV]};110;2;[NoScaleOffset];[SingleLineTexture];Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;61;642.9706,-4151.756;Inherit;False;Property;_Metallic;Metallic Slider;9;1;[HideInInspector];Create;False;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1098;-3372.808,-1333.023;Inherit;False;Property;_UseShake2;Enable Shake 2;137;2;[HideInInspector];[ToggleUI];Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;666;1679.472,413.4476;Inherit;True;Property;_VertexNoiseMask;Vertex Noise Mask Map--{reference_properties:[_TilingNoiseMask,_OffsetNoiseMask,_UVNoiseMask]};51;2;[NoScaleOffset];[SingleLineTexture];Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;1096;-3417.392,-5734.739;Inherit;False;Property;_UseShake0;Enable Shake 0;80;2;[HideInInspector];[ToggleUI];Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1095;-3397.186,-3456.376;Inherit;False;Property;_UseShake1;Enable Shake 1;109;2;[HideInInspector];[ToggleUI];Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;59;624.3825,-4069.384;Inherit;True;Property;_MetallicGlossMap;Metallic Map--{reference_property:_Metallic};8;2;[NoScaleOffset];[SingleLineTexture];Create;False;0;0;0;False;0;False;51;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;1100;-3358.575,847.5449;Inherit;False;Property;_UseShake3;Enable Shake 3;166;2;[HideInInspector];[ToggleUI];Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;1068;-3035.499,-3325.767;Inherit;False;Property;_UseBand7;Enable Band 1;91;0;Create;False;0;0;0;False;0;False;0;0;0;True;_B1_ON;Toggle;2;Key0;Key1;Reference;1066;True;False;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.StaticSwitch;1074;-2988.518,985.1509;Inherit;False;Property;_UseBand11;Enable Band 3;148;0;Create;False;0;0;0;False;0;False;0;0;0;True;_B3_ON;Toggle;2;Key0;Key1;Reference;1072;True;False;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.StaticSwitch;1071;-3013.118,-1169.884;Inherit;False;Property;_UseBand9;Enable Band 2;120;0;Create;False;0;0;0;False;0;False;0;0;0;True;_B2_ON;Toggle;2;Key0;Key1;Reference;1069;True;False;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.StaticSwitch;1077;2263.876,215.9341;Inherit;False;Property;_VertexNoise;Enable Vertex Noise;50;0;Create;False;0;0;0;False;1;HideInInspector;False;0;0;0;True;_VertNoise_ON;Toggle;2;Key0;Key1;Create;True;False;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;1134;5643.548,-6475.587;Inherit;False;Property;_HueTime;Hue Time;6;0;Create;True;0;0;0;False;0;False;0;0;-0.5;0.5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;1065;-3050.984,-5559.171;Inherit;False;Property;_UseBand5;Enable Band 0;61;0;Create;False;0;0;0;False;0;False;0;0;0;True;_B0_ON;Toggle;2;Key0;Key1;Reference;1063;True;False;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1107;5773.811,-6352.982;Inherit;False;Property;_HueModifier;Hue Modifier;23;0;Create;True;0;0;0;False;0;False;0;0;-0.5;0.5;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;1135;5932.777,-6499.866;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;458;443.7283,-6343.615;Inherit;False;455.9268;793.7084;;6;260;575;576;89;88;90;Engine;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;1110;6093.811,-6297.482;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;89;515.597,-5666.476;Inherit;False;Property;Instancing;Instancing;181;1;[HideInInspector];Create;False;0;0;0;True;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;746;-5064.051,-6616.762;Inherit;False;Property;m_start_Band0;Band 0--{reference_property:_UseBand0};60;1;[HideInInspector];Create;False;0;0;0;True;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;979;-4729.726,801.6523;Inherit;False;Property;m_start_Shake3;Shake--{reference_property:_UseShake3};165;1;[HideInInspector];Create;False;0;0;0;True;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;84;2458.035,-6033.242;Inherit;False;Property;footer_github;;185;1;[HideInInspector];Create;False;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;749;-2860.157,-5156.58;Inherit;False;Property;m_end_Shake0;Shake 0;88;1;[HideInInspector];Create;False;0;0;0;True;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1133;3020.67,-4506.15;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;780;-4773.24,-3502.028;Inherit;False;Property;m_start_Shake1;Shake--{reference_property:_UseShake1};108;1;[HideInInspector];Create;False;0;0;0;True;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;88;510.4168,-5764.929;Inherit;False;Property;DSGI;DSGI;180;1;[HideInInspector];Create;False;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;912;-2818.193,-768.7872;Inherit;False;Property;m_end_Shake2;Shake 2;145;1;[HideInInspector];Create;False;0;0;0;True;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;90;508.597,-5847.476;Inherit;False;Property;LightmapFlags;LightmapFlags;179;1;[HideInInspector];Create;False;0;0;0;True;0;False;0;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;82;2138.23,-6032.16;Inherit;False;Property;footer_booth;;184;1;[HideInInspector];Create;False;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;747;-5267.767,-6889.392;Inherit;False;Property;m_start_AudioLink;Audio Link;59;1;[HideInInspector];Create;False;0;0;0;True;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;981;-5000.318,-77.7086;Inherit;False;Property;m_start_Band3;Band 3--{reference_property:_UseBand3};147;1;[HideInInspector];Create;False;0;0;0;True;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;913;-4747.604,-1346.609;Inherit;False;Property;m_start_Shake2;Shake--{reference_property:_UseShake2};136;1;[HideInInspector];Create;False;0;0;0;True;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;262;3463.682,-961.3279;Inherit;False;Property;m_end_eff;Emission Effect;39;1;[HideInInspector];Create;False;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;261;305.9659,-1526.734;Inherit;False;Property;m_start_eff;Emission Effect--{reference_property:_EnableEmissionEff};25;1;[HideInInspector];Create;False;0;0;0;True;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;397;2707.441,-235.7794;Inherit;False;Property;m_end_rim;Rimlight;48;1;[HideInInspector];Create;False;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;911;-5018.197,-2225.97;Inherit;False;Property;m_start_Band2;Band 2--{reference_property:_UseBand2};119;1;[HideInInspector];Create;False;0;0;0;True;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;980;-2800.315,1379.474;Inherit;False;Property;m_end_Shake3;Shake 3;174;1;[HideInInspector];Create;False;0;0;0;True;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;260;509.6126,-6197.18;Inherit;False;Property;_Cull;Cull;178;0;Create;True;0;0;0;True;1;Enum(UnityEngine.Rendering.CullMode);False;2;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;678;2535.611,590.312;Inherit;False;Property;m_end_noisevert;Vertex Noise;58;1;[HideInInspector];Create;False;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;801;-2843.831,-2924.204;Inherit;False;Property;m_end_Shake1;Shake 1;117;1;[HideInInspector];Create;False;0;0;0;True;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;85;2606.983,-6033.262;Inherit;False;Property;footer_discord;;183;1;[HideInInspector];Create;False;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;398;767.1793,-232.4575;Inherit;False;Property;m_start_rim;Rimlight--{reference_property:_EnableRimlight};40;1;[HideInInspector];Create;False;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;101;2135.274,-6146.626;Inherit;False;Property;m_end_Main;Main;24;1;[HideInInspector];Create;False;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;745;-759.4528,-5064.427;Inherit;False;Property;m_end_Band0;Band 0;89;1;[HideInInspector];Create;False;0;0;0;True;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;781;-742.1261,-2829.052;Inherit;False;Property;m_end_Band1;Band 1;118;1;[HideInInspector];Create;False;0;0;0;True;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;978;-698.6071,1474.626;Inherit;False;Property;m_end_Band3;Band 3;175;1;[HideInInspector];Create;False;0;0;0;True;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;83;2290.085,-6030.526;Inherit;False;Property;footer_patreon;;186;1;[HideInInspector];Create;False;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;677;349.3825,605.7237;Inherit;False;Property;m_start_noisevert;Vertex Noise--{reference_property:_VertexNoise};49;1;[HideInInspector];Create;False;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;576;762.4714,-5656.193;Inherit;False;Property;m_end_engine;Engine;182;1;[HideInInspector];Create;False;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;748;-4790.566,-5737.403;Inherit;False;Property;m_start_Shake0;Shake--{reference_property:_UseShake0};79;1;[HideInInspector];Create;False;0;0;0;True;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;750;-452.672,1680.548;Inherit;False;Property;m_end_AudioLink;Audio Link;176;1;[HideInInspector];Create;False;0;0;0;True;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;575;464.4715,-6293.193;Inherit;False;Property;m_start_engine;Engine;177;1;[HideInInspector];Create;False;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;910;-716.486,-673.6354;Inherit;False;Property;m_end_Band2;Band 2;146;1;[HideInInspector];Create;False;0;0;0;True;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;338;6365.269,-5973.539;Inherit;False;336;NormalMap;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;800;-5043.833,-4381.389;Inherit;False;Property;m_start_Band1;Band 1--{reference_property:_UseBand1};90;1;[HideInInspector];Create;False;0;0;0;True;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;478;6596.363,-6171.372;Half;False;True;-1;4;Thry.ShaderEditor;0;0;Standard;TsunaMoo/Party FX Cutout;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;True;479;0;True;480;False;0;False;-1;0;False;-1;False;0;Masked;0.5;True;True;0;False;TransparentCutout;;AlphaTest;All;9;d3d9;d3d11_9x;d3d11;glcore;gles;gles3;metal;vulkan;nomrt;True;True;True;True;0;False;-1;False;0;True;449;255;True;453;255;True;454;0;True;451;0;True;452;0;True;455;0;True;456;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;5;True;463;10;True;464;1;0;True;466;0;True;467;0;True;465;0;True;468;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;7;-1;-1;-1;0;False;0;0;True;260;-1;0;False;-1;1;Include;Packages/com.llealloo.audiolink/Runtime/Shaders/AudioLink.cginc;False;;Custom;0;0;False;0.1;False;-1;0;False;-1;True;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;1111;2;1135;0
WireConnection;1110;0;1103;1
WireConnection;1110;1;1107;0
WireConnection;1110;2;1135;0
WireConnection;1133;0;51;4
WireConnection;1133;1;53;4
...
WireConnection;478;10;1133;0
WireConnection;478;11;674;0
ASEEND*/
//CHKSM=ACA52D3EF738111B846ECE271A6CA1210390F33E