...
Shader "TsunaMoo/Party FX Transparent"
{
	Properties
	{
	...
	SubShader
	{
		...
		half2 UVSelector9_g362( int Set, half2 UV0, half2 UV1, half2 UV2, half2 UV3, half2 UV4, half2 UV5, half2 UV6 )
		{
			float2 UvSet[7];
			UvSet[0] = UV0;
			UvSet[1] = UV1;
		...
		half2 UVSelector9_g293( int Set, half2 UV0, half2 UV1, half2 UV2, half2 UV3, half2 UV4, half2 UV5, half2 UV6 )
		{
			float2 UvSet[7];
			UvSet[0] = UV0;
			UvSet[1] = UV1;
		...
		half2 UVSelector9_g355( int Set, half2 UV0, half2 UV1, half2 UV2, half2 UV3, half2 UV4, half2 UV5, half2 UV6 )
		{
			float2 UvSet[7];
			UvSet[0] = UV0;
			UvSet[1] = UV1;
		...
		half2 UVSelector9_g346( int Set, half2 UV0, half2 UV1, half2 UV2, half2 UV3, half2 UV4, half2 UV5, half2 UV6 )
		{
			float2 UvSet[7];
			UvSet[0] = UV0;
			UvSet[1] = UV1;
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			#ifdef _VertNoise_ON
				half4 staticSwitch1077 = ( ( (-1.0 + (simplePerlin3D660 - 0.0) * (1.0 - -1.0) / (1.0 - 0.0)) * _NoiseStength ) * SAMPLE_TEXTURE2D_LOD( _VertexNoiseMask, sampler_linear_repeat, ( _OffsetNoiseMask + ( _TilingNoiseMask * localUVSelector9_g364 ) ), 0.0 ) );
			#else
			...
			half2 break6_g302 = (float2( 0,0 ) + (temp_output_696_0 - float2( 0,0 )) * (float2( 0.9,1 ) - float2( 0,0 )) / (float2( 1,1 ) - float2( 0,0 )));
			...
			half temp_output_2_0_g302 = ifLocalVar1090;
			...
			half Delay3_g348 = ( ( (_Band0Delay + (( appendResult16_g302.x * _Band0Pulse ) - 0.0) * (1.0 - _Band0Delay) / (1.0 - 0.0)) % 1.0 ) * 128.0 );
			half localAudioLinkLerp3_g348 = AudioLinkLerp3_g348( Band3_g348 , Delay3_g348 );
			half temp_output_708_0 = localAudioLinkLerp3_g348;
			...
			int Set9_g362 = _Shake0UV;
			half2 UV09_g362 = v.texcoord.xy;
			half2 UV19_g362 = v.texcoord1.xy;
			half2 UV29_g362 = v.texcoord2.xy;
			half2 UV39_g362 = v.texcoord3.xy;
			half2 appendResult40_g362 = (half2(ase_worldPos.x , 0.0));
			half2 UV49_g362 = appendResult40_g362;
			half2 appendResult41_g362 = (half2(ase_worldPos.x , 0.0));
			half2 UV59_g362 = appendResult41_g362;
			half2 appendResult42_g362 = (half2(0.0 , 0.0));
			half2 UV69_g362 = appendResult42_g362;
			half2 localUVSelector9_g362 = UVSelector9_g362( Set9_g362 , UV09_g362 , UV19_g362 , UV29_g362 , UV39_g362 , UV49_g362 , UV59_g362 , UV69_g362 );
			half4 ifLocalVar1097 = 0;
			if( _UseShake0 == 1.0 )
				ifLocalVar1097 = ( ( Band0Amp720 * _Shake0Intensity * half4( ifLocalVar722 , 0.0 ) ) * SAMPLE_TEXTURE2D_LOD( _Shake0Mask, sampler_linear_repeat, ( _Shake0Offset + ( _Shake0Tiling * localUVSelector9_g362 ) ), 0.0 ) );
			#ifdef _B0_ON
			...
			int Band3_g347 = 1;
			int Set9_g293 = _Band1UV;
			half2 UV09_g293 = v.texcoord.xy;
			half2 UV19_g293 = v.texcoord1.xy;
			half2 UV29_g293 = v.texcoord2.xy;
			half2 UV39_g293 = v.texcoord3.xy;
			half2 appendResult40_g293 = (half2(ase_worldPos.x , 0.0));
			half2 UV49_g293 = appendResult40_g293;
			half2 appendResult41_g293 = (half2(ase_worldPos.x , 0.0));
			half2 UV59_g293 = appendResult41_g293;
			half2 appendResult42_g293 = (half2(0.0 , 0.0));
			half2 UV69_g293 = appendResult42_g293;
			half2 localUVSelector9_g293 = UVSelector9_g293( Set9_g293 , UV09_g293 , UV19_g293 , UV29_g293 , UV39_g293 , UV49_g293 , UV59_g293 , UV69_g293 );
			half2 temp_output_810_0 = ( _Band1Offset + ( _Band1Tiling * localUVSelector9_g293 ) );
			...
			half Delay3_g347 = ( ( (_Band1Delay + (( appendResult16_g304.x * _Band1Pulse ) - 0.0) * (1.0 - _Band1Delay) / (1.0 - 0.0)) % 1.0 ) * 128.0 );
			...
			int Set9_g355 = _Band1MaskUV;
			half2 UV09_g355 = v.texcoord.xy;
			half2 UV19_g355 = v.texcoord1.xy;
			half2 UV29_g355 = v.texcoord2.xy;
			half2 UV39_g355 = v.texcoord3.xy;
			half2 appendResult40_g355 = (half2(ase_worldPos.x , 0.0));
			half2 UV49_g355 = appendResult40_g355;
			half2 appendResult41_g355 = (half2(ase_worldPos.x , 0.0));
			half2 UV59_g355 = appendResult41_g355;
			half2 appendResult42_g355 = (half2(0.0 , 0.0));
			half2 UV69_g355 = appendResult42_g355;
			half2 localUVSelector9_g355 = UVSelector9_g355( Set9_g355 , UV09_g355 , UV19_g355 , UV29_g355 , UV39_g355 , UV49_g355 , UV59_g355 , UV69_g355 );
			half4 tex2DNode784 = SAMPLE_TEXTURE2D_LOD( _Band1Mask, sampler_linear_repeat, ( _Band1MaskOffset + ( _Band1MaskTiling * localUVSelector9_g355 ) ), 0.0 );
			#ifdef _B1_ON
			...
			half2 break6_g305 = (float2( 0,0 ) + (temp_output_860_0 - float2( 0,0 )) * (float2( 0.9,1 ) - float2( 0,0 )) / (float2( 1,1 ) - float2( 0,0 )));
			...
			half temp_output_2_0_g305 = ifLocalVar1087;
			...
			half Delay3_g350 = ( ( (_Band2Delay + (( appendResult16_g305.x * _Band2Pulse ) - 0.0) * (1.0 - _Band2Delay) / (1.0 - 0.0)) % 1.0 ) * 128.0 );
			half localAudioLinkLerp3_g350 = AudioLinkLerp3_g350( Band3_g350 , Delay3_g350 );
			half temp_output_869_0 = localAudioLinkLerp3_g350;
			...
			half2 break6_g303 = (float2( 0,0 ) + (temp_output_930_0 - float2( 0,0 )) * (float2( 0.9,1 ) - float2( 0,0 )) / (float2( 1,1 ) - float2( 0,0 )));
			...
			half temp_output_2_0_g303 = ifLocalVar1084;
			...
			half Delay3_g349 = ( ( (_Band3Delay + (( appendResult16_g303.x * _Band3Pulse ) - 0.0) * (1.0 - _Band3Delay) / (1.0 - 0.0)) % 1.0 ) * 128.0 );
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			int Set9_g346 = _UVMain;
			half2 UV09_g346 = i.uv_texcoord;
			half2 UV19_g346 = i.uv2_texcoord2;
			half2 UV29_g346 = i.uv3_texcoord3;
			half2 UV39_g346 = i.uv4_texcoord4;
			float3 ase_worldPos = i.worldPos;
			half2 appendResult40_g346 = (half2(ase_worldPos.x , 0.0));
			half2 UV49_g346 = appendResult40_g346;
			half2 appendResult41_g346 = (half2(ase_worldPos.x , 0.0));
			half2 UV59_g346 = appendResult41_g346;
			half2 appendResult42_g346 = (half2(0.0 , 0.0));
			half2 UV69_g346 = appendResult42_g346;
			half2 localUVSelector9_g346 = UVSelector9_g346( Set9_g346 , UV09_g346 , UV19_g346 , UV29_g346 , UV39_g346 , UV49_g346 , UV59_g346 , UV69_g346 );
			half2 MainUV339 = ( ( appendResult420 + _Offset ) + ( _Tiling * localUVSelector9_g346 ) );
			#ifdef _NormalMap_ON
			...
			half3 hsvTorgb301 = RGBToHSV( ( _EffectColor * SAMPLE_TEXTURE2D( _EffectAlbedoMap, sampler_linear_repeat, ( ( appendResult573 + _OffsetEff ) + ( _TilingEff * localUVSelector9_g351 ) ) ) ).rgb );
			...
			if( _UseEmissionMapasMask >= 1.0 )
				...
				ifLocalVar310 = SAMPLE_TEXTURE2D( _EffectMask, sampler_linear_repeat, ( ( appendResult568 + _OffsetEffMask ) + ( _TilingEffMask * localUVSelector9_g352 ) ) );
			...
			half3 temp_output_1_0_g358 = newWorldNormal402;
			half3 temp_output_4_0_g358 = ddx( temp_output_1_0_g358 );
			half dotResult6_g358 = dot( temp_output_4_0_g358 , temp_output_4_0_g358 );
			half3 temp_output_5_0_g358 = ddy( temp_output_1_0_g358 );
			half dotResult8_g358 = dot( temp_output_5_0_g358 , temp_output_5_0_g358 );
			half4 lerpResult424 = lerp( ( clampResult390 * _RimColor ) , float4( 0,0,0,0 ) , sqrt( sqrt( saturate( min( ( ( ( dotResult6_g358 + dotResult8_g358 ) * _AntiAliasingVariance ) * 2.0 ) , _AntiAliasingThreshold ) ) ) ));
			half4 ifLocalVar1092 = 0;
			if( _EnableRimlight == 1.0 )
				ifLocalVar1092 = ( lerpResult424 * _RimColor.a );
			half4 Rimlight395 = ifLocalVar1092;
			int Set9_g293 = _Band1UV;
			half2 UV09_g293 = i.uv_texcoord;
			half2 UV19_g293 = i.uv2_texcoord2;
			half2 UV29_g293 = i.uv3_texcoord3;
			half2 UV39_g293 = i.uv4_texcoord4;
			half2 appendResult40_g293 = (half2(ase_worldPos.x , 0.0));
			half2 UV49_g293 = appendResult40_g293;
			half2 appendResult41_g293 = (half2(ase_worldPos.x , 0.0));
			half2 UV59_g293 = appendResult41_g293;
			...
			if( _Band1BarAmp == 1.0 )
				...
				ifLocalVar1039 = temp_output_772_0;
			int Set9_g355 = _Band1MaskUV;
			half2 UV09_g355 = i.uv_texcoord;
			half2 UV19_g355 = i.uv2_texcoord2;
			half2 UV29_g355 = i.uv3_texcoord3;
			half2 UV39_g355 = i.uv4_texcoord4;
			half2 appendResult40_g355 = (half2(ase_worldPos.x , 0.0));
			half2 UV49_g355 = appendResult40_g355;
			half2 appendResult41_g355 = (half2(ase_worldPos.x , 0.0));
			half2 UV59_g355 = appendResult41_g355;
			...
			half2 UV69_g355 = appendResult42_g355;
			half2 localUVSelector9_g355 = UVSelector9_g355( Set9_g355 , UV09_g355 , UV19_g355 , UV29_g355 , UV39_g355 , UV49_g355 , UV59_g355 , UV69_g355 );
			half4 tex2DNode784 = SAMPLE_TEXTURE2D( _Band1Mask, sampler_linear_repeat, ( _Band1MaskOffset + ( _Band1MaskTiling * localUVSelector9_g355 ) ) );
			#ifdef _B1_ON
			...
			half3 temp_output_1_0_g365 = ase_worldNormal;
			half3 temp_output_4_0_g365 = ddx( temp_output_1_0_g365 );
			half dotResult6_g365 = dot( temp_output_4_0_g365 , temp_output_4_0_g365 );
			half3 temp_output_5_0_g365 = ddy( temp_output_1_0_g365 );
			half dotResult8_g365 = dot( temp_output_5_0_g365 , temp_output_5_0_g365 );
			half lerpResult443 = lerp( _Glossiness , 0.0 , sqrt( sqrt( saturate( min( ( ( ( dotResult6_g365 + dotResult8_g365 ) * _AntiAliasingVarianceSm ) * 2.0 ) , _AntiAliasingThresholdSm ) ) ) ));
			...
			o.Alpha = ( _Color.a * tex2DNode51.a );
		}
...
/*ASEBEGIN
Version=18935
89.6;132.8;2232;1533;4960.195;6262.815;5.043109;True;False
...
Node;AmplifyShaderEditor.FunctionNode;810;-4559.172,-4136.55;Inherit;False;UV Selector;-1;;293;d8047ff639977014ab6649a770bd5cd4;0;3;15;INT;0;False;16;FLOAT2;0,0;False;17;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;700;-3702.353,-6395.658;Inherit;False;RotateUVFill;-1;;302;459952d587cbfe742a7e7f4a8a0a4169;0;2;1;FLOAT2;0,0;False;2;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;931;-3670.51,177.2646;Inherit;True;RotateUVFill;-1;;303;459952d587cbfe742a7e7f4a8a0a4169;0;2;1;FLOAT2;0,0;False;2;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;862;-3684.389,-1978.998;Inherit;True;RotateUVFill;-1;;305;459952d587cbfe742a7e7f4a8a0a4169;0;2;1;FLOAT2;0,0;False;2;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;1126;-3257.527,-6099.911;Inherit;False;BandPulse;-1;;343;c478702160369ce4480fa2fb6d734ffa;0;3;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;645;1516.386,-4743.275;Inherit;False;UV Selector;-1;;346;d8047ff639977014ab6649a770bd5cd4;0;3;15;INT;0;False;16;FLOAT2;0,0;False;17;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;1127;-3212.564,-1703.117;Inherit;False;BandPulse;-1;;345;c478702160369ce4480fa2fb6d734ffa;0;3;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;708;-2854.797,-6095.887;Inherit;False;4BandAmplitudeLerp;-1;;348;3cf4b6e83381a9a4f84f8cf857bc3af5;0;2;2;INT;0;False;4;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;869;-2813.214,-1691.094;Inherit;False;4BandAmplitudeLerp;-1;;350;3cf4b6e83381a9a4f84f8cf857bc3af5;0;2;2;INT;0;False;4;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;646;1192.539,-1114.024;Inherit;False;UV Selector;-1;;351;d8047ff639977014ab6649a770bd5cd4;0;3;15;INT;0;False;16;FLOAT2;0,0;False;17;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.ColorNode;308;1539.579,-1324.684;Inherit;False;Property;_EffectColor;Effect Color;15;2;[HideInInspector];[HDR];Create;False;0;0;0;False;1;hide_in_inspector;False;0,0,0,1;0.7169812,0.4633322,0.4633322,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;647;1524.016,-1502.703;Inherit;False;UV Selector;-1;;352;d8047ff639977014ab6649a770bd5cd4;0;3;15;INT;0;False;16;FLOAT2;0,0;False;17;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.ColorNode;391;1068.949,-334.215;Inherit;False;Property;_RimColor;Color;41;1;[HDR];Create;False;0;0;0;False;0;False;0,0,0,1;8.47419,0.1331024,0.4436749,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;755;-2084.503,-3830.552;Inherit;False;UV Selector;-1;;355;d8047ff639977014ab6649a770bd5cd4;0;3;15;INT;0;False;16;FLOAT2;0,0;False;17;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;446;1654.896,-336.5821;Inherit;False;GSAA;-1;;358;a3c5c6cf9d1dd744589a5e3146f5a3a1;0;3;1;FLOAT3;0,0,0;False;10;FLOAT;0;False;12;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;1008;3925.017,-6644.813;Inherit;False;3192.067;1473.515;;3;476;830;1134;Final Data;1,0.8339342,0,1;0;0
...
Node;AmplifyShaderEditor.FunctionNode;721;-4588.175,-5317.085;Inherit;False;UV Selector;-1;;362;d8047ff639977014ab6649a770bd5cd4;0;3;15;INT;0;False;16;FLOAT2;0,0;False;17;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;447;665.1736,-3849.251;Inherit;False;GSAA;-1;;365;a3c5c6cf9d1dd744589a5e3146f5a3a1;0;3;1;FLOAT3;0,0,0;False;10;FLOAT;0;False;12;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;680;1339.295,569.2529;Inherit;False;UV Selector;-1;;364;d8047ff639977014ab6649a770bd5cd4;0;3;15;INT;0;False;16;FLOAT2;0,0;False;17;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1134;5730.661,-6499.954;Inherit;False;Property;_HueTime;Hue Time;22;0;Create;True;0;0;0;False;0;False;0;0;-0.5;0.5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleTimeNode;1135;6019.891,-6524.232;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;84;2458.035,-6033.242;Inherit;False;Property;footer_github;;184;1;[HideInInspector];Create;False;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1133;2898.656,-4516.439;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;89;515.597,-5666.476;Inherit;False;Property;Instancing;Instancing;180;1;[HideInInspector];Create;False;0;0;0;True;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;82;2138.23,-6032.16;Inherit;False;Property;footer_booth;;183;1;[HideInInspector];Create;False;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;88;510.4168,-5764.929;Inherit;False;Property;DSGI;DSGI;179;1;[HideInInspector];Create;False;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;83;2290.085,-6030.526;Inherit;False;Property;footer_patreon;;185;1;[HideInInspector];Create;False;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;85;2606.983,-6033.262;Inherit;False;Property;footer_discord;;182;1;[HideInInspector];Create;False;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;576;762.4714,-5656.193;Inherit;False;Property;m_end_engine;Engine;181;1;[HideInInspector];Create;False;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;90;508.597,-5847.476;Inherit;False;Property;LightmapFlags;LightmapFlags;178;1;[HideInInspector];Create;False;0;0;0;True;0;False;0;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;478;6596.363,-6171.372;Half;False;True;-1;4;Thry.ShaderEditor;0;0;Standard;TsunaMoo/Party FX Transparent;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;Back;0;True;479;0;True;480;False;0;False;-1;0;False;-1;False;0;Transparent;0.5;True;True;0;False;Transparent;;Transparent;All;9;d3d9;d3d11_9x;d3d11;glcore;gles;gles3;metal;vulkan;nomrt;True;True;True;True;0;False;-1;False;0;True;449;255;True;453;255;True;454;0;True;451;0;True;452;0;True;455;0;True;456;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;2;5;True;463;10;True;464;1;0;True;466;0;True;467;0;True;465;0;True;468;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;-1;-1;-1;-1;0;False;0;0;True;260;-1;0;False;-1;1;Include;Packages/com.llealloo.audiolink/Runtime/Shaders/AudioLink.cginc;False;;Custom;0;0;False;0.1;False;-1;0;False;-1;True;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;1133;0;53;4
WireConnection;1133;1;51;4
...
WireConnection;478;9;1133;0
WireConnection;478;11;674;0
ASEEND*/
//CHKSM=DD40F0B3AE5905773C26A37EE62DA818E0A9C909
