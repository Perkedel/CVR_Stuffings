Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/501e1faba68aaf94ab0d2d9d75d8e28e"
{
	Properties
	{
		...
		[ThryWideEnum(Replace, 0, Multiply, 2, Screen, 6, Subtract, 7, Add, 8, Overlay, 9, Mixed, 20)]_FlipbookBlendType ("Blending", Range(0, 1)) = 0
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyFlipbook(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				if ((1.0 /*_FlipbookStartAndEnd*/))
				{
					totalFrames -= (totalFrames - min(max((0.0 /*_FlipbookStartFrame*/), (38.0 /*_FlipbookEndFrame*/)), totalFrames));
