Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/e36059eca3ac846409756b39ad4c90f4"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float3 applyEmission(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				{
					emissionStrength0 *= calculateBlinkingEmission((0.02 /*_EmissiveBlink_Min*/), (0.1 /*_EmissiveBlink_Max*/), (12.0 /*_EmissiveBlink_Velocity*/), (0.0 /*_EmissionBlinkingOffset*/));
				}
