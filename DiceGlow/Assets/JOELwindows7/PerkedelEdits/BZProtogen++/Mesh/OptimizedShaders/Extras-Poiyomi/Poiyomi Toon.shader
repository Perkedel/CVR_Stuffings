Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/80148176cf016644d87d45345297084a"
{
	Properties
	{
		...
		[ThryWideEnum(Replace, 0, Multiply, 2, Screen, 6, Subtract, 7, Add, 8, Overlay, 9, Mixed, 20)]_ALVolumeColorBlendType ("Blend Type", Range(0, 1)) = 0
 ...
 #define OPTIMIZER_ENABLED 
			...
			void ApplyAudioLinkDecal(in PoiMesh poiMesh, inout PoiFragData poiFragData, in PoiMods poiMods)
			{
				...
				float3 emissionColor = lerp(lowColor * (20.0 /*_ALDecalLowEmission*/), midColor * (20.0 /*_ALDecalMidEmission*/), saturate(volumeColorSrc * 2));
				emissionColor = lerp(emissionColor, highColor * (20.0 /*_ALDecalHighEmission*/), saturate(volumeColorSrc * 2 - 1));
			...
			void ApplyAudioLinkVolumeColor(in PoiMesh poiMesh, inout PoiFragData poiFragData, in PoiMods poiMods)
			{
				...
				float3 lowColor = float4(0,0,1,1).rgb * poiThemeColor(poiMods, float4(0,0,1,1).rgb, (0.0 /*_ALVolumeColorLowThemeIndex*/));
				...
				float3 emissionColor = lerp(lowColor * (20.0 /*_ALLowEmission*/), midColor * (20.0 /*_ALMidEmission*/), saturate(volume * 2));
				emissionColor = lerp(emissionColor, highColor * (20.0 /*_ALHighEmission*/), saturate(volume * 2 - 1));
				#if defined(POI_PASS_BASE) || defined(POI_PASS_ADD)
			...
			{
				float smoothness = (0.792 /*_MochieRoughnessMultiplier*/);
				...
				specularMask *= (0.92 /*_MochieSpecularStrength*/);
