...
Shader "Silent/FakeGlass Rain"
{
	Properties
	{
		...
		[HeaderEx(Rain Properties)]_RainPattern("Rain Pattern", 2D) = "gray" {}
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float3 newWorldNormal2_g65 = (WorldNormalVector( i , float3(0,0,1) ));
			float noRainArea17_g65 = ( 1.0 - saturate( -newWorldNormal2_g65.y ) );
			float3 ase_worldPos = i.worldPos;
			float rainSpeed10_g65 = _RainSpeed;
			float rainSpeed45_g67 = rainSpeed10_g65;
			float streakTiling7_g65 = _StreakTiling;
			float streakTiling50_g67 = streakTiling7_g65;
			float3 break59_g67 = ( ( ase_worldPos + ( _Time.y * float3(0,0,0) * rainSpeed45_g67 ) ) / streakTiling50_g67 );
			float streakLength8_g65 = _StreakLength;
			float streakLength52_g67 = streakLength8_g65;
			float3 appendResult13_g67 = (float3(break59_g67.x , ( break59_g67.y / streakLength52_g67 ) , break59_g67.z));
			float2 temp_output_29_0_g67 = (appendResult13_g67).xy;
			float3 break24_g67 = appendResult13_g67;
			float2 appendResult28_g67 = (float2(break24_g67.z , break24_g67.y));
			float3 ase_worldNormal = WorldNormalVector( i, float3( 0, 0, 1 ) );
			float temp_output_30_0_g67 = saturate( abs( ase_worldNormal.x ) );
			float lerpResult36_g67 = lerp( SAMPLE_TEXTURE2D( _RainPattern, sampler_RainPattern, temp_output_29_0_g67 ).g , SAMPLE_TEXTURE2D( _RainPattern, sampler_RainPattern, appendResult28_g67 ).g , temp_output_30_0_g67);
			float3 temp_output_19_0_g67 = ( ( appendResult13_g67 * float3( 1,0.5,1 ) ) + ( _Time.y * float3(0,1,0) * rainSpeed45_g67 ) );
			float3 break20_g67 = temp_output_19_0_g67;
			float2 appendResult22_g67 = (float2(break20_g67.z , break20_g67.y));
			float lerpResult34_g67 = lerp( SAMPLE_TEXTURE2D( _RainPattern, sampler_RainPattern, (temp_output_19_0_g67).xy ).b , SAMPLE_TEXTURE2D( _RainPattern, sampler_RainPattern, appendResult22_g67 ).b , temp_output_30_0_g67);
			float temp_output_40_0_g67 = saturate( ( ( lerpResult36_g67 - pow( lerpResult34_g67 , 4.0 ) ) * 5.0 ) );
			float2 worldUVs114_g66 = (ase_worldPos).xz;
			float2 temp_output_20_0_g66 = (worldUVs114_g66*_RainPattern_ST.xy + ( _RainPattern_ST.zw + float2( 0,0 ) ));
			float rainSpeed60_g66 = rainSpeed10_g65;
			float temp_output_19_0_g66 = ( ( _Time.y + 0.0 ) * rainSpeed60_g66 );
			float temp_output_25_0_g66 = ( (SAMPLE_TEXTURE2D( _RainPattern, sampler_RainPattern, temp_output_20_0_g66 )).r - ( 1.0 - frac( temp_output_19_0_g66 ) ) );
			float smoothstepResult11_g66 = smoothstep( 0.0 , 1.0 , ( distance( temp_output_25_0_g66 , 0.05 ) / max( 0.05 , saturate( fwidth( temp_output_25_0_g66 ) ) ) ));
			float rainTime29_g66 = temp_output_19_0_g66;
			float temp_output_12_0_g66 = abs( sin( ( rainTime29_g66 * UNITY_PI ) ) );
			float2 temp_output_41_0_g66 = (worldUVs114_g66*_RainPattern_ST.xy + ( _RainPattern_ST.zw + 0.1 ));
			float temp_output_40_0_g66 = ( ( _Time.y + 0.5 ) * rainSpeed60_g66 );
			float temp_output_45_0_g66 = ( (SAMPLE_TEXTURE2D( _RainPattern, sampler_RainPattern, temp_output_41_0_g66 )).r - ( 1.0 - frac( temp_output_40_0_g66 ) ) );
			float smoothstepResult65_g66 = smoothstep( 0.0 , 1.0 , ( distance( temp_output_45_0_g66 , 0.05 ) / max( 0.05 , saturate( fwidth( temp_output_45_0_g66 ) ) ) ));
			float rainTime246_g66 = temp_output_40_0_g66;
			float rainAxis12_g65 = saturate( newWorldNormal2_g65.y );
			float lerpResult23_g65 = lerp( temp_output_40_0_g67 , ( ( ( 1.0 - smoothstepResult11_g66 ) * temp_output_12_0_g66 ) + ( ( 1.0 - smoothstepResult65_g66 ) * abs( sin( ( rainTime246_g66 * UNITY_PI ) ) ) ) ) , rainAxis12_g65);
			float rainMask26_g65 = ( noRainArea17_g65 * lerpResult23_g65 * _RainFade );
			float rainMask469 = rainMask26_g65;
			float surfaceLevel165 = saturate( ( tex2DNode96.r + _SurfaceLevelTweak + rainMask469 ) );
			...
			#endif
			float3 lerpResult57_g67 = lerp( UnpackNormal( SAMPLE_TEXTURE2D( _DropletNormals, sampler_DropletNormals, temp_output_29_0_g67 ) ) , UnpackNormal( SAMPLE_TEXTURE2D( _DropletNormals, sampler_DropletNormals, appendResult28_g67 ) ) , temp_output_30_0_g67);
			float3 lerpResult58_g67 = lerp( float3( 0,0,1 ) , lerpResult57_g67 , temp_output_40_0_g67);
			float3 rippleNormalsSample1101_g66 = UnpackNormal( SAMPLE_TEXTURE2D( _RippleNormals, sampler_RippleNormals, temp_output_20_0_g66 ) );
			float3 rippleNormalsSample2104_g66 = UnpackNormal( SAMPLE_TEXTURE2D( _RippleNormals, sampler_RippleNormals, temp_output_41_0_g66 ) );
			float3 lerpResult111_g66 = lerp( rippleNormalsSample1101_g66 , rippleNormalsSample2104_g66 , temp_output_12_0_g66);
			float3 lerpResult21_g65 = lerp( lerpResult58_g67 , lerpResult111_g66 , rainAxis12_g65);
			float3 rainNormals24_g65 = lerpResult21_g65;
			float3 rainNormals468 = rainNormals24_g65;
			float3 lerpResult473 = lerp( staticSwitch401 , BlendNormals( staticSwitch401 , rainNormals468 ) , rainMask469);
			float3 normalMap87 = lerpResult473;
			float3 newWorldNormal414 = (WorldNormalVector( i , normalMap87 ));
			...
			float surfaceSmoothness166 = saturate( ( ( _SurfaceSmoothness * saturate( ( _SurfaceSmoothnessTweak + tex2DNode96.r ) ) ) + rainMask469 ) );
...
/*ASEBEGIN
Version=18909
2132;-7;1713;2120;4434.11;1184.136;1;True;False
Node;AmplifyShaderEditor.CommentaryNode;103;-4625.976,-676.8352;Inherit;False;2091.764;516.8967;Normal Map;16;28;87;206;137;415;414;401;9;402;30;153;472;471;473;470;475;;0.1215686,0.3254902,0.6509804,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;466;913.8393,-556.4202;Inherit;False;489.7418;255.0002;Rain System;3;469;468;467;;0.8235295,0.3294118,0,1;0;0
...
Node;AmplifyShaderEditor.FunctionNode;467;963.8393,-480.063;Inherit;False;RainMain;22;;65;5afea9810a4777e4aaf04a945a148144;0;0;2;FLOAT;0;FLOAT3;31
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;468;1159.022,-416.4203;Inherit;False;rainNormals;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;469;1160.581,-506.4201;Inherit;False;rainMask;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;471;-3819.216,-570.4575;Inherit;False;468;rainNormals;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.BlendNormalsNode;472;-3614.216,-500.4575;Inherit;False;0;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;470;-3596.216,-608.4575;Inherit;False;469;rainMask;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;473;-3367.216,-456.4575;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;87;-3204.169,-456.9276;Float;False;normalMap;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;475;-3575.216,-325.4575;Inherit;False;87;normalMap;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.WorldNormalVector;414;-3351.699,-318.8025;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.NegateNode;415;-3107.456,-236.257;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SwitchByFaceNode;137;-2965.574,-321.0783;Inherit;False;2;0;FLOAT3;1,1,1;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;206;-2739.26,-251.6584;Inherit;False;worldNormal;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.CommentaryNode;257;-1707.561,1725.809;Inherit;False;1290.449;661.2965;Surface Mask;15;165;146;166;149;151;148;150;143;152;144;96;476;478;480;481;;0.1215686,0.3254902,0.6509804,1;0;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;152;-1271.061,2158.611;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;150;-1131.945,2166.177;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;478;-1022.623,2259.566;Inherit;False;469;rainMask;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;149;-993.9457,2138.177;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;476;-1532.557,1808.759;Inherit;False;469;rainMask;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;480;-866.2539,2151.573;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;151;-1257.561,1897.809;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;304;-1224.051,2532.897;Inherit;True;Property;_DFG;DFG;31;1;[HideInInspector];Create;True;0;0;0;False;1;NonModifiableTextureData;False;-1;6489e9ca11fba6e4c8825c44b14636e3;6489e9ca11fba6e4c8825c44b14636e3;True;0;False;white;Auto;False;Object;-1;MipLevel;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.OneMinusNode;39;100.2235,-525.2184;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;481;-815.2539,2290.573;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;166;-665.0894,2269.734;Inherit;False;surfaceSmoothness;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;379;-3980.941,1097.005;Inherit;False;Property;_LTCGI;LTCGI;34;0;Create;True;0;0;0;True;1;LTCGI(_LTCGI);False;0;0;0;True;_LTCGI;Toggle;2;Key0;Key1;Create;True;False;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.IntNode;113;1210.002,-130.5897;Float;False;Property;_CullMode;Cull Mode;32;1;[Enum];Create;True;1;;0;1;UnityEngine.Rendering.CullMode;True;1;HeaderEx(System Options);False;2;2;False;0;1;INT;0
...
Node;AmplifyShaderEditor.IntNode;371;1132.374,-211.5427;Float;False;Property;_ZWrite;ZWrite (for solid glass);33;0;Create;False;0;0;1;UnityEngine.Rendering.CullMode;True;1;ToggleUI;False;0;0;False;0;1;INT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;252;-4528.265,24.38753;Inherit;False;Property;_DitheredRefraction;Dithered Refraction;30;0;Create;True;0;0;0;False;1;ToggleUI;False;0;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=96A11DBBB1FBE6B930A64C2CAF9414160F037E6D