...
float3 calculateEmissionNew(in float3 baseColor, inout float4 finalColor)
{
    ...
    #endif
    float glowInTheDarkMultiplier0 = calculateGlowInTheDark((0.0 /*_GITDEMinLight*/), (1.0 /*_GITDEMaxLight*/), (1.0 /*_GITDEMinEmissionMultiplier*/), (0.0 /*_GITDEMaxEmissionMultiplier*/), (1.0 /*_EnableGITDEmission*/), (0.0 /*_GITDEWorldOrMesh*/));
    #if defined(PROP_EMISSIONMAP) || !defined(OPTIMIZER_ENABLED)
