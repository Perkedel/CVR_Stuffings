...
{
	half3 mainNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN(_BumpMap, _MainTex, poiMesh.uv[(0.0 /*_BumpMapUV*/)], float4(0,0,0,0)), (1.0 /*_BumpScale*/));
	#ifdef FINALPASS
		#if defined(PROP_DETAILMASK) || !defined(OPTIMIZER_ENABLED)
			detailMask = POI2D_SAMPLER_PAN(_DetailMask, _MainTex, poiMesh.uv[(0.0 /*_DetailMaskUV*/)], float4(0,0,0,0)).rgb;
		#else
			detailMask = 1;
		#endif
		
		if ((0.0 /*_DetailNormalMapScale*/) > 0)
		{
			#if defined(PROP_DETAILNORMALMAP) || !defined(OPTIMIZER_ENABLED)
				half3 detailNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN(_DetailNormalMap, _MainTex, poiMesh.uv[(0.0 /*_DetailNormalMapUV*/)], float4(0,0,0,0)), (0.0 /*_DetailNormalMapScale*/) * detailMask.g);
