...
Shader "Furality/Luma Avatar Shader"
{
	Properties
	{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float3 appendResult432 = (float3(tex2DNode34.xy , ( tex2DNode34.b * i.ASEVFace )));
			float3 Normal49 = appendResult432;
			UnityGI gi47 = gi;
			...
			#endif //aseld
			float dotResult2 = dot( (WorldNormalVector( i , appendResult432 )) , ase_worldlightDir );
			...
			float4 Albedo59 = ( _Color * tex2D( _MainTex, uv_MainTex ) );
			float MetallicExists415 = step( max( _Metallic_TexelSize.z , _Metallic_TexelSize.w ) , 1.0 );
			float temp_output_260_0 = ( ( MetallicExists415 + tex2D( _Metallic, uv_MainTex ).r ) * _Metalness );
			float Metalness424 = temp_output_260_0;
			float3 indirectNormal60 = WorldNormalVector( i , Normal49 );
			float4 tex2DNode65 = tex2D( _Metallic, uv_MainTex );
			float temp_output_200_0 = ( ( tex2DNode65.a + MetallicExists415 ) * _Smoothness );
			...
			c.rgb = ( ( float4( LightingColored55 , 0.0 ) * ( Albedo59 * ( 1.0 - Metalness424 ) ) ) + float4( IndirectLighting79 , 0.0 ) ).rgb;
			c.a = 1;
			return c;
		}
		...
		void surf( Input i , inout SurfaceOutputCustomLightingCustom o )
		{
			...
			float4 tex2DNode373 = tex2D( _Mask, uv_TexCoord272 );
...
/*ASEBEGIN
Version=18906
257.3333;536;1834;620;560.4722;2107.521;1.3;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;28;-4185.894,141.9583;Inherit;False;2638.98;576.8051;Calculate Shading;31;157;20;49;154;22;21;16;36;9;4;153;6;2;3;1;34;150;33;57;149;152;151;35;147;158;160;195;394;430;431;432;;1,1,1,1;0;0
Node;AmplifyShaderEditor.GetLocalVarNode;147;-4286.313,609.4386;Inherit;False;43;ShadingStyle;1;0;OBJECT;;False;1;INT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;35;-4341.202,465.0427;Inherit;False;Property;_NormalScale;     Normal Scale;4;0;Create;True;0;0;0;False;0;False;1;0.074;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;151;-4005.943,614.0349;Inherit;False;2;0;INT;0;False;1;INT;1;False;1;INT;0
Node;AmplifyShaderEditor.SaturateNode;152;-3856.56,611.7366;Inherit;False;1;0;INT;0;False;1;INT;0
Node;AmplifyShaderEditor.Vector2Node;394;-4316.072,289.2042;Inherit;False;Property;_NormalTiling;     Normal Tiling;5;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;149;-4003.643,524.4057;Inherit;False;2;2;0;FLOAT;0.2;False;1;FLOAT;0.7;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;57;-3897.556,313.1165;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.GetLocalVarNode;33;-3787.534,220.7551;Inherit;False;31;NormalTex;1;0;OBJECT;;False;1;SAMPLER2D;0
Node;AmplifyShaderEditor.LerpOp;150;-3711.772,470.3988;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FaceVariableNode;431;-3451.502,462.3201;Inherit;False;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;34;-3545.214,236.7137;Inherit;True;Property;_TextureSample0;Texture Sample 0;4;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;430;-3226.973,345.9977;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.DynamicAppendNode;432;-3080.895,283.7786;Inherit;False;FLOAT3;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.WorldNormalVector;3;-2935.561,303.5149;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.WorldSpaceLightDirHlpNode;1;-2942.421,441.8257;Inherit;False;True;1;0;FLOAT;0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SaturateNode;403;-1901.686,-664.8754;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.DotProductOpNode;2;-2638.162,336.7148;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ScaleAndOffsetNode;6;-2221.7,290.8405;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0.5;False;2;FLOAT;0.5;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;36;-2579.201,541.249;Inherit;False;Constant;_Vector1;Vector 1;1;1;[RemapSliders];Create;True;0;0;0;False;0;False;0,0.05362779;0,0.05362779;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;153;-2379.09,413.4496;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;9;-2194.202,199.3405;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;62;-4366.274,1317.518;Inherit;True;Property;_Metallic;;6;3;[Header];[NoScaleOffset];[SingleLineTexture];Create;False;1;Metallic;0;0;False;0;False;None;36689d4181ca3504fb09048e23c695a0;False;black;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.SmoothstepOpNode;16;-2205.128,410.5243;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;4;-1994.199,293.4404;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;154;-2029.16,412.8099;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;22;-1830.464,191.9583;Inherit;False;Lambert;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;21;-1833.065,286.8582;Inherit;False;HalfLambert;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;49;-2938.755,196.8105;Inherit;False;Normal;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SaturateNode;157;-1909.099,412.1451;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;20;-1759.795,406.2121;Inherit;False;ToonShading;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;415;-3685.301,1456.597;Inherit;False;MetallicExists;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;58;-331.1064,-28.23487;Inherit;False;0;39;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;45;-295.852,-110.0051;Inherit;False;38;MainTex;1;0;OBJECT;;False;1;SAMPLER2D;0
...
Node;AmplifyShaderEditor.ColorNode;269;-33.75408,-277.1487;Inherit;False;Property;_Color;     Color;2;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,0.7499998,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.GetLocalVarNode;417;-2191.094,992.343;Inherit;False;415;MetallicExists;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;46;-93.8521,-111.0051;Inherit;True;Property;;;4;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;202;-2169.137,1073.205;Inherit;False;Property;_Smoothness;     Smoothness;9;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;270;243.2044,-123.988;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;59;443.3597,-89.27107;Inherit;False;Albedo;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;422;-1478.744,1420.91;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;264;-1216.167,1113.943;Inherit;False;2;2;0;FLOAT;0.05;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;255;-1795.214,1621.726;Inherit;False;Property;_Metalness;     Metalness;7;0;Create;False;0;0;0;False;0;False;0;0.952;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;373;41.56404,-1777.056;Inherit;True;Property;_Mask;Mask;12;2;[NoScaleOffset];[SingleLineTexture];Create;True;0;0;0;False;0;False;-1;None;36689d4181ca3504fb09048e23c695a0;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;260;-1310.296,1390.864;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;424;-1038.075,1423.388;Inherit;False;Metalness;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;254;-1032.275,1225.23;Inherit;False;3;0;FLOAT3;1,1,1;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.ColorNode;311;524.9701,-1541.638;Inherit;False;Property;_EmissionTint;     Emission Tint;13;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.GetLocalVarNode;425;-281.307,89.73565;Inherit;False;424;Metalness;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;426;-57.30696,88.73565;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;427;678.3306,-78.0432;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;206;128.9443,290.6017;Inherit;False;Constant;_Float1;Float 1;16;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.WorldSpaceLightPos;195;-4178.717,194.2072;Inherit;False;0;3;FLOAT4;0;FLOAT3;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleMinOpNode;160;-2473.831,185.9895;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;181;-1296.623,2005.489;Inherit;False;Property;_SpecularColorRGBSpecularIntensityA;Specular Color(RGB) Specular Intensity(A);8;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,1;0.7490196,0.7490196,0.7490196,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMaxOpNode;376;632.064,-1699.056;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;429;20.95569,199.7936;Inherit;False;-1;;1;0;OBJECT;;False;1;OBJECT;0
...
Node;AmplifyShaderEditor.ComponentMaskNode;183;-911.2469,1992.643;Inherit;False;True;True;True;False;1;0;COLOR;0,0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.LightAttenuation;158;-2710.592,245.334;Inherit;False;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;1655.68,-327.4505;Float;False;True;-1;2;ASEMaterialInspector;0;0;CustomLighting;Furality/Luma Avatar Shader;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;All;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;0;0;True;388;-1;0;True;396;0;0;0;False;0.1;False;-1;0;False;-1;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=0E276CDD18B393302726BF71BB8525F3F6D55B1B