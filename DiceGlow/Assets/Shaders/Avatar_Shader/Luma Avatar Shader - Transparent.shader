...
Shader "Furality/Luma Avatar Shader - Transparent"
{
	Properties
	{
		...
		[Header(Metallic)][NoScaleOffset][SingleLineTexture]_Metallic("", 2D) = "black" {}
		...
		[Header(Misc)][Enum(Off,0,Front,1,Back,2)]_Culling("     Culling", Float) = 2
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float MetallicExists416 = step( max( _Metallic_TexelSize.z , _Metallic_TexelSize.w ) , 1.0 );
			float temp_output_260_0 = ( ( MetallicExists416 + tex2D( _Metallic, uv_MainTex ).r ) * _Metalness );
			float Metalness420 = temp_output_260_0;
			float3 indirectNormal60 = WorldNormalVector( i , Normal49 );
			float4 tex2DNode65 = tex2D( _Metallic, uv_MainTex );
			float temp_output_200_0 = ( ( MetallicExists416 + tex2DNode65.a ) * _Smoothness );
			...
			float3 lerpResult254 = lerp( float3( 1,1,1 ) , (Albedo59).rgb , temp_output_260_0);
			float3 ase_worldViewDir = normalize( UnityWorldSpaceViewDir( ase_worldPos ) );
			float fresnelNdotV75 = dot( (WorldNormalVector( i , Normal49 )), ase_worldViewDir );
			float fresnelNode75 = ( saturate( ( 0.05 + temp_output_200_0 ) ) + temp_output_200_0 * pow( 1.0 - fresnelNdotV75, 5.0 ) );
			float3 IndirectLighting79 = ( ( indirectSpecular60 * lerpResult254 ) * saturate( fresnelNode75 ) );
			c.rgb = ( ( float4( LightingColored55 , 0.0 ) * ( Albedo59 * ( 1.0 - Metalness420 ) ) ) + float4( IndirectLighting79 , 0.0 ) ).rgb;
			c.a = ( _Opacity * tex2DNode46.a );
			return c;
		}
...
/*ASEBEGIN
Version=18906
257.3333;536;1834;620;632.6313;2138.961;1.615531;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;32;-4439.199,773.8618;Inherit;False;769.4817;1684.206;Texture Assignments;15;105;104;38;39;68;67;63;62;31;30;108;109;413;414;415;;1,1,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;35;-4010.69,461.7375;Inherit;False;Property;_NormalScale;     Normal Scale;5;0;Create;True;0;0;0;False;0;False;1;0.074;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;151;-3675.425,610.7297;Inherit;False;2;0;INT;0;False;1;INT;1;False;1;INT;0
Node;AmplifyShaderEditor.TexturePropertyNode;30;-4351.033,823.8618;Inherit;True;Property;_Normal;;4;3;[Header];[Normal];[SingleLineTexture];Create;False;1;Normals;0;0;False;0;False;None;None;True;bump;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.Vector2Node;394;-3985.559,285.899;Inherit;False;Property;_NormalTiling;     Normal Tiling;6;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.TexturePropertyNode;39;-4355.687,1066.58;Inherit;True;Property;_MainTex;Main Texture;1;1;[Header];Create;False;1;Main;0;0;False;0;False;None;36689d4181ca3504fb09048e23c695a0;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.FaceVariableNode;426;-3172.289,122.0245;Inherit;False;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;425;-2947.76,5.702087;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.DynamicAppendNode;424;-2801.682,-56.51703;Inherit;False;FLOAT3;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;62;-4366.274,1317.518;Inherit;True;Property;_Metallic;;7;3;[Header];[NoScaleOffset];[SingleLineTexture];Create;False;1;Metallic;0;0;False;0;False;None;36689d4181ca3504fb09048e23c695a0;False;black;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.TexelSizeNode;413;-4141.496,1402.606;Inherit;False;-1;1;0;SAMPLER2D;;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMaxOpNode;414;-3951.013,1473.785;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;81;-2208.291,765.8812;Inherit;False;2042.179;619.1633;Indirect Specular;26;69;70;73;71;77;64;76;72;61;75;60;78;79;65;199;200;202;254;258;253;262;265;264;310;410;418;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;67;-4363.791,1578.533;Inherit;True;Property;_Occlusion;;18;3;[Header];[NoScaleOffset];[SingleLineTexture];Create;False;1;Ambient Occlusion;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;63;-4076.274,1312.518;Inherit;False;MetallicTex;-1;True;1;0;SAMPLER2D;;False;1;SAMPLER2D;0
Node;AmplifyShaderEditor.StepOpNode;415;-3820.779,1472.607;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;416;-3704.362,1467.932;Inherit;False;MetallicExists;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;58;-395.5064,0.9651321;Inherit;False;0;39;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.GetLocalVarNode;64;-2158.291,897.9981;Inherit;False;63;MetallicTex;1;0;OBJECT;;False;1;SAMPLER2D;0
Node;AmplifyShaderEditor.GetLocalVarNode;45;-360.252,-80.80508;Inherit;False;38;MainTex;1;0;OBJECT;;False;1;SAMPLER2D;0
...
Node;AmplifyShaderEditor.SamplerNode;46;-158.2521,-81.80508;Inherit;True;Property;;;4;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.GetLocalVarNode;418;-2119.986,999.2488;Inherit;False;416;MetallicExists;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;269;-214.9541,-268.7487;Inherit;False;Property;_Color;     Color;2;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,0.7490196,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;417;-1557.51,1031.087;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;95;-3269.698,1422.29;Inherit;False;Property;_OcclusionPower;     Occlusion Power;19;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;202;-2169.137,1073.205;Inherit;False;Property;_Smoothness;     Smoothness;10;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;270;178.8044,-94.78796;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SamplerNode;256;-1877.139,1460.519;Inherit;True;Property;_TextureSample9;Texture Sample 9;18;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;200;-1404.866,1059.971;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;59;338.4807,-72.02603;Inherit;False;Albedo;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;255;-1900.333,1714.583;Inherit;False;Property;_Metalness;     Metalness;8;0;Create;False;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;264;-949.4152,1131.293;Inherit;False;2;2;0;FLOAT;0.05;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;397;-527.6939,-1972.679;Inherit;False;Property;_EmissionTiling;     Emission Tiling;16;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.TexturePropertyNode;104;-4368.32,1875.739;Inherit;True;Property;_Emission;;12;2;[Header];[SingleLineTexture];Create;False;1;Emission;0;0;False;0;False;None;36689d4181ca3504fb09048e23c695a0;False;black;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;275;350.4601,-986.7307;Inherit;False;Property;_MinEmission;     Min Emission;15;0;Create;True;0;0;0;False;0;False;0;0;0;3;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;419;-1499.723,1492.023;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;260;-1281.818,1512.349;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;373;41.56404,-1777.056;Inherit;True;Property;_Mask;Mask;13;2;[NoScaleOffset];[SingleLineTexture];Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;273;-224.3388,-1857.64;Inherit;False;Property;_EmissionPanDirection;     Emission Pan Direction;17;0;Create;True;0;0;0;False;0;False;0,0;0,0.01;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.SamplerNode;70;-1920.369,1155.044;Inherit;True;Property;_TextureSample2;Texture Sample 2;5;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SaturateNode;265;-702.415,1144.193;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;420;-1010.794,1496.494;Inherit;False;Metalness;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMaxOpNode;374;372.064,-1756.256;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;254;-1032.275,1225.23;Inherit;True;3;0;FLOAT3;1,1,1;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;421;127.3769,129.5167;Inherit;False;420;Metalness;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;346;1122.534,-1123.536;Inherit;False;326;IsActive;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;311;524.9701,-1541.638;Inherit;False;Property;_EmissionTint;     Emission Tint;14;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,0;0.4716981,0.4716981,0.4716981,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.OneMinusNode;422;312.9767,132.7167;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;423;573.7771,-97.68332;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.CommentaryNode;197;-2189.601,2039.884;Inherit;False;2052.868;519.6117;Blinn-Phong;19;163;162;164;165;172;177;178;179;176;170;171;181;183;182;184;173;198;266;267;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;389;2794.719,-285.269;Inherit;False;250.3334;266;DO NOT DELETE;1;388;;1,1,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;408;1062.362,-183.1654;Inherit;False;Property;_Opacity;     Opacity;3;0;Create;True;0;0;0;False;0;False;1;0.578;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;267;-572.1853,2462.125;Inherit;False;Constant;_Float4;Float 4;18;0;Create;True;0;0;0;False;0;False;8;8;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;409;1307.458,-3.324493;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;410;-1847.38,1093.828;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;73;-1485.369,1245.044;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;309;1137.073,-460.678;Inherit;False;Property;_Vector10;Vector 10;27;0;Create;True;0;0;0;False;0;False;-0.7,0;-0.7,-0.01;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;182;-590.6491,2252.651;Inherit;False;4;4;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;3;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;178;-993.0116,2238.296;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;128;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ComponentMaskNode;183;-909.1161,2339.65;Inherit;False;True;True;True;False;1;0;COLOR;0,0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;177;-1297.011,2270.296;Float;False;Property;_Shininess;Shininess;11;0;Create;True;0;0;0;False;0;False;0.1;0.5994547;0.01;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;330;3117.878,-502.2151;Inherit;False;Property;_Vector13;Vector 13;22;0;Create;True;0;0;0;False;0;False;-0.709,-0.01;-0.72,-0.01;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.ClampOpNode;384;1090.473,-1506.088;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0.1,0,0,0;False;2;COLOR;1,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.Vector2Node;347;3747.564,-1193.181;Inherit;False;Property;_Vector14;Vector 14;21;0;Create;True;0;0;0;False;0;False;-0.72,-0.01;-0.73,-0.01;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.OneMinusNode;392;713.8572,1122.279;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;173;-385.3989,2253.279;Inherit;False;Specular;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.Vector2Node;118;349.0277,712.5345;Inherit;False;Property;_Vector2;Vector 2;24;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.GetLocalVarNode;171;-2090.344,2377.149;Inherit;False;49;Normal;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.WorldNormalVector;170;-1707.559,2238.09;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.ClampOpNode;266;-410.7369,2383.194;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;1,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;164;-1859.369,2153.884;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMaxOpNode;72;-1424.369,1158.044;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;179;-833.0114,2174.296;Inherit;True;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;304;716.9474,-551.7731;Inherit;False;Property;_Vector8;Vector 8;26;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RGBToHSVNode;385;741.6179,-1612.489;Inherit;False;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;388;2844.719,-235.2691;Inherit;False;Property;_Culling;     Culling;30;2;[Header];[Enum];Create;True;1;Misc;3;Off;0;Front;1;Back;2;0;True;0;False;2;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;307;2508.194,-454.2403;Inherit;False;Property;_Vector9;Vector 9;28;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.SimpleMaxOpNode;176;-1176.914,2163.527;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;213;-1274.644,-885.2482;Inherit;False;Property;_ZoneSelect;ZoneSelect;25;1;[Enum];Create;True;0;4;Zone01;0;Zone02;1;Zone03;2;Zone04;3;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;108;-4387.497,2189.223;Inherit;True;Property;_VideoTest;VideoTest;20;0;Create;True;0;0;0;False;0;False;None;5085477d40b8bdc489a8c7a93f30f8bb;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.ColorNode;181;-1294.492,2352.496;Inherit;False;Property;_SpecularColorRGBSpecularIntensityA;Specular Color(RGB) Specular Intensity(A);9;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,1;0.7490196,0.7490196,0.7490196,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector2Node;328;3130.172,-1098.828;Inherit;False;Property;_Vector12;Vector 12;29;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.WireNode;184;-687.2787,2442.511;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.NormalizeNode;165;-1699.369,2153.884;Inherit;False;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;198;-1579.736,2434.41;Inherit;False;199;Smoothness;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.DotProductOpNode;172;-1420.066,2165.666;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.WorldSpaceLightDirHlpNode;162;-2139.601,2238.783;Inherit;False;True;1;0;FLOAT;0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.ViewDirInputsCoordNode;163;-2115.369,2089.884;Float;False;World;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.Vector2Node;117;347.9789,566.8648;Inherit;False;Property;_Vector0;Vector 0;23;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.HSVToRGBNode;386;1323.773,-1557.547;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;1655.68,-327.4505;Float;False;True;-1;2;ASEMaterialInspector;0;0;CustomLighting;Furality/Luma Avatar Shader - Transparent;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;True;0;Transparent;0.5;True;True;0;False;Transparent;;Transparent;All;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;2;5;False;-1;10;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;0;0;True;388;-1;0;True;396;0;0;0;False;0.1;False;-1;0;False;-1;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;414;0;413;3
WireConnection;414;1;413;4
...
WireConnection;0;9;409;0
WireConnection;0;13;74;0
ASEEND*/
//CHKSM=746ECB910E085D4DA1F3E32F48F4F15A015007C5