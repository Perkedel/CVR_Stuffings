Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Pro/211d1cbe21bb38943b3c06820177f255"
{
	Properties
	{
 ...
 #define POI_VERTEXLIGHT_ON 
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				if (float(0))
				{
					mainUV = sharpSample(float4(0.000390625,0.0007575757,2560,1320), mainUV);
				}
				float4 mainTexture = UNITY_SAMPLE_TEX2D(_MainTex, poiUV(mainUV, float4(-1,1,1,0)) + _Time.x * float4(0,0,0,0));
