...
Shader "Furality/Sylva Shader/Sylva Cutout Outline"
{
	Properties
	{
	...
	SubShader
	{
		...
		void outlineVertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			int temp_output_18_0_g4562 = _OutlineMaskingChannel;
			float lerpResult1_g4562 = lerp( 1.0 , break1044.r , (float)saturate( temp_output_18_0_g4562 ));
			int temp_output_5_0_g4562 = ( temp_output_18_0_g4562 - 1 );
			float lerpResult12_g4562 = lerp( lerpResult1_g4562 , break1044.g , (float)saturate( temp_output_5_0_g4562 ));
			int temp_output_6_0_g4562 = ( temp_output_5_0_g4562 - 1 );
			float lerpResult10_g4562 = lerp( lerpResult12_g4562 , break1044.b , (float)saturate( temp_output_6_0_g4562 ));
			float lerpResult11_g4562 = lerp( lerpResult10_g4562 , break1044.a , (float)saturate( ( temp_output_6_0_g4562 - 1 ) ));
			float temp_output_1042_0 = lerpResult11_g4562;
		...
		void outlineSurf( Input i, inout SurfaceOutput o )
		{
			...
			float3 temp_output_229_0_g5052 = OutlineRGB788.rgb;
			int EmissionReactiveBand236_g5052 = _OutlineReactiveBand;
			int Band3_g5053 = EmissionReactiveBand236_g5052;
			int Delay3_g5053 = 0;
			float localAudioLinkData3_g5053 = AudioLinkData3_g5053( Band3_g5053 , Delay3_g5053 );
			int temp_output_64_0_g5052 = step( _OutlineReactiveBand , 9 );
			float lerpResult66_g5052 = lerp( 1.0 , localAudioLinkData3_g5053 , (float)temp_output_64_0_g5052);
			int Band3_g5055 = _OutlineReactiveBand;
			float cos78_g5052 = cos( radians( _OutlineReactivePulseDir ) );
			float sin78_g5052 = sin( radians( _OutlineReactivePulseDir ) );
			float2 rotator78_g5052 = mul( i.uv_texcoord - float2( 0.5,0.5 ) , float2x2( cos78_g5052 , -sin78_g5052 , sin78_g5052 , cos78_g5052 )) + float2( 0.5,0.5 );
			float x96_g5052 = ( ( rotator78_g5052.x * _OutlineReactivePulseScale ) + _OutlineReactivePulseOffset );
			float y96_g5052 = 127.0;
			float localglslmod96_g5052 = glslmod96_g5052( x96_g5052 , y96_g5052 );
			float2 CenteredUV15_g5056 = ( i.uv_texcoord - _OutlineReactiveRadialCenter );
			float2 break17_g5056 = CenteredUV15_g5056;
			float2 appendResult23_g5056 = (float2(( length( CenteredUV15_g5056 ) * _OutlineReactivePulseScale * 2.0 ) , ( atan2( break17_g5056.x , break17_g5056.y ) * ( 1.0 / 6.28318548202515 ) * 1.0 )));
			float x97_g5052 = ( _OutlineReactivePulseOffset + appendResult23_g5056.x );
			float y97_g5052 = 127.0;
			float localglslmod97_g5052 = glslmod97_g5052( x97_g5052 , y97_g5052 );
			int EmissionReactiveMode99_g5052 = _OutlineReactiveMode;
			int temp_output_90_0_g5052 = ( EmissionReactiveMode99_g5052 - 1 );
			float lerpResult77_g5052 = lerp( localglslmod96_g5052 , localglslmod97_g5052 , (float)saturate( temp_output_90_0_g5052 ));
			...
			float temp_output_1189_244 = Direction27_g4913;
			float DirectionalMap106_g5052 = temp_output_1189_244;
			float lerpResult174_g5052 = lerp( DirectionalMap106_g5052 , ( 1.0 - DirectionalMap106_g5052 ) , (float)saturate( ( EmissionReactiveMode99_g5052 - 3 ) ));
			float x98_g5052 = ( _OutlineReactivePulseOffset + ( _OutlineReactivePulseScale * lerpResult174_g5052 ) );
			float y98_g5052 = 127.0;
			float localglslmod98_g5052 = glslmod98_g5052( x98_g5052 , y98_g5052 );
			float lerpResult87_g5052 = lerp( lerpResult77_g5052 , localglslmod98_g5052 , (float)saturate( ( temp_output_90_0_g5052 - 1 ) ));
			float Delay3_g5055 = lerpResult87_g5052;
			float localAudioLinkLerp3_g5055 = AudioLinkLerp3_g5055( Band3_g5055 , Delay3_g5055 );
			float lerpResult102_g5052 = lerp( 1.0 , localAudioLinkLerp3_g5055 , (float)temp_output_64_0_g5052);
			float lerpResult103_g5052 = lerp( lerpResult66_g5052 , lerpResult102_g5052 , (float)saturate( EmissionReactiveMode99_g5052 ));
			int Band3_g5057 = _OutlineReactiveBand;
			float FilteredAmount3_g5057 = ( ( 1.0 - _OutlineReactiveGlobalSmoothing ) * 15.0 );
			float localAudioLinkLerp3_g5057 = AudioLinkLerp3_g5057( Band3_g5057 , FilteredAmount3_g5057 );
			float lerpResult168_g5052 = lerp( 1.0 , localAudioLinkLerp3_g5057 , (float)temp_output_64_0_g5052);
			float lerpResult172_g5052 = lerp( lerpResult103_g5052 , lerpResult168_g5052 , (float)saturate( ( EmissionReactiveMode99_g5052 - 4 ) ));
			float ReactivityAlpha132_g5052 = (_OutlineReactiveMinBrightness + (lerpResult172_g5052 - 0.0) * (( _OutlineReactiveMinBrightness + 1.0 ) - _OutlineReactiveMinBrightness) / (1.0 - 0.0));
			float4 temp_cast_10 = (1.0).xxxx;
			float4 lerpResult240_g5052 = lerp( temp_cast_10 , _OutlineReactiveTint , (float)step( EmissionReactiveBand236_g5052 , 9 ));
			float4 FinalReactivity68_g5052 = ( ReactivityAlpha132_g5052 * lerpResult240_g5052 );
			float4 temp_cast_12 = (1.0).xxxx;
			float3 temp_cast_13 = (1.0).xxx;
			int EmissionGlowZone47_g5052 = _OutlineGlowZone;
			int clampResult8_g5059 = clamp( EmissionGlowZone47_g5052 , 1 , 4 );
			int temp_output_3_0_g5059 = ( clampResult8_g5059 - 1 );
			int Zone16_g5059 = temp_output_3_0_g5059;
			float3 localgetThemeData16_g5059 = getThemeData( Zone16_g5059 );
			int Band11_g5060 = 56;
			int localIsLumaActive11_g5060 = IsLumaActive11_g5060( Band11_g5060 );
			int temp_output_14_0_g5059 = localIsLumaActive11_g5060;
			int lerpResult15_g5059 = lerp( temp_output_3_0_g5059 , ( 63 - temp_output_3_0_g5059 ) , (float)temp_output_14_0_g5059);
			int Band2_g5059 = lerpResult15_g5059;
			int Delay2_g5059 = 0;
			float3 localLumaGlowData2_g5059 = LumaGlowData2_g5059( Band2_g5059 , Delay2_g5059 );
			float3 lerpResult17_g5059 = lerp( ( localgetThemeData16_g5059 * localLumaGlowData2_g5059 ) , localLumaGlowData2_g5059 , (float)temp_output_14_0_g5059);
			int temp_output_21_0_g5052 = saturate( EmissionGlowZone47_g5052 );
			float3 lerpResult20_g5052 = lerp( temp_cast_13 , lerpResult17_g5059 , (float)temp_output_21_0_g5052);
			float3 temp_cast_17 = (1.0).xxx;
			int clampResult8_g5061 = clamp( EmissionGlowZone47_g5052 , 1 , 4 );
			int temp_output_3_0_g5061 = ( clampResult8_g5061 - 1 );
			int Zone15_g5061 = temp_output_3_0_g5061;
			float3 localgetThemeData15_g5061 = getThemeData( Zone15_g5061 );
			int Band11_g5062 = 56;
			int localIsLumaActive11_g5062 = IsLumaActive11_g5062( Band11_g5062 );
			int temp_output_13_0_g5061 = localIsLumaActive11_g5062;
			int lerpResult14_g5061 = lerp( temp_output_3_0_g5061 , ( 63 - temp_output_3_0_g5061 ) , (float)temp_output_13_0_g5061);
			int Band11_g5061 = lerpResult14_g5061;
			float cos6_g5052 = cos( radians( _OutlineGlowPulseDir ) );
			float sin6_g5052 = sin( radians( _OutlineGlowPulseDir ) );
			float2 rotator6_g5052 = mul( i.uv_texcoord - float2( 0.5,0.5 ) , float2x2( cos6_g5052 , -sin6_g5052 , sin6_g5052 , cos6_g5052 )) + float2( 0.5,0.5 );
			float x13_g5052 = ( ( rotator6_g5052.x * _OutlineGlowPulseScale ) + _OutlineGlowPulseOffset );
			float y13_g5052 = 127.0;
			float localglslmod13_g5052 = glslmod13_g5052( x13_g5052 , y13_g5052 );
			float2 CenteredUV15_g5054 = ( i.uv_texcoord - _OutlineGlowRadialCenter );
			float2 break17_g5054 = CenteredUV15_g5054;
			float2 appendResult23_g5054 = (float2(( length( CenteredUV15_g5054 ) * _OutlineGlowPulseScale * 2.0 ) , ( atan2( break17_g5054.x , break17_g5054.y ) * ( 1.0 / 6.28318548202515 ) * 1.0 )));
			float x12_g5052 = ( _OutlineGlowPulseOffset + appendResult23_g5054.x );
			float y12_g5052 = 127.0;
			float localglslmod12_g5052 = glslmod12_g5052( x12_g5052 , y12_g5052 );
			int EmissionGlowMode35_g5052 = _OutlineGlowMode;
			int temp_output_37_0_g5052 = ( EmissionGlowMode35_g5052 - 1 );
			float lerpResult5_g5052 = lerp( localglslmod13_g5052 , localglslmod12_g5052 , (float)saturate( temp_output_37_0_g5052 ));
			float lerpResult179_g5052 = lerp( DirectionalMap106_g5052 , ( 1.0 - DirectionalMap106_g5052 ) , (float)saturate( ( EmissionGlowMode35_g5052 - 3 ) ));
			float x34_g5052 = ( _OutlineGlowPulseOffset + ( _OutlineGlowPulseScale * lerpResult179_g5052 ) );
			float y34_g5052 = 127.0;
			float localglslmod34_g5052 = glslmod34_g5052( x34_g5052 , y34_g5052 );
			float lerpResult30_g5052 = lerp( lerpResult5_g5052 , localglslmod34_g5052 , (float)saturate( ( temp_output_37_0_g5052 - 1 ) ));
			float EmissionGlowDelay56_g5052 = lerpResult30_g5052;
			float Delay11_g5061 = EmissionGlowDelay56_g5052;
			float3 localLumaGlowLerp11_g5061 = LumaGlowLerp11_g5061( Band11_g5061 , Delay11_g5061 );
			float3 lerpResult17_g5061 = lerp( ( localgetThemeData15_g5061 * localLumaGlowLerp11_g5061 ) , localLumaGlowLerp11_g5061 , (float)temp_output_13_0_g5061);
			float3 lerpResult22_g5052 = lerp( temp_cast_17 , lerpResult17_g5061 , (float)temp_output_21_0_g5052);
			float3 lerpResult23_g5052 = lerp( lerpResult20_g5052 , lerpResult22_g5052 , (float)saturate( EmissionGlowMode35_g5052 ));
			float4 temp_cast_26 = (1.0).xxxx;
			float temp_output_10_0_g5063 = EmissionGlowDelay56_g5052;
			float Position1_g5065 = ( temp_output_10_0_g5063 / 127.0 );
			float4 localAudioLinkLerp1_g5065 = AudioLinkLerp1_g5065( Position1_g5065 );
			int clampResult8_g5063 = clamp( ( EmissionGlowZone47_g5052 - 4 ) , 1 , 3 );
			int Band11_g5063 = ( 59 - ( clampResult8_g5063 - 1 ) );
			float Delay11_g5063 = temp_output_10_0_g5063;
			float3 localLumaGlowLerp11_g5063 = LumaGlowLerp11_g5063( Band11_g5063 , Delay11_g5063 );
			int Band11_g5064 = 56;
			int localIsLumaActive11_g5064 = IsLumaActive11_g5064( Band11_g5064 );
			float4 lerpResult14_g5063 = lerp( localAudioLinkLerp1_g5065 , float4( localLumaGlowLerp11_g5063 , 0.0 ) , (float)localIsLumaActive11_g5064);
			float4 lerpResult52_g5052 = lerp( temp_cast_26 , lerpResult14_g5063 , (float)saturate( EmissionGlowZone47_g5052 ));
			float4 lerpResult51_g5052 = lerp( float4( lerpResult23_g5052 , 0.0 ) , lerpResult52_g5052 , (float)saturate( ( EmissionGlowZone47_g5052 - 4 ) ));
			float4 temp_cast_31 = (_OutlineGlowMinBrightness).xxxx;
			float4 temp_cast_32 = (( _OutlineGlowMinBrightness + 1.0 )).xxxx;
			int temp_output_234_0_g5052 = saturate( EmissionGlowZone47_g5052 );
			float4 EmissionGlow142_g5052 = ( (temp_cast_31 + (lerpResult51_g5052 - float4( 0,0,0,0 )) * (temp_cast_32 - temp_cast_31) / (float4( 1,1,1,1 ) - float4( 0,0,0,0 ))) * _OutlineGlowTint * temp_output_234_0_g5052 );
			float4 lerpResult248_g5052 = lerp( temp_cast_12 , EmissionGlow142_g5052 , (float)temp_output_234_0_g5052);
			float4 EmissionGlowTog250_g5052 = lerpResult248_g5052;
			float4 lerpResult146_g5052 = lerp( ( FinalReactivity68_g5052 * EmissionGlowTog250_g5052 ) , ( EmissionGlow142_g5052 + ( FinalReactivity68_g5052 * step( EmissionReactiveBand236_g5052 , 9 ) ) ) , (float)saturate( _OutlineReactiveBlendMode ));
			float4 ReversedReactivity152_g5052 = ( ( 1.0 - ReactivityAlpha132_g5052 ) * lerpResult240_g5052 );
			int temp_output_157_0_g5052 = ( _OutlineReactiveBlendMode - 1 );
			float4 lerpResult114_g5052 = lerp( lerpResult146_g5052 , ( EmissionGlowTog250_g5052 * ReversedReactivity152_g5052 ) , (float)saturate( temp_output_157_0_g5052 ));
			float4 lerpResult164_g5052 = lerp( lerpResult114_g5052 , ( EmissionGlow142_g5052 + ( ReversedReactivity152_g5052 * step( EmissionReactiveBand236_g5052 , 9 ) ) ) , (float)saturate( ( temp_output_157_0_g5052 - 1 ) ));
			int ReactiveBlendmode257_g5052 = _OutlineReactiveBlendMode;
			float x266_g5052 = (float)ReactiveBlendmode257_g5052;
			float y266_g5052 = 2.0;
			float localglslmod266_g5052 = glslmod266_g5052( x266_g5052 , y266_g5052 );
			float lerpResult253_g5052 = lerp( localglslmod266_g5052 , (float)_OutlineGlowBlendMode , (float)saturate( EmissionGlowZone47_g5052 ));
			float4 lerpResult222_g5052 = lerp( ( lerpResult164_g5052 * float4( temp_output_229_0_g5052 , 0.0 ) ) , ( lerpResult164_g5052 + float4( temp_output_229_0_g5052 , 0.0 ) ) , lerpResult253_g5052);
			float localIfAudioLinkv2Exists1_g5067 = IfAudioLinkv2Exists1_g5067();
			float4 lerpResult273_g5052 = lerp( float4( temp_output_229_0_g5052 , 0.0 ) , lerpResult222_g5052 , localIfAudioLinkv2Exists1_g5067);
			float4 OutlineGlow790 = lerpResult273_g5052;
			...
			clip( min( Alpha1147 , temp_output_1042_0 ) - _MaskClipValue );
		}
		ENDCG
		...
		inline int AudioLinkDecodeDataAsUInt6_g5011( int Band, int Mode )
		{
			return AudioLinkDecodeDataAsUInt( ALPASS_CHRONOTENSITY + int2(Mode, Band));
		}


		float IfAudioLinkv2Exists1_g5014(  )
		{
			int w = 0; 
			int h; 
			int res = 0;
		...
		float2 voronoihash2_g5083( float2 p )
		{
		...
		float voronoi2_g5083( float2 v, float time, inout float2 id, inout float2 mr, float smoothness, inout float2 smoothId )
		{
			float2 n = floor( v );
			float2 f = frac( v );
			float F1 = 8.0;
			...
			for ( int j = -1; j <= 1; j++ )
			{
				for ( int i = -1; i <= 1; i++ )
			 	{
			 		float2 g = float2( i, j );
			 		float2 o = voronoihash2_g5083( n + g );
		...
		inline int IsLumaActive11_g5092( int Band )
		{
			return AudioLinkData( ALPASS_AUDIOLINK + uint2( 0, Band ) ).r;
		}


		inline float3 LumaGlowData2_g5091( int Band, int Delay )
		{
			return AudioLinkData( ALPASS_AUDIOLINK + uint2( Delay, Band ) );
		}


		inline int IsLumaActive11_g5094( int Band )
		{
			return AudioLinkData( ALPASS_AUDIOLINK + uint2( 0, Band ) ).r;
		}


		inline int AudioLinkDecodeDataAsUInt6_g5098( int Band, int Mode )
		{
			return AudioLinkDecodeDataAsUInt( ALPASS_CHRONOTENSITY + int2(Mode, Band));
		}


		inline float glslmod13_g5085( float x, float y )
		{
			return glsl_mod(x,y);
		}


		inline float glslmod12_g5085( float x, float y )
		{
			return glsl_mod(x,y);
		}


		inline float glslmod34_g5085( float x, float y )
		{
			return glsl_mod(x,y);
		}


		inline float3 LumaGlowLerp11_g5093( int Band, float Delay )
		{
			return AudioLinkLerp( ALPASS_AUDIOLINK + float2( Delay, Band ) );
		}


		inline float4 AudioLinkLerp1_g5097( float Position )
		{
			return AudioLinkLerp( ALPASS_CCSTRIP + float2( Position * 128., 0 ) ).rgba;;
		}


		inline float3 LumaGlowLerp11_g5095( int Band, float Delay )
		{
			return AudioLinkLerp( ALPASS_AUDIOLINK + float2( Delay, Band ) );
		}


		inline int IsLumaActive11_g5096( int Band )
		{
			return AudioLinkData( ALPASS_AUDIOLINK + uint2( 0, Band ) ).r;
		}


		inline float AudioLinkData3_g5086( int Band, int Delay )
		{
			return AudioLinkData( ALPASS_AUDIOLINK + uint2( Delay, Band ) ).rrrr;
		}


		inline float glslmod96_g5085( float x, float y )
		{
			return glsl_mod(x,y);
		}


		inline float glslmod97_g5085( float x, float y )
		{
			return glsl_mod(x,y);
		}


		inline float glslmod98_g5085( float x, float y )
		{
			return glsl_mod(x,y);
		}


		inline float AudioLinkLerp3_g5088( int Band, float Delay )
		{
			return AudioLinkLerp( ALPASS_AUDIOLINK + float2( Delay, Band ) ).r;
		}


		inline float AudioLinkLerp3_g5090( int Band, float FilteredAmount )
		{
			return AudioLinkLerp( ALPASS_FILTEREDAUDIOLINK + float2( FilteredAmount, Band ) ).r;
		}


		float IfAudioLinkv2Exists1_g5100(  )
		{
			int w = 0; 
			int h; 
			int res = 0;
		...
		float IfAudioLinkv2Exists1_g5101(  )
		{
			int w = 0; 
			int h; 
			int res = 0;
		...
		inline int AudioLinkDecodeDataAsUInt6_g5080( int Band, int Mode )
		{
			return AudioLinkDecodeDataAsUInt( ALPASS_CHRONOTENSITY + int2(Mode, Band));
		}


		float IfAudioLinkv2Exists1_g5081(  )
		{
			int w = 0; 
			int h; 
			int res = 0;
		...
		inline float AudioLinkData3_g5053( int Band, int Delay )
		{
			return AudioLinkData( ALPASS_AUDIOLINK + uint2( Delay, Band ) ).rrrr;
		}


		inline float glslmod96_g5052( float x, float y )
		{
			return glsl_mod(x,y);
		}


		inline float glslmod97_g5052( float x, float y )
		{
			return glsl_mod(x,y);
		}


		inline float glslmod98_g5052( float x, float y )
		{
			return glsl_mod(x,y);
		}


		inline float AudioLinkLerp3_g5055( int Band, float Delay )
		{
			return AudioLinkLerp( ALPASS_AUDIOLINK + float2( Delay, Band ) ).r;
		}


		inline float AudioLinkLerp3_g5057( int Band, float FilteredAmount )
		{
			return AudioLinkLerp( ALPASS_FILTEREDAUDIOLINK + float2( FilteredAmount, Band ) ).r;
		}


		inline int IsLumaActive11_g5060( int Band )
		{
			return AudioLinkData( ALPASS_AUDIOLINK + uint2( 0, Band ) ).r;
		}


		inline float3 LumaGlowData2_g5059( int Band, int Delay )
		{
			return AudioLinkData( ALPASS_AUDIOLINK + uint2( Delay, Band ) );
		}


		inline int IsLumaActive11_g5062( int Band )
		{
			return AudioLinkData( ALPASS_AUDIOLINK + uint2( 0, Band ) ).r;
		}


		inline float glslmod13_g5052( float x, float y )
		{
			return glsl_mod(x,y);
		}


		inline float glslmod12_g5052( float x, float y )
		{
			return glsl_mod(x,y);
		}


		inline float glslmod34_g5052( float x, float y )
		{
			return glsl_mod(x,y);
		}


		inline float3 LumaGlowLerp11_g5061( int Band, float Delay )
		{
			return AudioLinkLerp( ALPASS_AUDIOLINK + float2( Delay, Band ) );
		}


		inline float4 AudioLinkLerp1_g5065( float Position )
		{
			return AudioLinkLerp( ALPASS_CCSTRIP + float2( Position * 128., 0 ) ).rgba;;
		}


		inline float3 LumaGlowLerp11_g5063( int Band, float Delay )
		{
			return AudioLinkLerp( ALPASS_AUDIOLINK + float2( Delay, Band ) );
		}


		inline int IsLumaActive11_g5064( int Band )
		{
			return AudioLinkData( ALPASS_AUDIOLINK + uint2( 0, Band ) ).r;
		}


		inline float glslmod266_g5052( float x, float y )
		{
			return glsl_mod(x,y);
		}


		float IfAudioLinkv2Exists1_g5067(  )
		{
			int w = 0; 
			int h; 
			int res = 0;
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float3 appendResult1201 = (float3(tex2DNode241.xy , ( tex2DNode241.b * ( ( i.ASEIsFrontFacing * 2.0 ) - 1.0 ) )));
			float3 Normal243 = appendResult1201;
			...
			float4 MainTex147_g5010 = MainTex224;
			int Band6_g5011 = _IridescentALAnimationBand;
			int Mode6_g5011 = ( ( _IridescentALAnimationMode * 2 ) + _IridescentALAnimationSpeed );
			int localAudioLinkDecodeDataAsUInt6_g5011 = AudioLinkDecodeDataAsUInt6_g5011( Band6_g5011 , Mode6_g5011 );
			float localGetNetworkTime4_g5013 = ( AudioLinkDecodeDataAsSeconds( ALPASS_GENERALVU_NETWORK_TIME ) );
			float localIfAudioLinkv2Exists1_g5014 = IfAudioLinkv2Exists1_g5014();
			float lerpResult118_g5010 = lerp( _Time.y , localGetNetworkTime4_g5013 , localIfAudioLinkv2Exists1_g5014);
			float lerpResult121_g5010 = lerp( ( ( ( localAudioLinkDecodeDataAsUInt6_g5011 % 628319 ) / 100000.0 ) * step( _IridescentALAnimationBand , 9 ) ) , lerpResult118_g5010 , (float)saturate( ( _IridescentALAnimationMode - 3 ) ));
			float EmissionGlowAnimation62_g5010 = ( _IridescentALAnimationStrength * lerpResult121_g5010 );
			float3 temp_output_21_0_g5010 = Normal243;
			float3 normalizeResult4_g5010 = normalize( ( WorldReflectionVector( i , temp_output_21_0_g5010 ) + ase_worldViewDir ) );
			float dotResult18_g5010 = dot( normalizeResult4_g5010 , ase_worldViewDir );
			float temp_output_197_0_g5010 = ( dotResult18_g5010 * 0.5 );
			...
			float3 temp_output_165_0_g5010 = lightDir32;
			float3 normalizeResult168_g5010 = normalize( ( temp_output_165_0_g5010 + ase_worldViewDir ) );
			float3 wNorm170_g5010 = temp_output_21_0_g5010;
			float3 newWorldNormal169_g5010 = (WorldNormalVector( i , wNorm170_g5010 ));
			float dotResult172_g5010 = dot( normalizeResult168_g5010 , newWorldNormal169_g5010 );
			float Specular209_g5010 = max( dotResult172_g5010 , 0.0 );
			float dotResult177_g5010 = dot( temp_output_165_0_g5010 , newWorldNormal169_g5010 );
			float temp_output_182_0_g5010 = max( dotResult177_g5010 , 0.0 );
			float smoothstepResult194_g5010 = smoothstep( -0.125 , 0.5 , temp_output_182_0_g5010);
			...
			float temp_output_208_0_g5010 = ( smoothstepResult194_g5010 * Attenuation533 );
			float lerpResult198_g5010 = lerp( temp_output_197_0_g5010 , Specular209_g5010 , temp_output_208_0_g5010);
			float lerpResult175_g5010 = lerp( dotResult18_g5010 , lerpResult198_g5010 , (float)saturate( _IridescentMode2 ));
			float lerpResult192_g5010 = lerp( temp_output_197_0_g5010 , temp_output_182_0_g5010 , temp_output_208_0_g5010);
			float lerpResult179_g5010 = lerp( lerpResult175_g5010 , lerpResult192_g5010 , (float)saturate( ( _IridescentMode2 - 1 ) ));
			float temp_output_211_0_g5010 = ( ( lerpResult179_g5010 * _IridescentScale ) + _IridescentOffset );
			float temp_output_34_0_g5010 = ( max( abs( sin( ( EmissionGlowAnimation62_g5010 + temp_output_211_0_g5010 ) ) ) , 0.0 ) * 2.0 );
			float temp_output_2_0_g5012 = pow( ( 1.0 / 2.71828 ) , pow( ( -( 1.0 - 2.5 ) * temp_output_34_0_g5010 ) , 2.0 ) );
			float temp_output_41_0_g5010 = ( 1.0 - temp_output_2_0_g5012 );
			float4 lerpResult26_g5010 = lerp( _IridescentEmissionColor1 , _IridescentEmissionColor2 , temp_output_41_0_g5010);
			...
			float4 Colors149_g5010 = lerpResult32_g5010;
			float3 hsvTorgb86_g5010 = RGBToHSV( Colors149_g5010.rgb );
			float3 hsvTorgb85_g5010 = RGBToHSV( MainTex147_g5010.rgb );
			float3 hsvTorgb87_g5010 = HSVToRGB( float3(hsvTorgb86_g5010.x,hsvTorgb85_g5010.y,hsvTorgb85_g5010.z) );
			float Intensity132_g5010 = _IridescentIntensity;
			float4 lerpResult205_g5010 = lerp( MainTex147_g5010 , float4( hsvTorgb87_g5010 , 0.0 ) , saturate( Intensity132_g5010 ));
			...
			int ModeTransferSat145_g5010 = temp_output_91_0_g5010;
			float4 lerpResult92_g5010 = lerp( MainTex147_g5010 , ( lerpResult205_g5010 * max( Intensity132_g5010 , 1.0 ) ) , (float)ModeTransferSat145_g5010);
			float AnimatedDot130_g5010 = ( temp_output_211_0_g5010 + EmissionGlowAnimation62_g5010 );
			float3 hsvTorgb99_g5010 = RGBToHSV( MainTex147_g5010.rgb );
			float3 hsvTorgb100_g5010 = HSVToRGB( float3(( AnimatedDot130_g5010 + hsvTorgb99_g5010.x ),hsvTorgb99_g5010.y,hsvTorgb99_g5010.y) );
			float4 lerpResult199_g5010 = lerp( MainTex147_g5010 , float4( hsvTorgb100_g5010 , 0.0 ) , saturate( Intensity132_g5010 ));
			float4 Holographic153_g5010 = ( lerpResult199_g5010 * max( Intensity132_g5010 , 1.0 ) );
			int ModeTransfer143_g5010 = temp_output_90_0_g5010;
			int temp_output_97_0_g5010 = ( ModeTransfer143_g5010 - 1 );
			float4 lerpResult96_g5010 = lerp( lerpResult92_g5010 , Holographic153_g5010 , (float)saturate( temp_output_97_0_g5010 ));
			float3 hsvTorgb124_g5010 = RGBToHSV( MainTex147_g5010.rgb );
			float3 hsvTorgb126_g5010 = HSVToRGB( float3(( hsvTorgb124_g5010.x + AnimatedDot130_g5010 ),hsvTorgb124_g5010.y,hsvTorgb124_g5010.z) );
			float4 lerpResult203_g5010 = lerp( MainTex147_g5010 , float4( hsvTorgb126_g5010 , 0.0 ) , saturate( Intensity132_g5010 ));
			float4 Hueshift152_g5010 = ( lerpResult203_g5010 * max( Intensity132_g5010 , 1.0 ) );
			float4 lerpResult127_g5010 = lerp( lerpResult96_g5010 , Hueshift152_g5010 , (float)saturate( ( temp_output_97_0_g5010 - 1 ) ));
			...
			float temp_output_214_0_g5010 = GGXTerm1132;
			int temp_output_225_0_g5010 = saturate( _IridescenceLightMode );
			float lerpResult218_g5010 = lerp( 0.0 , temp_output_214_0_g5010 , (float)temp_output_225_0_g5010);
			...
			float temp_output_215_0_g5010 = RimAlpha1134;
			int temp_output_220_0_g5010 = ( _IridescenceLightMode - 1 );
			float lerpResult219_g5010 = lerp( lerpResult218_g5010 , temp_output_215_0_g5010 , (float)saturate( temp_output_220_0_g5010 ));
			float lerpResult222_g5010 = lerp( lerpResult219_g5010 , max( temp_output_214_0_g5010 , temp_output_215_0_g5010 ) , (float)saturate( ( temp_output_220_0_g5010 - 1 ) ));
			float Atten232_g5010 = temp_output_208_0_g5010;
			float temp_output_233_0_g5010 = ( lerpResult222_g5010 * Atten232_g5010 );
			float4 lerpResult227_g5010 = lerp( MainTex147_g5010 , lerpResult127_g5010 , temp_output_233_0_g5010);
			float4 lerpResult236_g5010 = lerp( lerpResult127_g5010 , lerpResult227_g5010 , (float)temp_output_225_0_g5010);
			float2 uv_EffectMask = i.uv_texcoord * _EffectMask_ST.xy + _EffectMask_ST.zw;
			float4 EffectMaskRGBA871 = tex2D( _EffectMask, uv_EffectMask );
			float4 break57_g5010 = EffectMaskRGBA871;
			int temp_output_18_0_g5016 = _IridescentMaskingChannel;
			float lerpResult1_g5016 = lerp( 1.0 , break57_g5010.r , (float)saturate( temp_output_18_0_g5016 ));
			int temp_output_5_0_g5016 = ( temp_output_18_0_g5016 - 1 );
			float lerpResult12_g5016 = lerp( lerpResult1_g5016 , break57_g5010.g , (float)saturate( temp_output_5_0_g5016 ));
			int temp_output_6_0_g5016 = ( temp_output_5_0_g5016 - 1 );
			float lerpResult10_g5016 = lerp( lerpResult12_g5016 , break57_g5010.b , (float)saturate( temp_output_6_0_g5016 ));
			float lerpResult11_g5016 = lerp( lerpResult10_g5016 , break57_g5010.a , (float)saturate( ( temp_output_6_0_g5016 - 1 ) ));
			float temp_output_55_0_g5010 = lerpResult11_g5016;
			float EffectMask140_g5010 = temp_output_55_0_g5010;
			float4 lerpResult95_g5010 = lerp( MainTex147_g5010 , lerpResult236_g5010 , EffectMask140_g5010);
			float4 lerpResult248_g5010 = lerp( MainTex147_g5010 , lerpResult95_g5010 , _Enableiridescence);
			float4 IridescentMainTex1049 = lerpResult248_g5010;
			...
			float4 specColor21194 = lerpResult381;
			...
			float4 lerpResult213 = lerp( specColor21194 , temp_cast_266 , saturate( smoothstepResult482 ));
			float4 lerpResult204 = lerp( temp_cast_242 , lerpResult213 , metallic46);
			float lerpResult1195 = lerp( ( Smoothness90 * Smoothness90 ) , 1.0 , metallic46);
			float4 IndirectSpecular158 = ( float4( indirectSpecular151 , 0.0 ) * lerpResult204 * lerpResult1195 );
			...
			float3 temp_output_125_0_g5083 = ColoredSpec987.rgb;
			float3 SpecularIN194_g5083 = temp_output_125_0_g5083;
			float time2_g5083 = 0.0;
			float2 voronoiSmoothId2_g5083 = 0;
			float2 coords2_g5083 = i.uv_texcoord * _SparkleScale;
			float2 id2_g5083 = 0;
			float2 uv2_g5083 = 0;
			float voroi2_g5083 = voronoi2_g5083( coords2_g5083, time2_g5083, id2_g5083, uv2_g5083, 0, voronoiSmoothId2_g5083 );
			float2 ID44_g5083 = id2_g5083;
			float2 break71_g5083 = ( ID44_g5083 * float2( 360,360 ) );
			float cos68_g5083 = cos( radians( max( break71_g5083.x , break71_g5083.y ) ) );
			float sin68_g5083 = sin( radians( max( break71_g5083.x , break71_g5083.y ) ) );
			float2 rotator68_g5083 = mul( uv2_g5083 - float2( 0,0 ) , float2x2( cos68_g5083 , -sin68_g5083 , sin68_g5083 , cos68_g5083 )) + float2( 0,0 );
			float2 UV45_g5083 = rotator68_g5083;
			float mulTime14_g5083 = _Time.y * _SparkleSpeed;
			float simplePerlin2D37_g5083 = snoise( ( ( ID44_g5083 * _SparkleSeed ) + mulTime14_g5083 ) );
			simplePerlin2D37_g5083 = simplePerlin2D37_g5083*0.5 + 0.5;
			float Noise50_g5083 = ( _SparkleSize * simplePerlin2D37_g5083 );
			float smoothstepResult31_g5083 = smoothstep( 0.2 , 0.1 , ( length( UV45_g5083 ) - (-0.5 + (Noise50_g5083 - 0.0) * (0.5 - -0.5) / (1.0 - 0.0)) ));
			float Sphere52_g5083 = smoothstepResult31_g5083;
			float2 temp_cast_270 = (( 0.4 + (-0.5 + (Noise50_g5083 - 0.0) * (0.5 - -0.5) / (1.0 - 0.0)) )).xx;
			float2 temp_output_54_0_g5083 = ( abs( UV45_g5083 ) - temp_cast_270 );
			float2 temp_cast_271 = (( 0.4 + (-0.5 + (Noise50_g5083 - 0.0) * (0.5 - -0.5) / (1.0 - 0.0)) )).xx;
			float2 break59_g5083 = temp_output_54_0_g5083;
			float smoothstepResult62_g5083 = smoothstep( 0.01 , 0.0 , ( length( max( temp_output_54_0_g5083 , float2( 0,0 ) ) ) + min( max( break59_g5083.x , break59_g5083.y ) , 0.0 ) ));
			float Square63_g5083 = smoothstepResult62_g5083;
			float lerpResult111_g5083 = lerp( Sphere52_g5083 , Square63_g5083 , (float)saturate( _SparkleShape ));
			float2 p73_g5083 = UV45_g5083;
			float r73_g5083 = (-0.5 + (Noise50_g5083 - 0.0) * (0.5 - -0.5) / (1.0 - 0.0));
			float rf73_g5083 = 0.25;
			float localsdStar573_g5083 = sdStar5( p73_g5083 , r73_g5083 , rf73_g5083 );
			float smoothstepResult79_g5083 = smoothstep( 0.01 , 0.0 , localsdStar573_g5083);
			float Star80_g5083 = smoothstepResult79_g5083;
			int temp_output_114_0_g5083 = ( _SparkleShape - 1 );
			float lerpResult112_g5083 = lerp( lerpResult111_g5083 , Star80_g5083 , (float)saturate( temp_output_114_0_g5083 ));
			float temp_output_99_0_g5083 = (-0.25 + (Noise50_g5083 - 0.0) * (0.0 - -0.25) / (1.0 - 0.0));
			float2 p85_g5083 = ( UV45_g5083 * 2.15 );
			float localsdHeart85_g5083 = sdHeart( p85_g5083 );
			float smoothstepResult91_g5083 = smoothstep( ( temp_output_99_0_g5083 + 0.01 ) , temp_output_99_0_g5083 , ( localsdHeart85_g5083 / 2.15 ));
			float Heart90_g5083 = smoothstepResult91_g5083;
			float lerpResult113_g5083 = lerp( lerpResult112_g5083 , Heart90_g5083 , (float)saturate( ( temp_output_114_0_g5083 - 1 ) ));
			float4 temp_output_2_0_g5068 = EffectMaskRGBA871;
			float4 break120_g5083 = temp_output_2_0_g5068;
			int temp_output_18_0_g5084 = _SparkleMaskingChannel;
			float lerpResult1_g5084 = lerp( 1.0 , break120_g5083.r , (float)saturate( temp_output_18_0_g5084 ));
			int temp_output_5_0_g5084 = ( temp_output_18_0_g5084 - 1 );
			float lerpResult12_g5084 = lerp( lerpResult1_g5084 , break120_g5083.g , (float)saturate( temp_output_5_0_g5084 ));
			int temp_output_6_0_g5084 = ( temp_output_5_0_g5084 - 1 );
			float lerpResult10_g5084 = lerp( lerpResult12_g5084 , break120_g5083.b , (float)saturate( temp_output_6_0_g5084 ));
			float lerpResult11_g5084 = lerp( lerpResult10_g5084 , break120_g5083.a , (float)saturate( ( temp_output_6_0_g5084 - 1 ) ));
			float SparkleAlpha129_g5083 = ( lerpResult113_g5083 * lerpResult11_g5084 );
			float4 temp_cast_280 = (1.0).xxxx;
			float4 temp_cast_282 = (1.0).xxxx;
			float3 temp_cast_283 = (1.0).xxx;
			int EmissionGlowZone47_g5085 = _SparkleGlowZone;
			int clampResult8_g5091 = clamp( EmissionGlowZone47_g5085 , 1 , 4 );
			int temp_output_3_0_g5091 = ( clampResult8_g5091 - 1 );
			int Zone16_g5091 = temp_output_3_0_g5091;
			float3 localgetThemeData16_g5091 = getThemeData( Zone16_g5091 );
			int Band11_g5092 = 56;
			int localIsLumaActive11_g5092 = IsLumaActive11_g5092( Band11_g5092 );
			int temp_output_14_0_g5091 = localIsLumaActive11_g5092;
			int lerpResult15_g5091 = lerp( temp_output_3_0_g5091 , ( 63 - temp_output_3_0_g5091 ) , (float)temp_output_14_0_g5091);
			int Band2_g5091 = lerpResult15_g5091;
			int Delay2_g5091 = 0;
			float3 localLumaGlowData2_g5091 = LumaGlowData2_g5091( Band2_g5091 , Delay2_g5091 );
			float3 lerpResult17_g5091 = lerp( ( localgetThemeData16_g5091 * localLumaGlowData2_g5091 ) , localLumaGlowData2_g5091 , (float)temp_output_14_0_g5091);
			int temp_output_21_0_g5085 = saturate( EmissionGlowZone47_g5085 );
			float3 lerpResult20_g5085 = lerp( temp_cast_283 , lerpResult17_g5091 , (float)temp_output_21_0_g5085);
			float3 temp_cast_287 = (1.0).xxx;
			int clampResult8_g5093 = clamp( EmissionGlowZone47_g5085 , 1 , 4 );
			int temp_output_3_0_g5093 = ( clampResult8_g5093 - 1 );
			int Zone15_g5093 = temp_output_3_0_g5093;
			float3 localgetThemeData15_g5093 = getThemeData( Zone15_g5093 );
			int Band11_g5094 = 56;
			int localIsLumaActive11_g5094 = IsLumaActive11_g5094( Band11_g5094 );
			int temp_output_13_0_g5093 = localIsLumaActive11_g5094;
			int lerpResult14_g5093 = lerp( temp_output_3_0_g5093 , ( 63 - temp_output_3_0_g5093 ) , (float)temp_output_13_0_g5093);
			int Band11_g5093 = lerpResult14_g5093;
			float cos6_g5085 = cos( radians( _SparkleGlowPulseDir ) );
			float sin6_g5085 = sin( radians( _SparkleGlowPulseDir ) );
			float2 rotator6_g5085 = mul( i.uv_texcoord - float2( 0.5,0.5 ) , float2x2( cos6_g5085 , -sin6_g5085 , sin6_g5085 , cos6_g5085 )) + float2( 0.5,0.5 );
			int Band6_g5098 = _SparkleGlowAnimationBand;
			int Mode6_g5098 = ( ( _SparkleGlowAnimationMode * 2 ) + _SparkleGlowAnimationSpeed );
			int localAudioLinkDecodeDataAsUInt6_g5098 = AudioLinkDecodeDataAsUInt6_g5098( Band6_g5098 , Mode6_g5098 );
			float localGetLocalTime2_g5099 = ( AudioLinkDecodeDataAsSeconds( ALPASS_GENERALVU_LOCAL_TIME ) );
			float lerpResult206_g5085 = lerp( ( ( localAudioLinkDecodeDataAsUInt6_g5098 % 628319 ) / 100000.0 ) , localGetLocalTime2_g5099 , (float)saturate( ( _SparkleGlowAnimationMode - 3 ) ));
			float EmissionGlowAnimation195_g5085 = ( _SparkleGlowAnimationStrength * lerpResult206_g5085 * step( _SparkleGlowAnimationBand , 9 ) );
			float x13_g5085 = ( ( rotator6_g5085.x * _SparkleGlowPulseScale ) + _SparkleGlowPulseOffset + EmissionGlowAnimation195_g5085 );
			float y13_g5085 = 127.0;
			float localglslmod13_g5085 = glslmod13_g5085( x13_g5085 , y13_g5085 );
			float2 CenteredUV15_g5087 = ( i.uv_texcoord - _SparkleGlowRadialCenter );
			float2 break17_g5087 = CenteredUV15_g5087;
			float2 appendResult23_g5087 = (float2(( length( CenteredUV15_g5087 ) * _SparkleGlowPulseScale * 2.0 ) , ( atan2( break17_g5087.x , break17_g5087.y ) * ( 1.0 / 6.28318548202515 ) * 1.0 )));
			float x12_g5085 = ( _SparkleGlowPulseOffset + appendResult23_g5087.x + EmissionGlowAnimation195_g5085 );
			float y12_g5085 = 127.0;
			float localglslmod12_g5085 = glslmod12_g5085( x12_g5085 , y12_g5085 );
			int EmissionGlowMode35_g5085 = _SparkleGlowMode;
			int temp_output_37_0_g5085 = ( EmissionGlowMode35_g5085 - 1 );
			float lerpResult5_g5085 = lerp( localglslmod13_g5085 , localglslmod12_g5085 , (float)saturate( temp_output_37_0_g5085 ));
			float2 uv_DirectionalMap = i.uv_texcoord * _DirectionalMap_ST.xy + _DirectionalMap_ST.zw;
			float Direction27_g4913 = tex2D( _DirectionalMap, uv_DirectionalMap ).r;
			float temp_output_1189_244 = Direction27_g4913;
			float DirectionMap1031 = temp_output_1189_244;
			float temp_output_23_0_g5068 = DirectionMap1031;
			float DirectionalMap106_g5085 = temp_output_23_0_g5068;
			float lerpResult179_g5085 = lerp( DirectionalMap106_g5085 , ( 1.0 - DirectionalMap106_g5085 ) , (float)saturate( ( EmissionGlowMode35_g5085 - 3 ) ));
			float x34_g5085 = ( _SparkleGlowPulseOffset + ( _SparkleGlowPulseScale * lerpResult179_g5085 ) + EmissionGlowAnimation195_g5085 );
			float y34_g5085 = 127.0;
			float localglslmod34_g5085 = glslmod34_g5085( x34_g5085 , y34_g5085 );
			float lerpResult30_g5085 = lerp( lerpResult5_g5085 , localglslmod34_g5085 , (float)saturate( ( temp_output_37_0_g5085 - 1 ) ));
			float EmissionGlowDelay56_g5085 = lerpResult30_g5085;
			float Delay11_g5093 = EmissionGlowDelay56_g5085;
			float3 localLumaGlowLerp11_g5093 = LumaGlowLerp11_g5093( Band11_g5093 , Delay11_g5093 );
			float3 lerpResult17_g5093 = lerp( ( localgetThemeData15_g5093 * localLumaGlowLerp11_g5093 ) , localLumaGlowLerp11_g5093 , (float)temp_output_13_0_g5093);
			float3 lerpResult22_g5085 = lerp( temp_cast_287 , lerpResult17_g5093 , (float)temp_output_21_0_g5085);
			float3 lerpResult23_g5085 = lerp( lerpResult20_g5085 , lerpResult22_g5085 , (float)saturate( EmissionGlowMode35_g5085 ));
			float4 temp_cast_297 = (1.0).xxxx;
			float temp_output_10_0_g5095 = EmissionGlowDelay56_g5085;
			float Position1_g5097 = ( temp_output_10_0_g5095 / 127.0 );
			float4 localAudioLinkLerp1_g5097 = AudioLinkLerp1_g5097( Position1_g5097 );
			int clampResult8_g5095 = clamp( ( EmissionGlowZone47_g5085 - 4 ) , 1 , 3 );
			int Band11_g5095 = ( 59 - ( clampResult8_g5095 - 1 ) );
			float Delay11_g5095 = temp_output_10_0_g5095;
			float3 localLumaGlowLerp11_g5095 = LumaGlowLerp11_g5095( Band11_g5095 , Delay11_g5095 );
			int Band11_g5096 = 56;
			int localIsLumaActive11_g5096 = IsLumaActive11_g5096( Band11_g5096 );
			float4 lerpResult14_g5095 = lerp( localAudioLinkLerp1_g5097 , float4( localLumaGlowLerp11_g5095 , 0.0 ) , (float)localIsLumaActive11_g5096);
			float4 lerpResult52_g5085 = lerp( temp_cast_297 , lerpResult14_g5095 , (float)saturate( EmissionGlowZone47_g5085 ));
			float4 lerpResult51_g5085 = lerp( float4( lerpResult23_g5085 , 0.0 ) , lerpResult52_g5085 , (float)saturate( ( EmissionGlowZone47_g5085 - 4 ) ));
			float4 temp_cast_302 = (_SparkleGlowMinBrightness).xxxx;
			float4 temp_cast_303 = (( _SparkleGlowMinBrightness + 1.0 )).xxxx;
			int temp_output_258_0_g5085 = saturate( EmissionGlowZone47_g5085 );
			float4 EmissionGlow142_g5085 = ( (temp_cast_302 + (lerpResult51_g5085 - float4( 0,0,0,0 )) * (temp_cast_303 - temp_cast_302) / (float4( 1,1,1,1 ) - float4( 0,0,0,0 ))) * _SparkleGlowTint * temp_output_258_0_g5085 );
			float4 lerpResult261_g5085 = lerp( temp_cast_282 , EmissionGlow142_g5085 , (float)temp_output_258_0_g5085);
			float4 EmissionGlowTog262_g5085 = lerpResult261_g5085;
			int EmissionReactiveBand243_g5085 = _SparkleReactiveBand;
			int Band3_g5086 = EmissionReactiveBand243_g5085;
			int Delay3_g5086 = 0;
			float localAudioLinkData3_g5086 = AudioLinkData3_g5086( Band3_g5086 , Delay3_g5086 );
			int temp_output_64_0_g5085 = step( _SparkleReactiveBand , 9 );
			float lerpResult66_g5085 = lerp( 1.0 , localAudioLinkData3_g5086 , (float)temp_output_64_0_g5085);
			int Band3_g5088 = _SparkleReactiveBand;
			float cos78_g5085 = cos( radians( _SparkleReactivePulseDir ) );
			float sin78_g5085 = sin( radians( _SparkleReactivePulseDir ) );
			float2 rotator78_g5085 = mul( i.uv_texcoord - float2( 0.5,0.5 ) , float2x2( cos78_g5085 , -sin78_g5085 , sin78_g5085 , cos78_g5085 )) + float2( 0.5,0.5 );
			float x96_g5085 = ( ( rotator78_g5085.x * _SparkleReactivePulseScale ) + _SparkleReactivePulseOffset );
			float y96_g5085 = 127.0;
			float localglslmod96_g5085 = glslmod96_g5085( x96_g5085 , y96_g5085 );
			float2 CenteredUV15_g5089 = ( i.uv_texcoord - _SparkleReactiveRadialCenter );
			float2 break17_g5089 = CenteredUV15_g5089;
			float2 appendResult23_g5089 = (float2(( length( CenteredUV15_g5089 ) * _SparkleReactivePulseScale * 2.0 ) , ( atan2( break17_g5089.x , break17_g5089.y ) * ( 1.0 / 6.28318548202515 ) * 1.0 )));
			float x97_g5085 = ( _SparkleReactivePulseOffset + appendResult23_g5089.x );
			float y97_g5085 = 127.0;
			float localglslmod97_g5085 = glslmod97_g5085( x97_g5085 , y97_g5085 );
			int EmissionReactiveMode99_g5085 = _SparkleReactiveMode;
			int temp_output_90_0_g5085 = ( EmissionReactiveMode99_g5085 - 1 );
			float lerpResult77_g5085 = lerp( localglslmod96_g5085 , localglslmod97_g5085 , (float)saturate( temp_output_90_0_g5085 ));
			float lerpResult174_g5085 = lerp( DirectionalMap106_g5085 , ( 1.0 - DirectionalMap106_g5085 ) , (float)saturate( ( EmissionReactiveMode99_g5085 - 3 ) ));
			float x98_g5085 = ( _SparkleReactivePulseOffset + ( _SparkleReactivePulseScale * lerpResult174_g5085 ) );
			float y98_g5085 = 127.0;
			float localglslmod98_g5085 = glslmod98_g5085( x98_g5085 , y98_g5085 );
			float lerpResult87_g5085 = lerp( lerpResult77_g5085 , localglslmod98_g5085 , (float)saturate( ( temp_output_90_0_g5085 - 1 ) ));
			float Delay3_g5088 = lerpResult87_g5085;
			float localAudioLinkLerp3_g5088 = AudioLinkLerp3_g5088( Band3_g5088 , Delay3_g5088 );
			float lerpResult102_g5085 = lerp( 1.0 , localAudioLinkLerp3_g5088 , (float)temp_output_64_0_g5085);
			float lerpResult103_g5085 = lerp( lerpResult66_g5085 , lerpResult102_g5085 , (float)saturate( EmissionReactiveMode99_g5085 ));
			int Band3_g5090 = _SparkleReactiveBand;
			float FilteredAmount3_g5090 = ( ( 1.0 - _SparkleReactiveGlobalSmoothing ) * 15.0 );
			float localAudioLinkLerp3_g5090 = AudioLinkLerp3_g5090( Band3_g5090 , FilteredAmount3_g5090 );
			float lerpResult168_g5085 = lerp( 1.0 , localAudioLinkLerp3_g5090 , (float)temp_output_64_0_g5085);
			float lerpResult172_g5085 = lerp( lerpResult103_g5085 , lerpResult168_g5085 , (float)saturate( ( EmissionReactiveMode99_g5085 - 4 ) ));
			float ReactivityAlpha132_g5085 = (_SparkleReactiveMinBrightness + (lerpResult172_g5085 - 0.0) * (( _SparkleReactiveMinBrightness + 1.0 ) - _SparkleReactiveMinBrightness) / (1.0 - 0.0));
			float4 temp_cast_314 = (1.0).xxxx;
			float4 lerpResult268_g5085 = lerp( temp_cast_314 , _SparkleReactiveTint , (float)step( EmissionReactiveBand243_g5085 , 9 ));
			float4 FinalReactivity68_g5085 = ( ReactivityAlpha132_g5085 * lerpResult268_g5085 );
			float4 lerpResult146_g5085 = lerp( ( EmissionGlowTog262_g5085 * FinalReactivity68_g5085 ) , ( EmissionGlow142_g5085 + FinalReactivity68_g5085 ) , (float)saturate( _SparkleReactiveBlendMode ));
			float4 ReversedReactivity152_g5085 = ( ( 1.0 - ReactivityAlpha132_g5085 ) * lerpResult268_g5085 );
			int temp_output_157_0_g5085 = ( _SparkleReactiveBlendMode - 1 );
			float4 lerpResult114_g5085 = lerp( lerpResult146_g5085 , ( EmissionGlowTog262_g5085 * ReversedReactivity152_g5085 ) , (float)saturate( temp_output_157_0_g5085 ));
			int temp_output_255_0_g5085 = step( EmissionReactiveBand243_g5085 , 9 );
			float4 lerpResult164_g5085 = lerp( lerpResult114_g5085 , ( EmissionGlow142_g5085 + ( ReversedReactivity152_g5085 * temp_output_255_0_g5085 ) ) , (float)max( saturate( ( temp_output_157_0_g5085 - 1 ) ) , ( 1.0 - step( EmissionReactiveBand243_g5085 , 9 ) ) ));
			float4 lerpResult280_g5085 = lerp( _SparkleGlowTint , lerpResult164_g5085 , (float)max( temp_output_255_0_g5085 , saturate( EmissionGlowZone47_g5085 ) ));
			float localIfAudioLinkv2Exists1_g5100 = IfAudioLinkv2Exists1_g5100();
			float4 lerpResult275_g5085 = lerp( temp_cast_280 , ( lerpResult280_g5085 * SparkleAlpha129_g5083 ) , localIfAudioLinkv2Exists1_g5100);
			float localIfAudioLinkv2Exists1_g5101 = IfAudioLinkv2Exists1_g5101();
			float4 lerpResult172_g5083 = lerp( ( _SparkleColor * SparkleAlpha129_g5083 ) , lerpResult275_g5085 , ( saturate( EmissionGlowZone47_g5085 ) * localIfAudioLinkv2Exists1_g5101 ));
			float4 Sparkles152_g5083 = lerpResult172_g5083;
			float4 lerpResult190_g5083 = lerp( ( Sparkles152_g5083 * float4( temp_output_125_0_g5083 , 0.0 ) ) , ( Sparkles152_g5083 + float4( temp_output_125_0_g5083 , 0.0 ) ) , (float)_SparkleBlendMode);
			float4 SpecularSparkles142_g5083 = lerpResult190_g5083;
			int temp_output_133_0_g5083 = saturate( _SparkleMode );
			float4 lerpResult127_g5083 = lerp( float4( SpecularIN194_g5083 , 0.0 ) , SpecularSparkles142_g5083 , (float)temp_output_133_0_g5083);
			int temp_output_137_0_g5083 = ( _SparkleMode - 1 );
			float4 lerpResult198_g5083 = lerp( lerpResult127_g5083 , float4( SpecularIN194_g5083 , 0.0 ) , (float)saturate( temp_output_137_0_g5083 ));
			int temp_output_150_0_g5083 = ( temp_output_137_0_g5083 - 1 );
			int temp_output_151_0_g5083 = saturate( temp_output_150_0_g5083 );
			float4 lerpResult149_g5083 = lerp( lerpResult198_g5083 , SpecularSparkles142_g5083 , (float)temp_output_151_0_g5083);
			int temp_output_160_0_g5083 = saturate( ( temp_output_150_0_g5083 - 1 ) );
			float4 lerpResult153_g5083 = lerp( lerpResult149_g5083 , SpecularSparkles142_g5083 , (float)temp_output_160_0_g5083);
			#ifdef _SPARKLES
				float4 staticSwitch173_g5083 = lerpResult153_g5083;
			#else
				float4 staticSwitch173_g5083 = float4( SpecularIN194_g5083 , 0.0 );
			#endif
			float4 SpecEffects1117 = staticSwitch173_g5083;
			...
			float3 uvw1205 = (WorldNormalVector( i , Normal243 ));
			float3 localReflectionProbeSample1205 = ReflectionProbeSample( uvw1205 );
			float3 lerpResult1208 = lerp( lerpResult520 , localReflectionProbeSample1205 , 0.5);
			float3 ToonAmbience521 = lerpResult1208;
			...
			float4 lerpResult182_g5083 = lerp( Sparkles152_g5083 , float4( 0,0,0,0 ) , (float)temp_output_133_0_g5083);
			#ifdef UNITY_PASS_FORWARDBASE
				float4 staticSwitch177_g5083 = Sparkles152_g5083;
			#else
				float4 staticSwitch177_g5083 = float4( 0,0,0,0 );
			#endif
			float4 lerpResult185_g5083 = lerp( lerpResult182_g5083 , staticSwitch177_g5083 , (float)temp_output_160_0_g5083);
			#ifdef _SPARKLES
				float4 staticSwitch178_g5083 = lerpResult185_g5083;
			#else
				float4 staticSwitch178_g5083 = float4( 0,0,0,0 );
			#endif
			int Band6_g5080 = _RainbowALAnimationBand;
			int Mode6_g5080 = ( ( _RainbowALAnimationMode * 2 ) + _RainbowALAnimationSpeed );
			int localAudioLinkDecodeDataAsUInt6_g5080 = AudioLinkDecodeDataAsUInt6_g5080( Band6_g5080 , Mode6_g5080 );
			float localGetNetworkTime4_g5082 = ( AudioLinkDecodeDataAsSeconds( ALPASS_GENERALVU_NETWORK_TIME ) );
			float localIfAudioLinkv2Exists1_g5081 = IfAudioLinkv2Exists1_g5081();
			float temp_output_95_0_g5077 = localIfAudioLinkv2Exists1_g5081;
			float lerpResult94_g5077 = lerp( _Time.y , localGetNetworkTime4_g5082 , temp_output_95_0_g5077);
			float lerpResult66_g5077 = lerp( ( ( ( localAudioLinkDecodeDataAsUInt6_g5080 % 628319 ) / 100000.0 ) * step( _RainbowALAnimationBand , 9 ) ) , lerpResult94_g5077 , (float)saturate( ( _RainbowALAnimationMode - 3 ) ));
			float lerpResult96_g5077 = lerp( _Time.y , lerpResult66_g5077 , temp_output_95_0_g5077);
			float EmissionGlowAnimation67_g5077 = ( _RainbowALAnimationStrength * lerpResult96_g5077 );
			float cos45_g5077 = cos( radians( _RainbowRotation ) );
			float sin45_g5077 = sin( radians( _RainbowRotation ) );
			float2 rotator45_g5077 = mul( i.uv_texcoord - float2( 0.5,0.5 ) , float2x2( cos45_g5077 , -sin45_g5077 , sin45_g5077 , cos45_g5077 )) + float2( 0.5,0.5 );
			float2 CenteredUV15_g5079 = ( i.uv_texcoord - _RainbowRadialCenter );
			float2 break17_g5079 = CenteredUV15_g5079;
			float2 appendResult23_g5079 = (float2(( length( CenteredUV15_g5079 ) * _RainbowSpiralCurve * 2.0 ) , ( atan2( break17_g5079.x , break17_g5079.y ) * ( 1.0 / 6.28318548202515 ) * 1.0 )));
			float2 break50_g5077 = appendResult23_g5079;
			float lerpResult49_g5077 = lerp( rotator45_g5077.x , break50_g5077.x , (float)saturate( _RainbowUVMode ));
			int temp_output_60_0_g5077 = ( _RainbowUVMode - 1 );
			float lerpResult63_g5077 = lerp( lerpResult49_g5077 , ( break50_g5077.x + ( break50_g5077.y * ( 2.0 * UNITY_PI ) ) ) , (float)saturate( temp_output_60_0_g5077 ));
			float temp_output_85_0_g5077 = temp_output_23_0_g5068;
			int temp_output_81_0_g5077 = ( temp_output_60_0_g5077 - 1 );
			float lerpResult79_g5077 = lerp( lerpResult63_g5077 , temp_output_85_0_g5077 , (float)saturate( temp_output_81_0_g5077 ));
			float lerpResult80_g5077 = lerp( lerpResult79_g5077 , ( 1.0 - temp_output_85_0_g5077 ) , (float)saturate( ( temp_output_81_0_g5077 - 1 ) ));
			float temp_output_24_0_g5077 = ( ( 1.0 - _RainbowHueRange ) * 0.5 );
			float3 hsvTorgb3_g5077 = HSVToRGB( float3(( (temp_output_24_0_g5077 + (sin( ( EmissionGlowAnimation67_g5077 + ( lerpResult80_g5077 * _RainbowScale ) ) ) - -1.0) * (( 1.0 - temp_output_24_0_g5077 ) - temp_output_24_0_g5077) / (1.0 - -1.0)) + _RainbowHue ),_RainbowSaturation,_RainbowValue) );
			float4 EffectMaskRGBA8_g5068 = temp_output_2_0_g5068;
			float4 break38_g5077 = EffectMaskRGBA8_g5068;
			int temp_output_18_0_g5078 = _RainbowMaskingChannel;
			float lerpResult1_g5078 = lerp( 1.0 , break38_g5077.r , (float)saturate( temp_output_18_0_g5078 ));
			int temp_output_5_0_g5078 = ( temp_output_18_0_g5078 - 1 );
			float lerpResult12_g5078 = lerp( lerpResult1_g5078 , break38_g5077.g , (float)saturate( temp_output_5_0_g5078 ));
			int temp_output_6_0_g5078 = ( temp_output_5_0_g5078 - 1 );
			float lerpResult10_g5078 = lerp( lerpResult12_g5078 , break38_g5077.b , (float)saturate( temp_output_6_0_g5078 ));
			float lerpResult11_g5078 = lerp( lerpResult10_g5078 , break38_g5077.a , (float)saturate( ( temp_output_6_0_g5078 - 1 ) ));
			float3 lerpResult98_g5077 = lerp( float3( 0,0,0 ) , ( hsvTorgb3_g5077 * lerpResult11_g5078 ) , _EnableScrollingRainbow);
			#ifdef UNITY_PASS_FORWARDBASE
				float3 staticSwitch35_g5068 = lerpResult98_g5077;
			#else
				float3 staticSwitch35_g5068 = float3( 0,0,0 );
			#endif
			...
			#endif
			float4 Rimlighting557 = ( max( -dotResult617 , 0.0 ) * temp_output_547_0 * ( ( lightColor45 + float4( ToonAmbience521 , 0.0 ) ) / 2.0 ) * _RimlightColor * specColor21194 * staticSwitch625 );
			float3 temp_output_126_0_g5083 = Rimlighting557.rgb;
			float3 RimlightIN195_g5083 = temp_output_126_0_g5083;
			float4 lerpResult191_g5083 = lerp( ( Sparkles152_g5083 * float4( temp_output_126_0_g5083 , 0.0 ) ) , ( Sparkles152_g5083 + float4( temp_output_126_0_g5083 , 0.0 ) ) , (float)_SparkleBlendMode);
			float4 RimlightSparkles143_g5083 = lerpResult191_g5083;
			float4 lerpResult136_g5083 = lerp( float4( RimlightIN195_g5083 , 0.0 ) , RimlightSparkles143_g5083 , (float)saturate( temp_output_137_0_g5083 ));
			float4 lerpResult181_g5083 = lerp( lerpResult136_g5083 , RimlightSparkles143_g5083 , (float)temp_output_151_0_g5083);
			float4 lerpResult183_g5083 = lerp( lerpResult181_g5083 , RimlightSparkles143_g5083 , (float)temp_output_160_0_g5083);
			#ifdef _SPARKLES
				float4 staticSwitch187_g5083 = lerpResult183_g5083;
			#else
				float4 staticSwitch187_g5083 = float4( RimlightIN195_g5083 , 0.0 );
			#endif
			float4 RimlightEffects1118 = staticSwitch187_g5083;
			c.rgb = ( IndirectSpecular158 + BRDF219 + ( staticSwitch178_g5083 + float4( staticSwitch35_g5068 , 0.0 ) ) + RimlightEffects1118 ).rgb;
			c.a = 1;
		...
		void surf( Input i , inout SurfaceOutputCustomLightingCustom o )
		{
			...
			float4 EmissionRGBA135_g5010 = EmissionGlow791;
			float4 EffectMaskRGBA871 = tex2D( _EffectMask, uv_EffectMask );
			float4 break57_g5010 = EffectMaskRGBA871;
			int temp_output_18_0_g5016 = _IridescentMaskingChannel;
			float lerpResult1_g5016 = lerp( 1.0 , break57_g5010.r , (float)saturate( temp_output_18_0_g5016 ));
...
Node;AmplifyShaderEditor.CommentaryNode;639;-8826.997,-1500.422;Inherit;False;3010.964;860.379;Comment;27;568;569;570;571;572;574;573;577;575;583;592;582;576;584;32;588;578;581;589;580;533;627;629;630;632;628;1202;Light Color + Attenuation;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;403;-3335.939,-3496.149;Inherit;False;2162.522;1530.744;Comment;42;90;1143;1142;386;241;223;391;246;302;1065;383;380;852;225;272;392;385;394;384;224;393;247;255;254;252;7;253;251;269;250;243;388;242;389;1144;1197;1199;1200;1196;1201;1203;1204;Texture Assignment;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;563;-6117.17,1090.775;Inherit;False;1218.21;440.525;Comment;14;512;516;519;511;534;513;517;501;535;518;520;521;594;1208;Toon Ambience;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;217;-1594.872,200.3197;Inherit;False;2616.111;764.0852;Comment;33;174;175;156;204;162;213;205;214;215;203;161;202;166;200;201;191;181;208;315;180;158;165;151;152;276;153;480;481;484;482;498;1165;1195;Indirect Specular;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.LightColorNode;568;-8776.997,-1046.661;Inherit;False;0;3;COLOR;0;FLOAT3;1;FLOAT;2
Node;AmplifyShaderEditor.BreakToComponentsNode;569;-8624.665,-1022.559;Inherit;False;FLOAT3;1;0;FLOAT3;0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.SimpleMaxOpNode;570;-8502.465,-1022.559;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMaxOpNode;571;-8385.465,-1003.059;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.StepOpNode;572;-8263.319,-1003.689;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0.001;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;574;-8127.507,-1096.09;Inherit;False;Constant;_Float9;Float 9;7;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;573;-8135.079,-1009.198;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.CustomExpressionNode;577;-7745.504,-1143.28;Inherit;False;int lightEnv = int(any(_WorldSpaceLightPos0.xyz))@       $if(lightEnv != 1){$	return 0@$	}$return 1@;0;Create;0;LightExists;True;False;0;;False;0;1;INT;0
Node;AmplifyShaderEditor.StaticSwitch;575;-7958.539,-1049.381;Inherit;False;Property;_Keyword0;Keyword 0;6;0;Create;True;0;0;0;False;0;False;0;0;0;False;UNITY_PASS_FORWARDBASE;Toggle;2;Key0;Key1;Fetch;False;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector3Node;583;-7615.39,-1450.422;Inherit;False;Constant;_FakeLightDir;Fake Light Dir;0;0;Create;True;0;0;0;False;0;False;1,1,2;1,1,2;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.NormalizeNode;592;-7435.062,-1444.377;Inherit;False;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.WorldSpaceLightDirHlpNode;582;-7620.742,-1299.493;Inherit;False;True;1;0;FLOAT;0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;576;-7599.785,-1141.652;Inherit;False;2;2;0;INT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;584;-7267.931,-1443.926;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;32;-7108.909,-1448.286;Inherit;False;lightDir;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.LerpOp;578;-6382.189,-1236.315;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;581;-6191.528,-1239.508;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;589;-6049.367,-1244.141;Inherit;False;InitialLightColor;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.LerpOp;580;-6549.264,-1117.713;Inherit;False;3;0;FLOAT;1;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;533;-6402.373,-1121.74;Inherit;False;Attenuation;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LightAttenuation;627;-7268.194,-919.065;Inherit;False;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;630;-6750.57,-945.21;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LightColorNode;632;-6610.046,-1257.027;Inherit;False;0;3;COLOR;0;FLOAT3;1;FLOAT;2
Node;AmplifyShaderEditor.ScaleAndOffsetNode;628;-7012.062,-1024.379;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0.5;False;2;FLOAT;0.5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;497;2291.574,109.3901;Inherit;False;Property;_OutlineColor;Outline Color;54;0;Create;True;0;0;0;True;0;False;0,0,0,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMinOpNode;1186;3999.04,82.15136;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1187;-3190.829,-1234.786;Inherit;False;Property;_BlendModeIndex;_BlendModeIndex;199;0;Create;True;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1188;-3185.829,-1146.786;Inherit;False;Property;_EnableOutline;EnableOutline;198;1;[Toggle];Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;1189;1625.512,1469.38;Inherit;False;Luma Glow Properties;55;;4913;7b40ef0e4b7a40f4f9276cd62640845c;1,260,0;2;1;COLOR;0,0,0,0;False;155;FLOAT3;0,0,0;False;3;FLOAT;244;FLOAT4;183;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;1192;1638.881,1686.992;Inherit;False;Outline Glow;0;;5052;a95beee5cd09a3848994f1983d4ef324;0;2;229;FLOAT3;0,0,0;False;42;FLOAT;1;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;214;-77.45105,524.8002;Inherit;False;1194;specColor2;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;1194;-1682.422,-688.542;Inherit;False;specColor2;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;567;-239.0434,2075.365;Inherit;False;1194;specColor2;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.LerpOp;1195;655.3516,589.0156;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;243;-1797.6,-3229.549;Inherit;False;Normal;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1199;-2353.866,-3113.582;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;2;False;1;FLOAT;0
Node;AmplifyShaderEditor.FaceVariableNode;1196;-2479.866,-3114.582;Inherit;False;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;1202;-8211.755,-915.814;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;276;40.03976,402.8723;Inherit;False;272;Occlusion;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;272;-2073.777,-2544.305;Inherit;False;Occlusion;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector4Node;629;-7279.346,-847.043;Inherit;False;Global;_WorldSpaceLightPos0;_WorldSpaceLightPos0;15;0;Fetch;True;0;0;0;False;0;False;0,0,0,0;-0.3735284,0.9245684,0.07516718,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TFHCRemapNode;1203;-2307.142,-2524.402;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;1204;-2481.142,-2447.402;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;588;-6632.768,-1357.06;Inherit;False;521;ToonAmbience;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;1206;-5854.693,1543.817;Inherit;False;243;Normal;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.WorldNormalVector;1207;-5688.562,1548.219;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.CustomExpressionNode;1205;-5475.976,1538.578;Inherit;False;half4 skyData = UNITY_SAMPLE_TEXCUBE_LOD(unity_SpecCube0, uvw, 5)@ //('cubemap', 'sample coordinate', 'map-map level')$         half3 skyColor = DecodeHDR (skyData, unity_SpecCube0_HDR)@$         return half4(skyColor, 1.0)@;3;Create;1;True;uvw;FLOAT3;0,0,0;In;;Inherit;False;ReflectionProbeSample;False;True;0;;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;1209;-5376.735,1616.537;Inherit;False;Constant;_Float23;Float 23;54;0;Create;True;0;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;1208;-5120.735,1361.537;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;1210;4586.708,44.20444;Inherit;False;Applfy Effects;228;;5068;86ee36ff59e1113469676c1c5ac8dd3c;0;7;31;COLOR;0,0,0,0;False;15;FLOAT3;0,0,1;False;16;COLOR;0,0,1,0;False;2;COLOR;0,0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;23;FLOAT;0;False;3;FLOAT4;0;FLOAT4;38;FLOAT4;39
...
WireConnection;790;0;1192;0
WireConnection;798;0;1189;183
WireConnection;798;1;1189;0
...
WireConnection;1031;0;1189;244
...
WireConnection;1029;0;1190;0
WireConnection;1118;0;1210;39
WireConnection;121;0;301;0
WireConnection;121;1;445;0
WireConnection;987;0;121;0
WireConnection;1117;0;1210;38
...
WireConnection;1189;1;787;0
WireConnection;1190;214;1133;0
WireConnection;1190;215;1135;0
WireConnection;1190;207;1127;0
WireConnection;1190;165;1095;0
WireConnection;1190;84;1048;0
WireConnection;1190;21;1011;0
WireConnection;1190;44;1027;0
WireConnection;1190;56;983;0
WireConnection;1192;229;789;0
WireConnection;1192;42;1189;244
WireConnection;851;0;850;0
WireConnection;44;0;1146;0
WireConnection;1194;0;381;0
WireConnection;498;0;484;0
WireConnection;498;1;484;0
WireConnection;1195;0;498;0
WireConnection;1195;1;215;0
WireConnection;1195;2;205;0
WireConnection;1143;0;255;0
WireConnection;243;0;1201;0
...
WireConnection;1202;0;571;0
WireConnection;272;0;1203;0
WireConnection;1203;0;386;2
WireConnection;1203;3;1204;0
WireConnection;1204;0;391;0
WireConnection;1207;0;1206;0
WireConnection;1205;0;1207;0
WireConnection;1208;0;520;0
WireConnection;1208;1;1205;0
WireConnection;1208;2;1209;0
WireConnection;1210;2;983;0
WireConnection;1210;3;988;0
