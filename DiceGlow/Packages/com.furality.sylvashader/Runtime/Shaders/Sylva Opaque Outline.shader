...
Shader "Furality/Sylva Shader/Sylva Opaque Outline"
{
	Properties
	{
	...
	SubShader
	{
		...
		void outlineVertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float3 worldToObjDir1060 = mul( unity_WorldToObject, float4( ( ( ase_worldNormal * min( ( lerpResult824 + ( lerpResult824 * eyeDepth ) ) , lerpResult829 ) * lerpResult11_g4562 ) + ( -ase_worldViewDir * _ViewFudge ) ), 0 ) ).xyz;
		...
		void outlineSurf( Input i, inout SurfaceOutput o )
		{
			...
			float3 temp_output_229_0_g4913 = OutlineRGB788.rgb;
			int EmissionReactiveBand236_g4913 = _OutlineReactiveBand;
			int Band3_g4914 = EmissionReactiveBand236_g4913;
			int Delay3_g4914 = 0;
			float localAudioLinkData3_g4914 = AudioLinkData3_g4914( Band3_g4914 , Delay3_g4914 );
			int temp_output_64_0_g4913 = step( _OutlineReactiveBand , 9 );
			float lerpResult66_g4913 = lerp( 1.0 , localAudioLinkData3_g4914 , (float)temp_output_64_0_g4913);
			int Band3_g4916 = _OutlineReactiveBand;
			float cos78_g4913 = cos( radians( _OutlineReactivePulseDir ) );
			float sin78_g4913 = sin( radians( _OutlineReactivePulseDir ) );
			float2 rotator78_g4913 = mul( i.uv_texcoord - float2( 0.5,0.5 ) , float2x2( cos78_g4913 , -sin78_g4913 , sin78_g4913 , cos78_g4913 )) + float2( 0.5,0.5 );
			float x96_g4913 = ( ( rotator78_g4913.x * _OutlineReactivePulseScale ) + _OutlineReactivePulseOffset );
			float y96_g4913 = 127.0;
			float localglslmod96_g4913 = glslmod96_g4913( x96_g4913 , y96_g4913 );
			float2 CenteredUV15_g4917 = ( i.uv_texcoord - _OutlineReactiveRadialCenter );
			float2 break17_g4917 = CenteredUV15_g4917;
			float2 appendResult23_g4917 = (float2(( length( CenteredUV15_g4917 ) * _OutlineReactivePulseScale * 2.0 ) , ( atan2( break17_g4917.x , break17_g4917.y ) * ( 1.0 / 6.28318548202515 ) * 1.0 )));
			float x97_g4913 = ( _OutlineReactivePulseOffset + appendResult23_g4917.x );
			float y97_g4913 = 127.0;
			float localglslmod97_g4913 = glslmod97_g4913( x97_g4913 , y97_g4913 );
			int EmissionReactiveMode99_g4913 = _OutlineReactiveMode;
			int temp_output_90_0_g4913 = ( EmissionReactiveMode99_g4913 - 1 );
			float lerpResult77_g4913 = lerp( localglslmod96_g4913 , localglslmod97_g4913 , (float)saturate( temp_output_90_0_g4913 ));
			...
			float DirectionalMap106_g4913 = temp_output_1074_244;
			float lerpResult174_g4913 = lerp( DirectionalMap106_g4913 , ( 1.0 - DirectionalMap106_g4913 ) , (float)saturate( ( EmissionReactiveMode99_g4913 - 3 ) ));
			float x98_g4913 = ( _OutlineReactivePulseOffset + ( _OutlineReactivePulseScale * lerpResult174_g4913 ) );
			float y98_g4913 = 127.0;
			float localglslmod98_g4913 = glslmod98_g4913( x98_g4913 , y98_g4913 );
			float lerpResult87_g4913 = lerp( lerpResult77_g4913 , localglslmod98_g4913 , (float)saturate( ( temp_output_90_0_g4913 - 1 ) ));
			float Delay3_g4916 = lerpResult87_g4913;
			float localAudioLinkLerp3_g4916 = AudioLinkLerp3_g4916( Band3_g4916 , Delay3_g4916 );
			float lerpResult102_g4913 = lerp( 1.0 , localAudioLinkLerp3_g4916 , (float)temp_output_64_0_g4913);
			float lerpResult103_g4913 = lerp( lerpResult66_g4913 , lerpResult102_g4913 , (float)saturate( EmissionReactiveMode99_g4913 ));
			int Band3_g4918 = _OutlineReactiveBand;
			float FilteredAmount3_g4918 = ( ( 1.0 - _OutlineReactiveGlobalSmoothing ) * 15.0 );
			float localAudioLinkLerp3_g4918 = AudioLinkLerp3_g4918( Band3_g4918 , FilteredAmount3_g4918 );
			float lerpResult168_g4913 = lerp( 1.0 , localAudioLinkLerp3_g4918 , (float)temp_output_64_0_g4913);
			float lerpResult172_g4913 = lerp( lerpResult103_g4913 , lerpResult168_g4913 , (float)saturate( ( EmissionReactiveMode99_g4913 - 4 ) ));
			float ReactivityAlpha132_g4913 = (_OutlineReactiveMinBrightness + (lerpResult172_g4913 - 0.0) * (( _OutlineReactiveMinBrightness + 1.0 ) - _OutlineReactiveMinBrightness) / (1.0 - 0.0));
			float4 temp_cast_10 = (1.0).xxxx;
			float4 lerpResult240_g4913 = lerp( temp_cast_10 , _OutlineReactiveTint , (float)step( EmissionReactiveBand236_g4913 , 9 ));
			float4 FinalReactivity68_g4913 = ( ReactivityAlpha132_g4913 * lerpResult240_g4913 );
			float4 temp_cast_12 = (1.0).xxxx;
			float3 temp_cast_13 = (1.0).xxx;
			int EmissionGlowZone47_g4913 = _OutlineGlowZone;
			int clampResult8_g4920 = clamp( EmissionGlowZone47_g4913 , 1 , 4 );
			int temp_output_3_0_g4920 = ( clampResult8_g4920 - 1 );
			int Zone16_g4920 = temp_output_3_0_g4920;
			float3 localgetThemeData16_g4920 = getThemeData( Zone16_g4920 );
			int Band11_g4921 = 56;
			int localIsLumaActive11_g4921 = IsLumaActive11_g4921( Band11_g4921 );
			int temp_output_14_0_g4920 = localIsLumaActive11_g4921;
			int lerpResult15_g4920 = lerp( temp_output_3_0_g4920 , ( 63 - temp_output_3_0_g4920 ) , (float)temp_output_14_0_g4920);
			int Band2_g4920 = lerpResult15_g4920;
			int Delay2_g4920 = 0;
			float3 localLumaGlowData2_g4920 = LumaGlowData2_g4920( Band2_g4920 , Delay2_g4920 );
			float3 lerpResult17_g4920 = lerp( ( localgetThemeData16_g4920 * localLumaGlowData2_g4920 ) , localLumaGlowData2_g4920 , (float)temp_output_14_0_g4920);
			int temp_output_21_0_g4913 = saturate( EmissionGlowZone47_g4913 );
			float3 lerpResult20_g4913 = lerp( temp_cast_13 , lerpResult17_g4920 , (float)temp_output_21_0_g4913);
			float3 temp_cast_17 = (1.0).xxx;
			int clampResult8_g4922 = clamp( EmissionGlowZone47_g4913 , 1 , 4 );
			int temp_output_3_0_g4922 = ( clampResult8_g4922 - 1 );
			int Zone15_g4922 = temp_output_3_0_g4922;
			float3 localgetThemeData15_g4922 = getThemeData( Zone15_g4922 );
			int Band11_g4923 = 56;
			int localIsLumaActive11_g4923 = IsLumaActive11_g4923( Band11_g4923 );
			int temp_output_13_0_g4922 = localIsLumaActive11_g4923;
			int lerpResult14_g4922 = lerp( temp_output_3_0_g4922 , ( 63 - temp_output_3_0_g4922 ) , (float)temp_output_13_0_g4922);
			int Band11_g4922 = lerpResult14_g4922;
			float cos6_g4913 = cos( radians( _OutlineGlowPulseDir ) );
			float sin6_g4913 = sin( radians( _OutlineGlowPulseDir ) );
			float2 rotator6_g4913 = mul( i.uv_texcoord - float2( 0.5,0.5 ) , float2x2( cos6_g4913 , -sin6_g4913 , sin6_g4913 , cos6_g4913 )) + float2( 0.5,0.5 );
			float x13_g4913 = ( ( rotator6_g4913.x * _OutlineGlowPulseScale ) + _OutlineGlowPulseOffset );
			float y13_g4913 = 127.0;
			float localglslmod13_g4913 = glslmod13_g4913( x13_g4913 , y13_g4913 );
			float2 CenteredUV15_g4915 = ( i.uv_texcoord - _OutlineGlowRadialCenter );
			float2 break17_g4915 = CenteredUV15_g4915;
			float2 appendResult23_g4915 = (float2(( length( CenteredUV15_g4915 ) * _OutlineGlowPulseScale * 2.0 ) , ( atan2( break17_g4915.x , break17_g4915.y ) * ( 1.0 / 6.28318548202515 ) * 1.0 )));
			float x12_g4913 = ( _OutlineGlowPulseOffset + appendResult23_g4915.x );
			float y12_g4913 = 127.0;
			float localglslmod12_g4913 = glslmod12_g4913( x12_g4913 , y12_g4913 );
			int EmissionGlowMode35_g4913 = _OutlineGlowMode;
			int temp_output_37_0_g4913 = ( EmissionGlowMode35_g4913 - 1 );
			float lerpResult5_g4913 = lerp( localglslmod13_g4913 , localglslmod12_g4913 , (float)saturate( temp_output_37_0_g4913 ));
			float lerpResult179_g4913 = lerp( DirectionalMap106_g4913 , ( 1.0 - DirectionalMap106_g4913 ) , (float)saturate( ( EmissionGlowMode35_g4913 - 3 ) ));
			float x34_g4913 = ( _OutlineGlowPulseOffset + ( _OutlineGlowPulseScale * lerpResult179_g4913 ) );
			float y34_g4913 = 127.0;
			float localglslmod34_g4913 = glslmod34_g4913( x34_g4913 , y34_g4913 );
			float lerpResult30_g4913 = lerp( lerpResult5_g4913 , localglslmod34_g4913 , (float)saturate( ( temp_output_37_0_g4913 - 1 ) ));
			float EmissionGlowDelay56_g4913 = lerpResult30_g4913;
			float Delay11_g4922 = EmissionGlowDelay56_g4913;
			float3 localLumaGlowLerp11_g4922 = LumaGlowLerp11_g4922( Band11_g4922 , Delay11_g4922 );
			float3 lerpResult17_g4922 = lerp( ( localgetThemeData15_g4922 * localLumaGlowLerp11_g4922 ) , localLumaGlowLerp11_g4922 , (float)temp_output_13_0_g4922);
			float3 lerpResult22_g4913 = lerp( temp_cast_17 , lerpResult17_g4922 , (float)temp_output_21_0_g4913);
			float3 lerpResult23_g4913 = lerp( lerpResult20_g4913 , lerpResult22_g4913 , (float)saturate( EmissionGlowMode35_g4913 ));
			float4 temp_cast_26 = (1.0).xxxx;
			float temp_output_10_0_g4924 = EmissionGlowDelay56_g4913;
			float Position1_g4926 = ( temp_output_10_0_g4924 / 127.0 );
			float4 localAudioLinkLerp1_g4926 = AudioLinkLerp1_g4926( Position1_g4926 );
			int clampResult8_g4924 = clamp( ( EmissionGlowZone47_g4913 - 4 ) , 1 , 3 );
			int Band11_g4924 = ( 59 - ( clampResult8_g4924 - 1 ) );
			float Delay11_g4924 = temp_output_10_0_g4924;
			float3 localLumaGlowLerp11_g4924 = LumaGlowLerp11_g4924( Band11_g4924 , Delay11_g4924 );
			int Band11_g4925 = 56;
			int localIsLumaActive11_g4925 = IsLumaActive11_g4925( Band11_g4925 );
			float4 lerpResult14_g4924 = lerp( localAudioLinkLerp1_g4926 , float4( localLumaGlowLerp11_g4924 , 0.0 ) , (float)localIsLumaActive11_g4925);
			float4 lerpResult52_g4913 = lerp( temp_cast_26 , lerpResult14_g4924 , (float)saturate( EmissionGlowZone47_g4913 ));
			float4 lerpResult51_g4913 = lerp( float4( lerpResult23_g4913 , 0.0 ) , lerpResult52_g4913 , (float)saturate( ( EmissionGlowZone47_g4913 - 4 ) ));
			float4 temp_cast_31 = (_OutlineGlowMinBrightness).xxxx;
			float4 temp_cast_32 = (( _OutlineGlowMinBrightness + 1.0 )).xxxx;
			int temp_output_234_0_g4913 = saturate( EmissionGlowZone47_g4913 );
			float4 EmissionGlow142_g4913 = ( (temp_cast_31 + (lerpResult51_g4913 - float4( 0,0,0,0 )) * (temp_cast_32 - temp_cast_31) / (float4( 1,1,1,1 ) - float4( 0,0,0,0 ))) * _OutlineGlowTint * temp_output_234_0_g4913 );
			float4 lerpResult248_g4913 = lerp( temp_cast_12 , EmissionGlow142_g4913 , (float)temp_output_234_0_g4913);
			float4 EmissionGlowTog250_g4913 = lerpResult248_g4913;
			float4 lerpResult146_g4913 = lerp( ( FinalReactivity68_g4913 * EmissionGlowTog250_g4913 ) , ( EmissionGlow142_g4913 + ( FinalReactivity68_g4913 * step( EmissionReactiveBand236_g4913 , 9 ) ) ) , (float)saturate( _OutlineReactiveBlendMode ));
			float4 ReversedReactivity152_g4913 = ( ( 1.0 - ReactivityAlpha132_g4913 ) * lerpResult240_g4913 );
			int temp_output_157_0_g4913 = ( _OutlineReactiveBlendMode - 1 );
			float4 lerpResult114_g4913 = lerp( lerpResult146_g4913 , ( EmissionGlowTog250_g4913 * ReversedReactivity152_g4913 ) , (float)saturate( temp_output_157_0_g4913 ));
			float4 lerpResult164_g4913 = lerp( lerpResult114_g4913 , ( EmissionGlow142_g4913 + ( ReversedReactivity152_g4913 * step( EmissionReactiveBand236_g4913 , 9 ) ) ) , (float)saturate( ( temp_output_157_0_g4913 - 1 ) ));
			int ReactiveBlendmode257_g4913 = _OutlineReactiveBlendMode;
			float x266_g4913 = (float)ReactiveBlendmode257_g4913;
			float y266_g4913 = 2.0;
			float localglslmod266_g4913 = glslmod266_g4913( x266_g4913 , y266_g4913 );
			float lerpResult253_g4913 = lerp( localglslmod266_g4913 , (float)_OutlineGlowBlendMode , (float)saturate( EmissionGlowZone47_g4913 ));
			float4 lerpResult222_g4913 = lerp( ( lerpResult164_g4913 * float4( temp_output_229_0_g4913 , 0.0 ) ) , ( lerpResult164_g4913 + float4( temp_output_229_0_g4913 , 0.0 ) ) , lerpResult253_g4913);
			float localIfAudioLinkv2Exists1_g4928 = IfAudioLinkv2Exists1_g4928();
			float4 lerpResult273_g4913 = lerp( float4( temp_output_229_0_g4913 , 0.0 ) , lerpResult222_g4913 , localIfAudioLinkv2Exists1_g4928);
			float4 OutlineGlow790 = lerpResult273_g4913;
		...
		inline float AudioLinkData3_g4914( int Band, int Delay )
		{
			return AudioLinkData( ALPASS_AUDIOLINK + uint2( Delay, Band ) ).rrrr;
		}


		inline float glslmod96_g4913( float x, float y )
		{
			return glsl_mod(x,y);
		}


		inline float glslmod97_g4913( float x, float y )
		{
			return glsl_mod(x,y);
		}


		inline float glslmod98_g4913( float x, float y )
		{
			return glsl_mod(x,y);
		}


		inline float AudioLinkLerp3_g4916( int Band, float Delay )
		{
			return AudioLinkLerp( ALPASS_AUDIOLINK + float2( Delay, Band ) ).r;
		}


		inline float AudioLinkLerp3_g4918( int Band, float FilteredAmount )
		{
			return AudioLinkLerp( ALPASS_FILTEREDAUDIOLINK + float2( FilteredAmount, Band ) ).r;
		}


		inline int IsLumaActive11_g4921( int Band )
		{
			return AudioLinkData( ALPASS_AUDIOLINK + uint2( 0, Band ) ).r;
		}


		inline float3 LumaGlowData2_g4920( int Band, int Delay )
		{
			return AudioLinkData( ALPASS_AUDIOLINK + uint2( Delay, Band ) );
		}
		...
		inline float glslmod13_g4913( float x, float y )
		{
			return glsl_mod(x,y);
		}


		inline float glslmod12_g4913( float x, float y )
		{
			return glsl_mod(x,y);
		}


		inline float glslmod34_g4913( float x, float y )
		{
			return glsl_mod(x,y);
		}
		...
		inline float4 AudioLinkLerp1_g4926( float Position )
		{
			return AudioLinkLerp( ALPASS_CCSTRIP + float2( Position * 128., 0 ) ).rgba;;
		}


		inline float3 LumaGlowLerp11_g4924( int Band, float Delay )
		{
			return AudioLinkLerp( ALPASS_AUDIOLINK + float2( Delay, Band ) );
		}


		inline int IsLumaActive11_g4925( int Band )
		{
			return AudioLinkData( ALPASS_AUDIOLINK + uint2( 0, Band ) ).r;
		}


		inline float glslmod266_g4913( float x, float y )
		{
			return glsl_mod(x,y);
		}


		float IfAudioLinkv2Exists1_g4928(  )
		{
			int w = 0; 
			int h; 
			int res = 0;
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float3 appendResult1195 = (float3(tex2DNode241.xy , ( tex2DNode241.b * ( ( i.ASEIsFrontFacing * 2.0 ) - 1.0 ) )));
			float3 Normal243 = appendResult1195;
			...
			float4 specColor21189 = lerpResult381;
			...
			float4 lerpResult213 = lerp( specColor21189 , temp_cast_266 , saturate( smoothstepResult482 ));
			float4 lerpResult204 = lerp( temp_cast_242 , lerpResult213 , metallic46);
			float lerpResult1190 = lerp( ( Smoothness90 * Smoothness90 ) , 1.0 , metallic46);
			float4 IndirectSpecular158 = ( float4( indirectSpecular151 , 0.0 ) * lerpResult204 * lerpResult1190 );
...
Node;AmplifyShaderEditor.CommentaryNode;563;-6117.17,1090.775;Inherit;False;1218.21;440.525;Comment;14;512;516;519;511;534;513;517;501;535;518;520;521;594;1203;Toon Ambience;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;217;-1594.872,200.3197;Inherit;False;2616.111;764.0852;Comment;33;174;175;156;204;162;213;205;214;215;203;161;202;166;200;201;191;181;208;315;180;158;165;151;152;276;153;480;481;484;482;498;1165;1190;Indirect Specular;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;214;-77.45105,524.8002;Inherit;False;1189;specColor2;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;567;-239.0434,2075.365;Inherit;False;1189;specColor2;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;5503.371,-421.687;Float;False;True;-1;5;FuralityShaderUI;0;0;CustomLighting;Furality/Sylva Shader/Sylva Opaque Outline;False;False;False;False;False;False;True;True;True;False;True;False;False;False;True;False;False;False;False;False;False;Back;0;False;;0;False;;False;0;False;;0;False;;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;All;12;all;True;True;True;True;0;False;;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;2;15;10;25;False;0.5;True;0;5;True;_BlendOPsrc;10;True;_BlendOPdst;0;5;False;;10;False;;0;False;;0;False;;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;-1;-1;-1;-1;0;False;0;0;True;_Culling;-1;0;True;_MaskClipValue;1;Include;;True;1ec20832dfbb48343b8e0764e0864276;Custom;False;0;0;;0;0;False;0.1;False;;0;False;;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1186;-3181.707,-1229.326;Inherit;False;Property;_BlendModeIndex;_BlendModeIndex;199;0;Create;True;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1187;-3176.707,-1141.326;Inherit;False;Property;_EnableOutline;EnableOutline;198;1;[Toggle];Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;1188;1647.364,1653.693;Inherit;False;Outline Glow;0;;4913;a95beee5cd09a3848994f1983d4ef324;0;2;229;FLOAT3;0,0,0;False;42;FLOAT;1;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;1189;-1680.999,-693.1841;Inherit;False;specColor2;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.LerpOp;1190;721.666,543.4408;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;243;-1807.6,-3300.549;Inherit;False;Normal;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1191;-2368.606,-3115.381;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;2;False;1;FLOAT;0
Node;AmplifyShaderEditor.FaceVariableNode;1192;-2494.606,-3116.381;Inherit;False;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;1197;-2323.367,-2533.421;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;1198;-2497.367,-2456.421;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;1199;-5942.224,1557.256;Inherit;False;243;Normal;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.WorldNormalVector;1200;-5776.093,1561.658;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
WireConnection;1188;229;789;0
WireConnection;1188;42;1074;244
WireConnection;1143;0;255;0
WireConnection;44;0;1146;0
WireConnection;1189;0;381;0
WireConnection;204;0;1165;0
WireConnection;204;1;213;0
WireConnection;204;2;205;0
WireConnection;1190;0;498;0
WireConnection;1190;1;215;0
WireConnection;1190;2;205;0
WireConnection;243;0;1195;0
WireConnection;1191;0;1192;0
WireConnection;1193;0;1191;0
WireConnection;1194;0;241;3
WireConnection;1194;1;1193;0
WireConnection;1195;0;241;0
WireConnection;1195;2;1194;0
WireConnection;246;1;269;0
WireConnection;1196;0;571;0
WireConnection;1197;0;386;2
WireConnection;1197;3;1198;0
WireConnection;1198;0;391;0
